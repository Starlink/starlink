...
Gaussclumps \citep[][\ascl{1406.018}]{1990ApJ...356..513S},
and CLUMPFIND. One of the aims of the CUPID package is to make it easy to compare
clump-finding algorithms by ensuring that the results are written out in a common format.
In common with the rest of the Starlink software \citep[][\ascl{1110.012}]{StarlinkAdass},
