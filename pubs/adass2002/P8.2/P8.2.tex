...
\author{Alasdiar Allan}
\affil{School of Physics, University of Exeter, Stoker Road, Exeter  EX4 4QL, United Kingdom }
\author{Tim Jenness}
\affil{Joint Astronomy Center, 660 N. A`oh\=ok\=u Place, University Park, Hilo, HI 96720}
...
The Starlink Software Collection (USSC) runs on three separate
...
been problematic due to the complex web of inter-dependences such
...
Collection}{http://www.starlink.ac.uk/} (USSC) is a large collection of
