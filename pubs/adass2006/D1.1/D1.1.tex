...
The \htmladdnormallinkfoot{GAIA}{http://www.starlink.ac.uk/gaia} 
application has been a popular choice for examining and analysing
...
PLASTIC protocol has been used to inter-operate with VO-enabled applications.
\end{abstract}
...
supported (using the
\htmladdnormallink{AST}{http://www.starlink.ac.uk/ast} library).
...
\htmladdnormallinkfoot{SPLAT-VO}{http://www.starlink.ac.uk/splat}
tool, or any other
\htmladdnormallink{PLASTIC}{http://plastic.sourceforge.net}
