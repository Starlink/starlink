...
\stardocinitials    {SUN}
\stardocnumber      {82.4}
\stardocauthors     {D C Parsons, H J Walker}
\stardocdate        {21 June 1993}
\stardoctitle       {IRAS --- Data Products Primer}
%------------------------------------------------------------------------------
...
\xref{SUN/106}{sun106}{} (SCAR --- Beginner's Guide) and \xref{SUN/70}{sun70}{} (Starlink Catalogue Access and
...
\end{itemize}
\begin{description}
\item [\xref{SUN/80.3}{sun80}{}] `IRAS90 --- Extraction and
Preparation of IRAS Images' provides details of all these
processes.
\item [\xref{SUN/163}{sun163}{}] `IRAS90 --- Survey and PO Data Analysis Package --- Reference
...
\end{itemize}
\begin{description}
\item [\xref{SUN/161}{sun161}{}] `IRAS90 --- Introductory/User Guide to Calibrated Reconstructed
...
applications.
\item [\xref{SUN/95}{sun95}{}] `KAPPA --- Kernel Application Package' provides full details of
...
environment.
\begin{description}
\item [\xref{SUN/161}{sun161}{}] `IRAS90 --- Introductory/User Guide to Calibrated
...
time consuming task. Details of the data you will receive are given in \xref{SUN/161}{sun161}{}.
...
format which can be handled by the spectral analysis program DIPSO (\xref{SUN/50}{sun50}{}).
...
database, see \xref{SUN/14}{sun14}{}.
...
\item CALIBRATED RAW DETECTOR DATA (CRDD) --- see \xref{SUN/161}{sun161}{}\\
...
\item LOW RESOLUTION SPECTROMETER (LRS) SPECTRA --- see \xref{SUN/81}{sun81}{} and \xref{SUN/14}{sun14}{}\\
