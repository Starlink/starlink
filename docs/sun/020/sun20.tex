...
\stardocinitials    {SUN}
\stardocnumber      {20.4}
\stardocauthors     {M J Murray, D J Stickland}
\stardocdate        {30 June 1993}
\stardoctitle       {ULDA/USSP --- Accessing the IUE Uniform Low-Dispersion Archive}
%------------------------------------------------------------------------------
...
to the six-month data retrieval rule). See \xref{SUN/58}{sun58}{} for details.
Most UK astronomers now reduce their IUE data from the photometric
images available in the archive using IUEDR (\xref{SUN/37}{sun37}{}).   However,
...
The reader  is referred to \xref{SUN/50}{sun50}{} for a full description of DIPSO.
