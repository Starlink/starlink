...
% \htmladdnormallink{CCDPACK}{http://www.starlink.rl.ac.uk/ccdpack/} package, 

For users of Starlink software,
this coordinate information can be attached automatically
...
\htmladdnormallinkfoot{{\tt WFC-b.ast}}{ftp://capc23.ast.cam.ac.uk/pub/star/register/WFC-b.ast}

There are a couple of provisos for using this facility:
first, it is best if the files are converted to Starlink NDF format
using the \xref{CONVERT}{sun55}{}
package as follows:
\begin{squote}
\begin{verbatim}
% convert
...
\end{verbatim}
\end{squote}
which will convert file {\tt r106280.fits} into {\tt r106280.sdf} and so on.
...
\htmladdnormallink{{\tt WFC-b.ast}}{ftp://capc23.ast.cam.ac.uk/pub/star/register/WFC-b.ast}
...
In this way, applying the {\tt WFC-b.ast} file to any set of 
...
\begin{quote}
\begin{center}
\latexhtml{\includegraphics[scale=0.4]{r106282-s8-display.ps}}{\htmladdimg{r106282-display.gif}}
\end{center}
\end{quote}
Close inspection will show that the grid is not parallel to the 
sides of the image, because of the slight rotation from the vertical
...
This calibration was done with assistance from 
