...
\newcommand{\stardocnumber}    {220.2}
\newcommand{\stardocauthors}   {A J Chipperfield}
\newcommand{\stardocdate}      {7 July 1997}
\newcommand{\stardoctitle}     {IRAFFIG\\
                                Figaro for IRAF}
\newcommand{\stardocversion}   {1.1}
\newcommand{\stardocmanual}    {}
\newcommand{\stardocabstract}  {
The general data reduction system,
\xref{Figaro}{sun86}{},
may now be run from the
\htmladdnormallink{IRAF}{\IRAFURL}
CL. The IRAFFIG package
...
\par
The main sources of documentation for users of Figaro from IRAF are
\xref{SUN/217}{sun217}{},
which gives some general guidance on running Starlink applications from IRAF
CL, and
\xref{SUN/86}{sun86}{}
which gives more specific information about the Figaro applications.}
...
\htmladdnormallink{IRAF}{\IRAFURL}
CL.
IRAFFIG contains the IRAF-specific files for Figaro and must be installed in
addition to Figaro itself for the system to work. IRAFFIG Version 1.1 is
suitable for use with FIGARO V5.2-0.

IRAFFIG will eventually be incorporated into the standard Starlink Figaro
release.

\section{Documentation}
This document is not intended as the main reference for users of Figaro from
IRAF \dash\ some general guidance on running Starlink applications from IRAF
CL is given in
\xref{SUN/217}{sun217}{},
and more specific information about the Figaro applications in
\xref{SUN/86}{sun86}{}
...
To run Figaro applications from IRAF CL you will require the following Starlink
software items:
\begin{description}
\item[\xref{FIGARO}{sun86}{}] The main Figaro package.
\item[IRAFFIG] The IRAF-specific components of Figaro.
