...
You can use the \picard\ recipe \drrecipe{SCUBA2\_MAPSATS} get the
...
reductions of a single observations. On coadded observations it could
...
executs the following steps to get the map noise.
