...
night and each individual observation can be used to determine an FCF value.
...
the FCF calculated from the calibrator observations performed close in time 
