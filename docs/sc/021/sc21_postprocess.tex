...
masking (see \cref{Section}{sec:masking}{Masking}). You can see
where any masks were applied by viewing the QUALITY component in
\gaia.
...
algorithms FellWalker\cite{fellwalker}, Gaussclumps, ClumpFind or Reinhold
and must supply a configuration file specific to each method. See the
