...
\sstroutine{
   ...
   \sstdescription{
      ...
      {\tt{"}}\xref{com.corr\_abstol}{sun258}{com.corr\_abstol}{\tt{"}}. Note - any initial iterations
...
\sstroutine{
   ...
   \sstdescription{
      ...
      filter to be skipped. See also parameter {\tt{"}}\xref{com.sig\_wing}{sun258}{com.sig\_wing}{\tt{"}}. [0]
   }
   \sstattributetype{
      real
   }
...
\sstroutine{
   ...
   \sstdescription{
      Together with parameter {\tt{"}}\xref{filt\_edge\_smallscale}{sun258}{filt\_edge\_smallscale}{\tt{"}}, this
      ...
      {\tt{"}}\xref{filt\_edgehigh}{sun258}{filt\_edgehigh}{\tt{"}} and parameter {\tt{"}}\xref{filt\_edgelow}{sun258}{filt\_edgelow}{\tt{"}}. For example,
...
\sstroutine{
   ...
   \sstdescription{
      This is the value to be used for parameter {\tt{"}}\xref{flt.filt\_edge\_largescale}{sun258}{flt.filt\_edge\_largescale}{\tt{"}}
