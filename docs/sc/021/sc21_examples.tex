...
\cref{Section}{sec:mf}{Point-source extraction} and Appendix~\ref{app:mf}).
\\ \\
...
removed in doing so (see Section \ref{sec:filt} and 
...
of 4 (pixels) for the FWHM parameter (since the default pixel size at 850 microns is 4 arcseconds).
