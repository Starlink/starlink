...
using the parameters \xparam{AST.ZERO_UNION}{ast.zero_union},
\xparam{FLT.ZERO_UNION}{flt.zero_union} and \xparam{COM.ZERO_UNION}
{com.zero_union}. By default, the union is used.
