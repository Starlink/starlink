...
This is done by:
\begin{terminalv}
% oracdr -files inputlist.txt -loop file 
\end{terminalv}
...
\begin{terminalv}
% oracdr -files inputlist.txt -loop file  -verbose
\end{terminalv}
...
\begin{terminalv}
% oracdr -files inputlist.txt -loop file  -log sf -verbose
\end{terminalv}
...
\begin{terminalv}
% oracdr -file mylist -loop file -log sf REDUCE_SCAN_CHECKRMS
\end{terminalv}
...
\begin{terminalv}
% oracdr -file mylist -loop file -log sf -recpars myparams.ini REDUCE_SCAN_CHECKRMS
\end{terminalv}
