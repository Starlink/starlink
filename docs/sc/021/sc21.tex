...
together. The three-letter code for each model is then appended to the filename (such as
...
Normally blank-field map would subsequently have a applied to it to aid
source detection (see \cref{Section}{sec:mf}{Point-source detection}),
...
\myfigduo{sc21_cosmo1-def}{sc21_cosmo1-bf}{[b!]}{width=0.47\linewidth}{fig:bfcompare}{3mm}{
...
\myfigduo{sc21_gal_def}{sc21_gal_brex}{[h!]}{width=0.47\linewidth}{fig:becompare}{3mm}{
...
\cref{Section}{sec:dimm}{The Dynamic Iterative Map-Maker}, all of
the settings for the map-maker are
...
\myfig{sc21_850cosmo_mf_crop_snr}{}{width=0.6\linewidth}{fig:snrmask}{
  Signal-to-noise map made the \Kappa\ command \texttt{makesnr}.
...
\cref{Figure}{fig:mask}{this figure}. The next step is to smooth this map by convolving it
