...
com.zero\_mask & 0  &s&Use if wish to provide an external COM mask. Must specify this on the command-line.  \\
...
while they both use the map-maker.
...
configuration parameters are identical.}
...
It is likely the first step, with the inclusion of \texttt{ast.zero\_snrlo}, will produce a perfectly good map and you may decide subsequent steps may be unneccesary. Nevertheless this example will cover the other main techniques if you wish to experiemnt further with masking options.
