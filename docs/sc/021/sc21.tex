\documentclass[11pt,oneside]{starlink}
...
\begin{tip}
TIP: An up-caret (\,\texttt{\^}\,) is required any time you are reading in
...
\begin{tip}
  TIP: The list of files can be the output from \texttt{cat}. Remember
...
\begin{enumerate}
\item (1) Crops the map to remove the noisy edges.
\begin{terminalv}
% picard CROP_JCMT_IMAGES map_cal.sdf
\end{terminalv}
\item (2) Runs the \Kappa\ command \stats\ to extract the median value from
the error array.
\begin{terminalv}
...
\myfig{sc21_dispmask3}{[hb!]}{width=0.95\linewidth}{fig:maskdisp}{
...
\newpage
\section{\xlabel{fits}Convert format from FITS to NDF}
\label{app:fits}
...
\subsection{\file{dimmconfig\_bright\_extended.lis}}
\begin{quote}
\begin{verbatim}
...
\subsection{\file{dimmconfig\_bright\_compact.lis}}
\begin{terminalv}
...
\subsection{\file{dimmconfig\_blank\_field.lis}}
\begin{terminalv}
   ^$STARLINK_DIR/share/smurf/dimmconfig.lis
...
\subsection{\file{dimmconfig\_bright.lis}}
