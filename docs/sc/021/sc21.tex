...
% LaTex2HTML has problem with coloured text swapping it from the
% myquote context to the main text.
...
\titleformat{\section}[display]
    ...
    {}
    {0pt}
    {Chapter \thesection:\hspace{0.8cm}}
...
is encountered (see \cref{Chapter}{sec:raw}{Handling Raw SCUBA-2 Data}).}
The variance and quality for the data are stored as the VARIANCE and QUALITY
...
Sub-Millimetre User Reduction Facility} MNRAS, 430, 2545
...
camera on the James Clerk Maxwell Telescope}, MNRAS, 430, 2513
