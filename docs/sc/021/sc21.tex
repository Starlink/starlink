...
TIP: You can write out the error array of your map into a new NDF
...
out the QUALITY component of the data to a separate file using \task{ndfcopy}.
\begin{myquote}
\begin{verbatim}
...
\gaiathing{Choose file...} file browser.
