...
Normally blank-field map would subsequently have a applied to it to aid source detection (see Section~\ref{sec:mf}),
...
\end{verbatim}
\end{myquote}
The output is shown in the left-hand panel of Figure~\ref{fig:bfnoi}.
...
maps is under development. Follow the \emph{Pipelines and Archives
...
\end{latexonly}
\begin{htmlonly}
\includegraphics[width=136mm]{sc21_gal12_crop.eps}
\end{htmlonly}
