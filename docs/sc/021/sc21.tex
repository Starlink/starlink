...
pipeline. \cref{Chapter}{sec:dimm}{The map-maker explained}
...
\cref{Chapter}{sec:pipe}{SCUBA-2 Pipeline} gives instruction on
...
is encountered (see \cref{Chapter}{sec:raw}{Raw SCUBA-2 Data}).} The variance
