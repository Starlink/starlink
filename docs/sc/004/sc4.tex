...
\newcommand{\stardocsource}    {sc4.3}
\newcommand{\stardocnumber}    {4.3}
\newcommand{\stardocauthors}   {Malcolm J. Currie}
\newcommand{\stardocdate}      {2005 November 4}
...
%\latexonly{{\em Function} & \begin{tabular}{c}Number of \\ arguments \end{tabular} & Description \\}
...
\htmlref{expression}{sc4_se_csharith}\latexonly{ (see
