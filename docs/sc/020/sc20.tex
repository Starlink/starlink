...
extensions ({\texttt PROEXTS}) and history records \texttt{PROHIS}),
...
A common one in the submillimetre world is the CLASS package used
...
This will create a \texttt{ga20091011\_37\_1\_reduced.fit} file with the
CLASS-style of WCS headers.
