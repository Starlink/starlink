...
\section{Opening a spectrum in GAIA}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=0.9\linewidth]{sc20_splat_window}
\typeout{sc20_splat_window inserted on page \arabic{page}}
\includegraphics[width=0.8\linewidth]{sc20_splat_spectrum}
...
\caption[The main \splat\ window and spectrum window.]{\label{fig:splat_window}
  Top: The main \splat\ window, Bottom: the spectral window.}
\end{center}
\end{figure}
