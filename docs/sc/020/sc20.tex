...
The extent of an NDF section can be specified as an arc-distance using WCS coordinates in the format of \guithing{"centre~extent"}.

For instance \guithing{'image(10:12:30~40am,-23:23:43~40am)'} will create a section of extent 40 arc-minutes on both axes ("as" and "ad" can be used in place of "am", indicating arc-seconds and arc-degrees).

This only works if the NDFs current Frame is a SkyFrame (an error is reported otherwise).
