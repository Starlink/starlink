...
\label{fig:display3}
\caption[Displaying a spectrum with \Kappa:\display.]{
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=0.55\linewidth]{sc20_display4}
\typeout{sc20_display4 inserted on page \arabic{page}}
\label{fig:display4}
\caption[Displaying a zoomed-in spectrum with \Kappa:\display.]{
...
\label{fig:display5}
\caption[Displaying two super-imposed spectra with \Kappa:\display.]{
...
\label{fig:display7}
\caption[Displaying two super-imposed spectra with \Kappa:\display.]{Displaying two
