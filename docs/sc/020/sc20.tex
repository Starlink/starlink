...
% arcminute symbol
\providecommand{\arcm}{\si{\arcminute}}%\hbox{$^{\prime$}}}

% arcsec symbol
\providecommand{\arcsec}{\si{\arcsecond}}%\arcm\hspace{-0.1em}\arcm}
...
$l$=60.$\udeg$87, $b$=0.$\udeg$18. Use existing \file{style.dat} except
