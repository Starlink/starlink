...
\textbf{Parameter} & \textbf{Description} \\
\hline
CALCULATE\_STANDARD\_ALWAYS & If set true (1), this will ensure that the \file{log.standard}
...
\hline
NOSIDEBANDCORR & If set to 1, this will prevent any sideband-calibration correction
                 factor from being applied to the data.\\

SIDEBAND &  Set the sideband (e.g. USB or LSB) to use when applying the sideband
