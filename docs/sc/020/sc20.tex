...
\caption[Change the units of the current spectrum.]{\label{fig:splat_units1}
  Top: Select the \splatthing{Change the units of the current spectrum}
  button. Note that in this example the current units are Frequency.
  Bottom: the \splatthing{Current spectrum units} window.}
\end{center}
\end{figure}
...
\caption[Spectrum with units of km/s.]{\label{fig:splat_units3}
...
\caption[Select the crop button in SPLAT.]{\label{fig:splat_crop1}
  Top: Select the cut button. Bottom: Select the \splatthing{Add} button.}
\end{center}
\end{figure}
...
\caption[Selected regions for removal.]{\label{fig:splat_crop2}
  ...
  by clicking the \splatthing{remove selected} button.}
\end{center}
\end{figure}
...
\caption[Filter regions of a spectrum window.]{\label{fig:splat_rebin}
  Top: The \splat\ \splatthing{Filter regions of a spectrum window}.
...
\caption[Select the stats button.]{\label{fig:splat_stats1}
  Top: Select the stats button. Bottom: Select the \splatthing{Add}
  button.}
\end{center}
\end{figure}
