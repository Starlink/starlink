...
is shown in Figure \ref{fig:telluric1}. In this figure we use the average
spectrum feature (see Section \ref{sec:gaiaaverage} -- and in this example
 -- we see expected bright emission around 7 km/s. In addition to the
expected bright emission we see some faint emission around -30 km/s.
...
\caption[An example of unexpected emission seen in \gaia.]{\label{fig:telluric1}
  An example of a spectrum with bright expected emission around 7 km/s and
unexpected emission around -30 km/s. The data are displayed using
\gaia.}
\end{center}
\end{figure}

We can use \splat to investigate this emission further (see Section \ref{sec:gaiatosplat}
on how to open up a spectrum in \splat\).
...
\caption[blah]{\label{fig:telluric3}
  Select \guithing{Observer} from the \guithing{Standard of rest} Menue and select
\guithing{Apply}.}
\end{center}
\end{figure}

We then use the drop down menue next to \guithing{Standard of rest} to select
...
\caption[blah]{\label{fig:telluric4}
  Spectrum from the observer rest frame. We see the unexpected line is found at 0 km/s
and is likely telluric contamination.}
\end{center}
\end{figure}

Now we see the unexpected line is at 0 km/s and is therfore likely to be
