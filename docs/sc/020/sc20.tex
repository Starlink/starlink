...
Efficiencies}{http://www.jach.hawaii.edu/JCMT/spectral_line/Standards/beameff_acsis.html}.
...
\myfig{sc20_makecube-outcat}{[h!]}{width=1\linewidth}{fig:makecube-outcat}{Displaying receptor positions in \gaia.}{
  ...
  your \param{OUTCAT} filename (here
...
the tiles to be abutted have the same pixel coordinates.  Each tile
