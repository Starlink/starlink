...
\section{\xlabel{software}Options for Reducing you Data}
...
\section{\xlabel{makecube}Identifying and Masking Bad Data}
\label{sec:badrecs}
...
\section{\xlabel{rebin}Main beam conversion}
\label{sec:mult}
...
\section{\xlabel{coords}Changing coordinate frames}
...
\section{\xlabel{recipes}The process}
...
\section{\xlabel{running_pl}Starting the pipeline}
\label{sec:runpl}
...
\section{\xlabel{convert}Converting a FITS file to NDF}
