...
#
# It employs KAPPA's GREYPLOT and NDFCOPY to do the work.
...
# Display the input image.
  ...
  greyplot in=$fname device=xw mode=perc percentiles='[10,90]' key=true
...
# Redisplay image by way of confirmation.
  greyplot in=$fname2 device=xw mode=perc percentiles='[10,90]' key=true
