...
\verb+/star+---one place to look is {\tt \$STARLINK\_DIR}---then
...
\xref{\tt{display}}{sun95}{DISPLAY} to look at the image:
...
\xref{\tt{xdisplay}}{sun129}{}\cite{xdisplay} command to ensure
...
To do this, use the {\sc kappa} command \xref{\tt{rotate}}{sun95}{ROTATE}.
...
{\sc kappa} \xref{\tt{flip}}{sun95}{FLIP} to do this:
...
\xref{\tt{fitslist}}{sun95}{FITSLIST}
...
\xref{\tt{cursor}}{sun95}{CURSOR} command:
...
\xref{\tt{iscrunch}}{sun86}{ISCRUNCH} program in order to correct and calibrate your data files:
...
We can now finally use this normalised spectrum to correct our observed data using the  \xref{{\sc figaro}}{sun86}{} \xref{\tt{isxdiv}}{sun86}{ISXDIV} command:
...
running \xref{\tt{echmenu}}{sun152}{ECHMENU}
...
by eye, or using the {\sc figaro} command \xref{\tt{icur}}{sun86}{ICUR}
...
\xref{\tt{creobj}}{sun86}{CREOBJ} and
\xref{\tt{setobj}}{sun86}{SETOBJ}:
...
try \xref{\tt{echmenu} Option~2}{sun152}{option2}\@.
...
\xref{\tt{echmenu}}{sun152}{ECHMENU} is generally fine, however,
...
use \xref{{\sc kappa}}{sun95}{} \xref{\tt{display}}{sun95}{DISPLAY}
...
\xref{\tt{echmenu}}{sun152}{ECHMENU} doesn't work, and you haven't been
