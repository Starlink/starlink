...
\stardocnumber      {7.2}
\stardocauthors     {Martin Clayton and Anthony Holloway}
\stardocdate        {15 June 1998}
\stardoctitle       {Simple Spectroscopy Reductions}
\startitlepic{%
...
planning to use \xref{\textsc{ccdpack}}{sun139}{}\cite{ccdpack} or
\xref{\textsc{figaro}}{sun86}{}\cite{figaro}, to do the preparation.
...
reductions with \xref{\textsc{echomop}}{sun152}{}\cite{echomop}\@.
...
\begin{figure}
\begin{center}
  \scspec{\leavevmode\includegraphics[height=105mm]{sc7_01}}
         {\leavevmode\includegraphics[height=136mm]{sc7_01}}
...
\begin{figure}
\begin{center}
  \scspec{\leavevmode\includegraphics[height=105mm]{sc7_01b}}
         {\leavevmode\includegraphics[height=136mm]{sc7_01b}}
...
\item [\textbf{Arc frames}]
      Exposures taken with an \htmlref{arc lamp}{gl_arc_lamp}
...
It is important to \emph{\htmlref{bracket}{gl_bracketing}} the science data exposures with
...
\htmlref{bracketing}{gl_bracketing} each science exposure in the same
...
wavelength-scale reference (\htmlref{arc}{gl_arc_lamp}) frames should be
taken \htmlref{bracketing}{gl_bracketing} the science exposures
\emph{if} \htmlref{wavelength scales}{gl_wavelength} are required
...
\item [\textbf{Generate master \htmlref{bias frame}{gl_bias_frame}}]
...
\item [\textbf{Generate master \htmlref{flat-field frame(s)}{gl_flat_field}}]
...
\xref{\textsc{ccdpack}}{sun139}{} and \xref{\textsc{figaro}}{sun86}{}\@.
...
\begin{figure}
\begin{center}
  \scspec{\leavevmode\includegraphics[height=105mm]{sc7_02}}
          {\leavevmode\includegraphics[height=136mm]{sc7_02}}
...
as a \htmlref{\emph{template}}{gl_template_order} for the extraction.
...
\begin{figure}
\begin{center}
  \scspec{\leavevmode\includegraphics[height=105mm]{sc7_07}}
         {\leavevmode\includegraphics[height=136mm]{sc7_07}}
...
\begin{figure}
\begin{center}
  \scspec{\leavevmode\includegraphics[height=105mm]{sc7_08}}
         {\leavevmode\includegraphics[height=136mm]{sc7_08}}

  \parbox{140mm}{
    \caption{Line Identification: a typical plot during interactive
             fitting with \xref{\textbf{echmenu}}{sun152}{}.}
...
\htmlref{arc lamp}{gl_arc_lamp},  perhaps obtained using
...
\begin{figure}
\begin{center}
  \scspec{\leavevmode\includegraphics[height=105mm]{sc7_09}}
         {\leavevmode\includegraphics[height=136mm]{sc7_09}}
...
\xref{\textsc{kappa}}{sun95}{}\cite{kappa} and
\xref{\textsc{echomop}}{sun152}{}\cite{echomop} and so get a display
something like:
...
\xref{\textbf{echmenu}}{sun152}{ECHMENU},
...
correctly.  To do this use \xref{\textsc{kappa}}{sun95}{}
\xref{\textbf{display}}{sun95}{DISPLAY} to look at the image:
...
\xref{\textbf{xdisplay}}{sun129}{}\cite{xdisplay} command to ensure
...
To do this, use the \textsc{kappa} command \xref{\textbf{rotate}}{sun95}{ROTATE}.
...
\textsc{kappa} \xref{\textbf{flip}}{sun95}{FLIP} to do this:
...
The spectrum extraction is done using the \xref{\textsc{echomop}}{sun152}{}
...
The first stage is to start \xref{\textbf{echmenu}}{sun152}{ECHMENU}:
...
\xref{\texttt{ech\_rdctn}}{sun152}{par_ECH_RDCTN} parameter,
...
The \xref{\texttt{soft}}{sun152}{par_SOFT} parameter points output
graphs to our existing \verb+xwindows+ screen.
Don't worry about \xref{\texttt{tune\_mxskypix}}{sun152}{par_TUNE_MXSKYPIX}
...
\begin{figure}
\begin{center}
  \scspec{\leavevmode\includegraphics[height=100mm]{sc7_10}}
         {\leavevmode\includegraphics[height=136mm]{sc7_10}}

   \parbox{140mm}{
   \caption{Order location: a cross-dispersion section produced using
            \textbf{echmenu} Option~1 {\sl Start a reduction.}}
...
\xref{\texttt{trc\_npoly}}{sun152}{par_TRC_NPOLY} selects the number of
...
\begin{figure}
\begin{center}
  \scspec{\leavevmode\includegraphics[height=100mm]{sc7_11}}
         {\leavevmode\includegraphics[height=136mm]{sc7_11}}
...
If you didn't specify \xref{\texttt{tune\_mxskypix=31}}{sun152}{par_TUNE_MXSKYPIX} when you started this
...
You should set
\xref{\texttt{pfl\_interact}}{sun152}{par_PFL_INTERACT} to \verb+yes+
...
\begin{figure}
\begin{center}
  \scspec{\leavevmode\includegraphics[height=100mm]{sc7_12}}
         {\leavevmode\includegraphics[height=136mm]{sc7_12}}

  \parbox{140mm}{
    \caption{Finding the dekker-limits of the slit: a plot of a section
             through a flat field, produced using \textbf{echmenu} Option~4.1
...
\xref{\texttt{photon\_to\_adu}}{sun152}{par_PHOTON_TO_ADU} (gain) value and
\xref{\texttt{readout\_noise}}{sun152}{par_READOUT_NOISE}\@.
You can do this using \xref{\textsc{kappa}}{sun95}{}
\xref{\textbf{fitslist}}{sun95}{FITSLIST}
...
\textbf{echmenu} \xref{Option~7 {\sl Model object profile}}{sun152}{option7}
...
\xref{\textbf{echmenu}}{sun152}{ECHMENU} has an
...
There are two stages to \xref{\textbf{echmenu}}{sun152}{ECHMENU}
...
\textbf{echmenu} \xref{Option~10 {\sl Identify features}}{sun152}{option10}
...
\xref{\texttt{ech\_ftrdb=\$ARCDIRS/CUAR}}{sun152}{par_ECH_FTRDB} and
\xref{\texttt{arc\_type=\$ARCDIRS/CUAR.ARC}}{sun152}{par_ARC_TYPE}\@.
...
If you select
\xref{\texttt{auto\_id=true}}{sun152}{par_AUTO_ID},
...
\xref{\texttt{hi\_wave}}{sun152}{par_HI_WAVE} and
\xref{\texttt{low\_wave}}{sun152}{par_LOW_WAVE} are limits on the wavelength
...
\xref{\texttt{max\_dispersion}}{sun152}{par_MAX_DISPERSION} and
\xref{\texttt{min\_dispersion}}{sun152}{par_MIN_DISPERSION} are the limits on the
...
\xref{\texttt{w\_npoly}}{sun152}{par_W_NPOLY} is the number of coefficients
...
Enter \verb+11+ at the main \xref{\textbf{echmenu}}{sun152}{ECHMENU} prompt
...
\xref{\texttt{blz\_interact=y}}{sun152}{par_BLZ_INTERACT} selects
interactive adjustment of the fit.
\xref{\texttt{blz\_npoly}}{sun152}{par_BLZ_NPOLY} sets the number of
...
You can produce NDFs which \xref{\textsc{dipso}}{sun50}{}\cite{dipso},
\xref{\textsc{kappa}}{sun95}{} and \xref{\textsc{figaro}}{sun86}{} can read,
...
Here
\xref{\texttt{ech\_rducd}}{sun152}{par_ECH_RDUCD} is the rather opaque-sounding
prompt for `output file name';
\xref{\texttt{result\_format}}{sun152}{par_RESULT_FORMAT} is \verb+NDF+,
select \verb+ASCII+ for a listing instead;
\xref{\texttt{result\_type}}{sun152}{par_RESULT_TYPE} should be set to
...
\begin{figure}
\begin{center}
  \scspec{\leavevmode\includegraphics[height=105mm]{sc7_13}}
         {\leavevmode\includegraphics[height=136mm]{sc7_13}}
...
major packages simply by typing their names.
For example, we are going to use
\xref{\textsc{figaro}}{sun86}{}\cite{figaro}, \xref{\textsc{kappa}}{sun95}{}\cite{kappa} and
\xref{\textsc{twodspec}}{sun16}{}\cite{twodspec} and so get a display
something like:
...
This can be done using \xref{\textsc{kappa}}{sun95}{}
\xref{\textbf{display}}{sun95}{DISPLAY}:
...
extend over. To do this we can use the \xref{\textsc{kappa}}{sun95}{}
\xref{\textbf{cursor}}{sun95}{CURSOR} command:
...
To carry out the fitting we use the \xref{\textsc{twodspec}}{sun16}{}
...
\begin{figure}
\begin{center}
\scspec{\leavevmode\includegraphics[height=105mm]{sc7_14}}
       {\leavevmode\includegraphics[height=136mm]{sc7_14}}
...
Enter \texttt{18} and press return. The next question asks if you wish to
...
\begin{figure}
\begin{center}
  \scspec{\leavevmode\includegraphics[height=105mm]{sc7_15}}
         {\leavevmode\includegraphics[height=136mm]{sc7_15}}
...
\begin{figure}
\begin{center}
  \scspec{\leavevmode\includegraphics[height=105mm]{sc7_16}}
         {\leavevmode\includegraphics[height=136mm]{sc7_16}}
...
\begin{figure}
\begin{center}
  \scspec{\leavevmode\includegraphics[height=105mm]{sc7_17}}
          {\leavevmode\includegraphics[height=136mm]{sc7_17}}
...
\begin{figure}
\begin{center}
  \scspec{\leavevmode\includegraphics[height=105mm]{sc7_18}}
         {\leavevmode\includegraphics[height=136mm]{sc7_18}}
...
The .iar file can be used by the \xref{\textsc{figaro}}{sun86}{}
\xref{\textbf{iscrunch}}{sun86}{ISCRUNCH} program in order to correct
...
\begin{figure}
\begin{center}
  \scspec{\leavevmode\includegraphics[height=105mm]{sc7_19}}
         {\leavevmode\includegraphics[height=136mm]{sc7_19}}
...
\begin{figure}
\begin{center}
  \scspec{\leavevmode\includegraphics[height=105mm]{sc7_20}}
          {\leavevmode\includegraphics[height=136mm]{sc7_20}}
...
\xref{\textsc{figaro}}{sun86}{} \xref{\textbf{cfit}}{sun86}{CFIT} command:
...
observed data using the \xref{\textsc{figaro}}{sun86}{}
\xref{\textbf{isxdiv}}{sun86}{ISXDIV} command:
...
\begin{figure}
\begin{center}
  \scspec{\leavevmode\includegraphics[height=105mm]{sc7_21}}
          {\leavevmode\includegraphics[height=136mm]{sc7_21}}
...
to use the \xref{\textsc{twodspec}}{sun16}{}\cite{twodspec} \textsc{longslit} package or \xref{\textsc{dipso}}{sun50}{}\cite{dipso}.
...
\subsection{\mlabel{cook_parameter_editor}How to Use the \textbf{echmenu}
            Parameter Editor}

In the \htmlref{worked example}{simple_worked_example}
\xref{\textbf{echmenu}}{sun152}{ECHMENU} was extensively used.
\xref{\textsc{echomop}}{sun152}{} is very flexible; there are a large number of
...
This is useful as normally \xref{\texttt{tune\_mxskypix}}{sun152}{par_TUNE_MXSKYPIX} will simply take its default
value (21) without ever prompting.

Another method for checking and setting parameter values is to use the
parameter editor built in to \textbf{echmenu}\@.  If, for example, you want
to inspect the parameters for
\xref{Option~4 {\sl Determine dekker/object extent}}{sun152}{option4},
you type \verb+-4+ at the main \textbf{echmenu} prompt:
...
\xref{{\sc{kappa}}}{sun95}{}.
The simplest is \xref{\texttt{fitslist}}{sun95}{FITSLIST} which displays
...
Another use for \xref{\texttt{fitslist}}{sun95}{FITSLIST} might be to
...
\xref{\textbf{echmenu}}{sun152}{option10}\@.
...
Another common use for \xref{\textbf{fitslist}}{sun95}{FITSLIST} is to
...
Two invocations of \textbf{fitslist} will get all the information needed:
...
The second \textbf{grep} searches for both `gain' and `adu' at the same
...
running \xref{\textbf{echmenu}}{sun152}{ECHMENU}
...
be done with a series of \xref{\textsc{figaro}}{sun86}{} commands:
...
by eye, or using the \textsc{figaro} command \xref{\textbf{icur}}{sun86}{ICUR}
to measure the display.

Once you have decided where the spectrum is, you can write this into the
\textsc{echomop}
\xref{reduction structure file}{sun152}{reduction_file} using \textsc{figaro}
\xref{\textbf{creobj}}{sun86}{CREOBJ} and
\xref{\textbf{setobj}}{sun86}{SETOBJ}:
...
try \xref{\textbf{echmenu} Option~2}{sun152}{option2}\@.


\subsection{\mlabel{cook_tracing}Tracing Strategies}

Usually the default value \texttt{C}, `centroid' for
\xref{\texttt{trace\_mode}}{sun152}{par_TRACE_MODE} works reasonably
well. Running \xref{\textbf{echmenu}}{sun152}{ECHMENU} \xref{Option~3
...
To trace a flat field, proceed in the normal way, but set \xref{\texttt{trace\_mode=e}}{sun152}{par_TRACE_MODE} which stands for `edges':
...
When modelling a spectrum \xref{\textsc{echomop}}{sun152}{} assumes by default
...
by the parameter \xref{\texttt{tune\_mxskypix}}{sun152}{par_TUNE_MXSKYPIX}\@.

You can use \xref{\textsc{figaro}}{sun86}{} to display a slice across an image
of the spectrum,
...
\xref{\textbf{echmenu}}{sun152}{ECHMENU} is generally fine, however,
...
done by setting \xref{\texttt{tune\_ffinter=yes}}{sun152}{par_TUNE_FFINTER}\@.
...
use \xref{\textsc{kappa}}{sun95}{} \xref{\textbf{display}}{sun95}{DISPLAY}
to inspect that image.  Within the \xref{\textsc{echomop}}{sun152}{}
package there is a stand-alone task for extracting the `flattened' field
\xref{\texttt{ech\_genflat}}{sun152}{option30}\@.
...
\xref{\textbf{echmenu}}{sun152}{ECHMENU} doesn't work, and you haven't been
...
To try this, set the parameter \xref{\texttt{tune\_revchk=true}}
...
or using the \textbf{echmenu} \htmlref{parameter editor}
...
the documentation for \xref{\textsc{FIGARO}}{sun86}{}
...
\item {\bf\label{gl_comparison}Comparison Spectrum}\\
      A spectrum from a known source, typically an \htmlref{arc lamp}{gl_arc_lamp},
...
\item {\bf\label{gl_dst}DST}\\
      A data format used by some versions of \xref{\textsc{figaro}}{sun86}{}.
      The \xref{\textsc{convert}}{sun55}{} utility provides facilities for
...
\bibitem{detut} Francisco Valdes,\\
      ...
      \texttt{http://www.starlink.ac.uk/iraf/web/tutorials/doslit/doslit.html},
      \\
      April 1994.
