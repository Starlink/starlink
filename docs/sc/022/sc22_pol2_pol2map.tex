...
This CALCQU tool creates time series holding Q and U values from a set of POL-2
...
parameter called ``\texttt{pca.pcathresh}'' although \poltwomap,
...
MAPVAR is a \poltwomap\ parameter that controls how the variances in the
