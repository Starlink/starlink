...
This \xref{calcqu}{sun258}{CALCQU} tool creates time series holding I, Q
and U values from a set of POL-2 time series holding raw data values. The
supplied time-series data files are first flat-fielded, cleaned and concatenated,
before being used to create the I, Q and U values. The I, Q and U time-series
are down-sampled to 2Hz (i.e. they contain two I, Q or U samples per second),
