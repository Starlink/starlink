...
is then compared to the coadd in order to determine a pointing correction
...
If \param{MAPVAR} is set \texttt{TRUE}, the variances in the coadded I, Q and U maps
