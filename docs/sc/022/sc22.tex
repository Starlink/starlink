...
\stardocinitials {SC}
\stardoccopyright{Copyright \copyright\ 2017 East Asian Observatory}
\stardocnumber   {22.1}
...
\stardocabstract {
   ...
   reduce the data, including an overview of the method. It also
   describes how to calibrate and display the data as images or
   vector maps.}
\stardocauthors{H.\ A.\ L.\ Parsons, D.\ S.\ Berry, M.\ G.\ Rawlings, and S.\ F.\ Graves}
\stardocdate{2017 June 27}
...
\textbf{I$_{p}$}     & Polarized Intensity \\
...
\newpage
\input{sc22_intro.tex}
\newpage
\input{sc22_pol2_overview.tex}
\newpage
\input{sc22_pol2_pol2map.tex}
\newpage
\input{sc22_run_pol2map.tex}
\newpage
\input{sc22_pol2_image_display.tex}
\newpage
\input{sc22_pol2_advanced.tex}
\newpage
