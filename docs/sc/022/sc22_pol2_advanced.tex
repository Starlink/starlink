...
observations with pre-existing \task{pol2map} reduction products.
...
can be used to conduct such an investigation. To use it, run \task{pol2map} twice,
as follows:
...
the catalogue \file{mycat.FIT} using \task{pol2map}, uses \textsc{Topcat}
