...
bolomtere camera on the JCMT \cite{Friberg}.
...
the POL-2 polarimeter for SCUBA-2 is a single beam polarimeter. 
The POL-2 polarimeter utilizes three optical components
...
850μm and absorbs somewhat at 450μm, depending on the thickness and ambient
temperature. The total transmission of the HWP integrated across the 850
and 450μm filter bands are about 86\% and 57\% respectively 
...
\caption [POL-2 mounted on SCUBA-2]{
  \small POL-2 mounted on SCUBA-2. The left image shows the SCUBA-2
