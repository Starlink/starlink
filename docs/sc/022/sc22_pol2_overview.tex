...
at \SI{850}{\micro\metre} only\footnote{\SI{450}{\micro\metre} data can
in fact be processed using the same commands as \SI{850}{\micro\metre}
data, but the noise levels and other possible artefacts have not yet been
fully characterised. Note, the default pixel size at 450 is 4 arc-seconds}.
