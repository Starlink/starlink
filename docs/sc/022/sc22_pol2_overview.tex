...
following expressions provide good approximations to correct the measurement for
...
IP correction of a POL-2 map therefore requires the use of a total intensity map
...
command \calcqu---used to calculate
