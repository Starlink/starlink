...
\caption [POL-2 mounted on SCUBA-2]{POL-2 mounted on the front of
  ...
  analyzer grid. The calibrator grid is only inserted for test
  purposes.}
\end{center}
\end{figure}
...
\section{Instrument Polarisation}
...
IP correction of a POL-2 map therefore requires the use of a total
intensity map of the same area of the sky to be available. This total
intensity map is referred to as the IP reference map.

Where flat mirrors or surfaces will produce a small, constant
