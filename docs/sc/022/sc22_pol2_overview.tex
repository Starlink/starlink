...
At the resolution of JCMT, planets such as Uranus should appear as unpolarized point sources.
...
In order to determine the true Q and U from an astronomical source it is necessary to correct
...
Thus to perform IP correction on a POL-2 map requires a total intensity map of the same area
