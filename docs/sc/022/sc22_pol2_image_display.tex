...
catalogue from \xref{\textsc{Gaia}}{sun214}{}\ or using the Starlink package
\xref{\textsc{Polpack}}{sun223}{} to manipulate
...
To then select the vectors of interest:

\begin{terminalv}
% polselect in=mycat.FIT out=selcat.FIT mode=expr "exp=?i>10*di && (ast>0)?"
\end{terminalv}

The use of the \xref{\textsc{Polpack}}{sun223}{} \task{polselect} command is
