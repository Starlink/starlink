...
\newcommand{\stardocnumber}    {77.3}
\newcommand{\stardocauthors}   {D.J. Allan}
\newcommand{\stardocdate}      {5 November 1993}
\newcommand{\stardoctitle}     {NBS \\ [1ex] The Noticeboard System V2.4}
\newcommand{\stardocversion}   {Version 2.4.1}
...
\newcommand{\sstdescription}[1]{\item[Description:] \mbox{} \\ #1}
...
The purpose of release V2.4.1 is to make NBS available for the DEC Alpha
...
The only loss in functionality is that {\tt NBS\_GET\_INFO} no longer
accepts the {\tt SAVE\_NAME} option. The new routine {\tt NBS\_GET\_CINFO}
...
\sstroutine{
   ...
   \sstinvocation{
      (Int) = NBS\_DEFINE\_PRIMITIVE \\ (ENVSID,NAME,TYPE,MAXDIMS,MAXBYTES,
           SID,STATUS)
   }
   \sstarguments{
      \sstsubsection{
