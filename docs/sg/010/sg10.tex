...
\newcommand{\HTTPGref}{\htmladdnormallink{\tt http://www.ast.cam.ac.uk/AAO/astronomers.ht}{http://www.ast.cam.ac.uk/AAO/astronomers.html}}
...
\subsection{The {\STARLINKref} Software Collection} \xlabel{STARLINK}
\label{sec:starlink}
...
\subsection{ASTUTIL -- {\IRAFref}} \xlabel{ASTUTIL}
\label{sec:astutil} 
...
\subsection{PREDICT -- {\RGOref}} \xlabel{PREDICT}
\label{sec:predict}
