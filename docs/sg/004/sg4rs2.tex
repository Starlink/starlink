...
\begin{description}
\item [On graphics/image devices:]
\begin{description}
...
\begin{description}
\item [Fabry-Perot infra-red grating spectrometer:]
\begin{description}
