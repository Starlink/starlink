...
\begin{htmlonly}
   \renewcommand{\latexonlysection}[1]{#1}
   \renewcommand{\latexonlysubsection}[1]{#1}
   \renewcommand{\latexonlysubsubsection}[1]{#1}
\end{htmlonly}
%  Title Page.
%  ===========
...
by the
{\em \htmladdnormallink{Starlink Project Group}
{http://star-www.rl.ac.uk/pro.html}}\/ 
within the
