...
\stardocdate        {23rd~March~1992}
\stardoctitle       {Starlink Application Programming Standard}
...
\section{\xlabel{preface}PREFACE}
...
is to promote \textit{software portability}.  What is meant by this
...
\textit{Absolute Portability}, \textit{Portable Fortran},
\textit{Adaptable Fortran}\, and \textit{Laissez-Faire}.

\textbf{ABSOLUTE PORTABILITY} is where application source code
