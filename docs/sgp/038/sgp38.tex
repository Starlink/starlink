...
be described fully
\latexelsehtml{in Section~\ref{se:ndf}).}{\htmlref{here.)}{se:ndf}}  The NDF
...
\latexelsehtml{in Section~\ref{se:ndf}}{\htmlref{here}{se:ndf}}
and the meaning of the TYPEs in
\latexelsehtml{Section~\ref{se:natyvar}.}{\htmlref{Naming, Types and Variants.}{se:natyvar}} 
...
\latexelsehtml{Section~\ref{se:newdesign}.}{\htmlref{Creating New
...
\latexelsehtml{in Section~\ref{se:badpixel}.}{\htmlref{here.}{se:badpixel}}
...
\latexelsehtml{Sections~\ref{se:basic}}{\htmlref{Low-Level Structures}{se:basic}} and 
\latexelsehtml{\ref{se:ndf}}{\htmlref{The Extensible n-dimensional Format}{se:ndf}} 
...
\latexelsehtml{Section~\ref{se:charset};}{\htmlref{Character Set;}{se:charset}}
...
\latexelsehtml{Section~\ref{se:shistory}.}{\htmlref{$<${\bf
HISTORY}$>$ Structure.}{se:history}}
...
\latexelsehtml{Section~\ref{se:Propag}}{\htmlref{Propagation}{se:propag}}),
...
\latexelsehtml{Section~\ref{se:exten}}{\htmlref{Extensions}{se:exten}})
...
\latexelsehtml{Section~\ref{se:notation}.}{\htmlref{Notation and
Pseudo-types.}{se:notation}}
...
rules given in 
\latexelsehtml{Section~\ref{se:overview}}{\htmlref{Overview}{se:overview}}
