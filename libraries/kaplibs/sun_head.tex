...
\item Replace old IRCAM-specific NXTNAM routine with the more-general
      KPG\_ISEQN.  This increments trailing sequence numbers in
      strings, most often used to generate a series of filenames.
...
\begin{tabular}{lcc}
COPYAx  & \multicolumn{2}{l}{VEC\_xTOx or KPG1\_COPY} \\
COPY1D  & {\tt "}   & {\tt "}  \\
COPY2D  & {\tt "}   & {\tt "}  \\
COPY3D  & {\tt "}   & {\tt "}  \\
