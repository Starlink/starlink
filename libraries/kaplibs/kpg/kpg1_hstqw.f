      SUBROUTINE KPG1_HSTQW( BAD, EL, INARR, NUMBIN, OLDHST, MAP,
     :                         OUTARR, STATUS )
*+
*  Name:
*     KPG1_HSTQx
...
*  Local Variables:
      ...
      INTEGER*2 MAXMUM             ! Maximum value in array
      INTEGER MAXPOS             ! Position of maximum found in array
      INTEGER*2 MINMUM             ! Minimum value in array
...
*  histogram.  Derive the number of good pixels.
      CALL KPG1_MXMNW( BAD, EL, INARR, NINVAL, MAXMUM, MINMUM,
...
*  Generate the histogram between those bounds.
      CALL KPG1_GHSTW( BAD2, EL, INARR, NUMBIN, MAXMUM, MINMUM,
     :                   OLDHST, STATUS )
...
*  create an equalised output array.
      CALL KPG1_RMAPW( EL, INARR, MAXMUM, MINMUM, NUMBIN, MAP, OUTARR,
     :                   STATUS )
