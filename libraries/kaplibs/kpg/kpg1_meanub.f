      SUBROUTINE KPG1_MEANUB( N, DATA, MEAN, STATUS )
*+
*  Name:
*     KPG1_MEANx
...
*        The data array.
*     MEAN = ? (Returned)
*        The mean value.  Set to VAL__BADUB if no good data are found.
