      SUBROUTINE KPG1_RFCOD( FD, DIM1, DIM2, POSCOD, COUNT, CODATA,
...
*  Arguments Given and Returned:
      INTEGER COUNT
      DOUBLE PRECISION CODATA( DIM1, DIM2 )
      DOUBLE PRECISION LBND( DIM1 )
      DOUBLE PRECISION UBND( DIM1 )
...
*  Local Variables:
      ...
      DOUBLE PRECISION JUNK               ! Numeric value in column to be skipped
...
*  should be annulled within a new error context.
                     ...
                     NCO = INDEXS
                     CALL KPG1_FFRD( BUFFER, 1, NCO, JUNK, STATUS )
...
*  delimiter.  To use the same system as KPG1_FFRD, pointer must be
...
*  numeric value required for the co-ordinates.
               NVAL = NVAL + 1
               J = INDPOS( NVAL )
               CALL KPG1_FFRD( BUFFER, 1, INDEXS, CODATA( J, COUNT ),
     :                           STATUS )
