      SUBROUTINE KPG1_HSTAR( BAD, EL, DATA, NUMBIN, NUMPER, PERCNT,
...
*  Local Variables:
      ...
      REAL MAXMUM             ! Maximum data value
      REAL MINMUM             ! Minimum data value
...
*  needed later and for ease of display.
      CALL KPG1_MXMNR( BAD, EL, DATA, NINVAL, MAXMUM, MINMUM,
     :                   IMAX, IMIN, STATUS )
      DMAX = NUM_RTOD( MAXMUM )
      DMIN = NUM_RTOD( MINMUM )
...
*  Generate the histogram between those bounds.
         CALL KPG1_GHSTR( BAD2, EL, DATA, NUMBIN, MAXMUM, MINMUM,
     :                      HIST, STATUS )
