      SUBROUTINE KPG1_HSTAUW( BAD, EL, DATA, NUMBIN, NUMPER, PERCNT,
...
*  Local Variables:
      ...
      INTEGER*2 MAXMUM             ! Maximum data value
      INTEGER*2 MINMUM             ! Minimum data value
...
*  needed later and for ease of display.
      CALL KPG1_MXMNUW( BAD, EL, DATA, NINVAL, MAXMUM, MINMUM,
     :                   IMAX, IMIN, STATUS )
      DMAX = NUM_UWTOD( MAXMUM )
      DMIN = NUM_UWTOD( MINMUM )
...
*  Generate the histogram between those bounds.
         CALL KPG1_GHSTUW( BAD2, EL, DATA, NUMBIN, MAXMUM, MINMUM,
     :                      HIST, STATUS )
