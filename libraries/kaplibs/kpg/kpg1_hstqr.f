      SUBROUTINE KPG1_HSTQR( BAD, EL, INARR, NUMBIN, OLDHST, MAP,
     :                         OUTARR, STATUS )
*+
*  Name:
*     KPG1_HSTQx
...
*  Local Variables:
      ...
      REAL MAXMUM             ! Maximum value in array
      INTEGER MAXPOS             ! Position of maximum found in array
      REAL MINMUM             ! Minimum value in array
...
*  histogram.  Derive the number of good pixels.
      CALL KPG1_MXMNR( BAD, EL, INARR, NINVAL, MAXMUM, MINMUM,
...
*  Generate the histogram between those bounds.
      CALL KPG1_GHSTR( BAD2, EL, INARR, NUMBIN, MAXMUM, MINMUM,
     :                   OLDHST, STATUS )
...
*  create an equalised output array.
      CALL KPG1_RMAPR( EL, INARR, MAXMUM, MINMUM, NUMBIN, MAP, OUTARR,
     :                   STATUS )
