      SUBROUTINE KPG1_TRLIB( NDIMI, IDIMS, INARR, VAR, INVAR, TRID,
...
*  Local Variables:
      ...
      INTEGER NCOUT            ! Number of values in the forward
                               ! transformation
      BYTE NEIGH( 2 ** NDF__MXDIM ) ! Vector of input data values
      ...
      INTEGER STRIDO( NDF__MXDIM ) ! Dimension strides for output arrays
                               ! and co-ordinates
      BYTE VNEIGH( 2 ** NDF__MXDIM ) ! Vector of input variance
