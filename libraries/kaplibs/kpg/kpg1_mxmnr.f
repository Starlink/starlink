      SUBROUTINE KPG1_MXMNR( BAD, EL, ARRAY, NINVAL, MAXMUM, MINMUM,
...
*  Use signed integers for the comparisons.
         IMAX = NUM_RTOI( MAXMUM )
         IMIN = NUM_RTOI( MINMUM )
...
*  Convert the integers back to the unsigned-integer type for export.
         MAXMUM = NUM_ITOR( IMAX )
         MINMUM = NUM_ITOR( IMIN )
      END IF
