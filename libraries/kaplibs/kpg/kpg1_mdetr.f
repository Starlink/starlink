      SUBROUTINE KPG1_MDETR( N, EL, ARRAY, WORK1, WORK2, DET, STATUS )
*+
*  Name:
*     KPG1_MDETx
...
*  Local Variables:
      REAL DETSIG              ! Sign of the determinant
      LOGICAL EVEN               ! If true the rows were interchanged an
                                 ! even number of times
      INTEGER I                  ! Loop counter
      REAL VALMAX              ! Logarithm of the maximum value
...
*  Perform the LU decomposition.
      CALL KPG1_LUDCR( N, EL, ARRAY, WORK1, WORK2, EVEN, STATUS )
