      SUBROUTINE KPG1_TRBOR( NDIMI, LBND, UBND, TRID, NDIMO, COMIN,
     :                         COMAX, STATUS )
*+
*  Name:
*     KPG1_TRBOx
...
*  Local Variables:
      REAL BOUNDI( MAXPTS, NDF__MXDIM ) ! Input co-ordinates
      REAL BOUNDO( MAXPTS, NDF__MXDIM ) ! Output co-ordinates
...
*   of the input array.
      CALL TRN_TRNR( .FALSE., MAXPTS, NCOUT, EL, BOUNDI,
...
*   co-ordinate system.
         DO I = 1, EL
            IF ( BOUNDO( I, IAXIS ) .NE. VAL__BADR ) THEN
