      SUBROUTINE KPG1_ISCLB( BAD, DIM1, DIM2, INARR, INVERT, LOWER,
...
*    if the scaling cannot be performed.
      ...
      IF ( ABS( DU - DL ) .LT. NUM_BTOD( VAL__SMLB ) ) THEN
         STATUS = SAI__ERROR
