      SUBROUTINE KPG1_ISCLR( BAD, DIM1, DIM2, INARR, INVERT, LOWER,
...
*    if the scaling cannot be performed.
      ...
      IF ( ABS( DU - DL ) .LT. NUM_RTOD( VAL__SMLR ) ) THEN
         STATUS = SAI__ERROR
...
*                Look for bad pixels.
                  ...
                  IF ( INARR( J, K ) .EQ. VAL__BADR ) THEN
                     OUTARR( J, I ) = BADVAL
                  ELSE
...
*                Look for bad pixels.
                  ...
                  IF ( INARR( J, I ) .EQ. VAL__BADR ) THEN
                     OUTARR( J, I ) = BADVAL
                  ELSE
