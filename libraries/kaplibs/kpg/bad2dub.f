      SUBROUTINE BAD2DUB( DIM1, DIM2, LBND, UBND, ARRAY, STATUS )
*+
*  Name:
*     BAD2DUB
...
*  Invocation:
*     CALL BAD2DUB( DIM1, DIM2, LBND, UBND, ARRAY, STATUS )
...
*     ARRAY( DIM1, DIM2 ) = _UBYTE (Given and Returned)
