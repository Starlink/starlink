      SUBROUTINE KPG1_HSTAB( BAD, EL, DATA, NUMBIN, NUMPER, PERCNT,
...
*  needed later and for ease of display.
      CALL KPG1_MXMNB( BAD, EL, DATA, NINVAL, MAXMUM, MINMUM,
     :                   IMAX, IMIN, STATUS )
      DMAX = NUM_BTOD( MAXMUM )
      DMIN = NUM_BTOD( MINMUM )
...
*  Generate the histogram between those bounds.
         CALL KPG1_GHSTB( BAD2, EL, DATA, NUMBIN, MAXMUM, MINMUM,
     :                      HIST, STATUS )
