      SUBROUTINE KPG1_MXMNI( BAD, EL, ARRAY, NINVAL, MAXMUM, MINMUM,
...
*  Use signed integers for the comparisons.
         IMAX = NUM_ITOI( MAXMUM )
         IMIN = NUM_ITOI( MINMUM )
...
*  Convert the integers back to the unsigned-integer type for export.
         MAXMUM = NUM_ITOI( IMAX )
         MINMUM = NUM_ITOI( IMIN )
      END IF
