      SUBROUTINE KPG1_CADDUB( BAD, EL, A, CONST, B, NERR, STATUS )
*+
*  Name:
*     KPG1_CADDx
...
*  External References:
      ...
      BYTE VAL_DTOUB          ! Convert from double precision
 
*  Local Variables:
      BYTE UBCON              ! Type converted constant
      INTEGER I                  ! Loop counter for array elements
      LOGICAL ALLBAD             ! Set output array all bad?
 
*  Internal References:
      INCLUDE 'NUM_DEC_CVT'      ! NUM_ type conversion functions
      INCLUDE 'NUM_DEC_UB'      ! NUM_ arithmetic/maths functions
...
*  Convert the constant to be added to the appropriate data type.
      ALLBAD = .FALSE.
      UBCON = VAL_DTOUB( .FALSE., CONST, STATUS )
