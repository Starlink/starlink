      SUBROUTINE KPG1_IS3D( ORDDAT, DDAT, PDAT, NENT, STATUS )
*+
*  Name:
*     KPG1_IS3D
...
*  Invocation:
*     CALL KPG1_IS3D( ORDDAT, DDAT, PDAT, NENT, STATUS )
...
*        Original version.
*     28-MAY-1992 (PDRAPER):
*        Added ancilliary data sort - integer and DOUBLE PRECISION types.
