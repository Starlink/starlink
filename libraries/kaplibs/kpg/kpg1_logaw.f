      SUBROUTINE KPG1_LOGAW( BAD, EL, INARR, VAR, INVAR, BASE, OUTARR,
...
*  Input array pixel is good.  Compute the output value.
                  OUTARR( J ) = NUM_DTOW( FACTOR *
     :                          LOG( NUM_WTOD( INARR( J ) ) ) )
