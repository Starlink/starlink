      SUBROUTINE KPG1_CSUBW( BAD, EL, A, CONST, B, NERR, STATUS )
*+
*  Name:
*     KPG1_CSUBx
...
*  External References:
      ...
      INTEGER*2 VAL_DTOW          ! Convert from double precision
 
*  Local Variables:
      INTEGER*2 WCON              ! Type converted constant
      INTEGER I                  ! Loop counter for array elements
      LOGICAL ALLBAD             ! Set output array all bad?
 
*  Internal References:
      INCLUDE 'NUM_DEC_CVT'      ! NUM_ type conversion functions
      INCLUDE 'NUM_DEC_W'      ! NUM_ arithmetic/maths functions
...
*  Convert the constant to be subtracted to the appropriate data type.
      ALLBAD = .FALSE.
      WCON = VAL_DTOW( .FALSE., CONST, STATUS )
