      SUBROUTINE KPG1_HSTAW( BAD, EL, DATA, NUMBIN, NUMPER, PERCNT,
...
*  needed later and for ease of display.
      CALL KPG1_MXMNW( BAD, EL, DATA, NINVAL, MAXMUM, MINMUM,
     :                   IMAX, IMIN, STATUS )
      DMAX = NUM_WTOD( MAXMUM )
      DMIN = NUM_WTOD( MINMUM )
...
*  Generate the histogram between those bounds.
         CALL KPG1_GHSTW( BAD2, EL, DATA, NUMBIN, MAXMUM, MINMUM,
     :                      HIST, STATUS )
