      SUBROUTINE KPG1_CADDI( BAD, EL, A, CONST, B, NERR, STATUS )
*+
*  Name:
*     KPG1_CADDx
...
*  External References:
      ...
      INTEGER VAL_DTOI          ! Convert from double precision
 
*  Local Variables:
      INTEGER ICON              ! Type converted constant
      INTEGER I                  ! Loop counter for array elements
      LOGICAL ALLBAD             ! Set output array all bad?
 
*  Internal References:
      INCLUDE 'NUM_DEC_CVT'      ! NUM_ type conversion functions
      INCLUDE 'NUM_DEC_I'      ! NUM_ arithmetic/maths functions
...
*  Convert the constant to be added to the appropriate data type.
      ALLBAD = .FALSE.
      ICON = VAL_DTOI( .FALSE., CONST, STATUS )
