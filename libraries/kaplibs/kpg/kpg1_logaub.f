      SUBROUTINE KPG1_LOGAUB( BAD, EL, INARR, VAR, INVAR, BASE, OUTARR,
...
*  Input array pixel is good.  Compute the output value.
                  OUTARR( J ) = NUM_DTOUB( FACTOR *
     :                          LOG( NUM_UBTOD( INARR( J ) ) ) )
