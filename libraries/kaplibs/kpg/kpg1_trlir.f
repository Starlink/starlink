      SUBROUTINE KPG1_TRLIR( NDIMI, IDIMS, INARR, VAR, INVAR, TRID,
...
*  Local Variables:
      ...
      INTEGER NCOUT            ! Number of values in the forward
                               ! transformation
      REAL NEIGH( 2 ** NDF__MXDIM ) ! Vector of input data values
      ...
      INTEGER STRIDO( NDF__MXDIM ) ! Dimension strides for output arrays
                               ! and co-ordinates
      REAL VNEIGH( 2 ** NDF__MXDIM ) ! Vector of input variance
