      SUBROUTINE KPG1_HSSTP( NUMBIN, HIST, VALMAX, VALMIN,
...
*  Invocation:
*     CALL KPG1_HSSTP( NUMBIN, HIST, VALMAX, VALMIN, SUM, MEAN,
*                      MEDIAN, MODE, STATUS )
...
*        Original version based on HSTPRP.  Performs calculations in
*        double precision so that this routine may be used in
*        conjunction with generic routines.
*     1996 March 11 (MJC):
