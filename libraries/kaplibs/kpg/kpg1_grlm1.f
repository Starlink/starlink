...
*  Copyright:
*     Copyright (C) 1999, 2000, 2004 Central Laboratory of the Research Councils.
*     All Rights Reserved.
...
*  Find the data limits, including error bars if supplied.
     ...
     :                SIGMA( I ) .NE. VAL__BADR ) THEN
                     DMIN = MIN( DMIN, D1( I ) - NSIGMA*SIGMA( I ) )
                     DMAX = MAX( DMAX, D1( I ) + NSIGMA*SIGMA( I ) )
                  END IF
               END DO
