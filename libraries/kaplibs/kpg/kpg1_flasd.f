      SUBROUTINE KPG1_FLASD( BAD, DIM1, DIM2, INARR, LOWPEN, HIPEN,
...
*                    Set bad pixels to lowest colour index.
                     ...
                     IF ( INARR( J, K ) .EQ. VAL__BADD ) THEN
                        OUTARR( J, I ) = LOWPEN
                     ELSE
...
*                   Set bad pixels to the lowest colour index.
                     ...
                     IF ( INARR( J, I ) .EQ. VAL__BADD ) THEN
                        OUTARR( J, I ) = LOWPEN
                     ELSE
