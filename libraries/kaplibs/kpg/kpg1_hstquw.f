      SUBROUTINE KPG1_HSTQUW( BAD, EL, INARR, NUMBIN, OLDHST, MAP,
     :                         OUTARR, STATUS )
*+
*  Name:
*     KPG1_HSTQx
...
*  histogram.  Derive the number of good pixels.
      CALL KPG1_MXMNUW( BAD, EL, INARR, NINVAL, MAXMUM, MINMUM,
...
*  Generate the histogram between those bounds.
      CALL KPG1_GHSTUW( BAD2, EL, INARR, NUMBIN, MAXMUM, MINMUM,
     :                   OLDHST, STATUS )
...
*  create an equalised output array.
      CALL KPG1_RMAPUW( EL, INARR, MAXMUM, MINMUM, NUMBIN, MAP, OUTARR,
     :                   STATUS )
