      SUBROUTINE KPG1_LOGAUW( BAD, EL, INARR, VAR, INVAR, BASE, OUTARR,
...
*  Input array pixel is good.  Compute the output value.
                  OUTARR( J ) = NUM_DTOUW( FACTOR *
     :                          LOG( NUM_UWTOD( INARR( J ) ) ) )
