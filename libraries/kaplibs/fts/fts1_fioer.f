      SUBROUTINE FTS1_FIOER( FSTAT, PARAM, ROUTIN, MESSGE, STATUS )
*+
*  Name:
*     FTS1_FIOER
...
*  Invocation:
*     CALL FTS1_FIOER( FSTAT, PARAM, ROUTIN, MESSGE, STATUS )
...
*     12-NOV-2013 (DSB):
*        Renamed from COF_FIOER and copied from CONVERT.
...
*  and exit.
      IF ( FSTAT .LE. 0 ) THEN
         STATUS = SAI__ERROR
         CALL ERR_REP( 'FTS1_FIOER',
     :     'FTS1_FIOER: No FITSIO error to report (programming error).',
     :     STATUS )
         GOTO 999
      END IF
