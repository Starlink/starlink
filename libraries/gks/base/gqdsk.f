C# IL>=b, OL>=0
      SUBROUTINE GQDSK (IWTYPE,IDCNR,NTH,MLDR,IER,MBUFSZ,NPETL,
...
*
*  GKS Function name:  INQUIRE DEFAULT STROKE DEVICE DATA
*  Author:             AS
*
...
*  ----------------------
*     Returns default stroke device data
*
*  MAINTENANCE LOG
*  ---------------
...
*     OUT MBUFSZ  maximum input buffer size
...
*
      INTEGER IWTYPE, IDCNR, NTH, MLDR, IER, MBUFSZ, NPETL, IPET,
     :        IBFLEN, LDR
      REAL EAREA(4)
      CHARACTER*(*) DATREC(*)
*
...
*---------------------------------------------------------------------
      ...
      IF (KERROR.EQ.0) THEN
        ...
        CALL GKQXXD(IWTYPE,KQDSK,IDCNR,1,1,MLDR,NTH,IER,I,NPETL,
