      SUBROUTINE CAT5_FIOB (IOFLG, CIELM, FI, ELEM, ROWNO, VALUE, 
     :  NULFLG, STATUS)
*+
*  Name:
*     CAT5_FIOB
...
*     Fortran 77.
*  Invocation:
*     CALL CAT5_FIOB (IOFLG, CIELM, FI, ELEM, ROWNO; VALUE, NULFLG; 
*       STATUS)
*  Description:
*     Get or put a value for a single field.
*  Arguments:
...
*             otherwise substitute the appropriate null value.
               ...
               CALL CAT5_GTAEL (ROWS, ROWNO, %VAL(PTRN), NULFLG, STATUS)

               IF (.NOT. NULFLG) THEN

                  IF (FDTYPE .EQ. CAT__TYPEB) THEN
                     CALL CAT5_GTAEB (ROWS, ROWNO, %VAL(PTR), BVALI,
     :                 STATUS)
                  ELSE IF (FDTYPE .EQ. CAT__TYPEW) THEN
                     CALL CAT5_GTAEW (ROWS, ROWNO, %VAL(PTR), WVALI,
     :                 STATUS)
                  ELSE IF (FDTYPE .EQ. CAT__TYPEI) THEN
                     CALL CAT5_GTAEI (ROWS, ROWNO, %VAL(PTR), IVALI,
     :                 STATUS)
                  ELSE IF (FDTYPE .EQ. CAT__TYPER) THEN
                     CALL CAT5_GTAER (ROWS, ROWNO, %VAL(PTR), RVALI,
     :                 STATUS)
                  ELSE IF (FDTYPE .EQ. CAT__TYPED) THEN
                     CALL CAT5_GTAED (ROWS, ROWNO, %VAL(PTR), DVALI,
     :                 STATUS)
                  ELSE IF (FDTYPE .EQ. CAT__TYPEL) THEN
                     CALL CAT5_GTAEL (ROWS, ROWNO, %VAL(PTR), LVALI,
     :                 STATUS)
                  ELSE IF (FDTYPE .EQ. CAT__TYPEC) THEN
                     CALL CAT5_GTCAE(ROWS, FCSIZE, ROWNO, %VAL(PTR),
     :                 CVALI, STATUS)
                  ELSE
                     STATUS = CAT__INVDT
                  END IF
...
*             A value is to be put.
     ...
     :              STATUS)
                  ...
                  IF (CONVOK) THEN
                     IF (FDTYPE .EQ. CAT__TYPEB) THEN
                        CALL CAT5_STAEB (ROWS, ROWNO, BVALO, %VAL(PTR),
     :                    STATUS)
                     ELSE IF (FDTYPE .EQ. CAT__TYPEW) THEN
                        CALL CAT5_STAEW (ROWS, ROWNO, WVALO, %VAL(PTR),
     :                    STATUS)
                     ELSE IF (FDTYPE .EQ. CAT__TYPEI) THEN
                        CALL CAT5_STAEI (ROWS, ROWNO, IVALO, %VAL(PTR),
     :                    STATUS)
                     ELSE IF (FDTYPE .EQ. CAT__TYPER) THEN
                        CALL CAT5_STAER (ROWS, ROWNO, RVALO, %VAL(PTR),
     :                    STATUS)
                     ELSE IF (FDTYPE .EQ. CAT__TYPED) THEN
                        CALL CAT5_STAED (ROWS, ROWNO, DVALO, %VAL(PTR),
     :                    STATUS)
                     ELSE IF (FDTYPE .EQ. CAT__TYPEL) THEN
                        CALL CAT5_STAEL (ROWS, ROWNO, LVALO, %VAL(PTR),
     :                    STATUS)
                     ELSE IF (FDTYPE .EQ. CAT__TYPEC) THEN
     ...
     :                    %VAL(PTR), STATUS)
                     ...
                     CALL CAT5_STAEL (ROWS, ROWNO, .FALSE., %VAL(PTRN),
     :                 STATUS)
                  ELSE
                     CALL CAT5_STAEL (ROWS, ROWNO, .TRUE., %VAL(PTRN),
     :                 STATUS)
                  END IF
               ELSE
                  CALL CAT5_STAEL (ROWS, ROWNO, .TRUE., %VAL(PTRN),
...
*       Report any error.
     ...
     :        /'(column: ', ERRMSG, ERRPOS)
            ...
            CALL CAT1_ERREP ('CAT5_FIOB_ERR', ERRMSG(1 : ERRPOS),
     :        STATUS)
         END IF
      ...
      END
      SUBROUTINE CAT5_FIOC (IOFLG, CIELM, FI, ELEM, ROWNO, VALUE, 
     :  NULFLG, STATUS)
*+
*  Name:
*     CAT5_FIOC
...
*     Fortran 77.
*  Invocation:
*     CALL CAT5_FIOC (IOFLG, CIELM, FI, ELEM, ROWNO; VALUE, NULFLG; 
*       STATUS)
*  Description:
*     Get or put a value for a single field.
*  Arguments:
...
*       Report any error.
     ...
     :        /'(column: ', ERRMSG, ERRPOS)
            ...
            CALL CAT1_ERREP ('CAT5_FIOC_ERR', ERRMSG(1 : ERRPOS),
     :        STATUS)
         END IF
      ...
      END
      SUBROUTINE CAT5_FIOD (IOFLG, CIELM, FI, ELEM, ROWNO, VALUE, 
     :  NULFLG, STATUS)
*+
*  Name:
*     CAT5_FIOD
...
*     Fortran 77.
*  Invocation:
*     CALL CAT5_FIOD (IOFLG, CIELM, FI, ELEM, ROWNO; VALUE, NULFLG; 
*       STATUS)
*  Description:
*     Get or put a value for a single field.
*  Arguments:
...
*       Report any error.
     ...
     :        /'(column: ', ERRMSG, ERRPOS)
            ...
            CALL CAT1_ERREP ('CAT5_FIOD_ERR', ERRMSG(1 : ERRPOS),
     :        STATUS)
         END IF
      ...
      END
      SUBROUTINE CAT5_FIOI (IOFLG, CIELM, FI, ELEM, ROWNO, VALUE, 
     :  NULFLG, STATUS)
*+
*  Name:
*     CAT5_FIOI
...
*     Fortran 77.
*  Invocation:
*     CALL CAT5_FIOI (IOFLG, CIELM, FI, ELEM, ROWNO; VALUE, NULFLG; 
*       STATUS)
*  Description:
*     Get or put a value for a single field.
*  Arguments:
...
*       Report any error.
     ...
     :        /'(column: ', ERRMSG, ERRPOS)
            ...
            CALL CAT1_ERREP ('CAT5_FIOI_ERR', ERRMSG(1 : ERRPOS),
     :        STATUS)
         END IF
      ...
      END
      SUBROUTINE CAT5_FIOL (IOFLG, CIELM, FI, ELEM, ROWNO, VALUE, 
     :  NULFLG, STATUS)
*+
*  Name:
*     CAT5_FIOL
...
*     Fortran 77.
*  Invocation:
*     CALL CAT5_FIOL (IOFLG, CIELM, FI, ELEM, ROWNO; VALUE, NULFLG; 
*       STATUS)
*  Description:
*     Get or put a value for a single field.
*  Arguments:
...
*       Report any error.
     ...
     :        /'(column: ', ERRMSG, ERRPOS)
            ...
            CALL CAT1_ERREP ('CAT5_FIOL_ERR', ERRMSG(1 : ERRPOS),
     :        STATUS)
         END IF
      ...
      END
      SUBROUTINE CAT5_FIOR (IOFLG, CIELM, FI, ELEM, ROWNO, VALUE, 
     :  NULFLG, STATUS)
*+
*  Name:
*     CAT5_FIOR
...
*     Fortran 77.
*  Invocation:
*     CALL CAT5_FIOR (IOFLG, CIELM, FI, ELEM, ROWNO; VALUE, NULFLG; 
*       STATUS)
*  Description:
*     Get or put a value for a single field.
*  Arguments:
...
*       Report any error.
     ...
     :        /'(column: ', ERRMSG, ERRPOS)
            ...
            CALL CAT1_ERREP ('CAT5_FIOR_ERR', ERRMSG(1 : ERRPOS),
     :        STATUS)
         END IF
      ...
      END
      SUBROUTINE CAT5_FIOW (IOFLG, CIELM, FI, ELEM, ROWNO, VALUE, 
     :  NULFLG, STATUS)
*+
*  Name:
*     CAT5_FIOW
...
*     Fortran 77.
*  Invocation:
*     CALL CAT5_FIOW (IOFLG, CIELM, FI, ELEM, ROWNO; VALUE, NULFLG; 
*       STATUS)
*  Description:
*     Get or put a value for a single field.
*  Arguments:
...
*       Report any error.
     ...
     :        /'(column: ', ERRMSG, ERRPOS)
            ...
            CALL CAT1_ERREP ('CAT5_FIOW_ERR', ERRMSG(1 : ERRPOS),
     :        STATUS)
         END IF
