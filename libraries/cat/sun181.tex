...
\newcommand{\stardoctitle}     {CAT \\ [1ex]
...
\end{center}
{\it The Merchant of Venice} \raggedleft
\end{quote}
...
less.' \\
{\it Through the Looking-Glass and What Alice Found There} \raggedleft
\\ Lewis Carroll
\end{quote}
...
\end{center}
{\it Lives of the English Poets} vol. ii \raggedleft
\\ Samuel Johnson
\end{quote}
