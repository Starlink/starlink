      SUBROUTINE TRN1_EVTMD( BAD, ND1, NVIN, DATA, NDAT, INDEX,
...
*  Purpose:
*     evaluate a DOUBLE PRECISION compiled transformation module.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL TRN1_EVTMD( BAD, ND1, NVIN, DATA, NDAT, INDEX,
*                        NVOUT, NS1, NSTACK, STACK, IERR, NERR,
*                        NSTAT, STATUS )
...
*  Arguments Given:
      ...
      DOUBLE PRECISION DATA( ND1, NVIN )  ! Array containing a list of the
...
*  Arguments Returned:
      DOUBLE PRECISION STACK( NS1, NSTACK )
...
*   of the stack.
        CALL TRN1_EVEXD( %VAL( CNF_PVAL( INDEX( TRN_IN_CODE ) ) ),
     :                   ICODE + 1,
