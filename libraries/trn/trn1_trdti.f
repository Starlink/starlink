      SUBROUTINE TRN1_TRDTI( BAD, ND1, NVIN, DATA, NDAT, CTTI, SLOT,
...
*  Invocation:
*     CALL TRN1_TRDTI( BAD, ND1, NVIN, DATA, NDAT, CTTI, SLOT,
*                        NR1, NVOUT, RESULT, STATUS )

*  Description:
*     The routine applies a compiled transformation to a coordinate list
*     for a set of INTEGER data points by splitting the list into a
...
*  Arguments Given:
      ...
      INTEGER DATA( ND1, NVIN )  ! Array containing sets of coordinate
...
*   Pass the components of the compiled module list to TRN1_TRBTI
