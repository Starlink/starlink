      SUBROUTINE TRN1_TRDTR( BAD, ND1, NVIN, DATA, NDAT, CTTI, SLOT,
...
*  Invocation:
*     CALL TRN1_TRDTR( BAD, ND1, NVIN, DATA, NDAT, CTTI, SLOT,
*                        NR1, NVOUT, RESULT, STATUS )

*  Description:
*     The routine applies a compiled transformation to a coordinate list
*     for a set of REAL data points by splitting the list into a
...
*  Arguments Given:
      ...
      REAL DATA( ND1, NVIN )  ! Array containing sets of coordinate
...
*   Pass the components of the compiled module list to TRN1_TRBTR
