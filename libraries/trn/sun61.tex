\documentclass[twoside,nolof,11pt]{starlink}
% -----------------------------------------------------------------------------
...
\stardocdate        {12th January 2006}
\stardoctitle       {TRANSFORM --- Coordinate Transformation Facility}
\stardocversion     {Version 0.9-6}
\stardocmanual      {Programmer's Guide and Reference Manual}
\stardocabstract  {%
...
then \name{TRN\_STOKR} (substitute a \emph{real} token value) could be used
...
with the formatted \emph{real} number `\verb#17.7#', while \fortvar{NSUBS}
...
\sstroutine{TRN\_TR1x}{Transform 1-dimensional data}
{
   ...
   \sstarguments{
      \sstsubsection{BAD = L}{
         Whether the input coordinates may be \emph{bad}.}
      \sstsubsection{NX = I}{
