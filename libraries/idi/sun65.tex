...
\stardocauthors     {Nicholas Eaton}
\stardocdate        {20 July 1995}
\stardoctitle       {IDI \\[\latex{1.0ex}]
...
\slhyperref{This appendix}{Appendix~}{}{se:qcn} gives details of the
...
\slhyperref{test program}{in appendix~}{}{se:exp}.
...
\slhyperref{example program}{example program (appendix~}{}{se:exp}).
...
\slhyperref{example program}{example program in appendix~}{}{se:exp}.
...
\slhyperref{this appendix}{appendix~}{}{se:qcn}).
...
\textbf{IDI\_ANNUL\label{IDI_ANNUL}\xlabel{IDI_ANNUL}} \\
...
\hspace*{10mm}\parbox{140mm}{
\textbf{IDI\_ASSOC\label{IDI_ASSOC}\xlabel{IDI_ASSOC}} \\
...
\hspace*{10mm}\parbox{140mm}{
\textbf{IDI\_CANCL\label{IDI_CANCL}\xlabel{IDI_CANCL}} \\
