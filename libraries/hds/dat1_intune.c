...
/*    05-MAY-2004 (BKM):                                                    */
/*       Added HDS_64BIT tuning parameter.                                  */
/*    {@enter_changes_here@}                                                */
...
/* Create 64-bit format files for *NEW* HDS files. Without this parameter   */
/* set all newly created files will remain in the traditional (HDS type 3)  */
/* format. Irrespective of this setting any existing HDS file will be       */
/* updated in the format defined when it was created.                       */
         dat1_getenv( "HDS_64BIT", HDS__64BIT, &hds_gl_c64bit );
