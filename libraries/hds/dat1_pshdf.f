      SUBROUTINE DAT1_PSHDF( STR, DIM, LBND, UBND, STATUS )
*+
*  Name:
*     DAT1_PSHDF
...
*  Invocation:
*     CALL DAT1_PSHDF( STR, DIM, LBND, UBND, STATUS )
...
*  lower bound.
         ELSE
            CALL DAT1_PSHDB( STR( F : COLON - 1 ), 1, LBND, STATUS )
...
*  upper bound.
         ELSE
            CALL DAT1_PSHDB( STR( COLON + 1 : L ), DIM, UBND, STATUS )
            IF ( STATUS .EQ. SAI__OK ) THEN
