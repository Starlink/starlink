...
\newcommand{\stardocsource}    {sun40.5}
\newcommand{\stardocnumber}    {40.5}
\newcommand{\stardocauthors}   {A C Charles\\P C T Rees\\A J Chipperfield}
\newcommand{\stardocdate}      {2 August 1995}
\newcommand{\stardoctitle}     {CHR \\ [1ex]
...
%  generally otherwise). This is done here intentionally.
...
\begin {description}
\item {\bf CHR\_\_EOSNT} -- End of sentence.
\item {\bf CHR\_\_WNOTF} -- Word not found.
\end {description}
\item [SAE\_PAR] Defines the global constants SAI\_\_OK and SAI\_\_ERROR.
\begin{description}
\item {\bf SAI\_\_ERROR} -- Error encountered.
\item {\bf SAI\_\_OK} -- No error.
\item {\bf SAI\_\_WARN} -- Warning.
\end {description}
\end {description}
...
\end{document}
% @(#)sun109.tex   1.8   95/07/03 15:32:32   95/07/13 14:23:26
