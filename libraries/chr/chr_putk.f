      SUBROUTINE CHR_PUTK( KVALUE, STRING, IPOSN )
*+
*  Name:
*     CHR_PUTK

*  Purpose:
*     Put an INTEGER*8 value into a string at a given position.

*  Language:
*     Starlink Fortran 77

*  Invocation:
*     CALL CHR_PUTK( KVALUE, STRING, IPOSN )

*  Description:
*     The INTEGER*8 value is encoded into a concise string which is
...
*  Perform copy using calls to CHR_ITOC and CHR_PUTC.
      CALL CHR_KTOC( KVALUE, STR1, SIZE1 )
