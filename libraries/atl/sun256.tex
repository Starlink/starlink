...
\newcommand{\stardocsource}    {sun256.0}
\newcommand{\stardocnumber}    {256.0}
\newcommand{\stardocauthors}   {D.S. Berry}
\newcommand{\stardocdate}      {26th May 2006}
...
\noteroutine{\htmlref{ATL\_AXTRM}{ATL_AXTRM}}{( IWCS, AXES, LBND, UBND, WORK, STATUS )}
            {Trim axes from the current Frame of a FrameSet}

\noteroutine{\htmlref{ATL\_MKLUT}{ATL_MKLUT}}{( IX, IY, NPNT, NVAR, FRM, TABLE, MAP, STATUS )}
