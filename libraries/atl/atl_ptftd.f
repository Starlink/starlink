      SUBROUTINE ATL_PTFTD( THIS, NAME, VALUE, COMMNT, STATUS )
*+
*  Name:
*     ATL_PTFTR
...
*  Invocation:
*     CALL ATL_PTFTD( THIS, NAME, VALUE, COMMNT, STATUS )
...
*        The new keyword value. If this is VAL__BADD, then an undefined
...
*  appending to the end of the FitsChan if the FitsChan is at end-of-file.)
      IF( VALUE .NE. VAL__BADD ) THEN
         CALL AST_SETFITSF( THIS, NAME, VALUE, COMMNT, .TRUE.,
     :                      STATUS )
      ELSE
