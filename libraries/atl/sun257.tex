...
\sstroutine{
   ...
   \sstarguments{
      \sstsubsection{
         ...
         extension in the required SPECX map file. It should contain
         entries with the following keys (the data type with which each
         entry is accessed is shown in parentheses):

            JFREST (\_INTEGER) - The value of SPECX extension item {\tt "}JFREST(1){\tt "}
            RA (\_DOUBLE) - The value of SPECX extension item {\tt "}RA\_DEC(1){\tt "}
            DEC (\_DOUBLE) - The value of SPECX extension item {\tt "}RA\_DEC(2){\tt "}
            DRA (\_DOUBLE) - The value of SPECX extension item {\tt "}DPOS(1){\tt "}
            DDEC (\_DOUBLE) - The value of SPECX extension item {\tt "}DPOS(2){\tt "}
            IDATE (\_CHAR) - The value of SPECX extension item {\tt "}IDATE{\tt "}
            ITIME (\_CHAR) - The value of SPECX extension item {\tt "}ITIME{\tt "}
            LSRFLG (\_INTEGER) - The value of SPECX extension item {\tt "}LSRFLG{\tt "}
            SRCVEL (\_DOUBLE)  - The value of SPECX extension item {\tt "}V\_SETL(4){\tt "}
            JFCEN (\_INTEGER) - The value of SPECX extension item {\tt "}JFCEN(1){\tt "}
            JFINC (\_INTEGER) - The value of SPECX extension item {\tt "}JFINC(1){\tt "}
            IFFREQ (\_DOUBLE) - The value of SPECX extension item {\tt "}IFFREQ(1){\tt "}
      }
      \sstsubsection{
         KM2 = INTEGER (Given)
      }{
         ...
         following keys:
            ...
            CD1 - The value of SPECX\_MAP extension item {\tt "}CELLSIZE(1){\tt "}
            CD2 - The value of SPECX\_MAP extension item {\tt "}CELLSIZE(2){\tt "}
            POSANG - The value of SPECX\_MAP extension item {\tt "}POSANGLE{\tt "}
      }
      \sstsubsection{
         DIM( 3 ) = INTEGER (Given)
      }{
