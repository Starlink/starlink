...
\stardocauthors   {P M Allan\\
                                ...
                                David S Berry}
\stardocdate        {26th September 2019}
\stardoctitle      {PSX \\ [1ex]
                                POSIX interface routines}
\stardocversion     {Version 0.6-0}
...
\sstroutine{
   ...
   \sstarguments{
      \sstsubsection{
         ...
         2.1E9), them routine PSX\_CALLOC8 should be used in place of
         PSX\_CALLOC. PSX\_CALLOC8 has an identical interface except that
...
\sstroutine{
   ...
   \sstarguments{
      \sstsubsection{
         ...
         exceeds the maximum that can be stored in an INTEGER (about
         2.1E9), them routine PSX\_MALLOC8 should be used in place of
         PSX\_MALLOC. PSX\_MALLOC8 has an identical interface except that
...
\sstroutine{
   ...
   \sstarguments{
      \sstsubsection{
         ...
         exceeds the maximum that can be stored in an INTEGER (about
         2.1E9), them routine PSX\_REALLOC8 should be used in place of
         PSX\_REALLOC. PSX\_REALLOC8 has an identical interface except that
         the SIZE argument is an INTEGER$*$8.
      }
      \sstsubsection{
         PNTR = POINTER (Given and Returned)
