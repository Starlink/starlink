      SUBROUTINE ARY1_PT1D( BAD, EL, ARRAY, TYPE, LOC, DCE, STATUS )
*+
*  Name:
*     ARY1_PT1D

*  Purpose:
*     Write a 1-dimensional array of DOUBLE PRECISION values to an HDS object.

*  Language:
*     Starlink Fortran 77

*  Invocation:
*     CALL ARY1_PT1D( BAD, EL, ARRAY, TYPE, LOC, DCE, STATUS )

*  Description:
*     The routine writes a 1-dimensional array of DOUBLE PRECISION values to an
...
*  directly.
      IF ( TYPE .EQ. '_DOUBLE' ) THEN
         DCE = .FALSE.
         CALL DAT_PUT( LOC, '_DOUBLE', 1, DIM, ARRAY, STATUS )
...
*  data.
      ELSE
         ...
         CALL ARY1_CVFD( BAD, EL, ARRAY, TYPE, PNTR, DCE, STATUS )
         CALL ARY1_HUNMP( LOC, STATUS )
      END IF

*  Call error tracing routine and exit.
      IF ( STATUS .NE. SAI__OK ) CALL ARY1_TRACE( 'ARY1_PT1D',
     :STATUS )
