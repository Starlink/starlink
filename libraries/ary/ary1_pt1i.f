      SUBROUTINE ARY1_PT1I( BAD, EL, ARRAY, TYPE, LOC, DCE, STATUS )
*+
*  Name:
*     ARY1_PT1I
 
*  Purpose:
*     Write a 1-dimensional array of INTEGER values to an HDS object.
 
*  Language:
*     Starlink Fortran 77
 
*  Invocation:
*     CALL ARY1_PT1I( BAD, EL, ARRAY, TYPE, LOC, DCE, STATUS )
 
*  Description:
*     The routine writes a 1-dimensional array of INTEGER values to an
...
*  directly.
      IF ( TYPE .EQ. '_INTEGER' ) THEN
         DCE = .FALSE.
         CALL DAT_PUT( LOC, '_INTEGER', 1, DIM, ARRAY, STATUS )
...
*  data.
      ELSE
         ...
         CALL ARY1_CVFI( BAD, EL, ARRAY, TYPE, PNTR, DCE, STATUS )
         CALL ARY1_HUNMP( LOC, STATUS )
      END IF
 
*  Call error tracing routine and exit.
      IF ( STATUS .NE. SAI__OK ) CALL ARY1_TRACE( 'ARY1_PT1I',
     :STATUS )
