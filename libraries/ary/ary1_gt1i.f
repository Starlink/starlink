      SUBROUTINE ARY1_GT1I( BAD, LOC, TYPE, EL, RESULT, DCE, STATUS )
*+
*  Name:
*     ARY1_GT1I
 
*  Purpose:
*     Read a 1-dimensional array of INTEGER values from an HDS object.
 
*  Language:
*     Starlink Fortran 77
 
*  Invocation:
*     CALL ARY1_GT1I( BAD, LOC, TYPE, EL, RESULT, DCE, STATUS )
 
*  Description:
*     The routine reads a 1-dimensional array of INTEGER values from an
...
*  directly.
      IF ( TYPE .EQ. '_INTEGER' ) THEN
         DCE = .FALSE.
         CALL DAT_GET( LOC, '_INTEGER', 1, DIM, RESULT, STATUS )
...
*  data.
      ELSE
         ...
         CALL ARY1_CVTI( BAD, EL, TYPE, PNTR, RESULT, DCE, STATUS )
         CALL ARY1_HUNMP( LOC, STATUS )
      END IF
 
*  Call error tracing routine and exit.
      IF ( STATUS .NE. SAI__OK ) CALL ARY1_TRACE( 'ARY1_GT1I',
     :STATUS )
