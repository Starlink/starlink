      SUBROUTINE HDR_EXIST( PARAM, XNAME, ITEM, FOUND, NCOMP, STATUS )
*+
*  Name:
*    HDR_EXIST
...
*  Invocation:
*     CALL HDR_EXIST( PARAM, XNAME, ITEM, FOUND, NCOMP, STATUS )
...
*        If XNAME is 'FITS' then this argument specifies the number of
*        times the keyword is found in the extension (used mostly for
*        accessing COMMENT and HISTORY records).
*     STATUS = INTEGER (Given and Returned)
*        The global status.

*  Notes:
*     - The item name for any extension may be hierarchical
...
*        Original version.
*     12-SEP-1994 (PDRAPER):
*        Now returns the nunber of occurrences of a FITS keyword.
