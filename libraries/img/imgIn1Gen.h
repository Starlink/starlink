...
IMG_IN1( IMG_F77_TYPE ) ( CHARACTER(param),
                          INTEGER(nx),
                          POINTER_ARRAY(ip),
                          INTEGER(status)
                          TRAIL(param) );

IMGIN1( IMG_SHORT_C_TYPE ) ( char *param,
                             int *nx,
                             IMG_FULL_C_TYPE **ip,
                             int *status )
{
  ...
  IMGIN1_CALL( IMG_F77_TYPE ) ( CHARACTER_ARG(fparam),
                                INTEGER_ARG(nx),
