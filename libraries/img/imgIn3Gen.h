...
IMG_IN3( IMG_F77_TYPE ) ( CHARACTER(param),
                          INTEGER(nx),
                          INTEGER(ny),
                          INTEGER(nz),
                          POINTER_ARRAY(ip),
...
IMGIN3( IMG_SHORT_C_TYPE ) ( char *param,
                             int *nx,
                             int *ny,
                             int *nz,
                             IMG_FULL_C_TYPE **ip,
                             int *status )
{
  ...
  IMGIN3_CALL( IMG_F77_TYPE ) ( CHARACTER_ARG(fparam),
                                INTEGER_ARG(nx),
                                INTEGER_ARG(ny),
                                INTEGER_ARG(nz),
