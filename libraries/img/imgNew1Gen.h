 ...
 *  Purpose:
 *     Creates a new 1-D input image using a specific type.
...
IMG_NEW1( IMG_F77_TYPE ) ( CHARACTER(param),
                           INTEGER(nx),
                           POINTER_ARRAY(ip),
                           INTEGER(status)
                           TRAIL(param) );

IMGNEW1( IMG_SHORT_C_TYPE ) ( char *param,
                              int nx,
                              IMG_FULL_C_TYPE **ip,
                              int *status )
{
  ...
  IMGNEW1_CALL( IMG_F77_TYPE ) ( CHARACTER_ARG(fparam),
                                 INTEGER_ARG(&nx),
