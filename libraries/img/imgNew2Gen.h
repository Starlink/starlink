 ...
 *  Purpose:
 *     Creates a new input 2-D image using a specific type.
...
IMG_NEW2( IMG_F77_TYPE ) ( CHARACTER(param),
                           INTEGER(nx),
                           INTEGER(ny),
                           POINTER_ARRAY(ip),
                           INTEGER(status)
...
IMGNEW2( IMG_SHORT_C_TYPE ) ( char *param,
                              int nx,
                              int ny,
                              IMG_FULL_C_TYPE **ip,
                              int *status )
{
  ...
  IMGNEW2_CALL( IMG_F77_TYPE ) ( CHARACTER_ARG(fparam),
                                 INTEGER_ARG(&nx),
                                 INTEGER_ARG(&ny),
