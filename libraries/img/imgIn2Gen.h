...
IMG_IN2( IMG_F77_TYPE ) ( CHARACTER(param),
                          INTEGER(nx),
                          INTEGER(ny),
                          POINTER_ARRAY(ip),
                          INTEGER(status)
...
IMGIN2( IMG_SHORT_C_TYPE ) ( char *param,
                             int *nx,
                             int *ny,
                             IMG_FULL_C_TYPE **ip,
                             int *status )
{
  ...
  IMGIN2_CALL( IMG_F77_TYPE ) ( CHARACTER_ARG(fparam),
                                INTEGER_ARG(nx),
                                INTEGER_ARG(ny),
