 ...
 *  Invocation:
 *     imgMod3?( param, nx, ny, nz, ip, status )

 *  Description:
 *     This C function sets up the required arguments and calls the
 *     Fortran subroutine img_mod3[x].
...
IMG_MOD3( IMG_F77_TYPE ) ( CHARACTER(param),
                           INTEGER(nx),
                           INTEGER(ny),
                           INTEGER(nz),
                           POINTER_ARRAY(ip),
...
IMGMOD3( IMG_SHORT_C_TYPE ) ( char *param,
                              int *nx,
                              int *ny,
                              int *nz,
                              IMG_FULL_C_TYPE **ip,
                              int *status )
{
  ...
  IMGMOD3_CALL( IMG_F77_TYPE ) ( CHARACTER_ARG(fparam),
                                 INTEGER_ARG(nx),
                                 INTEGER_ARG(ny),
                                 INTEGER_ARG(nz),
