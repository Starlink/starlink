      SUBROUTINE IMG1_GKEYC( NCARD, BUFFER, SCARD, NAME, NOCCUR, THERE,
     :                       VALUE, CARD, STATUS )
*+
*  Name:
*     IMG1_GKEYC
...
*  Invocation:
*     CALL IMG1_GKEYC( NCARD, BUFFER, SCARD, NAME, NOCCUR, THERE, VALUE,
*                      CARD, STATUS )
...
*  Copyright:
*     Copyright (C) 1988, 1989, 1990, 1991, 1992, 1994 Science & Engineering Research Council.
*     All Rights Reserved.
