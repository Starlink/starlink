      SUBROUTINE NDG1_GTYPS( MXTYP, STRING, NTYP, TYP, STATUS )
*+
*  Name:
*     NDG1_GTYPS

*  Purpose:
*     Get file types from an NDF environment variable value.

*  Language:
*     Starlink Fortran 77

*  Invocation:
*     CALL NDG1_GTYPS( MXTYP, STRING, NTYP, TYP, STATUS )

*  Description:
*     This routine extracts the file types (including leading dots) from
*     a string representing the value of the NDF_FORMATS_IN or
*     NDF_FORMATS_OUT environment variable.

*  Arguments:
*     MXTYP = INTEGER (Given)
*        The maximum number of types allowed.
*     STRING = CHARACTER * ( * ) (Given)
*        The value of NDF_FORMATS_IN or NDF_FORMATS_OUT.
