...
\newcommand{\stardocdate}      {10th March 2011}
\newcommand{\stardoctitle}     {NDG \\ [\latex{1ex}]
                                Routines for Accessing Groups of NDFs}
\newcommand{\stardocversion}   {Version 6.0}
...
PROVENANCE Extension:'' below (but note, the MORE component is not
included in the DATA array).

\item [MORE] --- An optional one-dimensional array of structures containing
arbitrary extra information about selected ancestor NDFs. If present,
each element of this array contains supplemental information for a single
ancestor NDF, and the DATA array will contain indices into the MORE array
for those ancestors which have additional information.
...
PROVENANCE extension changed radically at NDG version 6.0. Prior to v6.0,
