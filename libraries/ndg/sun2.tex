...
\newcommand{\stardocsource}    {sun2.6}
\newcommand{\stardocnumber}    {2.6}
\newcommand{\stardocauthors}   {D.S.\ Berry \\ M.B.\ Taylor}
\newcommand{\stardocdate}      {26th November 2007}
\newcommand{\stardoctitle}     {NDG \\ [1ex]
                                Routines for Accessing Groups of NDFs}
\newcommand{\stardocversion}   {Version 5.3}
...
\sstroutine{
   ...
   \sstarguments{
      ...
      \sstsubsection{
         ...
         extension. No error is reported if IANC is too large, but DAT\_\_NOLOC
