      SUBROUTINE PDA_QSIDI( EL, X, IP )
*+
*  Name:
*     PDA_QSIDI

*  Purpose:
*     Sort an array of pointers to access an INTEGER array in 
*     descending order.
...
*     8-NOV-1995 (PDRAPER):
*        Renamed to PDA_QSIA (Quick Sort Indexed Descending) and
...
*  exchange sort.
            ...
            I2 = ( L + R ) / 2
            I3 = R
            IF ( X( IP( I1 ) ) .LT. X( IP( I2 ) ) ) THEN
               ITMP = I1
               I1 = I2
               I2 = ITMP
            END IF
            IF ( X( IP( I1 ) ) .LT. X( IP( I3 ) ) ) THEN
               ITMP = I1
               I1 = I3
               I3 = ITMP
            END IF
            IF ( X( IP( I2 ) ) .LT. X( IP( I3 ) ) ) THEN
               ITMP = I2
               I2 = I3
               I3 = ITMP
            END IF
...
*  Iterate until the stack is empty.
      ...
      END IF
      END
* @(#)pda_qsidi.f   1.2   95/11/10 10:03:27   95/11/10 10:03:52
