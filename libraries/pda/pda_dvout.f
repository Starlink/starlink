*DECK PDA_DVOUT
      SUBROUTINE PDA_DVOUT (N, DX, IFMT, IDIGIT)
C***BEGIN PROLOGUE  PDA_DVOUT
C***SUBSIDIARY
C***PURPOSE  Subsidiary to DSPLP
C***LIBRARY   SLATEC
C***TYPE      DOUBLE PRECISION (SVOUT-S, PDA_DVOUT-D)
...
C     N = 100
C     IDIGIT = -6
C     CALL PDA_DVOUT(N,COSTS,'(''1COSTS OF PURCHASES'')',IDIGIT)
C
C***SEE ALSO  DSPLP
...
C***END PROLOGUE  PDA_DVOUT
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      DOUBLE PRECISION DX(*)
      CHARACTER IFMT*(*)
C***FIRST EXECUTABLE STATEMENT  PDA_DVOUT
      LOUT=PDA_I1MACH(2)
      WRITE(LOUT,IFMT)
      IF(N.LE.0) RETURN
      NDIGIT = IDIGIT
