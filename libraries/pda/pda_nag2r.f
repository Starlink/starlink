...
*     performed on them using FFTPACK routine PDA_RFFTB. The resulting inverse
...
*  Notes:
*     -  A call to PDA_R2NAG followed by a call to PDA_NAG2R will result in
