...
C***TYPE      ALL (PDA_BSPDOC-A)
C***KEYWORDS  B-SPLINE, DOCUMENTATION, SPLINES
C***AUTHOR  Amos, D. E., (SNLA)
C***DESCRIPTION
C
C     Abstract
C         PDA_BSPDOC is a non-executable, B-spline documentary routine.
...
C         BVALU and PDA_DBVALU are the single and double precision
...
C
C       BSGQ8,PPGQ8,BNSLV,BNFAC,PDA_XERMSG,DBSGQ8,DPPGQ8,PDA_DBNSLV,PDA_DBNFAC
C
C                    Machine Dependent Routines
C
C                      PDA_I1MACH, R1MACH, PDA_D1MACH
C
...
C***END PROLOGUE  PDA_BSPDOC
C***FIRST EXECUTABLE STATEMENT  PDA_BSPDOC
      RETURN
      END
