      SUBROUTINE PDA_QSIAI( EL, X, IP )
*+
*  Name:
*     PDA_QSIAI

*  Purpose:
*     Sort an array of pointers to access an INTEGER array in ascending
*     order.
...
*  Iterate until the stack is empty.
      ...
      END
* @(#)pda_qsiai.f   1.2   95/11/10 10:03:24   95/11/10 10:03:52
