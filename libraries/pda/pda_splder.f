...
c  subroutine pda_splder evaluates in a number of points x(i),i=1,2,...,m
c  the derivative of order nu of a spline s(x) of degree k,given in
c  its b-spline representation.
c
c  calling sequence:
c     call pda_splder(t,n,c,k,nu,x,y,m,wrk,ier)
c
c  input parameters:
...
c
c  other subroutines required: pda_fpbspl
c
c  references :
...
c  evaluate the non-zero b-splines of degree k-nu at arg.
 150    call pda_fpbspl(t,n,kk,arg,l,h)
