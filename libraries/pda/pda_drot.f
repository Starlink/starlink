*DECK PDA_DROT
      SUBROUTINE PDA_DROT (N, DX, INCX, DY, INCY, DC, DS)
C***BEGIN PROLOGUE  PDA_DROT
C***PURPOSE  Apply a plane Givens rotation.
C***LIBRARY   SLATEC (BLAS)
C***CATEGORY  D1A8
C***TYPE      DOUBLE PRECISION (SROT-S, PDA_DROT-D, CSROT-C)
...
C***END PROLOGUE  PDA_DROT
      DOUBLE PRECISION DX, DY, DC, DS, ZERO, ONE, W, Z
      DIMENSION DX(*), DY(*)
      SAVE ZERO, ONE
      DATA ZERO, ONE /0.0D0, 1.0D0/
C***FIRST EXECUTABLE STATEMENT  PDA_DROT
