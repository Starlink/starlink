*DECK PDA_DMOUT
      SUBROUTINE PDA_DMOUT (M, N, LDA, A, IFMT, IDIGIT)
C***BEGIN PROLOGUE  PDA_DMOUT
C***SUBSIDIARY
C***PURPOSE  Subsidiary to DBOCLS and DFC
C***LIBRARY   SLATEC
C***TYPE      DOUBLE PRECISION (SMOUT-S, PDA_DMOUT-D)
...
C     LDTABL = 20
C     IDIGIT = -6
C     CALL PDA_DMOUT(M,N,LDTABL,TABLEU,21H(16H1SIMPLEX TABLEAU),IDIGIT)
C
...
C***END PROLOGUE  PDA_DMOUT
      DOUBLE PRECISION A(LDA,*)
      CHARACTER IFMT*(*),ICOL*3
      SAVE ICOL
      DATA ICOL /'COL'/
C***FIRST EXECUTABLE STATEMENT  PDA_DMOUT
      LOUT=PDA_I1MACH(2)
      WRITE(LOUT,IFMT)
