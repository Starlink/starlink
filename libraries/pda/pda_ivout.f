*DECK PDA_IVOUT
      SUBROUTINE PDA_IVOUT (N, IX, IFMT, IDIGIT)
C***BEGIN PROLOGUE  PDA_IVOUT
C***SUBSIDIARY
C***PURPOSE  Subsidiary to SPLP
C***LIBRARY   SLATEC
C***TYPE      INTEGER (PDA_IVOUT-I)
...
C     N = 100
C     IDIGIT = -6
C     CALL PDA_IVOUT(N,ICOSTS,'(''1COSTS OF PURCHASES'')',IDIGIT)
C
C***SEE ALSO  SPLP
C***ROUTINES CALLED  PDA_I1MACH
...
C***END PROLOGUE  PDA_IVOUT
      DIMENSION IX(*)
      CHARACTER IFMT*(*)
C
C     GET THE UNIT NUMBER WHERE OUTPUT WILL BE WRITTEN.
C***FIRST EXECUTABLE STATEMENT  PDA_IVOUT
      J=2
      LOUT=PDA_I1MACH(J)
      WRITE(LOUT,IFMT)
      IF(N.LE.0) RETURN
