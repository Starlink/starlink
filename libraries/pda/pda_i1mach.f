...
*              *** CRAY T3E ***
               ...
               IMACH( 7) = 2
               IMACH( 8) = 63
               CALL PDA_I1MCR1(IMACH(9), K, 32767, 16777215, 16777215)
               IMACH(10) = 2
               IMACH(11) = 53
               IMACH(12) = -1021
               IMACH(13) = 1024
               ...
               IMACH(16) = 1024
               GO TO 35
 20            CALL PDA_I1MCR1(J, K, 16405, 9876536, 0)
...
*              *** CRAY 1, XMP, 2, AND 3 ***
               ...
               IMACH(7) = 2
               IMACH(8) = 45
               CALL PDA_I1MCR1(IMACH(9), K, 0, 4194303, 16777215)
               IMACH(10) = 2
               IMACH(11) = 47
               IMACH(12) = -8188
               IMACH(13) = 8189
...
*}
      END
      SUBROUTINE PDA_I1MCR1(A, A1, B, C, D)
