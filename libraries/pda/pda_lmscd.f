      SUBROUTINE PDA_LMSCD( ARRAY, NDEC, NC, IROW, IP, LINK )
*+
*  Name:
*     PDA_LMSCD
...
*  Invocation:
*     CALL PDA_LMSCD( ARRAY, NDEC, NC, IROL, IP, LINK )
...
*  Arguments:
*     ARRAY( NDEC, NC + 2 ) = DOUBLE PRECISION (Given)
...
*  Arguments Given:
      INTEGER NDEC
      INTEGER NC
      DOUBLE PRECISION ARRAY( NDEC, 0 : NC + 1 )
      INTEGER IP( 0: NC + 1 )
      INTEGER IROW
