*DECK PDA_DBNFAC
      SUBROUTINE PDA_DBNFAC (W, NROWW, NROW, NBANDL, NBANDU, IFLAG)
C***BEGIN PROLOGUE  PDA_DBNFAC
C***SUBSIDIARY
C***PURPOSE  Subsidiary to DBINT4 and PDA_DBINTK
C***LIBRARY   SLATEC
C***TYPE      DOUBLE PRECISION (BNFAC-S, PDA_DBNFAC-D)
C***AUTHOR  (UNKNOWN)
C***DESCRIPTION
C
C  PDA_DBNFAC is the BANFAC routine from
C        * A Practical Guide to Splines *  by C. de Boor
C
C  PDA_DBNFAC is a double precision routine
C
...
C              CALL PDA_DBNSLV ( W, NROWW, NROW, NBANDL, NBANDU, B )
