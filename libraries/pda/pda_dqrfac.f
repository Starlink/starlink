      SUBROUTINE PDA_DQRFAC (M, N, A, LDA, PIVOT, IPVT, LIPVT, SIGMA,
     +   ACNORM, WA)
...
C***END PROLOGUE  DQRFAC
      ...
      DOUBLE PRECISION PDA_D1MACH,PDA_DENORM
...
C
   ...
   70          CONTINUE
            ...
            SIGMA(K) = PDA_DENORM(M-J,A(JP1,K))
            WA(K) = SIGMA(K)
   80       CONTINUE
   90       CONTINUE
  100    CONTINUE
