      ...
      subroutine pda8_fpsurf(iopt,m,x,y,z,w,xb,xe,yb,ye,kxx,kyy,s,nxest,
...
c  ..scalar arguments..
      ...
      integer*8 m,lwrk
      integer iopt,kxx,kyy,nxest,nyest,maxit,nmax,km1,km2,ib1,ib3,
     * nc,intest,nrest,nx0,ny0,ier
c  ..array arguments..
...
c  ..local scalars..
     ...
     * la,lf,lh,lx,ly,l1,l2,n,ncof,nk1x,nk1y,nminx,nminy,nreg,
...
c  arrange the data points according to the panel they belong to.
        call pda8_fporde(x,y,m,kx,ky,tx,nx,ty,ny,nummer,index,nreg)
