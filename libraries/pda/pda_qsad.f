...
*  Local Variables:
      ...
      DOUBLE PRECISION XTMP     ! Storage for swaping values.
      ...
      INTEGER ITMP              ! Temporary storage for pointers
...
*  elements) by performing an elementary exchange sort.
            ...
            IF ( X( I1) .GT. X( I2 ) ) THEN
               ...
               I2 = ITMP
            END IF
            IF ( X( I1 ) .GT. X( I3 ) ) THEN
               ITMP = I1
               I1 = I3
               I3 = ITMP
            END IF
            IF ( X( I2 ) .GT. X( I3 ) ) THEN
               ITMP = I2
               I2 = I3
               I3 = ITMP
            END IF
...
*  Iterate until the stack is empty.
      ...
      END
* @(#)pda_qsad.f   1.2   95/11/10 10:03:17   95/11/10 10:03:51
