...
\stardocinitials    {SUN}
\stardocsource      {sun194.3}
\stardocnumber      {194.3}
\stardocauthors     {H.\ Meyerdierks, D.\ Berry, P.\ W.\ Draper, G.\ Privett, M.\ Currie }
\stardocdate        {12th October 2005}
\stardoctitle       {PDA \\ [\latex{1ex}]
                                Public Domain Algorithms}
\stardocversion     {Version 0.5}
\stardocmanual      {Programmer's Manual}
\startitlepic {\includegraphics[width=2.0in]{sun194_1}}
\stardocabstract {%
The PDA library provides numerical algorithm code that can be
used to replace NAG in open source software.
}
...
\subsubsection{\xlabel{forward_transforms_c06fcf}Forward transforms}
...
\subsubsection{\xlabel{inverse_transforms_c06fcf}Inverse transforms}
...
\subsubsection{\xlabel{forward_transforms_c06fjf}Forward transforms}
...
\subsubsection{\xlabel{inverse_transforms_c06fjf}Inverse transforms}
...
\subsection{\xlabel{minimisation_overview}Overview}
...
\subsection{\xlabel{matrices_overview}Overview}
...
\sstroutine{
   ...
   \sstdescription{
      ...
      one or more arguments.  It uses Clenshaw\texttt{'}s recurrence
      relationship twice.
   }
   \sstinvocation{
...
\sstroutine{
   ...
   \sstdescription{
      ...
      accuracy.  It is based upon Ahrens, Dieter \& Grube\texttt{'}s TOMS599
   ...
   \sstdiytopic{
      ...
      to NAG\texttt{'}s G05CBF).  If it has not, there is no guarantee that
      sensible values will be returned from this function.
   }
   \sstdiytopic{
      References
   }{
      Ahrens, J.H., Dieter, U. \& Grube, A., 1970, \texttt{"}Pseudo-random
        numbers: a new proposal for the choice of multiplicators\texttt{"},
...
\sstroutine{
   ...
   \sstnotes{
      \sstitemlist{
         ...
         \begin{description}
              \item \texttt{DO I = 1, N}
              \item   \hspace{0.5cm} \texttt{XX( I ) = X( PERM( I )}
              \item \texttt{END DO}
         \end{description}
...
\sstroutine{
   ...
   \sstdescription{
      ...
      Grube\texttt{'}s TOMS599 routines.
   }
   \sstinvocation{
      RESULT = PDA\_RNEXP( X )
   }
   ...
   \sstdiytopic{
      ...
      Ahrens, J.H., \& Dieter, U. 1972, \texttt{"}Computer Methods for sampling
      from the exponential and Normal distributions\texttt{"}, Comm. ACM 15(10),
      pp.873--882.
   }
}
\sstroutine{
   ...
   \sstdescription{
      ...
      7 digits accuracy.  It is based upon Ahrens, Dieter \& Grube\texttt{'}s
   ...
   \sstdiytopic{
      ...
      Ahrens, J.H., \& Dieter, U. 1982, \texttt{"}Generating gamma variates
        by a modified rejection technique\texttt{"}, Comm. ACM 25(1), pp.47--54.
        (For A $>$= 1.0, algorithm GD)
      Ahrens, J.H., \& Dieter, U. 1974, \texttt{"}Computer Methods for sampling
        gamma, Poisson and binomial distributions\texttt{"}, Computing. 12),
...
\sstroutine{
   ...
   \sstdiytopic{
      ...
      Ahrens, J.H., \& Dieter, U. 1973, \texttt{"}Extensions of Forsythe\texttt{'}s
        Method for Random Sampling from the Normal distribution\texttt{"},
...
\sstroutine{
   ...
   \sstdiytopic{
      ...
      Ahrens, J.H., \& Dieter, U. 1973, \texttt{"}Computer Generation of Poisson
        Deviates from modified Normal distributions\texttt{"}, ACM Trans. Math.
...
\sstroutine{
   ...
   \sstdescription{
      ...
      based upon Ahrens, Dieter \& Grube\texttt{'}s TOMS599 routines.  The seed
