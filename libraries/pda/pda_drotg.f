*DECK PDA_DROTG
      SUBROUTINE PDA_DROTG (DA, DB, DC, DS)
C***BEGIN PROLOGUE  PDA_DROTG
C***PURPOSE  Construct a plane Givens rotation.
C***LIBRARY   SLATEC (BLAS)
C***CATEGORY  D1B10
C***TYPE      DOUBLE PRECISION (SROTG-S, PDA_DROTG-D, CROTG-C)
...
C
C     Normally, the subprogram PDA_DROT(N,DX,INCX,DY,INCY,DC,DS) will
...
C***END PROLOGUE  PDA_DROTG
      DOUBLE PRECISION  DA, DB, DC, DS, U, V, R
C***FIRST EXECUTABLE STATEMENT  PDA_DROTG
