...
C***LIBRARY   SLATEC
C***CATEGORY  N6A2B
C***TYPE      DOUBLE PRECISION (SSORT-S, PDA_DSORT-D, ISORT-I)
C***KEYWORDS  SINGLETON QUICKSORT, SORT, SORTING
C***AUTHOR  Jones, R. E., (SNLA)
C           Wisniewski, J. A., (SNLA)
C***DESCRIPTION
C
C   PDA_DSORT sorts array DX and optionally makes the same interchanges in
...
C     .. Intrinsic Functions ..
      INTRINSIC ABS, INT
C***FIRST EXECUTABLE STATEMENT  PDA_DSORT
      NN = N
      IF (NN .LT. 1) THEN
         CALL PDA_XERMSG ('SLATEC', 'PDA_DSORT',
     +      'The number of values to be sorted is not positive.', 1,
     +      1, STATUS)
         RETURN
      ENDIF
C
