      ...
      subroutine pda8_surfit(iopt,m,x,y,z,w,xb,xe,yb,ye,
     :                      kx,ky,s,nxest,nyest,
...
c
c calling sequence:
c     call pda8_surfit(iopt,m,x,y,z,w,xb,xe,yb,ye,kx,ky,s,nxest,nyest,
...
c  lwrk1 : integer*8. on entry lwrk1 must specify the actual dimension of
...
c  lwrk2 : integer*8. on entry lwrk2 must specify the actual dimension of
...
c  kwrk  : integer*8. on entry kwrk must specify the actual dimension of
...
c  ..scalar arguments..
      ...
      integer*8 m,lwrk1,lwrk2,kwrk
      integer iopt,kx,ky,nxest,nyest,nmax,nx,ny,ier
c  ..array arguments..
...
c  we partition the working space and determine the spline approximation
      ...
      lsx = lby+nek
      lsy = lsx+m*km1
      call pda8_fpsurf(iopt,m,x,y,z,w,xb,xe,yb,ye,kx,ky,s,nxest,nyest,
