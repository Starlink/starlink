...
c     **********
c
c     subroutine pda_lmdif1
c
c     the purpose of pda_lmdif1 is to minimize the sum of the squares of
...
c     general least-squares solver pda_lmdif. the user must provide a
c     subroutine which calculates the functions. the jacobian is
c     then calculated by a forward-difference approximation.
c
c     the subroutine statement is
c
c       subroutine pda_lmdif1(fcn,m,n,x,fvec,tol,info,iwa,wa,lwa)
c
c     where
c
...
c         the user wants to terminate execution of pda_lmdif1.
...
c
      ...
      nprint = 0
      mp5n = m + 5*n
      call pda_lmdif(fcn,m,n,x,fvec,ftol,xtol,gtol,maxfev,epsfcn,wa(1),
   ...
   10 continue
      return
c
c     last card of subroutine pda_lmdif1.
c
      end
