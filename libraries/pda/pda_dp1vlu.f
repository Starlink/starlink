...
C***BEGIN PROLOGUE  PDA_DP1VLU
C***PURPOSE  Use the coefficients generated by PDA_DPOLFT to evaluate the
C            polynomial fit of degree L, along with the first NDER of
C            its derivatives, at a specified point.
C***LIBRARY   SLATEC
C***CATEGORY  K6
C***TYPE      DOUBLE PRECISION (PVALUE-S, PDA_DP1VLU-D)
...
C     Abstract
C
C     The subroutine  PDA_DP1VLU  uses the coefficients generated by  PDA_DPOLFT
...
C
C     The parameters for  PDA_DP1VLU  are
C
...
C***FIRST EXECUTABLE STATEMENT  PDA_DP1VLU
      IF (L .LT. 0) GO TO 12
      NDO = MAX(NDER,0)
      NDO = MIN(NDO,L)
      MAXORD = A(1) + 0.5D0
