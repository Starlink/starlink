...
void ary1Gmrb( AryACB *acb, char *mtrex, char *mrfull, char *whole, hdsdim lmrb[ ARY__MXDIM ], hdsdim umrb[ ARY__MXDIM ], hdsdim lmtr[ ARY__MXDIM ], hdsdim umtr[ ARY__MXDIM ], int *status );
