      SUBROUTINE PARSECON_PACKI( LU, ARRAY, START, END, STATUS )
...
*  Invocation:
*     CALL PARSECON_PACKI( LU, ARRAY, START, END, STATUS )
...
*  Local Variables:
      INTEGER VBUFF( SUBPAR__MAXPAR ) ! Values buffer
