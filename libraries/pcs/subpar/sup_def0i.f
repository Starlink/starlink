      SUBROUTINE SUBPAR_DEF0I ( NAMECODE, IVALUE, STATUS )
      IMPLICIT NONE
...
*  Invocation:
*     CALL SUBPAR_DEF0I ( NAMECODE, VALUE, STATUS )
...
*        Use SUBPAR_DEF1I
*     09-MAR-1992 (AJC):
*        Use the special flag NVAL = 0 in calling _DEF1I
...
*
*   set the number of values and call SUBPAR_DEF1I.
*   NVAL = 0 has special meaning i.e a scalar value
*
      NVAL = 0
      CALL SUBPAR_DEF1I ( NAMECODE, NVAL, IVALUE, STATUS )
