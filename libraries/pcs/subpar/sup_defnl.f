      SUBROUTINE SUBPAR_DEFNL ( NAMECODE, NDIM, MAXD, VALUES, ACTD,
     :  STATUS )
*+
*  Name:
*     SUBPAR_DEFNL
...
*  Invocation:
*     CALL SUBPAR_DEFNL ( NAMECODE, NDIM, MAXD, VALUES, ACTD,
...
*   Now put the values in the object, HDS converts if necessary
      CALL DAT_PUTNL ( BOTLOC, NDIM, MAXD, VALUES, ACTD, STATUS )
*
