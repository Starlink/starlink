      SUBROUTINE SUBPAR_GETVL ( NAMECODE, MAXVAL, LVALUES, ACTVAL,
     :  STATUS )
...
*  Invocation:
*     CALL SUBPAR_GETVL ( NAMECODE, MAXVAL, LVALUES, ACTVAL, STATUS )
...
*           Obtain the 'vectorised' data
               CALL DAT_GETVL ( BOTLOC, MAXVAL, LVALUES, ACTVAL,
     :         STATUS )
