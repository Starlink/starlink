      SUBROUTINE SUBPAR_PUTNI ( NAMECODE, NDIM, MAXD, VALUES, ACTD,
     :  STATUS )
*+
*  Name:
*     SUBPAR_PUTNI
...
*  Invocation:
*     CALL SUBPAR_PUTNI ( NAMECODE, NDIM, MAXD, VALUES, ACTD,
...
*         Write the data
*
            CALL DAT_PUTNI ( BOTLOC, NDIM, MAXD, VALUES, ACTD,
     :       STATUS )
*
