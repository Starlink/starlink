      SUBROUTINE SUBPAR_GET1C ( NAMECODE, MAXVAL, CVALUES, ACTVAL,
     :  STATUS )
*+
*  Name:
*     SUBPAR_GET1C
...
*  Invocation:
*     CALL SUBPAR_GET1C ( NAMECODE, MAXVAL, CVALUES, ACTVAL, STATUS )
...
*  Arguments Returned:
      CHARACTER*(*) CVALUES(*)               ! Array for values
...
*              Get the data values and size
                  CALL DAT_GET1C( BOTLOC, MAXVAL, CVALUES,
     :            ACTVAL, STATUS )
               ENDIF
...
*           Get the data value
               CALL DAT_GET0C( BOTLOC, CVALUES(1), STATUS )
*           and set size = 1
               ACTVAL = 1
