      SUBROUTINE SUBPAR_GET1R ( NAMECODE, MAXVAL, RVALUES, ACTVAL,
     :  STATUS )
*+
*  Name:
*     SUBPAR_GET1R
...
*  Invocation:
*     CALL SUBPAR_GET1R ( NAMECODE, MAXVAL, RVALUES, ACTVAL, STATUS )
...
*              Get the data values and size
                  CALL DAT_GET1R( BOTLOC, MAXVAL, RVALUES,
     :            ACTVAL, STATUS )
               ENDIF
...
*           Get the data value
               CALL DAT_GET0R( BOTLOC, RVALUES(1), STATUS )
*           and set size = 1
               ACTVAL = 1
