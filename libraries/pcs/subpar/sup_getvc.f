      SUBROUTINE SUBPAR_GETVC ( NAMECODE, MAXVAL, CVALUES, ACTVAL,
     :  STATUS )
...
*  Invocation:
*     CALL SUBPAR_GETVC ( NAMECODE, MAXVAL, CVALUES, ACTVAL, STATUS )
...
*           Obtain the 'vectorised' data
               CALL DAT_GETVC ( BOTLOC, MAXVAL, CVALUES, ACTVAL,
     :         STATUS )
