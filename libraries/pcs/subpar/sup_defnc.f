      SUBROUTINE SUBPAR_DEFNC ( NAMECODE, NDIM, MAXD, VALUES, ACTD,
     :  STATUS )
*+
*  Name:
*     SUBPAR_DEFNC
...
*  Invocation:
*     CALL SUBPAR_DEFNC ( NAMECODE, NDIM, MAXD, VALUES, ACTD,
...
*   Now put the values in the object, HDS converts if necessary
      CALL DAT_PUTNC ( BOTLOC, NDIM, MAXD, VALUES, ACTD, STATUS )
*
