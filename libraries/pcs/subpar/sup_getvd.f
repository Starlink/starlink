      SUBROUTINE SUBPAR_GETVD ( NAMECODE, MAXVAL, DVALUES, ACTVAL,
     :  STATUS )
...
*  Invocation:
*     CALL SUBPAR_GETVD ( NAMECODE, MAXVAL, DVALUES, ACTVAL, STATUS )
...
*     DVALUES(MAXVAL)=DOUBLE PRECISION
...
*           Obtain the 'vectorised' data
               CALL DAT_GETVD ( BOTLOC, MAXVAL, DVALUES, ACTVAL,
     :         STATUS )
