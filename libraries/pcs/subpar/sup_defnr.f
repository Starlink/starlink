      SUBROUTINE SUBPAR_DEFNR ( NAMECODE, NDIM, MAXD, VALUES, ACTD,
     :  STATUS )
*+
*  Name:
*     SUBPAR_DEFNR
...
*  Invocation:
*     CALL SUBPAR_DEFNR ( NAMECODE, NDIM, MAXD, VALUES, ACTD,
...
*   Now put the values in the object, HDS converts if necessary
      CALL DAT_PUTNR ( BOTLOC, NDIM, MAXD, VALUES, ACTD, STATUS )
*
