      SUBROUTINE SUBPAR_PUT0R ( NAMECODE, RVALUE, STATUS )
*+
*  Name:
*     SUBPAR_PUT0R

*  Purpose:
*     Write scalar REAL parameter value.

*  Language:
*     Starlink Fortran 77

*  Invocation:
*     CALL SUBPAR_PUT0R ( NAMECODE, RVALUE, STATUS )
...
*
     ...
     :            'for parameter ^NAME - ', STATUS )
            ...
            ELSE
               ...
               CALL EMS_SETC ( 'NAME', PARKEY(NAMECODE) )
               CALL EMS_REP ( 'SUP_PUT0R4',
     :         'SUBPAR: Parameter ^NAME is non-primitive - '//
     :         'attempted PUT0R to it', STATUS )
