*+  TASK_DEC1D - decode a character string as a vector
      SUBROUTINE TASK_DEC1D ( STRING, MAXVALS, NVALS, DVALS,
     :                          STATUS )
*    Description :
...
*    Invocation :
*     CALL TASK_DEC1D ( STRING, MAXVALS, NVALS, DVALS, STATUS )
*    Parameters :
...
*     DVALS(NVALS)=DOUBLE PRECISION (returned)
