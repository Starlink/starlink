...
\stardocnumber      {115.3}
\stardocauthors     {A J Chipperfield, B D Kelly, S L Wright}
...
\subsection{The HELP Field\xlabel{the_parameter_help_field}}
...
\subsection{The HELP Field\xlabel{the_action_help_field}}
...
\xlabel{interface_module_search_path_and_adam_ifl}\label{searchpath}}
...
\item[Suggested Values] The term \emph{prompt value} has been replaced by
\emph{suggested value} which is now the preferred term.
