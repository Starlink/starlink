...
\newcommand{\stardocdate}      {18th September 2001}
...
the position angle (in degrees) of the first of the two ellipse axes. 
...
gives the position angle (in degrees) of the first side of the box. 
This keyword can only be used in 2-dimensional ARD descriptions. Note, the
