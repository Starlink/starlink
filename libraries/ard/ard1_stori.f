      SUBROUTINE ARD1_STORI( VALUE, SIZE, NEXT, PNTR, STATUS )
*+
*  Name:
*     ARD1_STORI

*  Purpose:
*     Store an integer value in a dynamic array

*  Language:
*     Starlink Fortran 77

*  Invocation:
*     CALL ARD1_STORI( VALUE, SIZE, NEXT, PNTR, STATUS )
...
*  If the array is not big enough increase its size.
      IF( NEXT .GT. SIZE ) THEN
         ...
         CALL PSX_REALLOC( VAL__NBI*SIZE, PNTR, STATUS )
      END IF
