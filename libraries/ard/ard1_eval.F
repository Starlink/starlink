...
*        pointed to in this way gives the integer code corresponding to
*        the type of region (CIRCLE, BOX, etc). The next element of
*        OPRNDS contains an integer which gives the number of 
*        parameters (N say) needed to describe the region. The next N
*        elements of OPRNDS contain these N parameter values.
