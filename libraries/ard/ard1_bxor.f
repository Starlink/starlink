      SUBROUTINE ARD1_BXOR( NDIM, LBND, UBND, MSKSIZ, A, LBOX,
     :                      UBOX, B, STATUS )
*+
*  Name:
*     ARD1_BXOR
...
*  Purpose:
*     Perform an OR operation within a box region.

*  Language:
*     Starlink Fortran 77

*  Invocation:
*     CALL ARD1_BXOR( NDIM, LBND, UBND, MSKSIZ, A, LBOX, UBOX,
*                     B, STATUS )

*  Description:
*     The area of arrays A and B within the supplied bounding box are
*     OR'ed together and the results stored back in B. All elements of
...
*     other values are treated as .TRUE. The value used to represent
*     .TRUE. in the output mask is the maximum of the input values.
