      SUBROUTINE ARD1_BXXOR( NDIM, LBND, UBND, MSKSIZ, A, LBOX,
     :                       UBOX, B, STATUS )
*+
*  Name:
*     ARD1_BXXOR
...
*  Purpose:
*     Perform an XOR operation within a box region.

*  Language:
*     Starlink Fortran 77

*  Invocation:
*     CALL ARD1_BXXOR( NDIM, LBND, UBND, MSKSIZ, A, LBOX, UBOX,
*                      B, STATUS )

*  Description:
*     The area of arrays A and B within the supplied bounding box are
*     XOR'ed together and the results stored back in B. All elements of
...
*     other values are treated as .TRUE. Output .TRUE. values retain
*     their input values.
