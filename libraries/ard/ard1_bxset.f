      SUBROUTINE ARD1_BXSET( NDIM, LBND, UBND, MSKSIZ, VALUE, LBOX,
     :                       UBOX, B, STATUS )
*+
*  Name:
*     ARD1_BXSET
...
*  Purpose:
*     Assign a constant value to a box region.

*  Language:
*     Starlink Fortran 77

*  Invocation:
*     CALL ARD1_BXSET( NDIM, LBND, UBND, MSKSIZ, VALUE, LBOX, UBOX,
*                      B, STATUS )

*  Description:
*     The area of array B within the supplied bounding box is
*     assign the value given by argument VALUE. A general N-d
*     algorithm is used.
