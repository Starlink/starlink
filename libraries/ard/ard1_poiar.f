      SUBROUTINE ARD1_POIAR( NDIM, C, ELEM, L, IPOPND, IOPND, SZOPND,
     :                       NARG, I, KEYW, STATUS )
*+
*  Name:
*     ARD1_POIAR
...
*  Purpose:
*     Assemble argument list for a POINT keyword

*  Language:
*     Starlink Fortran 77

*  Invocation:
*     CALL ARD1_POIAR( NDIM, C, ELEM, L, IPOPND, IOPND, SZOPND, NARG,
*                      I, KEYW, STATUS )
...
*  Ensure that the contents of the ARGS array and AXIS variable are
*  saved between invocations of this routine.
      SAVE ARGS, AXIS
*.
...
*  multiple of NDIM).
         ELSE IF( .NOT. KEYW ) THEN
            ...
            IF( AXIS .NE. NDIM .AND. STATUS .EQ. SAI__OK ) THEN
               STATUS = ARD__ARGS
