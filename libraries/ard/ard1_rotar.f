      SUBROUTINE ARD1_ROTAR( NWCS, CFRM, ELEM, L, IPOPND, IOPND, SZOPND,
     :                       NARG, I, KEYW, STATUS )
*+
*  Name:
*     ARD1_ROTAR
...
*  Invocation:
*     CALL ARD1_ROTAR( NWCS, CFRM, ELEM, L, IPOPND, IOPND, SZOPND, NARG,
*                      I, KEYW, STATUS )
...
*  Third and fourth arguments are distances. Find the index of the axis along
*  which they are measured.
         ELSE IF( NARG .LT. 4 ) THEN
            CALL ARD1_DSTAX( CFRM, AXIS, STATUS )

*  Remaining arguments are interpreted as simple floating point values.
         ELSE
            AXIS = 0
         END IF
