      SUBROUTINE ARD1_BOXAR( NDIM, C, ELEM, L, IPOPND, IOPND, SZOPND,
     :                       NARG, I, KEYW, STATUS )
*+
*  Name:
*     ARD1_BOXAR
...
*  the number of arguments obtained is incorrect.
         ELSE IF( .NOT. KEYW ) THEN
            ...
            IF( NARG .NE. 2*NDIM .AND. STATUS .EQ. SAI__OK ) THEN
               STATUS = ARD__ARGS
               CALL ERR_REP( 'ARD1_BOXAR_ERR1', 'Incorrect number of '//
