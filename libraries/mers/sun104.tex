...
\newcommand{\msgflevok}{\func{msgFlevok}}
\newcommand{\msgfmt}{\func{msgFmt}}
\newcommand{\msgifget}{\htmlref{\func{msgIfget}}{msgIfget}}
\newcommand{\msgifgetenv}{\htmlref{\func{msgIfgetenv}}{msgIfgetenv}}
\newcommand{\msgiflev}{\func{msgIflev}}
\newcommand{\msgifset}{\func{msgIfset}}
...
\newcommand{\msgtune}{\htmlref{\func{msgTune}}{msgTune}}
...
filter is set to \msgverb,r \msgdebug (and related constants) or \msgall.
\item [\msgverb] -- output the given message only if the current output
...
\begin{description}
\item \textbf{\saierr} -- Error encountered.
\item \textbf{\saiok} -- No error.
\item \textbf{SAI\_\_WARN} -- Warning.
\end {description}
\item [MSG\_PAR] Defines the public Message System constants.
\begin{description}
\item \textbf{\msgnorm} -- Normal conditional message output level.
\item \textbf{\msgquiet} -- Quiet (few messages) conditional message output 
level.
\item \textbf{MSG\_\_SZMSG} -- Maximum length of message text.
\item \textbf{\msgverb} -- Verbose (abundant messages) conditional message
output level.
