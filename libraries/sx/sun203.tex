...
\renewenvironment{ModuleOutputs}{
    \begin{description}
...
\renewcommand{\DemoMod}[2]{
\item \Modnam{{\bf {#1}}}: {#2}
}

\renewcommand{\DemoWidget}[1]{
   $<${\bf{#1}}$>$ } 
}
\renewcommand{\Cpanel}[1]{ {\sf ``{#1}''} }
\renewcommand{\DemoPanel}[1]{\item [{\sf {#1}}]\mbox{}\par\vspace{-1mm}}
