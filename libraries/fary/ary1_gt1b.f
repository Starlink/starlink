      SUBROUTINE ARY1_GT1B( BAD, LOC, TYPE, EL, RESULT, DCE, STATUS )
*+
*  Name:
*     ARY1_GT1B
 
*  Purpose:
*     Read a 1-dimensional array of BYTE values from an HDS object.
 
*  Language:
*     Starlink Fortran 77
 
*  Invocation:
*     CALL ARY1_GT1B( BAD, LOC, TYPE, EL, RESULT, DCE, STATUS )
 
*  Description:
*     The routine reads a 1-dimensional array of BYTE values from an
...
*  directly.
      IF ( TYPE .EQ. '_BYTE' ) THEN
         DCE = .FALSE.
         CALL DAT_GET( LOC, '_BYTE', 1, DIM, RESULT, STATUS )
...
*  data.
      ELSE
         ...
         CALL ARY1_CVTB( BAD, EL, TYPE, PNTR, RESULT, DCE, STATUS )
         CALL ARY1_HUNMP( LOC, STATUS )
      END IF
 
*  Call error tracing routine and exit.
      IF ( STATUS .NE. SAI__OK ) CALL ARY1_TRACE( 'ARY1_GT1B',
     :STATUS )
