      SUBROUTINE ARY1_PTNR( BAD, NDIM, LBNDA, UBNDA, ARRAY, LSUB,
...
*  Purpose:
*     Write REAL values to an n-dimensional subregion of an HDS
*     object.
...
*  Invocation:
*     CALL ARY1_PTNR( BAD, NDIM, LBNDA, UBNDA, ARRAY, LSUB, USUB,
...
*     REAL Fortran array and making use of lower and upper bounds
...
*  string supplied is too long.
      ...
      ELSE
         STATUS = ARY__FATIN
         CALL MSG_SETC( 'ROUTINE', 'ARY1_PTNR' )
         CALL MSG_SETC( 'BADHTYPE', HTYPE )
         CALL ERR_REP( 'ARY1_PTNR_TYP',
...
*  annul the slice. Note if a data conversion error occurred.
            CALL ARY1_PT1R( BAD, NCONTG, ARRAY( EA + 1 ), TYPE, SLICE,
     :                        DCESLC, STATUS )
...
*  Call error tracing routine and exit.
      IF ( STATUS .NE. SAI__OK ) CALL ARY1_TRACE( 'ARY1_PTNR',
     :STATUS )
