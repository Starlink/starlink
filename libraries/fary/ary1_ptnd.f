      SUBROUTINE ARY1_PTND( BAD, NDIM, LBNDA, UBNDA, ARRAY, LSUB,
...
*  Purpose:
*     Write DOUBLE PRECISION values to an n-dimensional subregion of an HDS
*     object.
...
*  Invocation:
*     CALL ARY1_PTND( BAD, NDIM, LBNDA, UBNDA, ARRAY, LSUB, USUB,
...
*     DOUBLE PRECISION Fortran array and making use of lower and upper bounds
...
*  string supplied is too long.
      ...
      ELSE
         STATUS = ARY__FATIN
         CALL MSG_SETC( 'ROUTINE', 'ARY1_PTND' )
         CALL MSG_SETC( 'BADHTYPE', HTYPE )
         CALL ERR_REP( 'ARY1_PTND_TYP',
...
*  annul the slice. Note if a data conversion error occurred.
            CALL ARY1_PT1D( BAD, NCONTG, ARRAY( EA + 1 ), TYPE, SLICE,
     :                        DCESLC, STATUS )
...
*  Call error tracing routine and exit.
      IF ( STATUS .NE. SAI__OK ) CALL ARY1_TRACE( 'ARY1_PTND',
     :STATUS )
