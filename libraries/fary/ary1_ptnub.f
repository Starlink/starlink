      SUBROUTINE ARY1_PTNUB( BAD, NDIM, LBNDA, UBNDA, ARRAY, LSUB,
...
*  Purpose:
*     Write UNSIGNED BYTE values to an n-dimensional subregion of an HDS
*     object.
...
*  Invocation:
*     CALL ARY1_PTNUB( BAD, NDIM, LBNDA, UBNDA, ARRAY, LSUB, USUB,
...
*     UNSIGNED BYTE Fortran array and making use of lower and upper bounds
...
*  string supplied is too long.
      ...
      ELSE
         STATUS = ARY__FATIN
         CALL MSG_SETC( 'ROUTINE', 'ARY1_PTNUB' )
         CALL MSG_SETC( 'BADHTYPE', HTYPE )
         CALL ERR_REP( 'ARY1_PTNUB_TYP',
...
*  annul the slice. Note if a data conversion error occurred.
            CALL ARY1_PT1UB( BAD, NCONTG, ARRAY( EA + 1 ), TYPE, SLICE,
     :                        DCESLC, STATUS )
...
*  Call error tracing routine and exit.
      IF ( STATUS .NE. SAI__OK ) CALL ARY1_TRACE( 'ARY1_PTNUB',
     :STATUS )
