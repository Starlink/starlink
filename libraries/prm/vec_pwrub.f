      SUBROUTINE VEC_PWRUB( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_PWRUB
...
*  Purpose:
*     Vectorised UNSIGNED BYTE exponentiation operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_PWRUB( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )
...
*        of UNSIGNED BYTE argument values for the exponentiation operation.
...
*  operation.
            ELSE
               RESV( I ) = NUM_PWRUB( ARGV1( I ), ARGV2( I ) )
