      SUBROUTINE VEC_UBTOR( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_UBTOR

*  Purpose:
*     Convert vectorised UNSIGNED BYTE values to REAL.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_UBTOR( BAD, N, ARGV, RESV, IERR, NERR, STATUS )

*  Description:
*     The routine performs type conversion on a vectorised array ARGV
*     of UNSIGNED BYTE values, converting them to the equivalent REAL
