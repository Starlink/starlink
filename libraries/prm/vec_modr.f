      SUBROUTINE VEC_MODR( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_MODR
...
*  Purpose:
*     Vectorised REAL Fortran MOD (remainder) function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_MODR( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )

*  Description:
*     The routine evaluates the Fortran MOD (remainder) function for two vectorised
...
*        of REAL argument values for the Fortran MOD (remainder) function.
...
*  If the argument values are acceptable, then evaluate the Fortran MOD (remainder)
*  function.
            ELSE
               RESV( I ) = NUM_MODR( ARG1, ARG2 )
