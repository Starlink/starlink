      BYTE FUNCTION VAL_SQRTUB( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_SQRTUB

*  Purpose:
*     Evaluate the UNSIGNED BYTE square root function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_SQRTUB( BAD, ARG, STATUS )
...
*     ARG = BYTE (Given)
*        The UNSIGNED BYTE argument of the square root function.
...
*  Returned Value:
*     VAL_SQRTUB = BYTE
*        Returns the evaluated square root function result as a UNSIGNED BYTE
