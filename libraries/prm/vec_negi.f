      SUBROUTINE VEC_NEGI( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_NEGI

*  Purpose:
*     Vectorised INTEGER negation function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_NEGI( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
...
*  increment the error count.
            IF( .NOT. ( BAD .OR. NUM_NEI( ARG, NUM__MINI ) ) ) THEN
               RESV( I ) = VAL__BADI
               NERR = NERR + 1
