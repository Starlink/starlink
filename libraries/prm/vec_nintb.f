      SUBROUTINE VEC_NINTB( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_NINTB

*  Purpose:
*     Vectorised BYTE nearest integer function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_NINTB( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
