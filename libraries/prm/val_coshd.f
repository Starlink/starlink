      DOUBLE PRECISION FUNCTION VAL_COSHD( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_COSHD

*  Purpose:
*     Evaluate the DOUBLE PRECISION hyperbolic cosine function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_COSHD( BAD, ARG, STATUS )

*  Description:
*     The routine evaluates the hyperbolic cosine function for a single
...
*        The DOUBLE PRECISION argument of the hyperbolic cosine function.
...
*  Returned Value:
*     VAL_COSHD = DOUBLE PRECISION
*        Returns the evaluated hyperbolic cosine function result as a DOUBLE PRECISION
