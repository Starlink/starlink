      BYTE FUNCTION VAL_DTOUB( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_DTOUB

*  Purpose:
*     Convert a value from DOUBLE PRECISION to UNSIGNED BYTE.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_DTOUB( BAD, ARG, STATUS )
