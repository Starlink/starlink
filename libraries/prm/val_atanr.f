      REAL FUNCTION VAL_ATANR( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_ATANR

*  Purpose:
*     Evaluate the REAL arc-tangent function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_ATANR( BAD, ARG, STATUS )
...
*     ARG = REAL (Given)
*        The REAL argument of the arc-tangent function.
...
*  Returned Value:
*     VAL_ATANR = REAL
*        Returns the evaluated arc-tangent function result as a REAL
