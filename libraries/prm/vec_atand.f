      SUBROUTINE VEC_ATAND( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_ATAND

*  Purpose:
*     Vectorised DOUBLE PRECISION arc-tangent function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_ATAND( BAD, N, ARGV, RESV, IERR, NERR, STATUS )

*  Description:
*     The routine evaluates the arc-tangent function for a vectorised
...
*        argument values for the arc-tangent function.
...
*  If the argument value is acceptable, then evaluate the arc-tangent
*  function.
            ELSE
               RESV( I ) = NUM_ATAND( ARG )
