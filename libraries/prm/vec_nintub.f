      SUBROUTINE VEC_NINTUB( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_NINTUB

*  Purpose:
*     Vectorised UNSIGNED BYTE nearest integer function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_NINTUB( BAD, N, ARGV, RESV, IERR, NERR, STATUS )

*  Description:
*     The routine evaluates the nearest integer function for a vectorised
...
*        argument values for the nearest integer function.
...
*  If the argument value is acceptable, then evaluate the nearest integer
*  function.
            ELSE
               RESV( I ) = NUM_NINTUB( ARG )
