      SUBROUTINE VEC_PWRD( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_PWRD
...
*  Purpose:
*     Vectorised DOUBLE PRECISION exponentiation operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_PWRD( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )
...
*        of DOUBLE PRECISION argument values for the exponentiation operation.
...
*  operation.
            ELSE
               RESV( I ) = NUM_PWRD( ARGV1( I ), ARGV2( I ) )
