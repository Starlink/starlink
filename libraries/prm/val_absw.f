      INTEGER*2 FUNCTION VAL_ABSW( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_ABSW

*  Purpose:
*     Evaluate the WORD Fortran ABS function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_ABSW( BAD, ARG, STATUS )
...
*     ARG = INTEGER*2 (Given)
*        The WORD argument of the Fortran ABS function.
...
*  Returned Value:
*     VAL_ABSW = INTEGER*2
*        Returns the evaluated Fortran ABS function result as a WORD
