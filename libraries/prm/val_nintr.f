      REAL FUNCTION VAL_NINTR( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_NINTR

*  Purpose:
*     Evaluate the REAL nearest integer function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_NINTR( BAD, ARG, STATUS )
...
*     ARG = REAL (Given)
*        The REAL argument of the nearest integer function.
...
*  Returned Value:
*     VAL_NINTR = REAL
*        Returns the evaluated nearest integer function result as a REAL
