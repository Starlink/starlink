      SUBROUTINE VEC_ADDW( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_ADDW
...
*  Purpose:
*     Vectorised WORD addition operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_ADDW( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )
...
*        of WORD argument values for the addition operation.
...
*  operation.
            ELSE
               RESV( I ) = NUM_ADDW( ARGV1( I ), ARGV2( I ) )
