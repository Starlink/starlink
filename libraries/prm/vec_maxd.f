      SUBROUTINE VEC_MAXD( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_MAXD
...
*  Purpose:
*     Vectorised DOUBLE PRECISION maximum function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_MAXD( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )
...
*        of DOUBLE PRECISION argument values for the maximum function.
