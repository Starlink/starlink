      SUBROUTINE VEC_ATNDR( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_ATNDR

*  Purpose:
*     Vectorised REAL arc_tangent (degrees) function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_ATNDR( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
