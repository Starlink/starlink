      BYTE FUNCTION VAL_NINTB( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_NINTB

*  Purpose:
*     Evaluate the BYTE nearest integer function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_NINTB( BAD, ARG, STATUS )
...
*     ARG = BYTE (Given)
*        The BYTE argument of the nearest integer function.
...
*  Returned Value:
*     VAL_NINTB = BYTE
*        Returns the evaluated nearest integer function result as a BYTE
