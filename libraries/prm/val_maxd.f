      DOUBLE PRECISION FUNCTION VAL_MAXD( BAD, ARG1, ARG2, STATUS )
*+
*  Name:
*     VAL_MAXD

*  Purpose:
*     Evaluate the DOUBLE PRECISION maximum function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_MAXD( BAD, ARG1, ARG2, STATUS )
...
*        The two DOUBLE PRECISION arguments of the maximum function.
...
*  Returned Value:
*     VAL_MAXD = DOUBLE PRECISION
*        Returns the evaluated maximum function result as a DOUBLE PRECISION
