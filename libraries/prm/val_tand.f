      DOUBLE PRECISION FUNCTION VAL_TAND( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_TAND

*  Purpose:
*     Evaluate the DOUBLE PRECISION tangent function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_TAND( BAD, ARG, STATUS )

*  Description:
*     The routine evaluates the tangent function for a single
...
*        The DOUBLE PRECISION argument of the tangent function.
...
*  Returned Value:
*     VAL_TAND = DOUBLE PRECISION
*        Returns the evaluated tangent function result as a DOUBLE PRECISION
