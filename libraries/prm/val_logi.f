      INTEGER FUNCTION VAL_LOGI( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_LOGI

*  Purpose:
*     Evaluate the INTEGER natural logarithm function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_LOGI( BAD, ARG, STATUS )
...
*     ARG = INTEGER (Given)
*        The INTEGER argument of the natural logarithm function.
...
*  Returned Value:
*     VAL_LOGI = INTEGER
*        Returns the evaluated natural logarithm function result as a INTEGER
