      DOUBLE PRECISION FUNCTION VAL_SIGND( BAD, ARG1, ARG2, STATUS )
*+
*  Name:
*     VAL_SIGND

*  Purpose:
*     Evaluate the DOUBLE PRECISION Fortran SIGN (sign transfer) function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_SIGND( BAD, ARG1, ARG2, STATUS )
...
*        The two DOUBLE PRECISION arguments of the Fortran SIGN (sign transfer) function.
...
*  Returned Value:
*     VAL_SIGND = DOUBLE PRECISION
*        Returns the evaluated Fortran SIGN (sign transfer) function result as a DOUBLE PRECISION
