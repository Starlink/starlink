      SUBROUTINE VEC_TANDR( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_TANDR

*  Purpose:
*     Vectorised REAL tangent (degrees) function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_TANDR( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
