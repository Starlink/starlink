      SUBROUTINE VEC_UWTOW( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_UWTOW

*  Purpose:
*     Convert vectorised UNSIGNED WORD values to WORD.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_UWTOW( BAD, N, ARGV, RESV, IERR, NERR, STATUS )

*  Description:
*     The routine performs type conversion on a vectorised array ARGV
*     of UNSIGNED WORD values, converting them to the equivalent WORD
