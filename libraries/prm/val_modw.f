      INTEGER*2 FUNCTION VAL_MODW( BAD, ARG1, ARG2, STATUS )
*+
*  Name:
*     VAL_MODW

*  Purpose:
*     Evaluate the WORD Fortran MOD (remainder) function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_MODW( BAD, ARG1, ARG2, STATUS )
...
*        The two WORD arguments of the Fortran MOD (remainder) function.
...
*  Returned Value:
*     VAL_MODW = INTEGER*2
*        Returns the evaluated Fortran MOD (remainder) function result as a WORD
