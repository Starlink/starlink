      SUBROUTINE VEC_ACOSR( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_ACOSR

*  Purpose:
*     Vectorised REAL arc-cosine function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_ACOSR( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
