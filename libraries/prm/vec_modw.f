      SUBROUTINE VEC_MODW( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_MODW
...
*  Purpose:
*     Vectorised WORD Fortran MOD (remainder) function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_MODW( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )
...
*        of WORD argument values for the Fortran MOD (remainder) function.
