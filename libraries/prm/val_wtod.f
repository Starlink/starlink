      DOUBLE PRECISION FUNCTION VAL_WTOD( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_WTOD

*  Purpose:
*     Convert a value from WORD to DOUBLE PRECISION.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_WTOD( BAD, ARG, STATUS )
