      SUBROUTINE VEC_SQRTW( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_SQRTW

*  Purpose:
*     Vectorised WORD square root function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_SQRTW( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
...
*  increment the error count.
            IF( .NOT. ( NUM_GEW( ARG, VAL__ZW ) ) ) THEN
               RESV( I ) = VAL__BADW
               NERR = NERR + 1
