      SUBROUTINE VEC_ACSDR( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_ACSDR

*  Purpose:
*     Vectorised REAL arc-cosine (degrees) function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_ACSDR( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
