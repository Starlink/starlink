      REAL FUNCTION VAL_DIMR( BAD, ARG1, ARG2, STATUS )
*+
*  Name:
*     VAL_DIMR

*  Purpose:
*     Evaluate the REAL Fortran DIM (positive difference) function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_DIMR( BAD, ARG1, ARG2, STATUS )
...
*        The two REAL arguments of the Fortran DIM (positive difference) function.
...
*  Returned Value:
*     VAL_DIMR = REAL
*        Returns the evaluated Fortran DIM (positive difference) function result as a REAL
