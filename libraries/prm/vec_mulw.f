      SUBROUTINE VEC_MULW( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_MULW
...
*  Purpose:
*     Vectorised WORD multiplication operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_MULW( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )
...
*        of WORD argument values for the multiplication operation.
...
*  operation.
            ELSE
               RESV( I ) = NUM_MULW( ARGV1( I ), ARGV2( I ) )
