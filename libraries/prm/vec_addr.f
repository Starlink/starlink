      SUBROUTINE VEC_ADDR( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_ADDR
...
*  Purpose:
*     Vectorised REAL addition operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_ADDR( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )
...
*        of REAL argument values for the addition operation.
...
*  operation.
            ELSE
               RESV( I ) = NUM_ADDR( ARGV1( I ), ARGV2( I ) )
