      DOUBLE PRECISION FUNCTION VAL_COSD( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_COSD

*  Purpose:
*     Evaluate the DOUBLE PRECISION cosine function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_COSD( BAD, ARG, STATUS )
...
*        The DOUBLE PRECISION argument of the cosine function.
...
*  Returned Value:
*     VAL_COSD = DOUBLE PRECISION
*        Returns the evaluated cosine function result as a DOUBLE PRECISION
