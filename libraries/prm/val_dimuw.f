      INTEGER*2 FUNCTION VAL_DIMUW( BAD, ARG1, ARG2, STATUS )
*+
*  Name:
*     VAL_DIMUW

*  Purpose:
*     Evaluate the UNSIGNED WORD Fortran DIM (positive difference) function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_DIMUW( BAD, ARG1, ARG2, STATUS )
...
*        The two UNSIGNED WORD arguments of the Fortran DIM (positive difference) function.
...
*  Returned Value:
*     VAL_DIMUW = INTEGER*2
*        Returns the evaluated Fortran DIM (positive difference) function result as a UNSIGNED WORD
