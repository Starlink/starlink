      DOUBLE PRECISION FUNCTION VAL_ACSDD( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_ACSDD

*  Purpose:
*     Evaluate the DOUBLE PRECISION arc-cosine (degrees) function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_ACSDD( BAD, ARG, STATUS )

*  Description:
*     The routine evaluates the arc-cosine (degrees) function for a single
...
*        The DOUBLE PRECISION argument of the arc-cosine (degrees) function.
...
*  Returned Value:
*     VAL_ACSDD = DOUBLE PRECISION
*        Returns the evaluated arc-cosine (degrees) function result as a DOUBLE PRECISION
