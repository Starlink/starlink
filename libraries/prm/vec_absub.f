      SUBROUTINE VEC_ABSUB( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_ABSUB

*  Purpose:
*     Vectorised UNSIGNED BYTE Fortran ABS function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_ABSUB( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
