      SUBROUTINE VEC_PWRUW( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_PWRUW
...
*  Purpose:
*     Vectorised UNSIGNED WORD exponentiation operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_PWRUW( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )
...
*        of UNSIGNED WORD argument values for the exponentiation operation.
...
*  operation.
            ELSE
               RESV( I ) = NUM_PWRUW( ARGV1( I ), ARGV2( I ) )
