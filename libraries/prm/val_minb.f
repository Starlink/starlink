      BYTE FUNCTION VAL_MINB( BAD, ARG1, ARG2, STATUS )
*+
*  Name:
*     VAL_MINB

*  Purpose:
*     Evaluate the BYTE minimum function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_MINB( BAD, ARG1, ARG2, STATUS )
...
*        The two BYTE arguments of the minimum function.
...
*  Returned Value:
*     VAL_MINB = BYTE
*        Returns the evaluated minimum function result as a BYTE
