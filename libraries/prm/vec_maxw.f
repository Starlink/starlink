      SUBROUTINE VEC_MAXW( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_MAXW
...
*  Purpose:
*     Vectorised WORD maximum function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_MAXW( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )
...
*        of WORD argument values for the maximum function.
