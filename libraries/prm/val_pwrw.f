      INTEGER*2 FUNCTION VAL_PWRW( BAD, ARG1, ARG2, STATUS )
*+
*  Name:
*     VAL_PWRW

*  Purpose:
*     Perform a WORD exponentiation operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_PWRW( BAD, ARG1, ARG2, STATUS )
...
*        The two WORD arguments for the exponentiation operation.
