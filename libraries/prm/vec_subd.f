      SUBROUTINE VEC_SUBD( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_SUBD
...
*  Purpose:
*     Vectorised DOUBLE PRECISION subtraction operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_SUBD( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )
...
*        of DOUBLE PRECISION argument values for the subtraction operation.
...
*  If the argument values are not bad, perform the subtraction
*  operation.
            ELSE
               RESV( I ) = NUM_SUBD( ARGV1( I ), ARGV2( I ) )
