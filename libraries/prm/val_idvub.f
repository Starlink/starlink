      BYTE FUNCTION VAL_IDVUB( BAD, ARG1, ARG2, STATUS )
*+
*  Name:
*     VAL_IDVUB

*  Purpose:
*     Perform a UNSIGNED BYTE integer divide operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_IDVUB( BAD, ARG1, ARG2, STATUS )
...
*        The two UNSIGNED BYTE arguments for the integer divide operation.
