      INTEGER FUNCTION VAL_DIMI( BAD, ARG1, ARG2, STATUS )
*+
*  Name:
*     VAL_DIMI

*  Purpose:
*     Evaluate the INTEGER Fortran DIM (positive difference) function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_DIMI( BAD, ARG1, ARG2, STATUS )
...
*        The two INTEGER arguments of the Fortran DIM (positive difference) function.
...
*  Returned Value:
*     VAL_DIMI = INTEGER
*        Returns the evaluated Fortran DIM (positive difference) function result as a INTEGER
