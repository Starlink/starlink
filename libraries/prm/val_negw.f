      INTEGER*2 FUNCTION VAL_NEGW( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_NEGW

*  Purpose:
*     Evaluate the WORD negation function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_NEGW( BAD, ARG, STATUS )
...
*     ARG = INTEGER*2 (Given)
*        The WORD argument of the negation function.
...
*  Returned Value:
*     VAL_NEGW = INTEGER*2
*        Returns the evaluated negation function result as a WORD
