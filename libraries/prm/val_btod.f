      DOUBLE PRECISION FUNCTION VAL_BTOD( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_BTOD

*  Purpose:
*     Convert a value from BYTE to DOUBLE PRECISION.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_BTOD( BAD, ARG, STATUS )
