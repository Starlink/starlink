      DOUBLE PRECISION FUNCTION VAL_PWRD( BAD, ARG1, ARG2, STATUS )
*+
*  Name:
*     VAL_PWRD

*  Purpose:
*     Perform a DOUBLE PRECISION exponentiation operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_PWRD( BAD, ARG1, ARG2, STATUS )
...
*        The two DOUBLE PRECISION arguments for the exponentiation operation.
