      REAL FUNCTION VAL_MINR( BAD, ARG1, ARG2, STATUS )
*+
*  Name:
*     VAL_MINR

*  Purpose:
*     Evaluate the REAL minimum function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_MINR( BAD, ARG1, ARG2, STATUS )
...
*        The two REAL arguments of the minimum function.
...
*  Returned Value:
*     VAL_MINR = REAL
*        Returns the evaluated minimum function result as a REAL
