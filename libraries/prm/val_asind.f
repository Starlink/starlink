      DOUBLE PRECISION FUNCTION VAL_ASIND( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_ASIND

*  Purpose:
*     Evaluate the DOUBLE PRECISION arc-sine function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_ASIND( BAD, ARG, STATUS )

*  Description:
*     The routine evaluates the arc-sine function for a single
...
*        The DOUBLE PRECISION argument of the arc-sine function.
...
*  Returned Value:
*     VAL_ASIND = DOUBLE PRECISION
*        Returns the evaluated arc-sine function result as a DOUBLE PRECISION
