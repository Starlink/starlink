      SUBROUTINE VEC_MODB( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_MODB
...
*  Purpose:
*     Vectorised BYTE Fortran MOD (remainder) function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_MODB( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )
...
*        of BYTE argument values for the Fortran MOD (remainder) function.
