      SUBROUTINE VEC_NINTD( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_NINTD

*  Purpose:
*     Vectorised DOUBLE PRECISION nearest integer function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_NINTD( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
