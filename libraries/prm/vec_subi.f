      SUBROUTINE VEC_SUBI( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_SUBI
...
*  Purpose:
*     Vectorised INTEGER subtraction operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_SUBI( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )
...
*        of INTEGER argument values for the subtraction operation.
...
*  operation.
            ELSE
               RESV( I ) = NUM_SUBI( ARGV1( I ), ARGV2( I ) )
