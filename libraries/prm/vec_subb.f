      SUBROUTINE VEC_SUBB( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_SUBB
...
*  Purpose:
*     Vectorised BYTE subtraction operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_SUBB( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )
...
*        of BYTE argument values for the subtraction operation.
...
*  operation.
            ELSE
               RESV( I ) = NUM_SUBB( ARGV1( I ), ARGV2( I ) )
