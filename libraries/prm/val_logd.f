      DOUBLE PRECISION FUNCTION VAL_LOGD( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_LOGD

*  Purpose:
*     Evaluate the DOUBLE PRECISION natural logarithm function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_LOGD( BAD, ARG, STATUS )
...
*        The DOUBLE PRECISION argument of the natural logarithm function.
...
*  Returned Value:
*     VAL_LOGD = DOUBLE PRECISION
*        Returns the evaluated natural logarithm function result as a DOUBLE PRECISION
