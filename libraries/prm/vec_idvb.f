      SUBROUTINE VEC_IDVB( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_IDVB
...
*  Purpose:
*     Vectorised BYTE integer divide operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_IDVB( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )
...
*        of BYTE argument values for the integer divide operation.
...
*  operation.
            ELSE
               RESV( I ) = NUM_IDVB( ARGV1( I ), ARGV2( I ) )
