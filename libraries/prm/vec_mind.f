      SUBROUTINE VEC_MIND( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_MIND
...
*  Purpose:
*     Vectorised DOUBLE PRECISION minimum function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_MIND( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )
...
*        of DOUBLE PRECISION argument values for the minimum function.
