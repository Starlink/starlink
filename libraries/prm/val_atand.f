      DOUBLE PRECISION FUNCTION VAL_ATAND( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_ATAND

*  Purpose:
*     Evaluate the DOUBLE PRECISION arc-tangent function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_ATAND( BAD, ARG, STATUS )

*  Description:
*     The routine evaluates the arc-tangent function for a single
...
*        The DOUBLE PRECISION argument of the arc-tangent function.
...
*  Returned Value:
*     VAL_ATAND = DOUBLE PRECISION
*        Returns the evaluated arc-tangent function result as a DOUBLE PRECISION
