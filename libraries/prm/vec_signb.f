      SUBROUTINE VEC_SIGNB( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_SIGNB
...
*  Purpose:
*     Vectorised BYTE Fortran SIGN (sign transfer) function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_SIGNB( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )
...
*        of BYTE argument values for the Fortran SIGN (sign transfer) function.
