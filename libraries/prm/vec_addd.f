      SUBROUTINE VEC_ADDD( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_ADDD
...
*  Purpose:
*     Vectorised DOUBLE PRECISION addition operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_ADDD( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )
...
*        of DOUBLE PRECISION argument values for the addition operation.
...
*  operation.
            ELSE
               RESV( I ) = NUM_ADDD( ARGV1( I ), ARGV2( I ) )
