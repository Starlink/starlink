      SUBROUTINE VEC_UBTOI( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_UBTOI

*  Purpose:
*     Convert vectorised UNSIGNED BYTE values to INTEGER.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_UBTOI( BAD, N, ARGV, RESV, IERR, NERR, STATUS )

*  Description:
*     The routine performs type conversion on a vectorised array ARGV
*     of UNSIGNED BYTE values, converting them to the equivalent INTEGER
