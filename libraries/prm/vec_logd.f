      SUBROUTINE VEC_LOGD( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_LOGD

*  Purpose:
*     Vectorised DOUBLE PRECISION natural logarithm function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_LOGD( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
