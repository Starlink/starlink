      SUBROUTINE VEC_LOGI( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_LOGI

*  Purpose:
*     Vectorised INTEGER natural logarithm function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_LOGI( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
...
*  increment the error count.
            IF( .NOT. ( NUM_GTI( ARG, VAL__ZI ) ) ) THEN
               RESV( I ) = VAL__BADI
               NERR = NERR + 1
