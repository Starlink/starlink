      SUBROUTINE VEC_WTOR( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_WTOR

*  Purpose:
*     Convert vectorised WORD values to REAL.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_WTOR( BAD, N, ARGV, RESV, IERR, NERR, STATUS )

*  Description:
*     The routine performs type conversion on a vectorised array ARGV
*     of WORD values, converting them to the equivalent REAL
