      SUBROUTINE VEC_COSDD( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_COSDD

*  Purpose:
*     Vectorised DOUBLE PRECISION cosine (degrees function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_COSDD( BAD, N, ARGV, RESV, IERR, NERR, STATUS )

*  Description:
*     The routine evaluates the cosine (degrees function for a vectorised
...
*        argument values for the cosine (degrees function.
...
*  If the argument value is acceptable, then evaluate the cosine (degrees
*  function.
            ELSE
               RESV( I ) = NUM_COSDD( ARG )
