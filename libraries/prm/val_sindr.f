      REAL FUNCTION VAL_SINDR( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_SINDR

*  Purpose:
*     Evaluate the REAL sine (degrees) function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_SINDR( BAD, ARG, STATUS )
...
*     ARG = REAL (Given)
*        The REAL argument of the sine (degrees) function.
...
*  Returned Value:
*     VAL_SINDR = REAL
*        Returns the evaluated sine (degrees) function result as a REAL
