      SUBROUTINE VEC_IDVW( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_IDVW
...
*  Purpose:
*     Vectorised WORD integer divide operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_IDVW( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )
...
*        of WORD argument values for the integer divide operation.
...
*  operation.
            ELSE
               RESV( I ) = NUM_IDVW( ARGV1( I ), ARGV2( I ) )
