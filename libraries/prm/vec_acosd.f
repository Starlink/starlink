      SUBROUTINE VEC_ACOSD( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_ACOSD

*  Purpose:
*     Vectorised DOUBLE PRECISION arc-cosine function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_ACOSD( BAD, N, ARGV, RESV, IERR, NERR, STATUS )

*  Description:
*     The routine evaluates the arc-cosine function for a vectorised
...
*        argument values for the arc-cosine function.
...
*  If the argument value is acceptable, then evaluate the arc-cosine
*  function.
            ELSE
               RESV( I ) = NUM_ACOSD( ARG )
