      SUBROUTINE VEC_NEGUW( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_NEGUW

*  Purpose:
*     Vectorised UNSIGNED WORD negation function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_NEGUW( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
...
*  increment the error count.
            IF( .NOT. ( NUM_EQUW( ARG, VAL__ZUW ) ) ) THEN
               RESV( I ) = VAL__BADUW
               NERR = NERR + 1
