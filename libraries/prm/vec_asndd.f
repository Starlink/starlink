      SUBROUTINE VEC_ASNDD( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_ASNDD

*  Purpose:
*     Vectorised DOUBLE PRECISION arc-sine (degrees) function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_ASNDD( BAD, N, ARGV, RESV, IERR, NERR, STATUS )

*  Description:
*     The routine evaluates the arc-sine (degrees) function for a vectorised
...
*        argument values for the arc-sine (degrees) function.
...
*  If the argument value is acceptable, then evaluate the arc-sine (degrees)
*  function.
            ELSE
               RESV( I ) = NUM_ASNDD( ARG )
