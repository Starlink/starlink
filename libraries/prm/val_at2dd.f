      DOUBLE PRECISION FUNCTION VAL_AT2DD( BAD, ARG1, ARG2, STATUS )
*+
*  Name:
*     VAL_AT2DD

*  Purpose:
*     Evaluate the DOUBLE PRECISION Fortran ATAN2 (in degrees) function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_AT2DD( BAD, ARG1, ARG2, STATUS )
...
*        The two DOUBLE PRECISION arguments of the Fortran ATAN2 (in degrees) function.
...
*  Returned Value:
*     VAL_AT2DD = DOUBLE PRECISION
*        Returns the evaluated Fortran ATAN2 (in degrees) function result as a DOUBLE PRECISION
