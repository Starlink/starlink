      SUBROUTINE VEC_ASNDR( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_ASNDR

*  Purpose:
*     Vectorised REAL arc-sine (degrees) function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_ASNDR( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
