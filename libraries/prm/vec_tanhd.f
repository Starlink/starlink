      SUBROUTINE VEC_TANHD( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_TANHD

*  Purpose:
*     Vectorised DOUBLE PRECISION hyperbolic tangent function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_TANHD( BAD, N, ARGV, RESV, IERR, NERR, STATUS )

*  Description:
*     The routine evaluates the hyperbolic tangent function for a vectorised
...
*        argument values for the hyperbolic tangent function.
...
*  If the argument value is acceptable, then evaluate the hyperbolic tangent
*  function.
            ELSE
               RESV( I ) = NUM_TANHD( ARG )
