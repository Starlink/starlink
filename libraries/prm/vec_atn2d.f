      SUBROUTINE VEC_ATN2D( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_ATN2D
...
*  Purpose:
*     Vectorised DOUBLE PRECISION Fortran ATAN2 function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_ATN2D( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )

*  Description:
*     The routine evaluates the Fortran ATAN2 function for two vectorised
...
*        of DOUBLE PRECISION argument values for the Fortran ATAN2 function.
...
*  If the argument values are acceptable, then evaluate the Fortran ATAN2
*  function.
            ELSE
               RESV( I ) = NUM_ATN2D( ARG1, ARG2 )
