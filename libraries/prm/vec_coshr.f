      SUBROUTINE VEC_COSHR( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_COSHR

*  Purpose:
*     Vectorised REAL hyperbolic cosine function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_COSHR( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
