      SUBROUTINE VEC_WTOB( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_WTOB

*  Purpose:
*     Convert vectorised WORD values to BYTE.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_WTOB( BAD, N, ARGV, RESV, IERR, NERR, STATUS )

*  Description:
*     The routine performs type conversion on a vectorised array ARGV
*     of WORD values, converting them to the equivalent BYTE
