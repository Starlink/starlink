      SUBROUTINE VEC_SQRTD( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_SQRTD

*  Purpose:
*     Vectorised DOUBLE PRECISION square root function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_SQRTD( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
...
*  increment the error count.
            IF( .NOT. ( NUM_GED( ARG, VAL__ZD ) ) ) THEN
               RESV( I ) = VAL__BADD
               NERR = NERR + 1
