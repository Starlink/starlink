      SUBROUTINE VEC_SQRTR( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_SQRTR

*  Purpose:
*     Vectorised REAL square root function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_SQRTR( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
...
*  increment the error count.
            IF( .NOT. ( NUM_GER( ARG, VAL__ZR ) ) ) THEN
               RESV( I ) = VAL__BADR
               NERR = NERR + 1
