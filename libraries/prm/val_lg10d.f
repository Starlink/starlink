      DOUBLE PRECISION FUNCTION VAL_LG10D( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_LG10D

*  Purpose:
*     Evaluate the DOUBLE PRECISION common logarithm (base 10) function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_LG10D( BAD, ARG, STATUS )
...
*        The DOUBLE PRECISION argument of the common logarithm (base 10) function.
...
*  Returned Value:
*     VAL_LG10D = DOUBLE PRECISION
*        Returns the evaluated common logarithm (base 10) function result as a DOUBLE PRECISION
