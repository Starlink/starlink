      SUBROUTINE VEC_TANHR( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_TANHR

*  Purpose:
*     Vectorised REAL hyperbolic tangent function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_TANHR( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
