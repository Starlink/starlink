      REAL FUNCTION VAL_ATN2R( BAD, ARG1, ARG2, STATUS )
*+
*  Name:
*     VAL_ATN2R

*  Purpose:
*     Evaluate the REAL Fortran ATAN2 function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_ATN2R( BAD, ARG1, ARG2, STATUS )
...
*        The two REAL arguments of the Fortran ATAN2 function.
...
*  Returned Value:
*     VAL_ATN2R = REAL
*        Returns the evaluated Fortran ATAN2 function result as a REAL
