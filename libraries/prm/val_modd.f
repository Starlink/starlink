      DOUBLE PRECISION FUNCTION VAL_MODD( BAD, ARG1, ARG2, STATUS )
*+
*  Name:
*     VAL_MODD

*  Purpose:
*     Evaluate the DOUBLE PRECISION Fortran MOD (remainder) function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_MODD( BAD, ARG1, ARG2, STATUS )
...
*        The two DOUBLE PRECISION arguments of the Fortran MOD (remainder) function.
...
*  Returned Value:
*     VAL_MODD = DOUBLE PRECISION
*        Returns the evaluated Fortran MOD (remainder) function result as a DOUBLE PRECISION
