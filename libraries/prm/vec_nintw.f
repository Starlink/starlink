      SUBROUTINE VEC_NINTW( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_NINTW

*  Purpose:
*     Vectorised WORD nearest integer function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_NINTW( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
