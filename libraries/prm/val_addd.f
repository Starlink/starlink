      DOUBLE PRECISION FUNCTION VAL_ADDD( BAD, ARG1, ARG2, STATUS )
*+
*  Name:
*     VAL_ADDD

*  Purpose:
*     Perform a DOUBLE PRECISION addition operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_ADDD( BAD, ARG1, ARG2, STATUS )
...
*        The two DOUBLE PRECISION arguments for the addition operation.
