      SUBROUTINE VEC_WTOUW( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_WTOUW

*  Purpose:
*     Convert vectorised WORD values to UNSIGNED WORD.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_WTOUW( BAD, N, ARGV, RESV, IERR, NERR, STATUS )

*  Description:
*     The routine performs type conversion on a vectorised array ARGV
*     of WORD values, converting them to the equivalent UNSIGNED WORD
