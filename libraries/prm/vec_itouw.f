      SUBROUTINE VEC_ITOUW( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_ITOUW

*  Purpose:
*     Convert vectorised INTEGER values to UNSIGNED WORD.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_ITOUW( BAD, N, ARGV, RESV, IERR, NERR, STATUS )

*  Description:
*     The routine performs type conversion on a vectorised array ARGV
*     of INTEGER values, converting them to the equivalent UNSIGNED WORD
