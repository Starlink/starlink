      BYTE FUNCTION VAL_ITOUB( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_ITOUB

*  Purpose:
*     Convert a value from INTEGER to UNSIGNED BYTE.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_ITOUB( BAD, ARG, STATUS )
