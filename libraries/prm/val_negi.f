      INTEGER FUNCTION VAL_NEGI( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_NEGI

*  Purpose:
*     Evaluate the INTEGER negation function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_NEGI( BAD, ARG, STATUS )
...
*     ARG = INTEGER (Given)
*        The INTEGER argument of the negation function.
...
*  Returned Value:
*     VAL_NEGI = INTEGER
*        Returns the evaluated negation function result as a INTEGER
