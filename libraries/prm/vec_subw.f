      SUBROUTINE VEC_SUBW( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_SUBW
...
*  Purpose:
*     Vectorised WORD subtraction operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_SUBW( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )
...
*        of WORD argument values for the subtraction operation.
...
*  operation.
            ELSE
               RESV( I ) = NUM_SUBW( ARGV1( I ), ARGV2( I ) )
