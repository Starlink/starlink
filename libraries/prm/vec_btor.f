      SUBROUTINE VEC_BTOR( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_BTOR

*  Purpose:
*     Convert vectorised BYTE values to REAL.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_BTOR( BAD, N, ARGV, RESV, IERR, NERR, STATUS )

*  Description:
*     The routine performs type conversion on a vectorised array ARGV
*     of BYTE values, converting them to the equivalent REAL
