      INTEGER*2 FUNCTION VAL_LG10W( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_LG10W

*  Purpose:
*     Evaluate the WORD common logarithm (base 10) function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_LG10W( BAD, ARG, STATUS )
...
*     ARG = INTEGER*2 (Given)
*        The WORD argument of the common logarithm (base 10) function.
...
*  Returned Value:
*     VAL_LG10W = INTEGER*2
*        Returns the evaluated common logarithm (base 10) function result as a WORD
