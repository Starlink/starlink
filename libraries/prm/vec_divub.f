      SUBROUTINE VEC_DIVUB( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_DIVUB
...
*  Purpose:
*     Vectorised UNSIGNED BYTE floating divide operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_DIVUB( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )
...
*        of UNSIGNED BYTE argument values for the floating divide operation.
...
*  operation.
            ELSE
               RESV( I ) = NUM_DIVUB( ARGV1( I ), ARGV2( I ) )
