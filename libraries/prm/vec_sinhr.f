      SUBROUTINE VEC_SINHR( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_SINHR

*  Purpose:
*     Vectorised REAL hyperbolic sine function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_SINHR( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
