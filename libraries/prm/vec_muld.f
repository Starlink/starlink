      SUBROUTINE VEC_MULD( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_MULD
...
*  Purpose:
*     Vectorised DOUBLE PRECISION multiplication operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_MULD( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )
...
*        of DOUBLE PRECISION argument values for the multiplication operation.
...
*  operation.
            ELSE
               RESV( I ) = NUM_MULD( ARGV1( I ), ARGV2( I ) )
