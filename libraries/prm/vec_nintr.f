      SUBROUTINE VEC_NINTR( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_NINTR

*  Purpose:
*     Vectorised REAL nearest integer function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_NINTR( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
