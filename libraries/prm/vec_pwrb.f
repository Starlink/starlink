      SUBROUTINE VEC_PWRB( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_PWRB
...
*  Purpose:
*     Vectorised BYTE exponentiation operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_PWRB( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )
...
*        of BYTE argument values for the exponentiation operation.
...
*  operation.
            ELSE
               RESV( I ) = NUM_PWRB( ARGV1( I ), ARGV2( I ) )
