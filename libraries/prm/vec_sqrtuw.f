      SUBROUTINE VEC_SQRTUW( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_SQRTUW

*  Purpose:
*     Vectorised UNSIGNED WORD square root function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_SQRTUW( BAD, N, ARGV, RESV, IERR, NERR, STATUS )

*  Description:
*     The routine evaluates the square root function for a vectorised
...
*        argument values for the square root function.
...
*  If the argument value is acceptable, then evaluate the square root
*  function.
            ELSE
               RESV( I ) = NUM_SQRTUW( ARG )
