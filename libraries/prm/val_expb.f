      BYTE FUNCTION VAL_EXPB( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_EXPB

*  Purpose:
*     Evaluate the BYTE exponential function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_EXPB( BAD, ARG, STATUS )
...
*     ARG = BYTE (Given)
*        The BYTE argument of the exponential function.
...
*  Returned Value:
*     VAL_EXPB = BYTE
*        Returns the evaluated exponential function result as a BYTE
