      SUBROUTINE VEC_DIVR( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_DIVR
...
*  Purpose:
*     Vectorised REAL floating divide operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_DIVR( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )
...
*        of REAL argument values for the floating divide operation.
...
*  operation.
            ELSE
               RESV( I ) = NUM_DIVR( ARGV1( I ), ARGV2( I ) )
