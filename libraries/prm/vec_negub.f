      SUBROUTINE VEC_NEGUB( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_NEGUB

*  Purpose:
*     Vectorised UNSIGNED BYTE negation function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_NEGUB( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
...
*        argument values for the negation function.
...
*  increment the numerical error count.
            ELSE IF( .NOT. ( NUM_EQUB( ARG, VAL__ZUB ) ) ) THEN
               RESV( I ) = VAL__BADUB
               NERR = NERR + 1
...
*  increment the error count.
            IF( .NOT. ( NUM_EQUB( ARG, VAL__ZUB ) ) ) THEN
               RESV( I ) = VAL__BADUB
               NERR = NERR + 1
