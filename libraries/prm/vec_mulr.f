      SUBROUTINE VEC_MULR( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_MULR
...
*  Purpose:
*     Vectorised REAL multiplication operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_MULR( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )

*  Description:
*     The routine performs an arithmetic multiplication operation between
*     two vectorised arrays ARGV1 and ARGV2 of REAL values.  If
*     numerical errors occur, the value VAL__BADR is returned in
...
*        of REAL argument values for the multiplication operation.
...
*  Arguments Given:
      ...
      REAL ARGV1( * )          ! First argument array
      REAL ARGV2( * )          ! Second argument array

*  Arguments Returned:
      REAL RESV( * )           ! Result array
...
*  array.
            IF( ARGV1( I ) .EQ. VAL__BADR .OR.
     :          ARGV2( I ) .EQ. VAL__BADR ) THEN
               RESV( I ) = VAL__BADR

*  If the argument values are not bad, perform the multiplication
*  operation.
            ELSE
               RESV( I ) = NUM_MULR( ARGV1( I ), ARGV2( I ) )

*  Check if the numerical error flag is set.  If so, put a value of
*  VAL__BADR in the corresponding element of the result array and
