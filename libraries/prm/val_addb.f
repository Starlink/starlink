      BYTE FUNCTION VAL_ADDB( BAD, ARG1, ARG2, STATUS )
*+
*  Name:
*     VAL_ADDB

*  Purpose:
*     Perform a BYTE addition operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_ADDB( BAD, ARG1, ARG2, STATUS )
...
*        The two BYTE arguments for the addition operation.
