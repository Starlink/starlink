      BYTE FUNCTION VAL_LOGB( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_LOGB

*  Purpose:
*     Evaluate the BYTE natural logarithm function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_LOGB( BAD, ARG, STATUS )
...
*     ARG = BYTE (Given)
*        The BYTE argument of the natural logarithm function.
...
*  Returned Value:
*     VAL_LOGB = BYTE
*        Returns the evaluated natural logarithm function result as a BYTE
