      SUBROUTINE VEC_BTOD( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_BTOD

*  Purpose:
*     Convert vectorised BYTE values to DOUBLE PRECISION.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_BTOD( BAD, N, ARGV, RESV, IERR, NERR, STATUS )

*  Description:
*     The routine performs type conversion on a vectorised array ARGV
*     of BYTE values, converting them to the equivalent DOUBLE PRECISION
