      INTEGER FUNCTION VAL_PWRI( BAD, ARG1, ARG2, STATUS )
*+
*  Name:
*     VAL_PWRI

*  Purpose:
*     Perform a INTEGER exponentiation operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_PWRI( BAD, ARG1, ARG2, STATUS )
...
*        The two INTEGER arguments for the exponentiation operation.
