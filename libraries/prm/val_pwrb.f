      BYTE FUNCTION VAL_PWRB( BAD, ARG1, ARG2, STATUS )
*+
*  Name:
*     VAL_PWRB

*  Purpose:
*     Perform a BYTE exponentiation operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_PWRB( BAD, ARG1, ARG2, STATUS )
...
*        The two BYTE arguments for the exponentiation operation.
