      SUBROUTINE VEC_ITOR( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_ITOR

*  Purpose:
*     Convert vectorised INTEGER values to REAL.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_ITOR( BAD, N, ARGV, RESV, IERR, NERR, STATUS )

*  Description:
*     The routine performs type conversion on a vectorised array ARGV
*     of INTEGER values, converting them to the equivalent REAL
