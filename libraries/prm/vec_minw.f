      SUBROUTINE VEC_MINW( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_MINW
...
*  Purpose:
*     Vectorised WORD minimum function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_MINW( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )
...
*        of WORD argument values for the minimum function.
