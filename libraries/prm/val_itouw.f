      INTEGER * 2 FUNCTION VAL_ITOUW( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_ITOUW

*  Purpose:
*     Convert a value from INTEGER to UNSIGNED WORD.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_ITOUW( BAD, ARG, STATUS )
