      SUBROUTINE VEC_COSDR( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_COSDR

*  Purpose:
*     Vectorised REAL cosine (degrees function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_COSDR( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
