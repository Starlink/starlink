      DOUBLE PRECISION FUNCTION VAL_SIND( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_SIND

*  Purpose:
*     Evaluate the DOUBLE PRECISION sine function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_SIND( BAD, ARG, STATUS )

*  Description:
*     The routine evaluates the sine function for a single
...
*        The DOUBLE PRECISION argument of the sine function.
...
*  Returned Value:
*     VAL_SIND = DOUBLE PRECISION
*        Returns the evaluated sine function result as a DOUBLE PRECISION
