      SUBROUTINE VEC_DIMW( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_DIMW
...
*  Purpose:
*     Vectorised WORD Fortran DIM (positive difference) function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_DIMW( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )
...
*        of WORD argument values for the Fortran DIM (positive difference) function.
