      SUBROUTINE VEC_DIVD( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_DIVD
...
*  Purpose:
*     Vectorised DOUBLE PRECISION floating divide operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_DIVD( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )
...
*        of DOUBLE PRECISION argument values for the floating divide operation.
...
*  operation.
            ELSE
               RESV( I ) = NUM_DIVD( ARGV1( I ), ARGV2( I ) )
