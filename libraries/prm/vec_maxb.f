      SUBROUTINE VEC_MAXB( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_MAXB
...
*  Purpose:
*     Vectorised BYTE maximum function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_MAXB( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )
...
*        of BYTE argument values for the maximum function.
