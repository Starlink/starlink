      SUBROUTINE VEC_ASIND( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_ASIND

*  Purpose:
*     Vectorised DOUBLE PRECISION arc-sine function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_ASIND( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
