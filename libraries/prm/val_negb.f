      BYTE FUNCTION VAL_NEGB( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_NEGB

*  Purpose:
*     Evaluate the BYTE negation function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_NEGB( BAD, ARG, STATUS )
...
*     ARG = BYTE (Given)
*        The BYTE argument of the negation function.
...
*  Returned Value:
*     VAL_NEGB = BYTE
*        Returns the evaluated negation function result as a BYTE
