      BYTE FUNCTION VAL_DIVUB( BAD, ARG1, ARG2, STATUS )
*+
*  Name:
*     VAL_DIVUB

*  Purpose:
*     Perform a UNSIGNED BYTE floating divide operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_DIVUB( BAD, ARG1, ARG2, STATUS )
...
*        The two UNSIGNED BYTE arguments for the floating divide operation.
