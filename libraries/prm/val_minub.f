      BYTE FUNCTION VAL_MINUB( BAD, ARG1, ARG2, STATUS )
*+
*  Name:
*     VAL_MINUB

*  Purpose:
*     Evaluate the UNSIGNED BYTE minimum function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_MINUB( BAD, ARG1, ARG2, STATUS )
...
*        The two UNSIGNED BYTE arguments of the minimum function.
...
*  Returned Value:
*     VAL_MINUB = BYTE
*        Returns the evaluated minimum function result as a UNSIGNED BYTE
