      REAL FUNCTION VAL_TANR( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_TANR

*  Purpose:
*     Evaluate the REAL tangent function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_TANR( BAD, ARG, STATUS )
...
*     ARG = REAL (Given)
*        The REAL argument of the tangent function.
...
*  Returned Value:
*     VAL_TANR = REAL
*        Returns the evaluated tangent function result as a REAL
