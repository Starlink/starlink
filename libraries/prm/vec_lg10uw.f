      SUBROUTINE VEC_LG10UW( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_LG10UW

*  Purpose:
*     Vectorised UNSIGNED WORD common logarithm (base 10) function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_LG10UW( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
