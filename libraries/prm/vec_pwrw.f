      SUBROUTINE VEC_PWRW( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_PWRW
...
*  Purpose:
*     Vectorised WORD exponentiation operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_PWRW( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )
...
*        of WORD argument values for the exponentiation operation.
...
*  operation.
            ELSE
               RESV( I ) = NUM_PWRW( ARGV1( I ), ARGV2( I ) )
