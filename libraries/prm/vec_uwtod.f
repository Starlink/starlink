      SUBROUTINE VEC_UWTOD( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_UWTOD

*  Purpose:
*     Convert vectorised UNSIGNED WORD values to DOUBLE PRECISION.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_UWTOD( BAD, N, ARGV, RESV, IERR, NERR, STATUS )

*  Description:
*     The routine performs type conversion on a vectorised array ARGV
*     of UNSIGNED WORD values, converting them to the equivalent DOUBLE PRECISION
