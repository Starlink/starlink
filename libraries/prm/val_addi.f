      INTEGER FUNCTION VAL_ADDI( BAD, ARG1, ARG2, STATUS )
*+
*  Name:
*     VAL_ADDI

*  Purpose:
*     Perform a INTEGER addition operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_ADDI( BAD, ARG1, ARG2, STATUS )
...
*        The two INTEGER arguments for the addition operation.
