      INTEGER FUNCTION VAL_MODI( BAD, ARG1, ARG2, STATUS )
*+
*  Name:
*     VAL_MODI

*  Purpose:
*     Evaluate the INTEGER Fortran MOD (remainder) function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_MODI( BAD, ARG1, ARG2, STATUS )
...
*        The two INTEGER arguments of the Fortran MOD (remainder) function.
...
*  Returned Value:
*     VAL_MODI = INTEGER
*        Returns the evaluated Fortran MOD (remainder) function result as a INTEGER
