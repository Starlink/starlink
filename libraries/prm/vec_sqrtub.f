      SUBROUTINE VEC_SQRTUB( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_SQRTUB

*  Purpose:
*     Vectorised UNSIGNED BYTE square root function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_SQRTUB( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
