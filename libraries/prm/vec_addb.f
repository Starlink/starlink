      SUBROUTINE VEC_ADDB( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_ADDB
...
*  Purpose:
*     Vectorised BYTE addition operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_ADDB( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )
...
*        of BYTE argument values for the addition operation.
...
*  operation.
            ELSE
               RESV( I ) = NUM_ADDB( ARGV1( I ), ARGV2( I ) )
