      INTEGER*2 FUNCTION VAL_NINTUW( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_NINTUW

*  Purpose:
*     Evaluate the UNSIGNED WORD nearest integer function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_NINTUW( BAD, ARG, STATUS )

*  Description:
*     The routine evaluates the nearest integer function for a single
...
*     ARG = INTEGER*2 (Given)
*        The UNSIGNED WORD argument of the nearest integer function.
...
*  Returned Value:
*     VAL_NINTUW = INTEGER*2
*        Returns the evaluated nearest integer function result as a UNSIGNED WORD
