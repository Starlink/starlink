      SUBROUTINE VEC_UBTOUW( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_UBTOUW

*  Purpose:
*     Convert vectorised UNSIGNED BYTE values to UNSIGNED WORD.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_UBTOUW( BAD, N, ARGV, RESV, IERR, NERR, STATUS )

*  Description:
*     The routine performs type conversion on a vectorised array ARGV
*     of UNSIGNED BYTE values, converting them to the equivalent UNSIGNED WORD
