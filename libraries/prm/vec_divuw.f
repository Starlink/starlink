      SUBROUTINE VEC_DIVUW( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_DIVUW
...
*  Purpose:
*     Vectorised UNSIGNED WORD floating divide operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_DIVUW( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )
...
*        of UNSIGNED WORD argument values for the floating divide operation.
...
*  operation.
            ELSE
               RESV( I ) = NUM_DIVUW( ARGV1( I ), ARGV2( I ) )
