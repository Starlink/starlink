      SUBROUTINE VEC_RTOB( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_RTOB

*  Purpose:
*     Convert vectorised REAL values to BYTE.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_RTOB( BAD, N, ARGV, RESV, IERR, NERR, STATUS )

*  Description:
*     The routine performs type conversion on a vectorised array ARGV
*     of REAL values, converting them to the equivalent BYTE
