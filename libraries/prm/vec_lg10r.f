      SUBROUTINE VEC_LG10R( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_LG10R

*  Purpose:
*     Vectorised REAL common logarithm (base 10) function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_LG10R( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
...
*  increment the error count.
            IF( .NOT. ( NUM_GTR( ARG, VAL__ZR ) ) ) THEN
               RESV( I ) = VAL__BADR
               NERR = NERR + 1
