      REAL FUNCTION VAL_TANHR( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_TANHR

*  Purpose:
*     Evaluate the REAL hyperbolic tangent function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_TANHR( BAD, ARG, STATUS )
...
*     ARG = REAL (Given)
*        The REAL argument of the hyperbolic tangent function.
...
*  Returned Value:
*     VAL_TANHR = REAL
*        Returns the evaluated hyperbolic tangent function result as a REAL
