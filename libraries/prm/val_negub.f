      BYTE FUNCTION VAL_NEGUB( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_NEGUB

*  Purpose:
*     Evaluate the UNSIGNED BYTE negation function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_NEGUB( BAD, ARG, STATUS )
...
*     ARG = BYTE (Given)
*        The UNSIGNED BYTE argument of the negation function.
...
*  Returned Value:
*     VAL_NEGUB = BYTE
*        Returns the evaluated negation function result as a UNSIGNED BYTE
