      SUBROUTINE VEC_DIVI( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_DIVI
...
*  Purpose:
*     Vectorised INTEGER floating divide operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_DIVI( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )
...
*        of INTEGER argument values for the floating divide operation.
...
*  operation.
            ELSE
               RESV( I ) = NUM_DIVI( ARGV1( I ), ARGV2( I ) )
