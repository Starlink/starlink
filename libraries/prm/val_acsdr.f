      REAL FUNCTION VAL_ACSDR( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_ACSDR

*  Purpose:
*     Evaluate the REAL arc-cosine (degrees) function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_ACSDR( BAD, ARG, STATUS )
...
*     ARG = REAL (Given)
*        The REAL argument of the arc-cosine (degrees) function.
...
*  Returned Value:
*     VAL_ACSDR = REAL
*        Returns the evaluated arc-cosine (degrees) function result as a REAL
