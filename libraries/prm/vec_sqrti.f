      SUBROUTINE VEC_SQRTI( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_SQRTI

*  Purpose:
*     Vectorised INTEGER square root function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_SQRTI( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
...
*  increment the error count.
            IF( .NOT. ( NUM_GEI( ARG, VAL__ZI ) ) ) THEN
               RESV( I ) = VAL__BADI
               NERR = NERR + 1
