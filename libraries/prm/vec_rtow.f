      SUBROUTINE VEC_RTOW( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_RTOW

*  Purpose:
*     Convert vectorised REAL values to WORD.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_RTOW( BAD, N, ARGV, RESV, IERR, NERR, STATUS )

*  Description:
*     The routine performs type conversion on a vectorised array ARGV
*     of REAL values, converting them to the equivalent WORD
