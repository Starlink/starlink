      SUBROUTINE VEC_DIMB( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_DIMB
...
*  Purpose:
*     Vectorised BYTE Fortran DIM (positive difference) function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_DIMB( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )
...
*        of BYTE argument values for the Fortran DIM (positive difference) function.
