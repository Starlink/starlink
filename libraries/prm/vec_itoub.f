      SUBROUTINE VEC_ITOUB( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_ITOUB

*  Purpose:
*     Convert vectorised INTEGER values to UNSIGNED BYTE.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_ITOUB( BAD, N, ARGV, RESV, IERR, NERR, STATUS )

*  Description:
*     The routine performs type conversion on a vectorised array ARGV
*     of INTEGER values, converting them to the equivalent UNSIGNED BYTE
