      SUBROUTINE VEC_RTOUB( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_RTOUB

*  Purpose:
*     Convert vectorised REAL values to UNSIGNED BYTE.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_RTOUB( BAD, N, ARGV, RESV, IERR, NERR, STATUS )

*  Description:
*     The routine performs type conversion on a vectorised array ARGV
*     of REAL values, converting them to the equivalent UNSIGNED BYTE
