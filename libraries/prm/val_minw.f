      INTEGER*2 FUNCTION VAL_MINW( BAD, ARG1, ARG2, STATUS )
*+
*  Name:
*     VAL_MINW

*  Purpose:
*     Evaluate the WORD minimum function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_MINW( BAD, ARG1, ARG2, STATUS )
...
*        The two WORD arguments of the minimum function.
...
*  Returned Value:
*     VAL_MINW = INTEGER*2
*        Returns the evaluated minimum function result as a WORD
