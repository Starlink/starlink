      SUBROUTINE VEC_AT2DR( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_AT2DR
...
*  Purpose:
*     Vectorised REAL Fortran ATAN2 (in degrees) function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_AT2DR( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )
...
*        of REAL argument values for the Fortran ATAN2 (in degrees) function.
...
*  array and increment the error count.
            ELSE IF( .NOT. ( ( ARG1 .NE. VAL__ZR ) .OR. ( ARG2 .NE. VAL_
     :_ZR ) ) ) THEN
               RESV( I ) = VAL__BADR
               NERR = NERR + 1
...
*  value of VAL__BADR in the corresponding element of the result
*  array and increment the error count.
            IF( .NOT. ( ( ARG1 .NE. VAL__ZR ) .OR. ( ARG2 .NE. VAL__ZR )
     : ) ) THEN
               RESV( I ) = VAL__BADR
               NERR = NERR + 1
