      SUBROUTINE VEC_ADDUB( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_ADDUB
...
*  Purpose:
*     Vectorised UNSIGNED BYTE addition operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_ADDUB( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )
...
*        of UNSIGNED BYTE argument values for the addition operation.
...
*  operation.
            ELSE
               RESV( I ) = NUM_ADDUB( ARGV1( I ), ARGV2( I ) )
