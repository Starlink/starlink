      BYTE FUNCTION VAL_MODB( BAD, ARG1, ARG2, STATUS )
*+
*  Name:
*     VAL_MODB

*  Purpose:
*     Evaluate the BYTE Fortran MOD (remainder) function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_MODB( BAD, ARG1, ARG2, STATUS )
...
*        The two BYTE arguments of the Fortran MOD (remainder) function.
...
*  Returned Value:
*     VAL_MODB = BYTE
*        Returns the evaluated Fortran MOD (remainder) function result as a BYTE
