      BYTE FUNCTION VAL_MAXUB( BAD, ARG1, ARG2, STATUS )
*+
*  Name:
*     VAL_MAXUB

*  Purpose:
*     Evaluate the UNSIGNED BYTE maximum function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_MAXUB( BAD, ARG1, ARG2, STATUS )
...
*        The two UNSIGNED BYTE arguments of the maximum function.
...
*  Returned Value:
*     VAL_MAXUB = BYTE
*        Returns the evaluated maximum function result as a UNSIGNED BYTE
