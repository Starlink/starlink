      SUBROUTINE VEC_RTOUW( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_RTOUW

*  Purpose:
*     Convert vectorised REAL values to UNSIGNED WORD.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_RTOUW( BAD, N, ARGV, RESV, IERR, NERR, STATUS )

*  Description:
*     The routine performs type conversion on a vectorised array ARGV
*     of REAL values, converting them to the equivalent UNSIGNED WORD
