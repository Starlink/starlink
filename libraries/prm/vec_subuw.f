      SUBROUTINE VEC_SUBUW( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_SUBUW
...
*  Purpose:
*     Vectorised UNSIGNED WORD subtraction operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_SUBUW( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )
...
*        of UNSIGNED WORD argument values for the subtraction operation.
...
*  operation.
            ELSE
               RESV( I ) = NUM_SUBUW( ARGV1( I ), ARGV2( I ) )
