      INTEGER * 2 FUNCTION VAL_UBTOUW( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_UBTOUW

*  Purpose:
*     Convert a value from UNSIGNED BYTE to UNSIGNED WORD.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_UBTOUW( BAD, ARG, STATUS )
