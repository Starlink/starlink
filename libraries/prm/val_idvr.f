      REAL FUNCTION VAL_IDVR( BAD, ARG1, ARG2, STATUS )
*+
*  Name:
*     VAL_IDVR

*  Purpose:
*     Perform a REAL integer divide operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_IDVR( BAD, ARG1, ARG2, STATUS )
...
*        The two REAL arguments for the integer divide operation.
