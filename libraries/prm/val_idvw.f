      INTEGER*2 FUNCTION VAL_IDVW( BAD, ARG1, ARG2, STATUS )
*+
*  Name:
*     VAL_IDVW

*  Purpose:
*     Perform a WORD integer divide operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_IDVW( BAD, ARG1, ARG2, STATUS )
...
*        The two WORD arguments for the integer divide operation.
