      DOUBLE PRECISION FUNCTION VAL_SINDD( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_SINDD

*  Purpose:
*     Evaluate the DOUBLE PRECISION sine (degrees) function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_SINDD( BAD, ARG, STATUS )

*  Description:
*     The routine evaluates the sine (degrees) function for a single
...
*        The DOUBLE PRECISION argument of the sine (degrees) function.
...
*  Returned Value:
*     VAL_SINDD = DOUBLE PRECISION
*        Returns the evaluated sine (degrees) function result as a DOUBLE PRECISION
