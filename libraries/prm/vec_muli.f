      SUBROUTINE VEC_MULI( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_MULI
...
*  Purpose:
*     Vectorised INTEGER multiplication operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_MULI( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )
...
*        of INTEGER argument values for the multiplication operation.
...
*  operation.
            ELSE
               RESV( I ) = NUM_MULI( ARGV1( I ), ARGV2( I ) )
