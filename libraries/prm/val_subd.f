      DOUBLE PRECISION FUNCTION VAL_SUBD( BAD, ARG1, ARG2, STATUS )
*+
*  Name:
*     VAL_SUBD

*  Purpose:
*     Perform a DOUBLE PRECISION subtraction operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_SUBD( BAD, ARG1, ARG2, STATUS )
...
*        The two DOUBLE PRECISION arguments for the subtraction operation.
