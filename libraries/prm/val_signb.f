      BYTE FUNCTION VAL_SIGNB( BAD, ARG1, ARG2, STATUS )
*+
*  Name:
*     VAL_SIGNB

*  Purpose:
*     Evaluate the BYTE Fortran SIGN (sign transfer) function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_SIGNB( BAD, ARG1, ARG2, STATUS )
...
*        The two BYTE arguments of the Fortran SIGN (sign transfer) function.
...
*  Returned Value:
*     VAL_SIGNB = BYTE
*        Returns the evaluated Fortran SIGN (sign transfer) function result as a BYTE
