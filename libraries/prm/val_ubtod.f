      DOUBLE PRECISION FUNCTION VAL_UBTOD( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_UBTOD

*  Purpose:
*     Convert a value from UNSIGNED BYTE to DOUBLE PRECISION.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_UBTOD( BAD, ARG, STATUS )
