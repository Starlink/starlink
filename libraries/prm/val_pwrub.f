      BYTE FUNCTION VAL_PWRUB( BAD, ARG1, ARG2, STATUS )
*+
*  Name:
*     VAL_PWRUB

*  Purpose:
*     Perform a UNSIGNED BYTE exponentiation operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_PWRUB( BAD, ARG1, ARG2, STATUS )
...
*        The two UNSIGNED BYTE arguments for the exponentiation operation.
