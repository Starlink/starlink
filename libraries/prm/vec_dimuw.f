      SUBROUTINE VEC_DIMUW( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_DIMUW
...
*  Purpose:
*     Vectorised UNSIGNED WORD Fortran DIM (positive difference) function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_DIMUW( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )
...
*        of UNSIGNED WORD argument values for the Fortran DIM (positive difference) function.
