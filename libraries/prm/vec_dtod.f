      SUBROUTINE VEC_DTOD( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_DTOD

*  Purpose:
*     Copy vectorised DOUBLE PRECISION values.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_DTOD( BAD, N, ARGV, RESV, IERR, NERR, STATUS )

*  Description:
*     The routine copies a vectorised array of DOUBLE PRECISION values.  It forms
