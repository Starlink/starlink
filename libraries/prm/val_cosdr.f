      REAL FUNCTION VAL_COSDR( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_COSDR

*  Purpose:
*     Evaluate the REAL cosine (degrees function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_COSDR( BAD, ARG, STATUS )
...
*     ARG = REAL (Given)
*        The REAL argument of the cosine (degrees function.
...
*  Returned Value:
*     VAL_COSDR = REAL
*        Returns the evaluated cosine (degrees function result as a REAL
