      SUBROUTINE VEC_MULB( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_MULB
...
*  Purpose:
*     Vectorised BYTE multiplication operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_MULB( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )
...
*        of BYTE argument values for the multiplication operation.
...
*  operation.
            ELSE
               RESV( I ) = NUM_MULB( ARGV1( I ), ARGV2( I ) )
