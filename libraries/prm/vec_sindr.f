      SUBROUTINE VEC_SINDR( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_SINDR

*  Purpose:
*     Vectorised REAL sine (degrees) function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_SINDR( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
