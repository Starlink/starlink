      INTEGER*2 FUNCTION VAL_MULUW( BAD, ARG1, ARG2, STATUS )
*+
*  Name:
*     VAL_MULUW

*  Purpose:
*     Perform a UNSIGNED WORD multiplication operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_MULUW( BAD, ARG1, ARG2, STATUS )
...
*        The two UNSIGNED WORD arguments for the multiplication operation.
