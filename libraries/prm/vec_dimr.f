      SUBROUTINE VEC_DIMR( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_DIMR
...
*  Purpose:
*     Vectorised REAL Fortran DIM (positive difference) function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_DIMR( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )

*  Description:
*     The routine evaluates the Fortran DIM (positive difference) function for two vectorised
*     arrays ARGV1 and ARGV2 of REAL argument values.  If numerical
*     errors occur, the value VAL__BADR is returned in appropriate
...
*     ARGV1( N ), ARGV2( N ) = REAL (Given)
*        Two vectorised (1-dimensional) arrays containing the N pairs
*        of REAL argument values for the Fortran DIM (positive difference) function.
...
*  Arguments Given:
      ...
      REAL ARGV1( * )          ! First function argument array
      REAL ARGV2( * )          ! Second function argument array
...
*  Local Variables:
      ...
      REAL ARG1                ! Temporary variable for argument 1
      REAL ARG2                ! Temporary variable for argument 2
...
*  value of VAL__BADR in the corresponding element of the result
*  array.
            IF( ARG1 .EQ. VAL__BADR .OR.
