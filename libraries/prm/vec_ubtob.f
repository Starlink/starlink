      SUBROUTINE VEC_UBTOB( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_UBTOB

*  Purpose:
*     Convert vectorised UNSIGNED BYTE values to BYTE.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_UBTOB( BAD, N, ARGV, RESV, IERR, NERR, STATUS )

*  Description:
*     The routine performs type conversion on a vectorised array ARGV
*     of UNSIGNED BYTE values, converting them to the equivalent BYTE
