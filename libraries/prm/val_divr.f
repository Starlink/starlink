      REAL FUNCTION VAL_DIVR( BAD, ARG1, ARG2, STATUS )
*+
*  Name:
*     VAL_DIVR

*  Purpose:
*     Perform a REAL floating divide operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_DIVR( BAD, ARG1, ARG2, STATUS )
...
*        The two REAL arguments for the floating divide operation.
