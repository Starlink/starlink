      INTEGER FUNCTION VAL_DIVI( BAD, ARG1, ARG2, STATUS )
*+
*  Name:
*     VAL_DIVI

*  Purpose:
*     Perform a INTEGER floating divide operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_DIVI( BAD, ARG1, ARG2, STATUS )
...
*        The two INTEGER arguments for the floating divide operation.
