      SUBROUTINE VEC_BTOUB( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_BTOUB

*  Purpose:
*     Convert vectorised BYTE values to UNSIGNED BYTE.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_BTOUB( BAD, N, ARGV, RESV, IERR, NERR, STATUS )

*  Description:
*     The routine performs type conversion on a vectorised array ARGV
*     of BYTE values, converting them to the equivalent UNSIGNED BYTE
