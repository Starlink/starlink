      DOUBLE PRECISION FUNCTION VAL_MIND( BAD, ARG1, ARG2, STATUS )
*+
*  Name:
*     VAL_MIND

*  Purpose:
*     Evaluate the DOUBLE PRECISION minimum function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_MIND( BAD, ARG1, ARG2, STATUS )
...
*        The two DOUBLE PRECISION arguments of the minimum function.
...
*  Returned Value:
*     VAL_MIND = DOUBLE PRECISION
*        Returns the evaluated minimum function result as a DOUBLE PRECISION
