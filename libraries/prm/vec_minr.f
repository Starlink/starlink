      SUBROUTINE VEC_MINR( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_MINR
...
*  Purpose:
*     Vectorised REAL minimum function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_MINR( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )
...
*        of REAL argument values for the minimum function.
