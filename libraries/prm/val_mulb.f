      BYTE FUNCTION VAL_MULB( BAD, ARG1, ARG2, STATUS )
*+
*  Name:
*     VAL_MULB

*  Purpose:
*     Perform a BYTE multiplication operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_MULB( BAD, ARG1, ARG2, STATUS )
...
*        The two BYTE arguments for the multiplication operation.
