      SUBROUTINE VEC_SUBR( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_SUBR
...
*  Purpose:
*     Vectorised REAL subtraction operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_SUBR( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )
...
*        of REAL argument values for the subtraction operation.
...
*  operation.
            ELSE
               RESV( I ) = NUM_SUBR( ARGV1( I ), ARGV2( I ) )
