      SUBROUTINE VEC_SUBUB( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_SUBUB
...
*  Purpose:
*     Vectorised UNSIGNED BYTE subtraction operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_SUBUB( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )
...
*        of UNSIGNED BYTE argument values for the subtraction operation.
...
*  operation.
            ELSE
               RESV( I ) = NUM_SUBUB( ARGV1( I ), ARGV2( I ) )
