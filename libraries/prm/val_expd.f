      DOUBLE PRECISION FUNCTION VAL_EXPD( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_EXPD

*  Purpose:
*     Evaluate the DOUBLE PRECISION exponential function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_EXPD( BAD, ARG, STATUS )
...
*        The DOUBLE PRECISION argument of the exponential function.
...
*  Returned Value:
*     VAL_EXPD = DOUBLE PRECISION
*        Returns the evaluated exponential function result as a DOUBLE PRECISION
