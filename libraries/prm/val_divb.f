      BYTE FUNCTION VAL_DIVB( BAD, ARG1, ARG2, STATUS )
*+
*  Name:
*     VAL_DIVB

*  Purpose:
*     Perform a BYTE floating divide operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_DIVB( BAD, ARG1, ARG2, STATUS )
...
*        The two BYTE arguments for the floating divide operation.
