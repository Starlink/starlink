      SUBROUTINE VEC_TANDD( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_TANDD

*  Purpose:
*     Vectorised DOUBLE PRECISION tangent (degrees) function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_TANDD( BAD, N, ARGV, RESV, IERR, NERR, STATUS )

*  Description:
*     The routine evaluates the tangent (degrees) function for a vectorised
...
*        argument values for the tangent (degrees) function.
...
*  If the argument value is acceptable, then evaluate the tangent (degrees)
*  function.
            ELSE
               RESV( I ) = NUM_TANDD( ARG )
