      INTEGER*2 FUNCTION VAL_SUBUW( BAD, ARG1, ARG2, STATUS )
*+
*  Name:
*     VAL_SUBUW

*  Purpose:
*     Perform a UNSIGNED WORD subtraction operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_SUBUW( BAD, ARG1, ARG2, STATUS )
...
*        The two UNSIGNED WORD arguments for the subtraction operation.
