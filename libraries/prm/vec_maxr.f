      SUBROUTINE VEC_MAXR( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_MAXR
...
*  Purpose:
*     Vectorised REAL maximum function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_MAXR( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )
...
*        of REAL argument values for the maximum function.
