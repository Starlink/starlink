      DOUBLE PRECISION FUNCTION VAL_MULD( BAD, ARG1, ARG2, STATUS )
*+
*  Name:
*     VAL_MULD

*  Purpose:
*     Perform a DOUBLE PRECISION multiplication operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_MULD( BAD, ARG1, ARG2, STATUS )
...
*        The two DOUBLE PRECISION arguments for the multiplication operation.
