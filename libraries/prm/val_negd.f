      DOUBLE PRECISION FUNCTION VAL_NEGD( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_NEGD

*  Purpose:
*     Evaluate the DOUBLE PRECISION negation function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_NEGD( BAD, ARG, STATUS )
...
*        The DOUBLE PRECISION argument of the negation function.
...
*  Returned Value:
*     VAL_NEGD = DOUBLE PRECISION
*        Returns the evaluated negation function result as a DOUBLE PRECISION
