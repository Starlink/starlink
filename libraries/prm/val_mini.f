      INTEGER FUNCTION VAL_MINI( BAD, ARG1, ARG2, STATUS )
*+
*  Name:
*     VAL_MINI

*  Purpose:
*     Evaluate the INTEGER minimum function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_MINI( BAD, ARG1, ARG2, STATUS )

*  Description:
*     The routine evaluates the minimum function for a pair of
...
*        The two INTEGER arguments of the minimum function.
...
*  Returned Value:
*     VAL_MINI = INTEGER
*        Returns the evaluated minimum function result as a INTEGER
