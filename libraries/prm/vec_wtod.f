      SUBROUTINE VEC_WTOD( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_WTOD

*  Purpose:
*     Convert vectorised WORD values to DOUBLE PRECISION.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_WTOD( BAD, N, ARGV, RESV, IERR, NERR, STATUS )

*  Description:
*     The routine performs type conversion on a vectorised array ARGV
*     of WORD values, converting them to the equivalent DOUBLE PRECISION
