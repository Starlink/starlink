      INTEGER*2 FUNCTION VAL_EXPW( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_EXPW

*  Purpose:
*     Evaluate the WORD exponential function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_EXPW( BAD, ARG, STATUS )
...
*     ARG = INTEGER*2 (Given)
*        The WORD argument of the exponential function.
...
*  Returned Value:
*     VAL_EXPW = INTEGER*2
*        Returns the evaluated exponential function result as a WORD
