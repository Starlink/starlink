      INTEGER*2 FUNCTION VAL_MAXW( BAD, ARG1, ARG2, STATUS )
*+
*  Name:
*     VAL_MAXW

*  Purpose:
*     Evaluate the WORD maximum function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_MAXW( BAD, ARG1, ARG2, STATUS )
...
*        The two WORD arguments of the maximum function.
...
*  Returned Value:
*     VAL_MAXW = INTEGER*2
*        Returns the evaluated maximum function result as a WORD
