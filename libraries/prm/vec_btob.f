      SUBROUTINE VEC_BTOB( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_BTOB

*  Purpose:
*     Copy vectorised BYTE values.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_BTOB( BAD, N, ARGV, RESV, IERR, NERR, STATUS )

*  Description:
*     The routine copies a vectorised array of BYTE values.  It forms
