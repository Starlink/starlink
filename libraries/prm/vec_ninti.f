      SUBROUTINE VEC_NINTI( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_NINTI

*  Purpose:
*     Vectorised INTEGER nearest integer function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_NINTI( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
