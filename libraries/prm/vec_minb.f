      SUBROUTINE VEC_MINB( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_MINB
...
*  Purpose:
*     Vectorised BYTE minimum function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_MINB( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )

*  Description:
*     The routine evaluates the minimum function for two vectorised
*     arrays ARGV1 and ARGV2 of BYTE argument values.  If numerical
*     errors occur, the value VAL__BADB is returned in appropriate
...
*        of BYTE argument values for the minimum function.
