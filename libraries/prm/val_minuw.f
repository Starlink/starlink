      INTEGER*2 FUNCTION VAL_MINUW( BAD, ARG1, ARG2, STATUS )
*+
*  Name:
*     VAL_MINUW

*  Purpose:
*     Evaluate the UNSIGNED WORD minimum function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_MINUW( BAD, ARG1, ARG2, STATUS )
...
*        The two UNSIGNED WORD arguments of the minimum function.
...
*  Returned Value:
*     VAL_MINUW = INTEGER*2
*        Returns the evaluated minimum function result as a UNSIGNED WORD
