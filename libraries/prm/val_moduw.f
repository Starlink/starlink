      INTEGER*2 FUNCTION VAL_MODUW( BAD, ARG1, ARG2, STATUS )
*+
*  Name:
*     VAL_MODUW

*  Purpose:
*     Evaluate the UNSIGNED WORD Fortran MOD (remainder) function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_MODUW( BAD, ARG1, ARG2, STATUS )
...
*        The two UNSIGNED WORD arguments of the Fortran MOD (remainder) function.
...
*  Returned Value:
*     VAL_MODUW = INTEGER*2
*        Returns the evaluated Fortran MOD (remainder) function result as a UNSIGNED WORD
