      SUBROUTINE VEC_LOGUB( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_LOGUB

*  Purpose:
*     Vectorised UNSIGNED BYTE natural logarithm function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_LOGUB( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
