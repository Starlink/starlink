      INTEGER FUNCTION VAL_NINTI( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_NINTI

*  Purpose:
*     Evaluate the INTEGER nearest integer function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_NINTI( BAD, ARG, STATUS )
...
*     ARG = INTEGER (Given)
*        The INTEGER argument of the nearest integer function.
...
*  Returned Value:
*     VAL_NINTI = INTEGER
*        Returns the evaluated nearest integer function result as a INTEGER
