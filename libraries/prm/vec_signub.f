      SUBROUTINE VEC_SIGNUB( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_SIGNUB
...
*  Purpose:
*     Vectorised UNSIGNED BYTE Fortran SIGN (sign transfer) function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_SIGNUB( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )
...
*        of UNSIGNED BYTE argument values for the Fortran SIGN (sign transfer) function.
