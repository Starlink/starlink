      BYTE FUNCTION VAL_NINTUB( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_NINTUB

*  Purpose:
*     Evaluate the UNSIGNED BYTE nearest integer function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_NINTUB( BAD, ARG, STATUS )
...
*     ARG = BYTE (Given)
*        The UNSIGNED BYTE argument of the nearest integer function.
...
*  Returned Value:
*     VAL_NINTUB = BYTE
*        Returns the evaluated nearest integer function result as a UNSIGNED BYTE
