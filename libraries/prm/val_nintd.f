      DOUBLE PRECISION FUNCTION VAL_NINTD( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_NINTD

*  Purpose:
*     Evaluate the DOUBLE PRECISION nearest integer function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_NINTD( BAD, ARG, STATUS )
...
*        The DOUBLE PRECISION argument of the nearest integer function.
...
*  Returned Value:
*     VAL_NINTD = DOUBLE PRECISION
*        Returns the evaluated nearest integer function result as a DOUBLE PRECISION
