      SUBROUTINE VEC_ADDI( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_ADDI
...
*  Purpose:
*     Vectorised INTEGER addition operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_ADDI( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )
...
*        of INTEGER argument values for the addition operation.
...
*  operation.
            ELSE
               RESV( I ) = NUM_ADDI( ARGV1( I ), ARGV2( I ) )
