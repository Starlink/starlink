      SUBROUTINE VEC_MODI( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_MODI
...
*  Purpose:
*     Vectorised INTEGER Fortran MOD (remainder) function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_MODI( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )

*  Description:
*     The routine evaluates the Fortran MOD (remainder) function for two vectorised
*     arrays ARGV1 and ARGV2 of INTEGER argument values.  If numerical
*     errors occur, the value VAL__BADI is returned in appropriate
...
*        of INTEGER argument values for the Fortran MOD (remainder) function.
...
*  Arguments Given:
      ...
      INTEGER ARGV1( * )          ! First function argument array
      INTEGER ARGV2( * )          ! Second function argument array
...
*  Local Variables:
      ...
      INTEGER ARG1                ! Temporary variable for argument 1
      INTEGER ARG2                ! Temporary variable for argument 2
