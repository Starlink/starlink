      DOUBLE PRECISION FUNCTION VAL_ATNDD( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_ATNDD

*  Purpose:
*     Evaluate the DOUBLE PRECISION arc_tangent (degrees) function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_ATNDD( BAD, ARG, STATUS )
...
*        The DOUBLE PRECISION argument of the arc_tangent (degrees) function.
...
*  Returned Value:
*     VAL_ATNDD = DOUBLE PRECISION
*        Returns the evaluated arc_tangent (degrees) function result as a DOUBLE PRECISION
