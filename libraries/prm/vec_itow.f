      SUBROUTINE VEC_ITOW( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_ITOW

*  Purpose:
*     Convert vectorised INTEGER values to WORD.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_ITOW( BAD, N, ARGV, RESV, IERR, NERR, STATUS )

*  Description:
*     The routine performs type conversion on a vectorised array ARGV
*     of INTEGER values, converting them to the equivalent WORD
