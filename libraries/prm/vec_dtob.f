      SUBROUTINE VEC_DTOB( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_DTOB

*  Purpose:
*     Convert vectorised DOUBLE PRECISION values to BYTE.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_DTOB( BAD, N, ARGV, RESV, IERR, NERR, STATUS )

*  Description:
*     The routine performs type conversion on a vectorised array ARGV
*     of DOUBLE PRECISION values, converting them to the equivalent BYTE
