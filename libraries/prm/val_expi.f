      INTEGER FUNCTION VAL_EXPI( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_EXPI

*  Purpose:
*     Evaluate the INTEGER exponential function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_EXPI( BAD, ARG, STATUS )
...
*     ARG = INTEGER (Given)
*        The INTEGER argument of the exponential function.
...
*  Returned Value:
*     VAL_EXPI = INTEGER
*        Returns the evaluated exponential function result as a INTEGER
