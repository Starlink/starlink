      SUBROUTINE VEC_PWRR( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_PWRR
...
*  Purpose:
*     Vectorised REAL exponentiation operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_PWRR( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )
...
*        of REAL argument values for the exponentiation operation.
...
*  operation.
            ELSE
               RESV( I ) = NUM_PWRR( ARGV1( I ), ARGV2( I ) )
