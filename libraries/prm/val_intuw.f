      INTEGER*2 FUNCTION VAL_INTUW( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_INTUW

*  Purpose:
*     Evaluate the UNSIGNED WORD truncation to integer function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_INTUW( BAD, ARG, STATUS )
...
*     ARG = INTEGER*2 (Given)
*        The UNSIGNED WORD argument of the truncation to integer function.
...
*  Returned Value:
*     VAL_INTUW = INTEGER*2
*        Returns the evaluated truncation to integer function result as a UNSIGNED WORD
