      SUBROUTINE VEC_INTUW( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_INTUW

*  Purpose:
*     Vectorised UNSIGNED WORD truncation to integer function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_INTUW( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
