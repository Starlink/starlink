      DOUBLE PRECISION FUNCTION VAL_COSDD( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_COSDD

*  Purpose:
*     Evaluate the DOUBLE PRECISION cosine (degrees function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_COSDD( BAD, ARG, STATUS )

*  Description:
*     The routine evaluates the cosine (degrees function for a single
...
*        The DOUBLE PRECISION argument of the cosine (degrees function.
...
*  Returned Value:
*     VAL_COSDD = DOUBLE PRECISION
*        Returns the evaluated cosine (degrees function result as a DOUBLE PRECISION
