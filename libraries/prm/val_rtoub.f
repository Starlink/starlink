      BYTE FUNCTION VAL_RTOUB( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_RTOUB

*  Purpose:
*     Convert a value from REAL to UNSIGNED BYTE.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_RTOUB( BAD, ARG, STATUS )
