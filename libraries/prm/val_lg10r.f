      REAL FUNCTION VAL_LG10R( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_LG10R

*  Purpose:
*     Evaluate the REAL common logarithm (base 10) function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_LG10R( BAD, ARG, STATUS )
...
*     ARG = REAL (Given)
*        The REAL argument of the common logarithm (base 10) function.
...
*  Returned Value:
*     VAL_LG10R = REAL
*        Returns the evaluated common logarithm (base 10) function result as a REAL
...
*  result VAL__BADR and set a STATUS value.
      ELSE IF( .NOT. ( NUM_GTR( ARG, VAL__ZR ) ) ) THEN
         VAL_LG10R = VAL__BADR
         STATUS = PRM__LOGZN
