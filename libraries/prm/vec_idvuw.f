      SUBROUTINE VEC_IDVUW( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_IDVUW
...
*  Purpose:
*     Vectorised UNSIGNED WORD integer divide operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_IDVUW( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )
...
*        of UNSIGNED WORD argument values for the integer divide operation.
...
*  operation.
            ELSE
               RESV( I ) = NUM_IDVUW( ARGV1( I ), ARGV2( I ) )
