      BYTE FUNCTION VAL_UWTOUB( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_UWTOUB

*  Purpose:
*     Convert a value from UNSIGNED WORD to UNSIGNED BYTE.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_UWTOUB( BAD, ARG, STATUS )
