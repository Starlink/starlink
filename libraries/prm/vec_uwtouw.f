      SUBROUTINE VEC_UWTOUW( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_UWTOUW

*  Purpose:
*     Copy vectorised UNSIGNED WORD values.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_UWTOUW( BAD, N, ARGV, RESV, IERR, NERR, STATUS )

*  Description:
*     The routine copies a vectorised array of UNSIGNED WORD values.  It forms
...
*        receive the UNSIGNED WORD results.
