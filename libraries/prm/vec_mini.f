      SUBROUTINE VEC_MINI( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_MINI
...
*  Purpose:
*     Vectorised INTEGER minimum function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_MINI( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )
...
*        of INTEGER argument values for the minimum function.
