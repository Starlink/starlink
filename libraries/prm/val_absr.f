      REAL FUNCTION VAL_ABSR( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_ABSR

*  Purpose:
*     Evaluate the REAL Fortran ABS function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_ABSR( BAD, ARG, STATUS )
...
*     ARG = REAL (Given)
*        The REAL argument of the Fortran ABS function.
...
*  Returned Value:
*     VAL_ABSR = REAL
*        Returns the evaluated Fortran ABS function result as a REAL
