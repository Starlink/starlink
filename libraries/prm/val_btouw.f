      INTEGER * 2 FUNCTION VAL_BTOUW( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_BTOUW

*  Purpose:
*     Convert a value from BYTE to UNSIGNED WORD.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_BTOUW( BAD, ARG, STATUS )
