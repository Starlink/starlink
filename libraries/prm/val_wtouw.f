      INTEGER * 2 FUNCTION VAL_WTOUW( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_WTOUW

*  Purpose:
*     Convert a value from WORD to UNSIGNED WORD.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_WTOUW( BAD, ARG, STATUS )
