      INTEGER * 2 FUNCTION VAL_RTOUW( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_RTOUW

*  Purpose:
*     Convert a value from REAL to UNSIGNED WORD.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_RTOUW( BAD, ARG, STATUS )
