      BYTE FUNCTION VAL_SIGNUB( BAD, ARG1, ARG2, STATUS )
*+
*  Name:
*     VAL_SIGNUB

*  Purpose:
*     Evaluate the UNSIGNED BYTE Fortran SIGN (sign transfer) function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_SIGNUB( BAD, ARG1, ARG2, STATUS )
...
*        The two UNSIGNED BYTE arguments of the Fortran SIGN (sign transfer) function.
...
*  Returned Value:
*     VAL_SIGNUB = BYTE
*        Returns the evaluated Fortran SIGN (sign transfer) function result as a UNSIGNED BYTE
...
*  Evaluate the function.
         VAL_SIGNUB = NUM_SIGNUB( ARG1, ARG2 )
