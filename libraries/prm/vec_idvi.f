      SUBROUTINE VEC_IDVI( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_IDVI
...
*  Purpose:
*     Vectorised INTEGER integer divide operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_IDVI( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )
...
*        of INTEGER argument values for the integer divide operation.
...
*  operation.
            ELSE
               RESV( I ) = NUM_IDVI( ARGV1( I ), ARGV2( I ) )
