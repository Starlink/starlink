      REAL FUNCTION VAL_NEGR( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_NEGR

*  Purpose:
*     Evaluate the REAL negation function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_NEGR( BAD, ARG, STATUS )
...
*     ARG = REAL (Given)
*        The REAL argument of the negation function.
...
*  Returned Value:
*     VAL_NEGR = REAL
*        Returns the evaluated negation function result as a REAL
