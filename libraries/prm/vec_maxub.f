      SUBROUTINE VEC_MAXUB( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_MAXUB
...
*  Purpose:
*     Vectorised UNSIGNED BYTE maximum function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_MAXUB( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )
...
*        of UNSIGNED BYTE argument values for the maximum function.
