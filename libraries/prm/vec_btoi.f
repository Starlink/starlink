      SUBROUTINE VEC_BTOI( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_BTOI

*  Purpose:
*     Convert vectorised BYTE values to INTEGER.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_BTOI( BAD, N, ARGV, RESV, IERR, NERR, STATUS )

*  Description:
*     The routine performs type conversion on a vectorised array ARGV
*     of BYTE values, converting them to the equivalent INTEGER
