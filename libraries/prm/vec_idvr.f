      SUBROUTINE VEC_IDVR( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_IDVR
...
*  Purpose:
*     Vectorised REAL integer divide operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_IDVR( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )
...
*        of REAL argument values for the integer divide operation.
...
*  operation.
            ELSE
               RESV( I ) = NUM_IDVR( ARGV1( I ), ARGV2( I ) )
