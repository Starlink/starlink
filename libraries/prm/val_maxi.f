      INTEGER FUNCTION VAL_MAXI( BAD, ARG1, ARG2, STATUS )
*+
*  Name:
*     VAL_MAXI

*  Purpose:
*     Evaluate the INTEGER maximum function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_MAXI( BAD, ARG1, ARG2, STATUS )
...
*        The two INTEGER arguments of the maximum function.
...
*  Returned Value:
*     VAL_MAXI = INTEGER
*        Returns the evaluated maximum function result as a INTEGER
