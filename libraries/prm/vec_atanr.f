      SUBROUTINE VEC_ATANR( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_ATANR

*  Purpose:
*     Vectorised REAL arc-tangent function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_ATANR( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
