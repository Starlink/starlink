      REAL FUNCTION VAL_MODR( BAD, ARG1, ARG2, STATUS )
*+
*  Name:
*     VAL_MODR

*  Purpose:
*     Evaluate the REAL Fortran MOD (remainder) function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_MODR( BAD, ARG1, ARG2, STATUS )
...
*        The two REAL arguments of the Fortran MOD (remainder) function.
...
*  Returned Value:
*     VAL_MODR = REAL
*        Returns the evaluated Fortran MOD (remainder) function result as a REAL
