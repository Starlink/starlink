      SUBROUTINE VEC_DTOUW( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_DTOUW

*  Purpose:
*     Convert vectorised DOUBLE PRECISION values to UNSIGNED WORD.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_DTOUW( BAD, N, ARGV, RESV, IERR, NERR, STATUS )

*  Description:
*     The routine performs type conversion on a vectorised array ARGV
*     of DOUBLE PRECISION values, converting them to the equivalent UNSIGNED WORD
