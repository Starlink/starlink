      SUBROUTINE VEC_RTOD( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_RTOD

*  Purpose:
*     Convert vectorised REAL values to DOUBLE PRECISION.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_RTOD( BAD, N, ARGV, RESV, IERR, NERR, STATUS )

*  Description:
*     The routine performs type conversion on a vectorised array ARGV
*     of REAL values, converting them to the equivalent DOUBLE PRECISION
