      DOUBLE PRECISION FUNCTION VAL_ABSD( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_ABSD

*  Purpose:
*     Evaluate the DOUBLE PRECISION Fortran ABS function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_ABSD( BAD, ARG, STATUS )
...
*        The DOUBLE PRECISION argument of the Fortran ABS function.
...
*  Returned Value:
*     VAL_ABSD = DOUBLE PRECISION
*        Returns the evaluated Fortran ABS function result as a DOUBLE PRECISION
