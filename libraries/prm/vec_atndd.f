      SUBROUTINE VEC_ATNDD( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_ATNDD

*  Purpose:
*     Vectorised DOUBLE PRECISION arc_tangent (degrees) function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_ATNDD( BAD, N, ARGV, RESV, IERR, NERR, STATUS )

*  Description:
*     The routine evaluates the arc_tangent (degrees) function for a vectorised
...
*        argument values for the arc_tangent (degrees) function.
...
*  If the argument value is acceptable, then evaluate the arc_tangent (degrees)
*  function.
            ELSE
               RESV( I ) = NUM_ATNDD( ARG )
