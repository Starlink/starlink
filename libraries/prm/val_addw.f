      INTEGER*2 FUNCTION VAL_ADDW( BAD, ARG1, ARG2, STATUS )
*+
*  Name:
*     VAL_ADDW

*  Purpose:
*     Perform a WORD addition operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_ADDW( BAD, ARG1, ARG2, STATUS )
...
*        The two WORD arguments for the addition operation.
