      SUBROUTINE VEC_NINTUW( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_NINTUW

*  Purpose:
*     Vectorised UNSIGNED WORD nearest integer function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_NINTUW( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
