      DOUBLE PRECISION FUNCTION VAL_INTD( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_INTD

*  Purpose:
*     Evaluate the DOUBLE PRECISION truncation to integer function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_INTD( BAD, ARG, STATUS )
...
*        The DOUBLE PRECISION argument of the truncation to integer function.
...
*  Returned Value:
*     VAL_INTD = DOUBLE PRECISION
*        Returns the evaluated truncation to integer function result as a DOUBLE PRECISION
