      INTEGER*2 FUNCTION VAL_IDVUW( BAD, ARG1, ARG2, STATUS )
*+
*  Name:
*     VAL_IDVUW

*  Purpose:
*     Perform a UNSIGNED WORD integer divide operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_IDVUW( BAD, ARG1, ARG2, STATUS )
...
*        The two UNSIGNED WORD arguments for the integer divide operation.
