      BYTE FUNCTION VAL_LOGUB( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_LOGUB

*  Purpose:
*     Evaluate the UNSIGNED BYTE natural logarithm function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_LOGUB( BAD, ARG, STATUS )
...
*     ARG = BYTE (Given)
*        The UNSIGNED BYTE argument of the natural logarithm function.
...
*  Returned Value:
*     VAL_LOGUB = BYTE
*        Returns the evaluated natural logarithm function result as a UNSIGNED BYTE
