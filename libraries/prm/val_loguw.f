      INTEGER*2 FUNCTION VAL_LOGUW( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_LOGUW

*  Purpose:
*     Evaluate the UNSIGNED WORD natural logarithm function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_LOGUW( BAD, ARG, STATUS )
...
*     ARG = INTEGER*2 (Given)
*        The UNSIGNED WORD argument of the natural logarithm function.
...
*  Returned Value:
*     VAL_LOGUW = INTEGER*2
*        Returns the evaluated natural logarithm function result as a UNSIGNED WORD
