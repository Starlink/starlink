      SUBROUTINE VEC_MODUW( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_MODUW
...
*  Purpose:
*     Vectorised UNSIGNED WORD Fortran MOD (remainder) function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_MODUW( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )
...
*        of UNSIGNED WORD argument values for the Fortran MOD (remainder) function.
