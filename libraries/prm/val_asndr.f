      REAL FUNCTION VAL_ASNDR( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_ASNDR

*  Purpose:
*     Evaluate the REAL arc-sine (degrees) function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_ASNDR( BAD, ARG, STATUS )
...
*     ARG = REAL (Given)
*        The REAL argument of the arc-sine (degrees) function.
...
*  Returned Value:
*     VAL_ASNDR = REAL
*        Returns the evaluated arc-sine (degrees) function result as a REAL
