      SUBROUTINE VEC_MAXI( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_MAXI
...
*  Purpose:
*     Vectorised INTEGER maximum function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_MAXI( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )
...
*        of INTEGER argument values for the maximum function.
