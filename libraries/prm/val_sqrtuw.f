      INTEGER*2 FUNCTION VAL_SQRTUW( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_SQRTUW

*  Purpose:
*     Evaluate the UNSIGNED WORD square root function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_SQRTUW( BAD, ARG, STATUS )

*  Description:
*     The routine evaluates the square root function for a single
...
*     ARG = INTEGER*2 (Given)
*        The UNSIGNED WORD argument of the square root function.
...
*  Returned Value:
*     VAL_SQRTUW = INTEGER*2
*        Returns the evaluated square root function result as a UNSIGNED WORD
