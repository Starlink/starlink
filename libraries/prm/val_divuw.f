      INTEGER*2 FUNCTION VAL_DIVUW( BAD, ARG1, ARG2, STATUS )
*+
*  Name:
*     VAL_DIVUW

*  Purpose:
*     Perform a UNSIGNED WORD floating divide operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_DIVUW( BAD, ARG1, ARG2, STATUS )
...
*        The two UNSIGNED WORD arguments for the floating divide operation.
