      SUBROUTINE VEC_ATN2R( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_ATN2R
...
*  Purpose:
*     Vectorised REAL Fortran ATAN2 function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_ATN2R( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )
...
*        of REAL argument values for the Fortran ATAN2 function.
