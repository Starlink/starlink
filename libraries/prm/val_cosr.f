      REAL FUNCTION VAL_COSR( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_COSR

*  Purpose:
*     Evaluate the REAL cosine function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_COSR( BAD, ARG, STATUS )

*  Description:
*     The routine evaluates the cosine function for a single
...
*     ARG = REAL (Given)
*        The REAL argument of the cosine function.
...
*  Returned Value:
*     VAL_COSR = REAL
*        Returns the evaluated cosine function result as a REAL
