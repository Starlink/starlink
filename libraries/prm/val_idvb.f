      BYTE FUNCTION VAL_IDVB( BAD, ARG1, ARG2, STATUS )
*+
*  Name:
*     VAL_IDVB

*  Purpose:
*     Perform a BYTE integer divide operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_IDVB( BAD, ARG1, ARG2, STATUS )
...
*        The two BYTE arguments for the integer divide operation.
