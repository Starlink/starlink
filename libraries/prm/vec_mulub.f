      SUBROUTINE VEC_MULUB( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_MULUB
...
*  Purpose:
*     Vectorised UNSIGNED BYTE multiplication operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_MULUB( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )
...
*        of UNSIGNED BYTE argument values for the multiplication operation.
...
*  operation.
            ELSE
               RESV( I ) = NUM_MULUB( ARGV1( I ), ARGV2( I ) )
