      INTEGER*2 FUNCTION VAL_NINTW( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_NINTW

*  Purpose:
*     Evaluate the WORD nearest integer function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_NINTW( BAD, ARG, STATUS )
...
*     ARG = INTEGER*2 (Given)
*        The WORD argument of the nearest integer function.
...
*  Returned Value:
*     VAL_NINTW = INTEGER*2
*        Returns the evaluated nearest integer function result as a WORD
