      REAL FUNCTION VAL_SINHR( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_SINHR

*  Purpose:
*     Evaluate the REAL hyperbolic sine function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_SINHR( BAD, ARG, STATUS )
...
*     ARG = REAL (Given)
*        The REAL argument of the hyperbolic sine function.
...
*  Returned Value:
*     VAL_SINHR = REAL
*        Returns the evaluated hyperbolic sine function result as a REAL
