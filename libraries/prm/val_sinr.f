      REAL FUNCTION VAL_SINR( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_SINR

*  Purpose:
*     Evaluate the REAL sine function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_SINR( BAD, ARG, STATUS )
...
*     ARG = REAL (Given)
*        The REAL argument of the sine function.
...
*  Returned Value:
*     VAL_SINR = REAL
*        Returns the evaluated sine function result as a REAL
