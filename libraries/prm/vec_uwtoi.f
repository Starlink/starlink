      SUBROUTINE VEC_UWTOI( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_UWTOI

*  Purpose:
*     Convert vectorised UNSIGNED WORD values to INTEGER.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_UWTOI( BAD, N, ARGV, RESV, IERR, NERR, STATUS )

*  Description:
*     The routine performs type conversion on a vectorised array ARGV
*     of UNSIGNED WORD values, converting them to the equivalent INTEGER
