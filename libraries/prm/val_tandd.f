      DOUBLE PRECISION FUNCTION VAL_TANDD( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_TANDD

*  Purpose:
*     Evaluate the DOUBLE PRECISION tangent (degrees) function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_TANDD( BAD, ARG, STATUS )
...
*        The DOUBLE PRECISION argument of the tangent (degrees) function.
...
*  Returned Value:
*     VAL_TANDD = DOUBLE PRECISION
*        Returns the evaluated tangent (degrees) function result as a DOUBLE PRECISION
