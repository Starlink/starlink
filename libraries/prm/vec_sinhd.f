      SUBROUTINE VEC_SINHD( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_SINHD

*  Purpose:
*     Vectorised DOUBLE PRECISION hyperbolic sine function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_SINHD( BAD, N, ARGV, RESV, IERR, NERR, STATUS )

*  Description:
*     The routine evaluates the hyperbolic sine function for a vectorised
...
*        argument values for the hyperbolic sine function.
...
*  If the argument value is acceptable, then evaluate the hyperbolic sine
*  function.
            ELSE
               RESV( I ) = NUM_SINHD( ARG )
