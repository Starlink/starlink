      REAL FUNCTION VAL_COSHR( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_COSHR

*  Purpose:
*     Evaluate the REAL hyperbolic cosine function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_COSHR( BAD, ARG, STATUS )
...
*     ARG = REAL (Given)
*        The REAL argument of the hyperbolic cosine function.
...
*  Returned Value:
*     VAL_COSHR = REAL
*        Returns the evaluated hyperbolic cosine function result as a REAL
