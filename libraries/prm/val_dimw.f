      INTEGER*2 FUNCTION VAL_DIMW( BAD, ARG1, ARG2, STATUS )
*+
*  Name:
*     VAL_DIMW

*  Purpose:
*     Evaluate the WORD Fortran DIM (positive difference) function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_DIMW( BAD, ARG1, ARG2, STATUS )
...
*        The two WORD arguments of the Fortran DIM (positive difference) function.
...
*  Returned Value:
*     VAL_DIMW = INTEGER*2
*        Returns the evaluated Fortran DIM (positive difference) function result as a WORD
