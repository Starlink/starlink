      SUBROUTINE VEC_LG10UB( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_LG10UB

*  Purpose:
*     Vectorised UNSIGNED BYTE common logarithm (base 10) function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_LG10UB( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
...
*  increment the error count.
            IF( .NOT. ( NUM_GTUB( ARG, VAL__ZUB ) ) ) THEN
               RESV( I ) = VAL__BADUB
               NERR = NERR + 1
