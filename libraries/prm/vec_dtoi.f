      SUBROUTINE VEC_DTOI( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_DTOI

*  Purpose:
*     Convert vectorised DOUBLE PRECISION values to INTEGER.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_DTOI( BAD, N, ARGV, RESV, IERR, NERR, STATUS )

*  Description:
*     The routine performs type conversion on a vectorised array ARGV
*     of DOUBLE PRECISION values, converting them to the equivalent INTEGER
