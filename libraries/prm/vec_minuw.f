      SUBROUTINE VEC_MINUW( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_MINUW
...
*  Purpose:
*     Vectorised UNSIGNED WORD minimum function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_MINUW( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )
...
*        of UNSIGNED WORD argument values for the minimum function.
