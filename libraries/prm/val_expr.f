      REAL FUNCTION VAL_EXPR( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_EXPR

*  Purpose:
*     Evaluate the REAL exponential function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_EXPR( BAD, ARG, STATUS )
...
*     ARG = REAL (Given)
*        The REAL argument of the exponential function.
...
*  Returned Value:
*     VAL_EXPR = REAL
*        Returns the evaluated exponential function result as a REAL
