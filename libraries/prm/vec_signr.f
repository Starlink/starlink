      SUBROUTINE VEC_SIGNR( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_SIGNR
...
*  Purpose:
*     Vectorised REAL Fortran SIGN (sign transfer) function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_SIGNR( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )
...
*        of REAL argument values for the Fortran SIGN (sign transfer) function.
