      SUBROUTINE VEC_MINUB( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_MINUB
...
*  Purpose:
*     Vectorised UNSIGNED BYTE minimum function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_MINUB( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )

*  Description:
*     The routine evaluates the minimum function for two vectorised
...
*        of UNSIGNED BYTE argument values for the minimum function.
...
*  If the argument values are acceptable, then evaluate the minimum
*  function.
            ELSE
               RESV( I ) = NUM_MINUB( ARG1, ARG2 )
