      SUBROUTINE VEC_DTOR( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_DTOR

*  Purpose:
*     Convert vectorised DOUBLE PRECISION values to REAL.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_DTOR( BAD, N, ARGV, RESV, IERR, NERR, STATUS )

*  Description:
*     The routine performs type conversion on a vectorised array ARGV
*     of DOUBLE PRECISION values, converting them to the equivalent REAL
