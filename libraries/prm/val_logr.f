      REAL FUNCTION VAL_LOGR( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_LOGR

*  Purpose:
*     Evaluate the REAL natural logarithm function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_LOGR( BAD, ARG, STATUS )
...
*     ARG = REAL (Given)
*        The REAL argument of the natural logarithm function.
...
*  Returned Value:
*     VAL_LOGR = REAL
*        Returns the evaluated natural logarithm function result as a REAL
