      SUBROUTINE VEC_DTOW( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_DTOW

*  Purpose:
*     Convert vectorised DOUBLE PRECISION values to WORD.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_DTOW( BAD, N, ARGV, RESV, IERR, NERR, STATUS )

*  Description:
*     The routine performs type conversion on a vectorised array ARGV
*     of DOUBLE PRECISION values, converting them to the equivalent WORD
