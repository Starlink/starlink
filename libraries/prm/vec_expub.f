      SUBROUTINE VEC_EXPUB( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_EXPUB

*  Purpose:
*     Vectorised UNSIGNED BYTE exponential function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_EXPUB( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
