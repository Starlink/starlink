      SUBROUTINE VEC_WTOUB( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_WTOUB

*  Purpose:
*     Convert vectorised WORD values to UNSIGNED BYTE.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_WTOUB( BAD, N, ARGV, RESV, IERR, NERR, STATUS )

*  Description:
*     The routine performs type conversion on a vectorised array ARGV
*     of WORD values, converting them to the equivalent UNSIGNED BYTE
