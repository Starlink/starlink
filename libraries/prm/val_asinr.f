      REAL FUNCTION VAL_ASINR( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_ASINR

*  Purpose:
*     Evaluate the REAL arc-sine function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_ASINR( BAD, ARG, STATUS )
...
*     ARG = REAL (Given)
*        The REAL argument of the arc-sine function.
...
*  Returned Value:
*     VAL_ASINR = REAL
*        Returns the evaluated arc-sine function result as a REAL
