      INTEGER*2 FUNCTION VAL_SUBW( BAD, ARG1, ARG2, STATUS )
*+
*  Name:
*     VAL_SUBW

*  Purpose:
*     Perform a WORD subtraction operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_SUBW( BAD, ARG1, ARG2, STATUS )
...
*        The two WORD arguments for the subtraction operation.
