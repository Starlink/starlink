      REAL FUNCTION VAL_SUBR( BAD, ARG1, ARG2, STATUS )
*+
*  Name:
*     VAL_SUBR

*  Purpose:
*     Perform a REAL subtraction operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_SUBR( BAD, ARG1, ARG2, STATUS )
...
*        The two REAL arguments for the subtraction operation.
