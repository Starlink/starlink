      SUBROUTINE VEC_BTOW( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_BTOW

*  Purpose:
*     Convert vectorised BYTE values to WORD.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_BTOW( BAD, N, ARGV, RESV, IERR, NERR, STATUS )

*  Description:
*     The routine performs type conversion on a vectorised array ARGV
*     of BYTE values, converting them to the equivalent WORD
