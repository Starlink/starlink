      REAL FUNCTION VAL_ADDR( BAD, ARG1, ARG2, STATUS )
*+
*  Name:
*     VAL_ADDR

*  Purpose:
*     Perform a REAL addition operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_ADDR( BAD, ARG1, ARG2, STATUS )
...
*        The two REAL arguments for the addition operation.
