      SUBROUTINE VEC_ITOB( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_ITOB

*  Purpose:
*     Convert vectorised INTEGER values to BYTE.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_ITOB( BAD, N, ARGV, RESV, IERR, NERR, STATUS )

*  Description:
*     The routine performs type conversion on a vectorised array ARGV
*     of INTEGER values, converting them to the equivalent BYTE
