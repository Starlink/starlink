      BYTE FUNCTION VAL_SUBUB( BAD, ARG1, ARG2, STATUS )
*+
*  Name:
*     VAL_SUBUB

*  Purpose:
*     Perform a UNSIGNED BYTE subtraction operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_SUBUB( BAD, ARG1, ARG2, STATUS )
...
*        The two UNSIGNED BYTE arguments for the subtraction operation.
