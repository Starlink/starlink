      SUBROUTINE VEC_INTD( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_INTD

*  Purpose:
*     Vectorised DOUBLE PRECISION truncation to integer function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_INTD( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
