      SUBROUTINE VEC_EXPUW( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_EXPUW

*  Purpose:
*     Vectorised UNSIGNED WORD exponential function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_EXPUW( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
