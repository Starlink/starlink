      REAL FUNCTION VAL_INTR( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_INTR

*  Purpose:
*     Evaluate the REAL truncation to integer function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_INTR( BAD, ARG, STATUS )
...
*     ARG = REAL (Given)
*        The REAL argument of the truncation to integer function.
...
*  Returned Value:
*     VAL_INTR = REAL
*        Returns the evaluated truncation to integer function result as a REAL
