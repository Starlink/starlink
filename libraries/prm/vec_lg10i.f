      SUBROUTINE VEC_LG10I( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_LG10I

*  Purpose:
*     Vectorised INTEGER common logarithm (base 10) function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_LG10I( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
