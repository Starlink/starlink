      DOUBLE PRECISION FUNCTION VAL_ACOSD( BAD, ARG, STATUS )
*+
*  Name:
*     VAL_ACOSD

*  Purpose:
*     Evaluate the DOUBLE PRECISION arc-cosine function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_ACOSD( BAD, ARG, STATUS )
...
*        The DOUBLE PRECISION argument of the arc-cosine function.
...
*  Returned Value:
*     VAL_ACOSD = DOUBLE PRECISION
*        Returns the evaluated arc-cosine function result as a DOUBLE PRECISION
