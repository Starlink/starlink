      SUBROUTINE VEC_SINDD( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_SINDD

*  Purpose:
*     Vectorised DOUBLE PRECISION sine (degrees) function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_SINDD( BAD, N, ARGV, RESV, IERR, NERR, STATUS )

*  Description:
*     The routine evaluates the sine (degrees) function for a vectorised
...
*        argument values for the sine (degrees) function.
...
*  If the argument value is acceptable, then evaluate the sine (degrees)
*  function.
            ELSE
               RESV( I ) = NUM_SINDD( ARG )
