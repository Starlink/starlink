      SUBROUTINE VEC_SQRTB( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_SQRTB

*  Purpose:
*     Vectorised BYTE square root function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_SQRTB( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
...
*  increment the error count.
            IF( .NOT. ( NUM_GEB( ARG, VAL__ZB ) ) ) THEN
               RESV( I ) = VAL__BADB
               NERR = NERR + 1
