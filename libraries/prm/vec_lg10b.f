      SUBROUTINE VEC_LG10B( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
*+
*  Name:
*     VEC_LG10B

*  Purpose:
*     Vectorised BYTE common logarithm (base 10) function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_LG10B( BAD, N, ARGV, RESV, IERR, NERR, STATUS )
...
*  increment the error count.
            IF( .NOT. ( NUM_GTB( ARG, VAL__ZB ) ) ) THEN
               RESV( I ) = VAL__BADB
               NERR = NERR + 1
