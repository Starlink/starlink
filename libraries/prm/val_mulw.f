      INTEGER*2 FUNCTION VAL_MULW( BAD, ARG1, ARG2, STATUS )
*+
*  Name:
*     VAL_MULW

*  Purpose:
*     Perform a WORD multiplication operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_MULW( BAD, ARG1, ARG2, STATUS )
...
*        The two WORD arguments for the multiplication operation.
