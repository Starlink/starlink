      DOUBLE PRECISION FUNCTION VAL_DIMD( BAD, ARG1, ARG2, STATUS )
*+
*  Name:
*     VAL_DIMD

*  Purpose:
*     Evaluate the DOUBLE PRECISION Fortran DIM (positive difference) function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_DIMD( BAD, ARG1, ARG2, STATUS )

*  Description:
*     The routine evaluates the Fortran DIM (positive difference) function for a pair of
*     arguments of type DOUBLE PRECISION.  If a numerical error occurs, the value
...
*        The two DOUBLE PRECISION arguments of the Fortran DIM (positive difference) function.
...
*  Returned Value:
*     VAL_DIMD = DOUBLE PRECISION
*        Returns the evaluated Fortran DIM (positive difference) function result as a DOUBLE PRECISION
...
*  Arguments Given:
      ...
      DOUBLE PRECISION ARG1                ! Function argument 1
      DOUBLE PRECISION ARG2                ! Function argument 2
