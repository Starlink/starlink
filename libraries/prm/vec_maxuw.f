      SUBROUTINE VEC_MAXUW( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_MAXUW
...
*  Purpose:
*     Vectorised UNSIGNED WORD maximum function.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_MAXUW( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )

*  Description:
*     The routine evaluates the maximum function for two vectorised
...
*        of UNSIGNED WORD argument values for the maximum function.
...
*  If the argument values are acceptable, then evaluate the maximum
*  function.
            ELSE
               RESV( I ) = NUM_MAXUW( ARG1, ARG2 )
