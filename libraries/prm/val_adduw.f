      INTEGER*2 FUNCTION VAL_ADDUW( BAD, ARG1, ARG2, STATUS )
*+
*  Name:
*     VAL_ADDUW

*  Purpose:
*     Perform a UNSIGNED WORD addition operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_ADDUW( BAD, ARG1, ARG2, STATUS )
...
*        The two UNSIGNED WORD arguments for the addition operation.
