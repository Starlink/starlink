      INTEGER FUNCTION VAL_IDVI( BAD, ARG1, ARG2, STATUS )
*+
*  Name:
*     VAL_IDVI

*  Purpose:
*     Perform a INTEGER integer divide operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     RESULT = VAL_IDVI( BAD, ARG1, ARG2, STATUS )
...
*        The two INTEGER arguments for the integer divide operation.
