      SUBROUTINE VEC_ADDUW( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
     :                          STATUS )
*+
*  Name:
*     VEC_ADDUW
...
*  Purpose:
*     Vectorised UNSIGNED WORD addition operation.

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL VEC_ADDUW( BAD, N, ARGV1, ARGV2, RESV, IERR, NERR,
*                         STATUS )
...
*        of UNSIGNED WORD argument values for the addition operation.
...
*  operation.
            ELSE
               RESV( I ) = NUM_ADDUW( ARGV1( I ), ARGV2( I ) )
