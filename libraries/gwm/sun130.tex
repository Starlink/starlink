...
\newcommand{\stardocsource}    {sun130.5}
...
the routine \htmlref{\tt GWM\_OPEN}{GWM_OPEN}
...
The connection is ended with a call to \htmlref{\tt GWM\_CLOSE}{GWM_CLOSE}.
These two routines
...
The routine \htmlref{\tt GWM\_CRWIN}{GWM_CRWIN}
...
routines \htmlref{\tt GWM\_WSETx}{GWM_WSETC} are made before 
...
\htmlref{\tt -geometry}{geometryOpt}
...
passing a true value in \htmlref{\tt GWM\_WSETL}{GWM_WSETL}
...
\htmlref{\tt GWM\_DSWIN}{GWM_DSWIN}.

\subsection{Inquiries}
The routine \htmlref{\tt GWM\_EXIST}{GWM_EXIST}
...
The routine \htmlref{\tt GWM\_GETCI}{GWM_GETCI}
