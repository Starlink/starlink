      SUBROUTINE PAR_GDR0D( PARAM, DEFAUL, VMIN, VMAX, NULL, VALUE,
     :                        STATUS )
...
*  Set the suggested value.
      IF ( SUGDEF ) CALL PAR_DEF0D( PARAM, DEFAUL, STATUS )

*  Set the range limits.
      CALL PAR_MIND( PARAM, VMIN, STATUS )
      CALL PAR_MAXD( PARAM, VMAX, STATUS )
...
*  Inform the user what has happened.
               ...
               CALL MSG_OUTIF( MSG__VERB, 'PAR_GDR0D_DEFA',
