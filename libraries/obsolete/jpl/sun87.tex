...
\stardocnumber      {87.6}
\stardocauthors     {P.\,T.\,Wallace \\ A.\,J.\,J.\,Broderick}
\stardocdate        {19 September 2000}
\stardoctitle       {JPL --- Solar System Ephemeris}
\stardocversion     {2.0}
...
% Starlink mods
% \vp
% \+&\texttt{Test~output~from~JPL~PLANETARY~EPHEMERIS:~DE-xxx~+~LE-xxx}\cr
% \+&{$\cdots$}\cr
% \+&\texttt{End~of~Test~output~from~JPL~PLANETARY~EPHEMERIS:~DE-xxx~+~LE-xxx}\cr
\begin{terminalv}
...
% Starlink mods
%\vp
%\texttt{%\+&C~~~~~~~~~~~~~~~~~~~~~~~~'OPEN'~STATEMENT~FOR~BINARY-FORMAT~TAPE\cr
%\+&~~~~~~~~OPEN(9,\cr
%\+&~~~~~*~~~~~~~FILE='EPHTAP',\cr
...
% Starlink mods
% \vp
% \texttt{% \+&\$~ALLOCATE \char123 tape unit\char125 :\cr
