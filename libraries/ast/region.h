...
/* Properties (e.g. methods) specific to this class. */
   ...
   AstFrameSet *(* GetRegFS)( AstRegion * );
   ...
   void (* ShowMesh)( AstRegion *, int, const char * );
   ...
   AstPointSet *(* BndMesh)( AstRegion *, double *, double * );
...
#define astShowMesh(this,format,ttl) astINVOKE(V,astShowMesh_(astCheckRegion(this),format,ttl))
...
#define astBndMesh(this,lbnd,ubnd) astINVOKE(O,astBndMesh_(astCheckRegion(this),lbnd,ubnd))
...
#define astGetRegFS(this) astINVOKE(O,astGetRegFS_(astCheckRegion(this)))
