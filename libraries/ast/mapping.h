...
#define astMAKE_INTERPOLATE_TYPE(abbrev,type) \
typedef int (* AstInterpolate##abbrev)( int, const int *, const int *, \
                                        const type *, const type *, int, \
                                        const int *, \
                                        double *, int, type, type *, type * );
...
#define astRESAMPLE_VTAB_ENTRY(abbrev,type) \
   int (* Resample##abbrev)( AstMapping *, int, const int *, const int *, const type *, const type *, AstInterpolate##abbrev, double, int, int, type, int, const int *, const int *, const int *, const int *, type *, type * );
...
int astResample##abbrev##_( AstMapping *, int, const int *, const int *, const type *, const type *, AstInterpolate##abbrev, double, int, int, type, int, const int *, const int *, const int *, const int *, type *, type * );
...
#define astResampleLD(this,ndim_in,lbnd_in,ubnd_in,in,in_var,method,acc,gridsize,flags,badval,ndim_out,lbnd_out,ubnd_out,lbnd,ubnd,out,out_var) \
astINVOKE(V,astResampleLD_(astCheckMapping(this),ndim_in,lbnd_in,ubnd_in,in,in_var,method,acc,gridsize,flags,badval,ndim_out,lbnd_out,ubnd_out,lbnd,ubnd,out,out_var))
#define astResampleD(this,ndim_in,lbnd_in,ubnd_in,in,in_var,method,acc,gridsize,flags,badval,ndim_out,lbnd_out,ubnd_out,lbnd,ubnd,out,out_var) \
astINVOKE(V,astResampleD_(astCheckMapping(this),ndim_in,lbnd_in,ubnd_in,in,in_var,method,acc,gridsize,flags,badval,ndim_out,lbnd_out,ubnd_out,lbnd,ubnd,out,out_var))
#define astResampleF(this,ndim_in,lbnd_in,ubnd_in,in,in_var,method,acc,gridsize,flags,badval,ndim_out,lbnd_out,ubnd_out,lbnd,ubnd,out,out_var) \
astINVOKE(V,astResampleF_(astCheckMapping(this),ndim_in,lbnd_in,ubnd_in,in,in_var,method,acc,gridsize,flags,badval,ndim_out,lbnd_out,ubnd_out,lbnd,ubnd,out,out_var))
#define astResampleL(this,ndim_in,lbnd_in,ubnd_in,in,in_var,method,acc,gridsize,flags,badval,ndim_out,lbnd_out,ubnd_out,lbnd,ubnd,out,out_var) \
astINVOKE(V,astResampleL_(astCheckMapping(this),ndim_in,lbnd_in,ubnd_in,in,in_var,method,acc,gridsize,flags,badval,ndim_out,lbnd_out,ubnd_out,lbnd,ubnd,out,out_var))
#define astResampleUL(this,ndim_in,lbnd_in,ubnd_in,in,in_var,method,acc,gridsize,flags,badval,ndim_out,lbnd_out,ubnd_out,lbnd,ubnd,out,out_var) \
astINVOKE(V,astResampleUL_(astCheckMapping(this),ndim_in,lbnd_in,ubnd_in,in,in_var,method,acc,gridsize,flags,badval,ndim_out,lbnd_out,ubnd_out,lbnd,ubnd,out,out_var))
#define astResampleI(this,ndim_in,lbnd_in,ubnd_in,in,in_var,method,acc,gridsize,flags,badval,ndim_out,lbnd_out,ubnd_out,lbnd,ubnd,out,out_var) \
astINVOKE(V,astResampleI_(astCheckMapping(this),ndim_in,lbnd_in,ubnd_in,in,in_var,method,acc,gridsize,flags,badval,ndim_out,lbnd_out,ubnd_out,lbnd,ubnd,out,out_var))
#define astResampleUI(this,ndim_in,lbnd_in,ubnd_in,in,in_var,method,acc,gridsize,flags,badval,ndim_out,lbnd_out,ubnd_out,lbnd,ubnd,out,out_var) \
astINVOKE(V,astResampleUI_(astCheckMapping(this),ndim_in,lbnd_in,ubnd_in,in,in_var,method,acc,gridsize,flags,badval,ndim_out,lbnd_out,ubnd_out,lbnd,ubnd,out,out_var))
#define astResampleS(this,ndim_in,lbnd_in,ubnd_in,in,in_var,method,acc,gridsize,flags,badval,ndim_out,lbnd_out,ubnd_out,lbnd,ubnd,out,out_var) \
astINVOKE(V,astResampleS_(astCheckMapping(this),ndim_in,lbnd_in,ubnd_in,in,in_var,method,acc,gridsize,flags,badval,ndim_out,lbnd_out,ubnd_out,lbnd,ubnd,out,out_var))
#define astResampleUS(this,ndim_in,lbnd_in,ubnd_in,in,in_var,method,acc,gridsize,flags,badval,ndim_out,lbnd_out,ubnd_out,lbnd,ubnd,out,out_var) \
astINVOKE(V,astResampleUS_(astCheckMapping(this),ndim_in,lbnd_in,ubnd_in,in,in_var,method,acc,gridsize,flags,badval,ndim_out,lbnd_out,ubnd_out,lbnd,ubnd,out,out_var))
#define astResampleB(this,ndim_in,lbnd_in,ubnd_in,in,in_var,method,acc,gridsize,flags,badval,ndim_out,lbnd_out,ubnd_out,lbnd,ubnd,out,out_var) \
astINVOKE(V,astResampleB_(astCheckMapping(this),ndim_in,lbnd_in,ubnd_in,in,in_var,method,acc,gridsize,flags,badval,ndim_out,lbnd_out,ubnd_out,lbnd,ubnd,out,out_var))
#define astResampleUB(this,ndim_in,lbnd_in,ubnd_in,in,in_var,method,acc,gridsize,flags,badval,ndim_out,lbnd_out,ubnd_out,lbnd,ubnd,out,out_var) \
astINVOKE(V,astResampleUB_(astCheckMapping(this),ndim_in,lbnd_in,ubnd_in,in,in_var,method,acc,gridsize,flags,badval,ndim_out,lbnd_out,ubnd_out,lbnd,ubnd,out,out_var))
