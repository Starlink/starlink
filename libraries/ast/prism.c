...
///* Special Case 1: If the extruded region is a PointList and the extrusion
//   Region is a non-negated, closed, Interval or Box with zero length on 
//   every axis (i.e. a point), then the two Regions can be combined into 
//   a single PointList. Check the Region classes are right. */
