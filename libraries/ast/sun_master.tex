...
Introduced in V7.0.7}

The following describes the most significant changes which have
occurred in the AST library between versions V7.0.6 and V7.0.7 (the
current version):

\begin{enumerate}

\item A new flag AST__NONORM can be used with astRebinSeq<X> to indicate that
