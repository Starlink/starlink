...
problem only occured if the nested structure was loaded from a data
c+
file (using astRead) and happened to be the first instance of that
c-
f+
file (using AST\_READ) and happened to be the first instance of that
f-
class of Object.
