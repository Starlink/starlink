...
c+
\newcommand{\stardocnumber}    {211.14}
c-
f+
\newcommand{\stardocnumber}    {210.14}
f-
\newcommand{\stardocauthors}   {R.F. Warren-Smith \& D.S. Berry}
\newcommand{\stardocdate}      {19th March 2004}
...
The following describes the most significant changes which have
occurred in the AST library between versions V3.1 and V3.2 (the
current version):
