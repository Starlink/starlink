...
c+
\newcommand{\stardocnumber}    {211.23}
c-
f+
\newcommand{\stardocnumber}    {210.23}
f-
\newcommand{\stardocauthors}   {R.F. Warren-Smith \& D.S. Berry}
\newcommand{\stardocdate}      {19th May 2008}
\newcommand{\stardoctitle}     {AST\\
                                A Library for Handling\\
                                World Coordinate Systems\\
                                in Astronomy}
\newcommand{\stardoccopyright} {Copyright (C) 1997-2008 Council for the Central Laboratory of the Research Councils}
...
in the ``ast.h'' header file is set to ``{tt yes}''. If the {tt pthreads}
...
case the AST\_\_THREADSAFE macro will be set to ``{tt no}'' in ast.h. The
...
The following describes the most significant changes which have
occurred in the AST library between versions V4.6 and V5.0 (the
current version):
