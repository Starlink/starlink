...
\newcommand{\stardocdate}      {20th July 2007}
\newcommand{\stardoctitle}     {AST\\
                                A Library for Handling\\
                                World Coordinate Systems\\
                                in Astronomy}
\newcommand{\stardoccopyright} {Copyright (C) 1997-2007 Council for the Central Laboratory of the Research Councils}
...
The following describes the most significant changes which have
occurred in the AST library between versions V4.5 and V4.6 (the
current version):
...
\item The AZEL coordinate system represented by a SkyFrame has been changed
from topocentric horizon coordinates to apparent horizon coordinates.
This means that a correction for diurnal aberration is now included when
