...
use the AST_GRFFUN method as described below.
f-
...
distribution, or the reference documentation for the astGrfFun method.
c-
f+
the reference documentation for the AST_GRFFUN method.
f-
