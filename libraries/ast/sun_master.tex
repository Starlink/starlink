...
with a CmpFrame. If used with a 2-dimensional Frame the returned angle
...
We have seen how geodesic curves and grid lines can be drawn, and the Plot
...
Mapping which maps distance along the curve\footnote{normalized so that
the start of the curve is at ``distance'' of 0.0 and the end of the curve
is at ``distance'' 1.0.}. into the corresponding
position in the current Frame of the Plot. 
c+
astGenCurve,
c- 
f+
