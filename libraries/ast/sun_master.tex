...
\newcommand{\stardocdate}      {27th April 2009}
...
which use a restricted subset of the IVOA Space-Time-Coordinates (STC)
system.

The StcsChan class supports the conversion of suitable AST Objects to and 
from the STC Linear String Implementation (also known as STC-S) described at 
\htmladdnormallink{http://www.ivoa.net/Documents/latest/STC-S.html }{
http://www.ivoa.net/Documents/latest/STC-S.html}. See the description of the 
StcsChan class for further details.

The XmlChan class supports the conversion of AST Objects to and from an
early draft (V1.2) the STC-X XML schema described at \htmladdnormallink{
http://hea-www.harvard.edu/~arots/nvometa/v1.2/STC.html 
}{
http://hea-www.harvard.edu/~arots/nvometa/v1.2/STC.html 
...
StcCatalogEntryLocation or StcObsDataLocation. See the description of the 
XmlChan class and the XmlFormat attribute for further details.
...
Object             - Base class for all AST Objects
   ...
   Channel         - Basic (textual) I/O channel
      ...
      StcsChan     - I/O Channel using STC-S descriptions
...
The following describes the most significant changes occurred in the 
...
The following describes the most significant changes which have
occurred in the AST library between versions V5.1 and V5.2 (the
current version):
