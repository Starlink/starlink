...
\item A bug has been fixed in the Plot3D class that caused a sementation
...
Introduced in V7.0.4}

The following describes the most significant changes which have
occurred in the AST library between versions V7.0.3 and V7.0.4 (the
current version):
