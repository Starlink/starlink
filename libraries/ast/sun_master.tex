...
\newcommand{\stardocdate}      {8th April 1998}
...
between the two values. It indicates that the ``Nin'' value is an
...
when they are written to a Channel) has changed slightly, but remains
