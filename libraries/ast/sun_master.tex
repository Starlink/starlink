...
\newcommand{\stardocdate}      {1th September 2001}
...
c-
f+
The AST\_AXANGLE routine is similar to AST_AXANGLE,
f-
...
The following describes the most significant changes which have
occurred in the AST library between versions V1.7 and V1.8-2 (the
current version):
...
c-
f+
routines (AST_ANGLE, AST_AXANGLE, AST_RESOLVE, AST_OFFSET2, AST_AXOFFSET, 
AST_AXDISTANCE) 
f-
...
c-
f+
AST_BEAR routine has been replaced by AST_AXANGLE.
f-
