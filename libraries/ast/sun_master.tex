...
\item A bug has been fixed in the FitsChan class that prevented an error
being reported if any FITS keyword names containing illegal characters
(i.e. not allowed by the FITS standard) are encountered. This bug could
under some circumstances cause a subsequent segmentation violation to
occur.
