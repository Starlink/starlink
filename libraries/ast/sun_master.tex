...
\newcommand{\stardocdate}      {25th February 2003}
...
The default value for its Domain attribute is ``CMP'' and the
(fixed) value for its System attribute is ``Compound''. A CmpFrame has no 
extra attributes over and above those common to all Frames. However,
