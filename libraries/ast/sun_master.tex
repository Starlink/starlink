...
c+
\newcommand{\stardocnumber}    {211.20}
c-
f+
\newcommand{\stardocnumber}    {210.20}
f-
\newcommand{\stardocauthors}   {R.F. Warren-Smith \& D.S. Berry}
\newcommand{\stardocdate}      {16th June 2005}
...
(\xref{SUN/67}{sun67}{}) is required. Even here, the minimal required
slalib code is included with the AST distribution, and is built as part
of building the AST library. Alternatively, you have the choice of
linking against an external, full version of SLALIB; either the Fortran 
version available from Starlink or the C version available from tpoint.
...
\item[ClockLon]\mbox{}\\
Specifies the longitude of the observer's clock (assumed to be on the surface 
of the earth). This is needed when converting between certain time scales.

\item[ClockLat]\mbox{}\\
Specifies the latitude of the observer's clock. Use in conjunction with
ClockLon.
...
The following describes the most significant changes which have
occurred in the AST library between versions V3.6 and V3.7 (the
current version):
