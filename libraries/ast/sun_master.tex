...
c+
\newcommand{\stardocnumber}    {211.15}
c-
f+
\newcommand{\stardocnumber}    {210.15}
f-
\newcommand{\stardocauthors}   {R.F. Warren-Smith \& D.S. Berry}
\newcommand{\stardocdate}      {15th June 2004}
...
\htmladdnormallink{http://www.starlink.ac.uk/$
...
The following describes the most significant changes which have
occurred in the AST library between versions V3.2 and V3.3 (the
current version):
