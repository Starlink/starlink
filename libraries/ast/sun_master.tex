...
\newcommand{\stardocdate}      {15th August 2005}
...
The following describes the most significant changes which have
occurred in the AST library between versions V4.0 and V4.1 (the
current version):
...
c-
f+
AST_PAR. These specify kernels for AST\_RESAMPLE and AST\_REBIN
f-
