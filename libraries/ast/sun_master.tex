...
pointers), and can then annul the pointer using astAnnul.
...
\item The PointList class has two new methods, 
c+
...
f-
that allow a Region that encloses the points to be associated with the 
PointList.
