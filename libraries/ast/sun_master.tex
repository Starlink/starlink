...
c+
\newcommand{\stardocnumber}    {211.18}
c-
f+
\newcommand{\stardocnumber}    {210.18}
f-
\newcommand{\stardocauthors}   {R.F. Warren-Smith \& D.S. Berry}
\newcommand{\stardocdate}      {17th January 2005}
...
The following describes the most significant changes which have
occurred in the AST library between versions V3.4 and V3.5 (the
current version):
