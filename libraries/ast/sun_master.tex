...
c+
\newcommand{\stardocnumber}    {211.22}
c-
f+
\newcommand{\stardocnumber}    {210.22}
f-
\newcommand{\stardocauthors}   {R.F. Warren-Smith \& D.S. Berry}
\newcommand{\stardocdate}      {14th February 2006}
...
The following describes the most significant changes which have
occurred in the AST library between versions V4.1 and V4.2 (the
current version):
...
parameters. At the moment there is only one such parameter, called
``ObjectCaching'', which causes AST to save unused Object memory in a
pool for later use rather than freeing it.
