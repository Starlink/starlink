...
\newcommand{\stardocdate}      {23rd October 2001}
...
Introduced in V1.8-5}

The following describes the most significant changes which have
occurred in the AST library between versions V1.8-4 and V1.8-5 (the
current version):
...
axes together, using graphical elements Axes, NumLabs, TextLabs and
Ticks.
