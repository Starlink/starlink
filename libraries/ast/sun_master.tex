...
c+
\newcommand{\stardocnumber}    {211.24}
c-
f+
\newcommand{\stardocnumber}    {210.24}
f-
\newcommand{\stardocauthors}   {R.F. Warren-Smith \& D.S. Berry}
\newcommand{\stardocdate}      {2nd December 2008}
...
\item The AST__UNDEF<X> parameters used to flag undefined FITS keyword values
