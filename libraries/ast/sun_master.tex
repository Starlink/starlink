...
c+
\newcommand{\stardocnumber}    {211.19}
c-
f+
\newcommand{\stardocnumber}    {210.19}
f-
\newcommand{\stardocauthors}   {R.F. Warren-Smith \& D.S. Berry}
\newcommand{\stardocdate}      {21st April 2005}
...
as a SkyFrame for celestial coordinates, or a SpecFrame for spectral
coordinates, or a CmpFrame for a combination of different coordinates.
...
The following describes the most significant changes which have
occurred in the AST library between versions V3.5 and V3.6 (the
current version):
