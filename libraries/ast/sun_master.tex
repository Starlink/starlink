...
\newcommand{\stardocdate}      {16th September 2004}
...
value includes a precision of ``\verb+.*+'', then Digits will be used to
...
includes a precision of ``\verb+.*+'', then Digits will be used to determine 
