...
\newcommand{\stardocdate}      {29th June 2006}
...
The following describes the most significant changes which have
occurred in the AST library between versions V4.2 and V4.3 (the
current version):
...
AST\_GETFITSS
f-
function now strips trailing white space from the returned string
