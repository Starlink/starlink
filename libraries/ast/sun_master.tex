...
\newcommand{\stardocdate}      {1st October 2003}
...
\item The SphMap class has a new attribute caller PolarLong which gives the 
...
FITS keyword values), and "Distortion" (which gives warnings about
unsupported distortion codes within CTYPE values).
