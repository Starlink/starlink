...
c+
\newcommand{\stardocnumber}    {211.21}
c-
f+
\newcommand{\stardocnumber}    {210.21}
f-
\newcommand{\stardocauthors}   {R.F. Warren-Smith \& D.S. Berry}
\newcommand{\stardocdate}      {24th June 2005}
...
The other is a subset of the IVOA Space-Time-Coordinates (STC) schema
...
The following describes the most significant changes which have
occurred in the AST library between versions V3.7 and V4.0 (the
current version):

\begin{enumerate}

\item Experimental support for reading IVOA Space-Time-Coordinates (STC)
descriptions using the XmlChan class has been added. 
