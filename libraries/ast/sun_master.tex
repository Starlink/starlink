...
\item The Region class has two new methods, 
c+
astSetEnclosure and astGetEnclosure,
c-
f+
AST\_SETENCLOSURE and AST\_GETENCLOSURE,
f-
that allow two Regions to be associated together. It is expected that this 
will be used to indicate that one Region encloses another, but this is not 
enforced.
