...
\sstroutine{
   ...
   \sstdescription{
      ...
      implements your own (see astInterpolate as an example).
   ...
   \sstsynopsis{
      int astResample$<$X$>$( AstMapping $*$this, int ndim\_in,
                          ...
                          int flags, $<$Xtype$>$ badval, int ndim\_out,
...
\sstroutine{
   ...
   \sstnotes{
      \sstitemlist{
         ...
         This will cause an immediate return from astResample$<$X$>$.
      }
   }
}
\sstroutine{
   ...
   \sstparameters{
      ...
      \sstsubsection{
         ...
         but note that params[0] will already have been used to specify
      ...
      \sstsubsection{
         ...
         Pointer to a double to receive the calculated kernal value,
