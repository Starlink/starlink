...
these grid lines will not be geodesics, so \htmlref{astCurve}{astCurve}
...
\sstroutine{
   ...
   \sstdiytopic{
      ...
      \sstitemlist{
         ...
         \sstitem
         Curves: Geodesic curves drawn using astCurve
...
\sstroutine{
   ...
   \sstexamples{
      \sstexamplesubsection{
         ...
         Links an ADAM program ``display'' which uses PGPLOT for graphical
         output. (If the program is written in C, it should, following ADAM
         conventions, be a Fortran-callable routine and be pre-compiled
         before using ``alink'' to link it.)
      }
      \sstexamplesubsection{
...
a compound \htmlref{Mapping}{Mapping} which is being simplified using \htmlref{astSimplify}{astSimplify}.
