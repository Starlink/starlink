...
\sstroutine{
   ...
   \sstdiytopic{
      ...
      the {\tt{"}}params{\tt{"}} array should be used to specify how many pixels are
      ...
      In these cases, the {\tt{"}}finterp{\tt{"}} parameter is not used:
      ...
      \sstitemlist{
         ...
         each side of the interpolation point (the {\tt{"}}params{\tt{"}} array is
