...
distribution, or the reference documentation for the astSetGrfFun method.
...
\sstroutine{
   ...
   \sstparameters{
      ...
      \sstsubsection{
         ...
         Six graphics functions are used in total by the
         ...
         six graphics functions are not replaced in this way, the
