...
operations and function invocations similar to those available in
Fortran (the \htmlref{MathMap}{MathMap}).
...
mathematical functions similar to those provided in Fortran.
