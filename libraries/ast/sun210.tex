...
\newcommand{\stardocdate}      {12th November 1998}
...
\sstroutine{
   ...
   \sstdiytopic{
      ...
      \sstitemlist{
         ...
         {\tt{"}}World Coordinate Systems Representations Within the FITS Format{\tt{"}}
         ...
         details, see the section {\tt{"}}The FITS-IRAF Encoding{\tt{"}} below.
   ...
   \sstdiytopic{
      ...
      \sstitemlist{
         ...
         \sstitem
         Otherwise, if the FitsChan contains a keyword of the form {\tt{"}}CDi\_j{\tt{"}}
         or {\tt{"}}CDiiijjj{\tt{"}}, where i and j are single digits, then FITS-IRAF
         encoding is used,
   ...
   \sstdiytopic{
      ...
      \sstitemlist{
         ...
         encoding. When writing a FrameSet, only the \htmlref{Base}{Base} and \htmlref{Current}{Current} Frames
      ...
      rotations are specified by a matrix of keywords of the form CDi\_j
      where {\tt{"}}i{\tt{"}} is the index of a pixel axis and {\tt{"}}j{\tt{"}} is the axis of a
...
\item The \htmlref{FitsChan}{FitsChan} class is now more tolerant of common minor
...
to think that conversion between a \htmlref{CmpFrame}{CmpFrame} and another \htmlref{Frame}{Frame} was
