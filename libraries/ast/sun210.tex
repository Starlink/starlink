...
\newcommand{\stardocnumber}    {210.4}
\newcommand{\stardocauthors}   {R.F. Warren-Smith \& D.S. Berry}
\newcommand{\stardocdate}      {4th June 1999}
...
\item[Digits or Digits(axis)]\mbox{}\\
...
Domain value for a \htmlref{SkyFrame}{SkyFrame} is SKY. Since there is
only one sky, you probably won't need to change this very often.
\end{description}
\end{quote}
...
\subsection{\xlabel{changes}\xlabel{list_of_most_recent_changes}Changes Introduced in V1.3}

The following describes the most significant changes which have
occurred in the AST library between versions V1.2 and V1.3 (the
current version):
