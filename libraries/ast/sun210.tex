...
\sstroutine{
   ...
   \sstdescription{
      ...
      implements your own (see AST\_INTERPOLATE as an example).
...
\sstroutine{
   ...
   \sstnotes{
      \sstitemlist{
         ...
         cause an immediate return from AST\_RESAMPLE$<$X$>$.
      }
   }
}
\sstroutine{
