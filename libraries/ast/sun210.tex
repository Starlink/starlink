...
\newcommand{\stardocdate}      {24th March 1998}
\newcommand{\stardoctitle}     {AST\\
                                A Library for Handling\\
                                World Coordinate Systems\\
                                in Astronomy}
\newcommand{\stardoccopyright} {Copyright (C) 1997 Central Laboratory of the Research Councils}
...
between the two values. It indicates that the ``\htmlref{Nin}{Nin}'' value is an
...
\item The textual representation used for some Objects ({\em{i.e.}}\
when they are written to a \htmlref{Channel}{Channel}) has changed slightly, but remains
compatible with earlier versions of AST.
