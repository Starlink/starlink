...
\newcommand{\stardocnumber}    {210.6}
\newcommand{\stardocauthors}   {R.F. Warren-Smith \& D.S. Berry}
\newcommand{\stardocdate}      {2nd April 2000}
\newcommand{\stardoctitle}     {AST\\
                                A Library for Handling\\
                                World Coordinate Systems\\
                                in Astronomy}
\newcommand{\stardoccopyright} {Copyright (C) 2000 Central Laboratory of the Research Councils}
\newcommand{\stardoctitlehtml} {AST - A Library for Handling World Coordinate
                                      Systems in Astronomy}
\newcommand{\stardocversion}   {V1.5}
...
occurred in the AST library between versions V1.4 and V1.5 (the
current version):
...
\item [FITS-PC] This encoding uses the conventions of the now superceded
FITS WCS paper by E.W.\,Greisen and M.\,Calabretta which used keywords
{\tt CDELTj} abd {\tt PCjjjiii} to describe axis scaling and rotation.
...
posible: FrameSets originally read from a FITS-WCS encoded FITS header
...
now depracated in favour of the new PVj\_m attributes. They are interpreted 
