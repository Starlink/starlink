...
*        associated with the boundary of the Circle being created. The 
*        uncertainty in any point on the boundary of the Circle is found by 
...
*        pointer will have no effect on the created Circle. Alternatively, 
f        a null Object pointer (AST__NULL) 
c        a NULL Object pointer 
*        may be supplied, in which case a default uncertainty is used 
*        equivalent to a Box 1.0E-6 of the size of the bounding box of
*        the Circle being created.
*
