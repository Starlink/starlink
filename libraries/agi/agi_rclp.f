************************************************************************
      ...
      SUBROUTINE AGI_RCLP ( PNAME, X, Y, PICID, STATUS )
...
*   Find a picture of that name starting from the last picture.
         CALL AGI_1SEARP( WKNAME, PNAME, 'L', 'B', PICNUM, OPNAME,
...
*   Have to decrement picnum before starting search again.
     ...
     :          ( DY .GT. DEVICE( 4 ) + SFA ) ) ) THEN
            PICNUM = PICNUM - 1
            CALL AGI_1SEARP( WKNAME, PNAME, 'P', 'B', PICNUM, OPNAME,
     :                       COMENT, DEVICE, NDC, WORLD, MEMID, STATUS )
            GOTO 10
         ENDIF
