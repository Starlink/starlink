************************************************************************
      ...
      SUBROUTINE AGI_RCPP( PNAME, PSTART, X, Y, PICID, STATUS )
...
*   Flag an eror if the starting identifier is improper
         ELSE
            STATUS = AGI__IMPID
            CALL ERR_REP( 'AGI_RCPP_IMPID',
