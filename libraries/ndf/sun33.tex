...
\sstroutine{
   ...
   \sstdescription{
      The routine creates a new NDF holding {\tt "}delta{\tt "} compressed copies of
...
\subsection{\xlabel{list_of_most_recent_changes}Changes Introduced in V1.11}

The following describes the most significant changes which occurred in
the NDF\_ system between versions V1.10 and V1.11 (the current version):
