...
void ndf1Adump( int iax, NdfACB *acb, int *status ){
/*
*+
*  Name:
*     ndf1Adump
...
*  Description:
*     This function unmaps an NDF axis data array which has previously been
*     mapped for access with the ndf1Admap function. An error will be
*     reported if the specified axis array is not currently mapped for
*     access. The NDF is identified by its index in the ACB.

*  Parameters:
*     iax
*        Zero-based index of the axis whose data array is to be unmapped.
*     acb
