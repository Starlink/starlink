...
F77_POINTER_FUNCTION(cnf_preg)( void ** );
...
F77_POINTER_FUNCTION(cnf_preg)( void ** locptr ) {
/*
*+
*  Name:
*     CNF_PREG
...
*     - Do not use this in a function call. The 0 return value
...
*     - The pointer should be unregistered using CNF_UPREG
