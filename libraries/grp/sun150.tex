...
\newcommand{\stardocsource}    {sun150.10}
\newcommand{\stardocnumber}    {150.10}
\newcommand{\stardocauthors}   {D.S. Berry}
\newcommand{\stardocdate}      {20th October 2012}
\newcommand{\stardoctitle}     {GRP \\ [1ex]
                                Routines for Managing Groups of Objects}
\newcommand{\stardocversion}   {Version 3.7}
...
\sstroutine{
   ...
   \sstdescription{
      ...
      to be called by the user. It{\tt '}s main purpose is to provide a break
   ...
   \sstarguments{
      ...
      \sstsubsection{
         ...
         This will be {\tt "}CREATE{\tt "} or {\tt "}DELETE{\tt "}.
      }
      \sstsubsection{
...
\sstroutine{
   ...
   \sstdescription{
      If the group identified by IGRP1 has had a {\tt "}slave{\tt "} group
...
\sstroutine{
   ...
   \sstarguments{
      \sstsubsection{
         ...
         The identifier for the group to be watched. If this is GRP\_\_NOID,
         the identifiers of all currently active groups are listed on
         standard output. NOTE, in the C interface this should be an
         integer (or GRP\_\_NOID), not a pointer to a Grp structure.
      }
      \sstsubsection{
         STATUS = INTEGER (Given and Returned)
      }{
