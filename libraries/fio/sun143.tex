...
\stardocnumber      {143.4}
\stardocauthors     {P M Allan \\ A J Chipperfield}
\stardocdate        {20 July 2001}
\stardoctitle     {FIO/RIO \\ [1ex]
                                FORTRAN file I/O routines}
\stardocversion     {Version 1.5}
...
\end{terminalv}
% verbatim is necessary to get the ^ to come out right.
...
\sstroutine{
   ...
   \sstexamples{
      \sstexamplesubsection{
         CALL FIO\_REP( UNIT, \texttt{' '}, IOSTAT, \texttt{' '}, STATUS )
      }{
      ...
      \sstexamplesubsection{
         CALL FIO\_REP( UNIT, \texttt{' '}, IOSTAT,
