...
Rather than using the WCS routines distributed with FITSIO, it is
...
world coordinates can be derived.  Programmers may use FITSIO to read
the header keywords and construct a long character array containing
all the keywords.  This character array can then be passed to the
WCS library routine.
