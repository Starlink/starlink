...
MANIFEST = false
ACLOCAL = perllibdir=/tmp/norman/merge/thirdparty/fsf/automake"/lib:./lib" /tmp/norman/merge/thirdparty/fsf/automake/aclocal --acdir=m4
AMTAR = ${SHELL} /tmp/norman/merge/thirdparty/fsf/automake/lib/missing --run tar
APIVERSION = 1.9
AUTOCONF = ${SHELL} /tmp/norman/merge/thirdparty/fsf/automake/lib/missing --run autoconf
AUTOHEADER = ${SHELL} /tmp/norman/merge/thirdparty/fsf/automake/lib/missing --run autoheader
AUTOMAKE = perllibdir=/tmp/norman/merge/thirdparty/fsf/automake"/lib:./lib" /tmp/norman/merge/thirdparty/fsf/automake/automake --libdir=lib
AWK = mawk
CYGPATH_W = echo
...
LN = ln
LTLIBOBJS = 
MAKEINFO = ${SHELL} /tmp/norman/merge/thirdparty/fsf/automake/lib/missing --run makeinfo
...
infodir = ${prefix}/info
install_sh = /tmp/norman/merge/thirdparty/fsf/automake/lib/install-sh
...
prefix = /tmp/norman/merge/STAR/buildsupport/bin
...
.PHONY: $(RECURSIVE_TARGETS) CTAGS GTAGS all all-am am--refresh check \
	...
	install-info install-info-am install-man install-manifest \
