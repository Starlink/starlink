...
* E.S.O. - VLT project
* 
* "@(#) $Id: rtdServer.C,v 1.2 2005/02/02 01:43:03 brighton Exp $"
* 
*  rtdServer.C
* 
* who          when      what
...
*/
static const char* const rcsId="@(#) $Id: rtdServer.C,v 1.2 2005/02/02 01:43:03 brighton Exp $";
...
#define RTD_DELAY 5     // default time to sleep before new events are read
