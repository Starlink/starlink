...
* E.S.O. - VLT project 
*
* "@(#) $Id: rtdImageEvent.h,v 1.9 1998/07/22 19:56:49 abrighto Exp $"
*
* rtdImageEvent.h
*
* who        when      what
...
* P.Biereichel 17/6/97 Added function prototype for rtdClose()
*/
/*************************************************************************
 *
 *
 ...
 * DEFINES
 */
#define RTD_EVT_VERSION   2 /* increment when the rtdIMAGE_INFO is not backwards compatible */
...
typedef struct {
    ...
    int               reserved[9];  /* reserved for future use */
