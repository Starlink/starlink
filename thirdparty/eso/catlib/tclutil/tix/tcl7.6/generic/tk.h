 ...
 *
 *     RCS:  $Id: tk.h,v 1.1.1.1 2002/04/04 20:12:00 brighton Exp $
 * ========================================================================
...
EXTERN void Itk_SetWidgetCommand _ANSI_ARGS_((Tk_Window tkwin,
    Tcl_Command cmd));
#define Itk_GetWidgetCommand(tkwin) (((Tk_FakeWin*)(tkwin))->widgetCmd)

EXTERN void Itk_SetMegaWidget _ANSI_ARGS_((Tk_Window tkwin,
    Tk_Window megawin));
#define Itk_GetMegaWidget(tkwin) (((Tk_FakeWin*)(tkwin))->megaPtr)
