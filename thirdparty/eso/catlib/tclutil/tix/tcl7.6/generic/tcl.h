 ...
 *
 *     RCS:  $Id: tcl.h,v 1.1.1.1 2002/04/04 20:12:00 brighton Exp $
 * ========================================================================
...
#   endif
#   if defined(_MSC_VER)
#	define TCL_EXPORT(a) __declspec(dllexport) a
#   else
#	if defined(__BORLANDC__)
#	    define TCL_EXPORT(a) a _export
#	endif
#   endif
#endif /* __WIN32__ */

#ifndef TCL_EXPORT
#   define TCL_EXPORT(a) a
#endif
 ...
 *
 * ITCL_FIND_DENY_ACCESS
 *   make it an error to access "private" and "protected" items
 *   during variable lookup.  Otherwise, access is quietly
 *   denied by returning a null pointer.
 *
 ...
 */
#define ITCL_FIND_LOCAL_ONLY    0x010
#define ITCL_FIND_NO_PRIVACY    0x020
#define ITCL_FIND_AUTO_CREATE   0x040
#define ITCL_FIND_NAMESP        0x080
#define ITCL_FIND_DENY_ACCESS   0x100
...
EXTERN int Itcl_NamespVarEval _ANSI_ARGS_(TCL_VARARGS(Tcl_Interp, *interp));
