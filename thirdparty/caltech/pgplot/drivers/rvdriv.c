 ...
 * C wrapper routine to call rvdriv() or rvdriv_().
 */
#ifdef PG_PPU
#define RVDRIV rvdriv_
#else
#define RVDRIV rvdriv
#endif

/*.......................................................................
 * This is a stub version of the Rivet-Tk PGPLOT widget device driver to
 ...
 */
#ifdef VMS
void rvdriv(ifunc, rbuf, nbuf, chrdsc, lchr)
     int *ifunc;
     float rbuf[];
     int *nbuf;
...
#else
void RVDRIV(ifunc, rbuf, nbuf, chr, lchr, len)
 int   *ifunc, *nbuf, *lchr;
 int   len;
 float rbuf[];
 char  *chr;
...
/*--- IFUNC=1, Return device name ---------------------------------------*/
  ...
  case 1:
    ...
    *lchr = 0;
    break;
  default:
    fprintf(stderr, "/XRV: Unexpected opcode=%d in stub driver.\n", *ifunc);
    *nbuf = -1;
    break;
  };
  return;
