...
* Modified by P.T.Wallace, Starlink, 12 November 1991, to avoid
* floating point overflow problems.  See code marked '!'.
...
*****************************************************
*
*  Fix by P.T.Wallace, Starlink, for "floating point
*  overflow when axis ends are both enormous or
*  both tiny" problem.
*
...
*
*  Modified version:
      IF ((VBGM.LT.0.0.AND.VNDP.GT.0.0).OR.
     :    (VBGM.GT.0.0.AND.VNDP.LT.0.0)) GO TO 201
*
*****************************************************
...
***********************************************
*
*  Fix by PTW, Starlink, for "misses
*  first axis label at random" bug.
*
*  Original NCAR version
*     EXMU=EXMU-AMOD(EXMU,1.)+.5+SIGN(.5,EXMU)
*
*  Modified version:
      IF (AMOD(EXMU,1.).NE.0.) EXMU=AINT(EXMU)+.5+SIGN(.5,EXMU)
*
***********************************************
C
...
********************************************
*
*  Fix by PTW, Starlink, for "missing ticks
*  near zero on small plots" bug.
*
*  Original NCAR version:
