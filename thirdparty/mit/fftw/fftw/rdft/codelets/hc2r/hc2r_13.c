...
/* Generated on Sun Jul  2 16:15:54 EDT 2006 */

#include "codelet-rdft.h"

#ifdef HAVE_FMA

/* Generated by: ../../../genfft/gen_hc2r -fma -reorder-insns -schedule-for-pipeline -compact -variables 4 -pipeline-latency 4 -sign 1 -n 13 -name hc2r_13 -include hc2r.h */

/*
 * This function contains 76 FP additions, 58 FP multiplications,
 * (or, 18 additions, 0 multiplications, 58 fused multiply/add),
 * 76 stack variables, and 26 memory accesses
 */
/*
 * Generator Id's : 
...
static void hc2r_13(const R *ri, const R *ii, R *O, stride ris, stride iis, stride os, INT v, INT ivs, INT ovs)
{
     ...
     for (i = v; i > 0; i = i - 1, ri = ri + ivs, ii = ii + ivs, O = O + ovs, MAKE_VOLATILE_STRIDE(ris), MAKE_VOLATILE_STRIDE(iis), MAKE_VOLATILE_STRIDE(os)) {
	  ...
	  Tr = FMA(KP1_033041561, Tq, Tl);
	  {
	       ...
	       O[WS(os, 8)] = FMA(KP1_200954543, T1e, T1d);
	       O[WS(os, 5)] = FNMS(KP1_200954543, T1e, T1d);
	       O[WS(os, 12)] = FMA(KP1_200954543, TO, Tr);
	       O[WS(os, 1)] = FNMS(KP1_200954543, TO, Tr);
	       {
		    E T1b, T15, T11, TT;
		    ...
		    TT = FNMS(KP1_150281458, TS, TR);
		    {
			 ...
			 O[WS(os, 11)] = FMA(KP1_150281458, T1c, T1b);
			 O[WS(os, 6)] = FNMS(KP1_150281458, T1c, T1b);
			 O[WS(os, 7)] = FMA(KP1_150281458, T1a, T15);
			 O[WS(os, 2)] = FNMS(KP1_150281458, T1a, T15);
			 O[WS(os, 10)] = FMA(KP1_040057143, T12, T11);
			 O[WS(os, 4)] = FNMS(KP1_040057143, T12, T11);
			 O[WS(os, 9)] = FMA(KP1_040057143, T10, TT);
			 O[WS(os, 3)] = FNMS(KP1_040057143, T10, TT);
		    }
	       }
	  }
     }
...
static const khc2r_desc desc = { 13, "hc2r_13", {18, 0, 58, 0}, &GENUS, 0, 0, 0, 0, 0 };
...
/* Generated by: ../../../genfft/gen_hc2r -compact -variables 4 -pipeline-latency 4 -sign 1 -n 13 -name hc2r_13 -include hc2r.h */
