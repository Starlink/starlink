...
/* Generated on Sun Jul  2 14:19:11 EDT 2006 */

#include "codelet-rdft.h"

#ifdef HAVE_FMA

/* Generated by: ../../../genfft/gen_r2hc -fma -reorder-insns -schedule-for-pipeline -compact -variables 4 -pipeline-latency 4 -n 13 -name r2hc_13 -include r2hc.h */

/*
 * This function contains 76 FP additions, 51 FP multiplications,
 * (or, 31 additions, 6 multiplications, 45 fused multiply/add),
 * 68 stack variables, and 26 memory accesses
 */
/*
 * Generator Id's : 
...
static void r2hc_13(const R *I, R *ro, R *io, stride is, stride ros, stride ios, INT v, INT ivs, INT ovs)
{
     ...
     for (i = v; i > 0; i = i - 1, I = I + ivs, ro = ro + ovs, io = io + ovs, MAKE_VOLATILE_STRIDE(is), MAKE_VOLATILE_STRIDE(ros), MAKE_VOLATILE_STRIDE(ios)) {
	       ...
	       ro[0] = TN + TS;
	       {
		    ...
		    TW = TU + TV;
		    {
			 ...
			 Ty = FMA(KP612264650, Tx, Tw);
			 {
			      ...
			      io[WS(ios, 1)] = KP600477271 * (FMA(KP957805992, TE, Tz));
			      TJ = FMA(KP522026385, TH, TI);
			      io[WS(ios, 5)] = -(KP600477271 * (FNMS(KP957805992, TI, TH)));
			      io[WS(ios, 4)] = -(KP575140729 * (FMA(KP904176221, TM, TL)));
			      io[WS(ios, 3)] = KP575140729 * (FNMS(KP904176221, TM, TL));
			      io[WS(ios, 6)] = KP575140729 * (FMA(KP904176221, TK, TJ));
			      io[WS(ios, 2)] = KP575140729 * (FNMS(KP904176221, TK, TJ));
	  ...
	  }
	  {
	       ...
	       ro[WS(ros, 1)] = FMA(KP516520780, T16, T11);
	       ro[WS(ros, 5)] = FNMS(KP516520780, T16, T11);
	       ro[WS(ros, 2)] = FMA(KP503537032, T1e, T1d);
	       ro[WS(ros, 6)] = FNMS(KP503537032, T1e, T1d);
	       ro[WS(ros, 3)] = FMA(KP503537032, T1c, T19);
	       ro[WS(ros, 4)] = FNMS(KP503537032, T1c, T19);
	  }
     }
}

static const kr2hc_desc desc = { 13, "r2hc_13", {31, 6, 45, 0}, &GENUS, 0, 0, 0, 0, 0 };
...
/* Generated by: ../../../genfft/gen_r2hc -compact -variables 4 -pipeline-latency 4 -n 13 -name r2hc_13 -include r2hc.h */
