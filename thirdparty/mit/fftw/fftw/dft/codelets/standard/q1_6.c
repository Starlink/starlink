...
/* Generated on Sat Jul  1 14:19:08 EDT 2006 */
 ...
 * 129 stack variables, and 144 memory accesses
 */
/*
 * Generator Id's : 
...
static const R *q1_6(R *rio, R *iio, const R *W, stride is, stride vs, INT m, INT dist)
{
     ...
     INT i;
     for (i = m; i > 0; i = i - 1, rio = rio + dist, iio = iio + dist, W = W + 10, MAKE_VOLATILE_STRIDE(is), MAKE_VOLATILE_STRIDE(vs)) {
			 ...
			 E T1b, T1g, T1c, T18, T19;
			 {
			      ...
			      }
			      {
				   ...
				   }
				   {
					...
					TO = Tk + Tl;
					Tm = Tk - Tl;
					T16 = rio[WS(vs, 1) + WS(is, 3)];
					T1b = rio[WS(vs, 1) + WS(is, 4)];
					TU = TN + TO;
					TP = TN - TO;
					Tu = Tj + Tm;
					Tn = Tj - Tm;
					...
					TJ = Tt + Tu;
					Tv = FNMS(KP500000000, Tu, Tt);
					T1c = rio[WS(vs, 1) + WS(is, 1)];
					T18 = rio[WS(vs, 1) + WS(is, 2)];
					T19 = rio[WS(vs, 1) + WS(is, 5)];
				   }
			      }
			 }
			 {
			      E T1v, T1R, T1n, T1w, T1o, T1p;
			      {
				   ...
				   T1l = iio[WS(vs, 1) + WS(is, 2)];
				   T1i = T1b - T1c;
				   T1d = T1b + T1c;
				   T1h = T18 - T19;
				   T1a = T18 + T19;
				   T1m = iio[WS(vs, 1) + WS(is, 5)];
				   T1v = iio[WS(vs, 1)];
				   T1j = T1h + T1i;
				   T1A = T1i - T1h;
				   T1e = T1a + T1d;
				   ...
				   T1w = iio[WS(vs, 1) + WS(is, 3)];
				   T1o = iio[WS(vs, 1) + WS(is, 4)];
				   T1p = iio[WS(vs, 1) + WS(is, 1)];
			      }
			      {
				   E T2z, T2V, T2r, T2A, T2s, T2t;
				   {
					E T2p, T1x, T1S, T1q, T2q, T1y;
					T2p = iio[WS(vs, 2) + WS(is, 2)];
					T1X = T1v + T1w;
					T1x = T1v - T1w;
					T1S = T1o + T1p;
					T1q = T1o - T1p;
					T2q = iio[WS(vs, 2) + WS(is, 5)];
					T2z = iio[WS(vs, 2)];
					T1Y = T1R + T1S;
					T1T = T1R - T1S;
					T1y = T1n + T1q;
					...
					T1N = T1x + T1y;
					T1z = FNMS(KP500000000, T1y, T1x);
					T2A = iio[WS(vs, 2) + WS(is, 3)];
					T2s = iio[WS(vs, 2) + WS(is, 4)];
					T2t = iio[WS(vs, 2) + WS(is, 1)];
				   }
				   {
					...
					T2W = T2s + T2t;
					T2u = T2s - T2t;
					T2a = rio[WS(vs, 2) + WS(is, 3)];
					T2f = rio[WS(vs, 2) + WS(is, 4)];
					T32 = T2V + T2W;
					T2X = T2V - T2W;
					T2C = T2r + T2u;
					T2v = T2r - T2u;
					...
					T2g = rio[WS(vs, 2) + WS(is, 1)];
					T2c = rio[WS(vs, 2) + WS(is, 2)];
					T2d = rio[WS(vs, 2) + WS(is, 5)];
				   }
			      }
			 }
		    }
		    {
			 E T4n, T4s, T4o, T4k, T4l;
			 {
			      E T3j, T3o, T3k, T3g, T3h;
			      {
				   ...
				   T2l = T2c - T2d;
				   T2e = T2c + T2d;
				   T3e = rio[WS(vs, 3) + WS(is, 3)];
				   T3j = rio[WS(vs, 3) + WS(is, 4)];
				   T2n = T2l + T2m;
				   T2E = T2m - T2l;
				   T2i = T2e + T2h;
				   T34 = T2h - T2e;
				   ...
				   T3k = rio[WS(vs, 3) + WS(is, 1)];
				   T3g = rio[WS(vs, 3) + WS(is, 2)];
				   T3h = rio[WS(vs, 3) + WS(is, 5)];
			      }
			      {
				   E T3D, T3Z, T3v, T3E, T3w, T3x;
				   {
					E T3t, T3q, T3l, T3p, T3i, T3u, T3r;
					T3t = iio[WS(vs, 3) + WS(is, 2)];
					T3q = T3j - T3k;
					T3l = T3j + T3k;
					T3p = T3g - T3h;
					T3i = T3g + T3h;
					T3u = iio[WS(vs, 3) + WS(is, 5)];
					T3D = iio[WS(vs, 3)];
					T3r = T3p + T3q;
					T3I = T3q - T3p;
					T3m = T3i + T3l;
					...
					T3E = iio[WS(vs, 3) + WS(is, 3)];
					T3w = iio[WS(vs, 3) + WS(is, 4)];
					T3x = iio[WS(vs, 3) + WS(is, 1)];
				   }
				   {
					...
					T40 = T3w + T3x;
					T3y = T3w - T3x;
					T4i = rio[WS(vs, 4) + WS(is, 3)];
					T4n = rio[WS(vs, 4) + WS(is, 4)];
					T46 = T3Z + T40;
					T41 = T3Z - T40;
					T3G = T3v + T3y;
					T3z = T3v - T3y;
					...
					T4o = rio[WS(vs, 4) + WS(is, 1)];
					T4k = rio[WS(vs, 4) + WS(is, 2)];
					T4l = rio[WS(vs, 4) + WS(is, 5)];
				   }
			      }
			 }
			 {
			      E T4H, T53, T4z, T4I, T4A, T4B;
			      {
				   ...
				   T4x = iio[WS(vs, 4) + WS(is, 2)];
				   T4u = T4n - T4o;
				   T4p = T4n + T4o;
				   T4t = T4k - T4l;
				   T4m = T4k + T4l;
				   T4y = iio[WS(vs, 4) + WS(is, 5)];
				   T4H = iio[WS(vs, 4)];
				   T4v = T4t + T4u;
				   T4M = T4u - T4t;
				   T4q = T4m + T4p;
				   ...
				   T4I = iio[WS(vs, 4) + WS(is, 3)];
				   T4A = iio[WS(vs, 4) + WS(is, 4)];
				   T4B = iio[WS(vs, 4) + WS(is, 1)];
			      }
			      {
				   E T5L, T67, T5D, T5M, T5E, T5F;
				   {
					E T5B, T4J, T54, T4C, T5C, T4K;
					T5B = iio[WS(vs, 5) + WS(is, 2)];
					T59 = T4H + T4I;
					T4J = T4H - T4I;
					T54 = T4A + T4B;
					T4C = T4A - T4B;
					T5C = iio[WS(vs, 5) + WS(is, 5)];
					T5L = iio[WS(vs, 5)];
					T5a = T53 + T54;
					T55 = T53 - T54;
					T4K = T4z + T4C;
					...
					T5M = iio[WS(vs, 5) + WS(is, 3)];
					T5E = iio[WS(vs, 5) + WS(is, 4)];
					T5F = iio[WS(vs, 5) + WS(is, 1)];
				   }
				   {
					...
					T68 = T5E + T5F;
					T5G = T5E - T5F;
					T5m = rio[WS(vs, 5) + WS(is, 3)];
					T5r = rio[WS(vs, 5) + WS(is, 4)];
					T6e = T67 + T68;
					T69 = T67 - T68;
					T5O = T5D + T5G;
					T5H = T5D - T5G;
					...
					T5s = rio[WS(vs, 5) + WS(is, 1)];
					T5o = rio[WS(vs, 5) + WS(is, 2)];
					T5p = rio[WS(vs, 5) + WS(is, 5)];
				   }
			      }
			 }
		    }
			      ...
			      }
			      {
				   E TC, TE, TB, TL, TS;
				   {
					...
					T61 = T5Z * T60;
					{
					     ...
					     iio[WS(vs, 3) + WS(is, 5)] = FNMS(T62, T60, T64);
					     rio[WS(vs, 3) + WS(is, 5)] = FMA(T62, T63, T61);
					     T6j = W[6];
					     T6m = W[7];
					     T6o = T6j * T6n;
					     T6l = T6j * T6k;
					     Tz = W[8];
					     TC = W[9];
					     iio[WS(vs, 4) + WS(is, 5)] = FNMS(T6m, T6k, T6o);
					     rio[WS(vs, 4) + WS(is, 5)] = FMA(T6m, T6n, T6l);
					     TE = Tz * TD;
					     TB = Tz * TA;
					}
				   }
				   ...
				   TS = W[3];
				   {
					...
					T5Y = T5T * T5X;
					T5V = T5T * T5U;
					iio[WS(vs, 5) + WS(is, 5)] = FNMS(T5W, T5U, T5Y);
					rio[WS(vs, 5) + WS(is, 5)] = FMA(T5W, T5X, T5V);
					T65 = W[2];
					T6c = W[3];
				   }
			      }
		    ...
		    }
		    {
			 E T5g, T5j, T5f, T5i;
			 {
			      E T1E, T1H, T3M, T3P, T56, T5d, T58, T5e, T57;
			      {
				   E T1s, T1B, T1f, T1u;
				   {
					...
					T5v = W[0];
					T5K = W[1];
					iio[WS(vs, 2) + WS(is, 5)] = FNMS(T6c, T6a, T6i);
					rio[WS(vs, 2) + WS(is, 5)] = FMA(T6c, T6h, T6b);
					T5S = T5v * T5R;
					T5J = T5v * T5I;
					...
					iio[WS(vs, 1) + WS(is, 5)] = FNMS(T5K, T5I, T5S);
					rio[WS(vs, 1) + WS(is, 5)] = FMA(T5K, T5R, T5J);
					T1f = W[0];
					T1u = W[1];
				   }
				   {
					...
					T3R = W[4];
					T3U = W[5];
					iio[WS(vs, 1) + WS(is, 1)] = FNMS(T1u, T1s, T1C);
					rio[WS(vs, 1) + WS(is, 1)] = FMA(T1u, T1B, T1t);
					T3W = T3R * T3V;
					T3T = T3R * T3S;
					{
					     ...
					     iio[WS(vs, 3) + WS(is, 3)] = FNMS(T3U, T3S, T3W);
					     rio[WS(vs, 3) + WS(is, 3)] = FMA(T3U, T3V, T3T);
					     T3n = W[0];
					     T3C = W[1];
					     ...
					     T51 = W[2];
					     T58 = W[3];
					     iio[WS(vs, 1) + WS(is, 3)] = FNMS(T3C, T3A, T3K);
					     rio[WS(vs, 1) + WS(is, 3)] = FMA(T3C, T3J, T3B);
					     T5e = T51 * T5d;
					     T57 = T51 * T56;
					}
				   }
			      }
			      {
				   E T38, T3b, T3O, T3Q, T3N, T37, T3a;
				   {
					...
					iio[WS(vs, 2) + WS(is, 4)] = FNMS(T58, T56, T5e);
					rio[WS(vs, 2) + WS(is, 4)] = FMA(T58, T5d, T57);
					T2T = W[2];
					T30 = W[3];
					T36 = T2T * T35;
					T2Z = T2T * T2Y;
					T3L = W[8];
					T3O = W[9];
					iio[WS(vs, 2) + WS(is, 2)] = FNMS(T30, T2Y, T36);
					rio[WS(vs, 2) + WS(is, 2)] = FMA(T30, T35, T2Z);
					T3Q = T3L * T3P;
					T3N = T3L * T3M;
				   }
				   iio[WS(vs, 5) + WS(is, 3)] = FNMS(T3O, T3M, T3Q);
				   rio[WS(vs, 5) + WS(is, 3)] = FMA(T3O, T3P, T3N);
				   T37 = W[6];
				   T3a = W[7];
				   {
					...
					T1D = W[8];
					T1G = W[9];
					iio[WS(vs, 4) + WS(is, 2)] = FNMS(T3a, T38, T3c);
					rio[WS(vs, 4) + WS(is, 2)] = FMA(T3a, T3b, T39);
					T1I = T1D * T1H;
					T1F = T1D * T1E;
					iio[WS(vs, 5) + WS(is, 1)] = FNMS(T1G, T1E, T1I);
					rio[WS(vs, 5) + WS(is, 1)] = FMA(T1G, T1H, T1F);
					T5f = W[6];
					T5i = W[7];
				   }
			      }
			 }
			 {
			      E T4Q, T4T, T2I, T2w, T2F, T2L, T2y, T2G, T2x, T4V, T4Y;
			      {
				   ...
				   T1J = W[4];
				   T1M = W[5];
				   iio[WS(vs, 4) + WS(is, 4)] = FNMS(T5i, T5g, T5k);
				   rio[WS(vs, 4) + WS(is, 4)] = FMA(T5i, T5j, T5h);
				   T1O = T1J * T1N;
				   T1L = T1J * T1K;
			      ...
			      }
			      {
				   ...
				   T4r = W[0];
				   T4G = W[1];
				   iio[WS(vs, 3) + WS(is, 4)] = FNMS(T4Y, T4W, T50);
				   rio[WS(vs, 3) + WS(is, 4)] = FMA(T4Y, T4Z, T4X);
				   T4O = T4r * T4N;
				   T4F = T4r * T4E;
				   {
					E T2N, T2Q, T2S, T2P, T2j;
					iio[WS(vs, 1) + WS(is, 4)] = FNMS(T4G, T4E, T4O);
					rio[WS(vs, 1) + WS(is, 4)] = FMA(T4G, T4N, T4F);
					T2N = W[4];
					T2Q = W[5];
					...
					T2j = W[0];
					T2y = W[1];
					iio[WS(vs, 3) + WS(is, 2)] = FNMS(T2Q, T2O, T2S);
					rio[WS(vs, 3) + WS(is, 2)] = FMA(T2Q, T2R, T2P);
					T2G = T2j * T2F;
					T2x = T2j * T2w;
				   }
			      }
			      {
				   E T1U, T21, T2H, T2K;
				   {
					...
					iio[WS(vs, 1) + WS(is, 2)] = FNMS(T2y, T2w, T2G);
					rio[WS(vs, 1) + WS(is, 2)] = FMA(T2y, T2F, T2x);
					T23 = W[6];
					T26 = W[7];
					{
					     ...
					     T3X = W[2];
					     T44 = W[3];
					     iio[WS(vs, 4) + WS(is, 1)] = FNMS(T26, T24, T28);
					     rio[WS(vs, 4) + WS(is, 1)] = FMA(T26, T27, T25);
					     T4a = T3X * T49;
					     T43 = T3X * T42;
					     iio[WS(vs, 2) + WS(is, 3)] = FNMS(T44, T42, T4a);
					     rio[WS(vs, 2) + WS(is, 3)] = FMA(T44, T49, T43);
					     T2H = W[8];
					     T2K = W[9];
					}
				   }
				   {
					...
					T4P = W[8];
					T4S = W[9];
					iio[WS(vs, 5) + WS(is, 2)] = FNMS(T2K, T2I, T2M);
					rio[WS(vs, 5) + WS(is, 2)] = FMA(T2K, T2L, T2J);
					T4U = T4P * T4T;
					T4R = T4P * T4Q;
					{
					     E T1P, T1W, T22, T1V, T4b;
					     iio[WS(vs, 5) + WS(is, 4)] = FNMS(T4S, T4Q, T4U);
					     rio[WS(vs, 5) + WS(is, 4)] = FMA(T4S, T4T, T4R);
					     T1P = W[2];
					     T1W = W[3];
					     T22 = T1P * T21;
					     T1V = T1P * T1U;
					     T4b = W[6];
					     T4e = W[7];
					     iio[WS(vs, 2) + WS(is, 1)] = FNMS(T1W, T1U, T22);
					     rio[WS(vs, 2) + WS(is, 1)] = FMA(T1W, T21, T1V);
					     T4g = T4b * T4f;
					     T4d = T4b * T4c;
					}
				   }
	  ...
	  iio[WS(vs, 4) + WS(is, 3)] = FNMS(T4e, T4c, T4g);
	  rio[WS(vs, 4) + WS(is, 3)] = FMA(T4e, T4f, T4d);
     }
     return W;
}
