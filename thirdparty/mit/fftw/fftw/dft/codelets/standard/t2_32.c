...
/* Generated on Sat Jul  1 14:08:52 EDT 2006 */

#include "codelet-dft.h"

#ifdef HAVE_FMA

/* Generated by: ../../../genfft/gen_twiddle -fma -reorder-insns -schedule-for-pipeline -compact -variables 4 -pipeline-latency 4 -twiddle-log3 -precompute-twiddles -n 32 -name t2_32 -include t.h */
...
static const R *t2_32(R *ri, R *ii, const R *W, stride ios, INT m, INT dist)
{
     ...
     for (i = m; i > 0; i = i - 1, ri = ri + dist, ii = ii + dist, W = W + 8, MAKE_VOLATILE_STRIDE(ios)) {
			      ...
			      E T7e, T8T, T7y, T7D, T7h, T8U, T8S, T8R;
			      {
				   ...
				   T2m = T1i + T2l;
				   {
					E T8s, T8P, T8Q, T8v;
					{
					     ...
					     T8f = T8d - T8e;
					     ri[0] = T2m + T45;
					     ri[WS(ios, 16)] = T2m - T45;
					     ri[WS(ios, 8)] = T8w + T8z;
					     ri[WS(ios, 24)] = T8w - T8z;
					     T8M = T8J - T8B;
					     T8K = T8B + T8J;
					     T8g = T8c + T8f;
					     T8s = T8c - T8f;
					     T8R = T8O - T8N;
					     T8P = T8N + T8O;
					     ii[WS(ios, 24)] = T8M - T8L;
					     ii[WS(ios, 8)] = T8L + T8M;
					     ii[WS(ios, 16)] = T8K - T8A;
					     ii[0] = T8A + T8K;
					     ri[WS(ios, 4)] = FMA(KP707106781, T8r, T8g);
					     ri[WS(ios, 20)] = FNMS(KP707106781, T8r, T8g);
					     T8Q = T8t + T8u;
					     T8v = T8t - T8u;
					}
					ii[WS(ios, 20)] = FNMS(KP707106781, T8Q, T8P);
					ii[WS(ios, 4)] = FMA(KP707106781, T8Q, T8P);
					ri[WS(ios, 12)] = FMA(KP707106781, T8v, T8s);
					ri[WS(ios, 28)] = FNMS(KP707106781, T8v, T8s);
				   }
			      }
			      {
				   ...
				   E T83;
				   {
					...
					T7P = T7L - T7O;
					T84 = T7L + T7O;
					ii[WS(ios, 28)] = FNMS(KP707106781, T8S, T8R);
					ii[WS(ios, 12)] = FMA(KP707106781, T8S, T8R);
					T7W = T7e + T7h;
					T7i = T7e - T7h;
					T85 = T7I + T7J;
					T7K = T7I - T7J;
				   ...
				   }
				   {
					...
					T7Q = FNMS(KP414213562, T7P, T7K);
					{
					     ...
					     T80 = FMA(KP707106781, T7Z, T7W);
					     {
						  ...
						  T96 = T7F + T7Q;
						  T7R = T7F - T7Q;
						  ri[WS(ios, 30)] = FMA(KP923879532, T7V, T7S);
						  ri[WS(ios, 14)] = FNMS(KP923879532, T7V, T7S);
						  ii[WS(ios, 22)] = FNMS(KP923879532, T94, T93);
						  ii[WS(ios, 6)] = FMA(KP923879532, T94, T93);
						  ii[WS(ios, 30)] = FMA(KP923879532, T96, T95);
						  ii[WS(ios, 14)] = FNMS(KP923879532, T96, T95);
						  ri[WS(ios, 6)] = FMA(KP923879532, T7R, T7u);
						  ri[WS(ios, 22)] = FNMS(KP923879532, T7R, T7u);
						  T87 = T83 + T86;
						  T90 = T86 - T83;
					     }
					     ...
					     T8Y = T89 + T8a;
					     T8b = T89 - T8a;
					     ri[WS(ios, 2)] = FMA(KP923879532, T87, T80);
					     ri[WS(ios, 18)] = FNMS(KP923879532, T87, T80);
					     ii[WS(ios, 18)] = FNMS(KP923879532, T8Y, T8X);
					     ii[WS(ios, 2)] = FMA(KP923879532, T8Y, T8X);
					}
				   }
			      }
			 }
			      ...
			      E T6s, T9o, T9n, T6v, T6N, T6Q, T6G, T6J, T9g, T9f;
			      {
				   E T6c, T4s, T9c, T4X, T9h, T9b, T9i, T6f, T5U, T6l, T64, T5k, T5v;
				   {
					E T6d, T6e, T99, T9a, T5T;
					{
					     ...
					     T6s = T46 - T4b;
					     T4c = T46 + T4b;
					     ri[WS(ios, 10)] = FMA(KP923879532, T8b, T88);
					     ri[WS(ios, 26)] = FNMS(KP923879532, T8b, T88);
					     ii[WS(ios, 26)] = FNMS(KP923879532, T90, T8Z);
					     ii[WS(ios, 10)] = FMA(KP923879532, T90, T8Z);
					     T4r = T4j + T4q;
					     T9o = T4q - T4j;
				   ...
				   }
				   {
					E T6m, T6q, T6j, T6p, T9l, T9m;
					{
					     ...
					     T9m = T5x + T66;
					     T67 = T5x - T66;
					     ii[WS(ios, 21)] = FNMS(KP831469612, T9k, T9j);
					     ii[WS(ios, 5)] = FMA(KP831469612, T9k, T9j);
					     ri[WS(ios, 5)] = FMA(KP831469612, T67, T4Y);
					     ri[WS(ios, 21)] = FNMS(KP831469612, T67, T4Y);
					     ri[WS(ios, 29)] = FMA(KP831469612, T6b, T68);
					     ri[WS(ios, 13)] = FNMS(KP831469612, T6b, T68);
					}
					{
					     ...
					     ii[WS(ios, 29)] = FMA(KP831469612, T9m, T9l);
					     ii[WS(ios, 13)] = FNMS(KP831469612, T9m, T9l);
					     ri[WS(ios, 1)] = FMA(KP980785280, T6n, T6g);
					     ri[WS(ios, 17)] = FNMS(KP980785280, T6n, T6g);
					     T9e = T6p + T6q;
					     T6r = T6p - T6q;
					     ii[WS(ios, 17)] = FNMS(KP980785280, T9e, T9d);
					     ii[WS(ios, 1)] = FMA(KP980785280, T9e, T9d);
					     ri[WS(ios, 9)] = FMA(KP980785280, T6r, T6o);
					     ri[WS(ios, 25)] = FNMS(KP980785280, T6r, T6o);
					}
				   }
			      }
			      {
				   E T6Y, T6w, T9w, T6D, T9v, T9p, T9q, T71, T6H, T74, T78, T7c, T6W, T6S;
				   {
					...
					ii[WS(ios, 25)] = FNMS(KP980785280, T9g, T9f);
					ii[WS(ios, 9)] = FMA(KP980785280, T9g, T9f);
					...
					T6K = FNMS(KP707106781, T6J, T6I);
					{
					     E T7a, T9x, T9y, T7d;
					     {
						  ...
						  T9x = FNMS(KP923879532, T9w, T9v);
						  {
						       ...
						       T9u = T6S - T6L;
						       T6T = T6L + T6S;
						       ri[WS(ios, 7)] = FMA(KP980785280, T79, T72);
						       ri[WS(ios, 23)] = FNMS(KP980785280, T79, T72);
						       ri[WS(ios, 11)] = FMA(KP831469612, T6X, T6U);
						       ri[WS(ios, 27)] = FNMS(KP831469612, T6X, T6U);
						       ii[WS(ios, 19)] = FNMS(KP831469612, T9s, T9r);
						       ii[WS(ios, 3)] = FMA(KP831469612, T9s, T9r);
						       ii[WS(ios, 27)] = FNMS(KP831469612, T9u, T9t);
						       ii[WS(ios, 11)] = FMA(KP831469612, T9u, T9t);
						       ri[WS(ios, 3)] = FMA(KP831469612, T6T, T6E);
						       ri[WS(ios, 19)] = FNMS(KP831469612, T6T, T6E);
						       T9y = T7c - T7b;
						       T7d = T7b + T7c;
						  }
					     }
					     ii[WS(ios, 23)] = FNMS(KP980785280, T9y, T9x);
					     ii[WS(ios, 7)] = FMA(KP980785280, T9y, T9x);
					     ri[WS(ios, 31)] = FMA(KP980785280, T7d, T7a);
					     ri[WS(ios, 15)] = FNMS(KP980785280, T7d, T7a);
					}
				   }
			      }
			 }
	  ...
	  ii[WS(ios, 31)] = FMA(KP980785280, T9A, T9z);
	  ii[WS(ios, 15)] = FNMS(KP980785280, T9A, T9z);
     }
     return W;
}
...
/* Generated by: ../../../genfft/gen_twiddle -compact -variables 4 -pipeline-latency 4 -twiddle-log3 -precompute-twiddles -n 32 -name t2_32 -include t.h */
