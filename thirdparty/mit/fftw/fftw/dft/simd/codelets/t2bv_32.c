...
/* Generated on Sat Jul  1 15:04:10 EDT 2006 */

#include "codelet-dft.h"

#ifdef HAVE_FMA

/* Generated by: ../../../genfft/gen_twiddle_c -fma -reorder-insns -schedule-for-pipeline -simd -compact -variables 4 -pipeline-latency 8 -n 32 -name t2bv_32 -include t2b.h -sign 1 */
...
static const R *t2bv_32(R *ri, R *ii, const R *W, stride ios, INT m, INT dist)
{
...
static const ct_desc desc = { 32, "t2bv_32", twinstr, &GENUS, {119, 62, 98, 0}, 0, 0, 0 };

void X(codelet_t2bv_32) (planner *p) {
     X(kdft_dit_register) (p, t2bv_32, &desc);
}
#else				/* HAVE_FMA */

/* Generated by: ../../../genfft/gen_twiddle_c -simd -compact -variables 4 -pipeline-latency 8 -n 32 -name t2bv_32 -include t2b.h -sign 1 */
...
static const ct_desc desc = { 32, "t2bv_32", twinstr, &GENUS, {201, 88, 16, 0}, 0, 0, 0 };
