...
/* Generated on Sat Jul  1 14:27:37 EDT 2006 */

#include "codelet-dft.h"

#ifdef HAVE_FMA

/* Generated by: ../../../genfft/gen_notw_c -fma -reorder-insns -schedule-for-pipeline -simd -compact -variables 4 -pipeline-latency 8 -sign 1 -n 11 -name n1bv_11 -include n1b.h */
...
static const kdft_desc desc = { 11, "n1bv_11", {15, 5, 55, 0}, &GENUS, 0, 0, 0, 0 };
void X(codelet_n1bv_11) (planner *p) {
     X(kdft_register) (p, n1bv_11, &desc);
}

#else				/* HAVE_FMA */

/* Generated by: ../../../genfft/gen_notw_c -simd -compact -variables 4 -pipeline-latency 8 -sign 1 -n 11 -name n1bv_11 -include n1b.h */
...
static const kdft_desc desc = { 11, "n1bv_11", {30, 10, 40, 0}, &GENUS, 0, 0, 0, 0 };
void X(codelet_n1bv_11) (planner *p) {
     X(kdft_register) (p, n1bv_11, &desc);
}
