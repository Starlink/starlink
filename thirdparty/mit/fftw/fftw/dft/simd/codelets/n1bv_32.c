...
/* Generated on Sat Jul  1 14:29:35 EDT 2006 */

#include "codelet-dft.h"

#ifdef HAVE_FMA

/* Generated by: ../../../genfft/gen_notw_c -fma -reorder-insns -schedule-for-pipeline -simd -compact -variables 4 -pipeline-latency 8 -sign 1 -n 32 -name n1bv_32 -include n1b.h */
...
static const kdft_desc desc = { 32, "n1bv_32", {88, 0, 98, 0}, &GENUS, 0, 0, 0, 0 };
void X(codelet_n1bv_32) (planner *p) {
     X(kdft_register) (p, n1bv_32, &desc);
}

#else				/* HAVE_FMA */

/* Generated by: ../../../genfft/gen_notw_c -simd -compact -variables 4 -pipeline-latency 8 -sign 1 -n 32 -name n1bv_32 -include n1b.h */

/*
 * This function contains 186 FP additions, 42 FP multiplications,
 * (or, 170 additions, 26 multiplications, 16 fused multiply/add),
 * 58 stack variables, and 64 memory accesses
 */
/*
 * Generator Id's : 
 * $Id: algsimp.ml,v 1.9 2006-02-12 23:34:12 athena Exp $
...
static const kdft_desc desc = { 32, "n1bv_32", {170, 26, 16, 0}, &GENUS, 0, 0, 0, 0 };
void X(codelet_n1bv_32) (planner *p) {
     X(kdft_register) (p, n1bv_32, &desc);
}
