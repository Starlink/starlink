      SUBROUTINE NAG1_SZLSF( IFLAG, M, N, XC, FVECC, FJACC, LJC, IW,
     :                       LIW, W, LW )
*+
*  Name:
*     CCD1_SZLSF
...
*  Description:
*     This is an instance of the LSQFUN service routine required by the
*     NAG library routine E04GBF which solves non-linear least-squares
...
*     governed by the requirements of the NAG library.
