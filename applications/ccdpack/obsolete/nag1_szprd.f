      SUBROUTINE NAG1_SZPRD( MODE, N, NIM, X, Y, W, LW, IW, LIW )
*+
*  Name:
*     CCD1_SZPRD
...
*     NAG library routine F04QAF which solves sparse linear
...
*     requirements of the NAG library.
...
*        The X vector supplied by the routine F04QAF, to be updated.
...
*        The Y vector supplied by the routine F04QAF, to be updated.
*        This will contain values of the logarithmic scale factor or
