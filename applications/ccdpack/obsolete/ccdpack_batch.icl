{
{  ICL control file for test BATCH CCDPACK reduction using the CCDPACK
{  monolith and ICL.
{
...
{
CCDNOTE "Test run of CCDPACK monolith" \
{
{ Make the bias frames.
{
MAKEBIAS IN=[.BIAS]* OUT=[.BIAS]MASTER_BIAS CMODE=MEAN RESET \
{
