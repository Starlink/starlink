...
\sstroutine{MAKEMOS} {
   ...
   \sstparameters{
      ...
      \sstsubsection{
         ...
         which can be read into the \xroutine{DRIZZLE} program. IF SCALE and ZERO are
...
\sstroutine{REGISTER} {
   ...
   \sstdescription{
      ...
      pixel coordinate system of the reference image, and are stored in
      the WCS components of the associated images. Transform structures
      may be stored in the CCDPACK exensions of the associated images or
      within a named HDS container file if no associated images exist.
      Whether TRANSFORM structures or frames within the WCS components
      are chosen, they can be used by the applications \xroutine{TRANNDF} and
      \xroutine{TRANLIST} to resample the datasets or transform position lists
      respectively.
   }
   \sstusage{
   ...
   \sstparameters{
      \sstsubsection{
         ...
         See \xref{SUN/61}{sun61}{} Appendix B for details of transformation
      ...
      \sstsubsection{
         ...
         images.  There are two possible values:
            \sstitemlist{
               \sstitem
   ...
   \sstexamples{
      ...
      \sstexamplesubsection{
         register ndfnames=false inlist={\tt '}{\tt "}list1.acc,list2.acc,list3.acc{\tt "}{\tt '}
               ...
               in={\tt '}{\tt "}image1,image2,image3{\tt "}{\tt '}
         ...
         given as {\tt "}file{\tt "} in which case the transform structures are
   ...
   \sstnotes{
      ...
      \sstitemlist{
        ...
        On exit, if OUTFORMAT is \qt{WCS} then a new coordinate system 
...
and can be used for backward compatibility
...
to read and write TRANSFORM structures may be
