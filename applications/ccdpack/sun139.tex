...
\item
  ...
  deal better with images containing a few rougue pixels with far 
  outlying values.
\item
  ...
  '[X1:X2,Y1:Y2]'.
\item
  The behaviour of \xroutine{IDICURS}, \xroutine{PAIRNDF} and 
  \xroutine{CCDALIGN} on TrueColor visuals (typically newer Linux X displays)
