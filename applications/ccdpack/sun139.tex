...
\newcommand{\stardocdate}      {21 November 2000}
...
\quickdes{PAIRNDF}{Aligns NDFs graphically by drag and drop}{PAIRNDF}
...
\subsection{This release 3.2-0}
  ...
  The following minor changes have also been made since v3.1-0:
  \begin{itemize}
  \item
     There have been bug fixes to \xroutine{MAKEMOS}: previously when USEVAR was 
     false, and SCALE was true or WEIGHTS were set, the wrong weights 
     were sometimes applied to images in overlap regions.
  \item
