...
Current coordinate system, which decreases running time 
...
image as if it had no extra coordinate systems attached you can
just run
\begin{myquote}
\begin{verbatim}
...
In most cases \routine{MAKEMOS} should be used for data
combination, but for some special purposes (see section \S\ref{drizzling})
\xroutine{DRIZZLE} may be more superior.
\routine{DRIZZLE} is a program with many of the capabilities
of \routine{MAKEMOS},  but unlike \routine{MAKEMOS} it
