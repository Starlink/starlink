...
\subsection{This release 3.0-2}

  Release 3.0-2 improves efficiency and removes some bugs from DRIZZLE.
  It improves behaviour of IDICURS, PAIRNDF and CCDALIGN on PseudoColor
  visuals (causes them to note a problem not just crash).
