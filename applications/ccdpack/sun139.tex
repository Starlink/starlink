...
their relative positions may be known.
...
for instance KAPPA's \xref{DISPLAY}{sun95}{DISPLAY} labels 
...
\routine{WCSEDIT}
\item
Sorting through existing frames:
\routine{WCSREG}
\end{itemize}
The rest of this subsection explains the use of these methods
(and a schematic illustration of how they fit together is contained
...
\subsection{Object matching and position lists}
...
transformations).
% The fourth method is undefined -- do-it-yourself --
...
%   (this refers to CCDEDIT)

\subsubsection{\xlabel{registration}Transformation parameter determination}
...
(or apply to the position list directly using \routine{TRANLIST})
...
semi-automated registration may be used.
This uses the applications:
\begin{itemize}
...
library which underlies the processing of WCS components.
