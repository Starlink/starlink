...
\newcommand{\stardocsource}    {sun139.8}
\newcommand{\stardocnumber}    {139.8}
\newcommand{\stardocauthors}   {Peter W. Draper}
\newcommand{\stardocdate}      {11 June 1998}
\newcommand{\stardoctitle}     {CCDPACK}
\newcommand{\stardoconeline}   {CCD data reduction package}
\newcommand{\stardocversion}   {Version 2.2-1}
...
% Quotes for SST. Note latex2html renews no longer needed.
...
% Figure environment. Defined for latex2html. #1 is \epsfig qualifiers
% (file=xxx etc.), #2 the gif file, #3 the label, #4 the caption.
\newcommand{\myfig} [4] {
  \begin{figure}
    \centering\epsfig{#1}
...
\myfig{file=sun139geo.eps}{geo.gif}{CCDPICCY}{Typical CCD geometries.
...
\myfig{file=sun139red.eps,height=0.85\textheight}{red.gif}
{reductionpicture}
...
\myfig{file=sun139reg.eps,height=0.85\textheight}{reg.gif}{registration}
{A schematic of the standard sequences
...
\section{Changes in release (2.2)}
...
\section{Changes in this release (2.2-1)}
