\documentclass[nolof,twoside,11pt]{starlink}

% ? Specify used packages
%\usepackage        %  Use this one for final production.
%% \usepackage %  Use this one for drafting.
%\usepackage  %  Ensure sensible hyphenation (esp. linux)
...
% \providecommand{\hotlink}[2]{\fbox{\begin{tabular}[t]{@{}c@{}}#1\\\hline{\footnotesize #2}\end{tabular}}}
...
\providecommand{\butt}[1]{{\ttsize \bf \tt #1}}
\providecommand{\menu}[1]{{\ttsize \bf \em #1}}
\providecommand{\wlab}[1]{{\ttsize \bf #1}}
...
% Quotes for SST.
\providecommand{\qt}[1]{{\tt "}#1{\tt "}}
\providecommand{\qs}[1]{{\tt '}#1{\tt '}}

% Routines with descriptions in the appendix.
\providecommand{\routine}[1]{{\sc #1}}
\providecommand{\xroutine}[1]{\htmlref{{\sc #1}}{#1}}
