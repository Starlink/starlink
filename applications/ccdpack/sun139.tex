...
\section{Demonstrations and test data}
...
\sstroutine{OUTLINE}{
   Draws aligned outlines of image on a graphics display
}{
   \sstdescription{
      ...
      OUTLINE uses the \xref{AGI graphics database}{sun95}{se_agitate} in a way which is
      ...
      invocation of OUTLINE or by a KAPPA program such as \xref{DISPLAY}{sun95}{DISPLAY}
