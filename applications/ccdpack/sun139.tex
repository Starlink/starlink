...
Not very many of the {\bf Examples:} sections in Appendix 
\S\ref{app:description} give explicit examples of using the commands
with Sets.
...
\sstroutine{ASTEXP} {
   ...
   \sstdiytopic{
      AST file format:
         ...
         should be taken (see \xref{SUN/210}{sun210}{ss:channels}) if any more involved changes
...
\sstroutine{CCDEDIT}{
   ...
   \sstexamples{
      ...
      \sstexamplesubsection{
         ccdedit mode=erase fixwcs=yes in=\qt{*}
      }{
...
\sstroutine{DRAWNDF}{
   ...
   \sstexamples{
      ...
      \sstexamplesubsection{
         ...
         device, for instance the result of a KAPPA \xroutine{DISPLAY}{sun95}{DISPLAY} command
   ...
   \sstnotes{
      \sstitemlist{
         ...
         Display:
            ...
            system, you may find KAPPA{\tt '}s \xroutine{DISPLAY}{sun95}{DISPLAY} program more versatile.
      }
   }
   \sstdiytopic{
      Behaviour of Parameters
...
\sstroutine{MAKESET}{
   ...
   \sstparameters{
      ...
      \sstsubsection{
         ...
         explained in the {\tt "}\xref{NDF Sections}{sun33}{ss:ndfsections}{\tt "} section of \xref{SUN/33}{sun33}{};
