...
\subsection{This release 3.2-0}
  ...
  \begin{itemize}
  \item
     There have been bug fixes to \xroutine{MAKEMOS}: when SCALE was true, data
     combination methods MEAN and MEDIAN were applying weights to the
     wrong input images in overlap regions.
  \item
