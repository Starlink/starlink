...
\newcommand{\stardocdate}      {14th November 1995}
...
%\newcommand{\butt}[1]{\fbox{\small \tt #1}}
%\newcommand{\menu}[1]{\fbox{\small \bf \em #1}}
%\newcommand{\wlab}[1]{\fbox{\small \bf #1}}

%  Don't use the colour option as this looks dreadful in netscape.
%\definecolor{lightgrey}{gray}{.82}
%\newcommand{\butt}[1]{\colorbox{lightgrey}{\small #1}}
%\newcommand{\menu}[1]{\colorbox{lightgrey}{\em \small #1}}
% -----------------------------------------------------------------------------
%  Title Page.
%  ===========
\begin{document}
...
Press \butt{OK} when you've happy with the values.
