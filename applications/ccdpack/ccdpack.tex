...
% -----------------------------------------------------------------------------
\stardoccategory    {Hypertext routine help}
\stardocinitials    {HRH}
\stardocsource      {ccdpack}
\stardocnumber      {1.0}
\stardocauthors     {P.W. Draper, M.B. Taylor}
\stardocdate        {July 2001}
\stardoctitle       {XREDUCE help}
\stardocversion     {Version 4.0}
\stardocmanual      {On-line help}
% -----------------------------------------------------------------------------
...
\stardocabstract{This document provides any additional hypertext help required by
