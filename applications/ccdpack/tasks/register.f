...
*       "CCD_REG" will be added to the .WCS component of input NDFs.
*       Taken together these contain the registration information 
*       and can be inspected using NDFTRACE or WCSSHOW (SUN/95).
*
