...
*  quality, label, history, units from the first NDF. Do NOT propagate
*  the CCDPACK extension (the information in this only applies to the
*  input NDF).
...
*  Combine all the NDFs in the stack using the method given.
         CALL CCD1_MKBC( ITYPE, GENVAR, IPWORK, EL, NNDF, VARS, IMETH,
     :                   MINPIX, NITER, NSIGMA, ALPHA, RMIN, RMAX,
     :                   IPOINT, IPVAR, WRK1, WRK2, WRK3,
     :                   %VAL( IPWRK4 ), NWRK4, NCON, POINT,
     :                   USED, STATUS )
...
*  Report MAKEBIAS parameters
     ...
     :                MINPIX, ALPHA, NSIGMA, NITER, RMIN, RMAX, STATS,
     :                VARS, NDFOUT, PRESER, DTYPE, PTYPE, GENVAR,
     :                USEEXT, DELETE, STATUS )
