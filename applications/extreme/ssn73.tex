...
the EXTREME package provides the header \file{extreme.h}
for this purpose.
...
builds on the same platform; if this is not the case then SOURCE\_VARIANT
should be allowed to default to \$(SYSTEM) as usual,
...
\file{cmp_inscnf.pl} (and similarly for the other filters),
and if you see this warning you can run this script yourself
to get an idea what the problem may have been. 
The above warning was emitted by \routine{do_frepint}; investigate 
as follows:
\begin{squote}
\begin{verbatim}
