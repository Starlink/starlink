...
type in the \file{mk} file, but packages built for the the new 
64-bit platforms should run properly on 32-bit systems.
Two new values of the \file{mk}/\file{makefile} environment variable 
...
\begin{squote}
\begin{verbatim}
      INCLUDE 'EXT_DEC'          ! Conversion declarations
      INCLUDE 'EXT_DEF'          ! Conversion definitions
        ...
...
{\it (Perhaps this function should be put in PRIMDAT?)}
%
...
fixed at g77 0.5.25.  So it's probably all right to leave this.
%
\end{description}
...
(typically \file{\$(PKG_NAME)\_source.tar}),
