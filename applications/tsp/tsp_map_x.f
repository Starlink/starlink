C+
      SUBROUTINE TSP_MAP_X (LOC,MODE,PTR,LOC2,STATUS)
C
C                               T S P _ M A P _ X
C
C  Routine name:
...
C
C  Function:
C     Map the X axis of a TSP structure
C
C  Description:
C     Given a locator to a 3D TSP structure map its X axis data.
C
C  Language:
C     FORTRAN
C
C  Call:
C     CALL TSP_MAP_X (LOC,MODE,PTR,LOC2,STATUS)
C
