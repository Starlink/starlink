...
*  Copy Intensity Data
     ...
     :         STATUS)
         ...
         CALL TSP_HDSPLOTCOPY(NCHANS,BIN,I,MAXLEN,%VAL(CNF_PVAL(DPTR)),
     :       STATUS)
         CALL TSP_HDSPLOTCOPY(NCHANS,BIN,IE,MAXLEN,%VAL(CNF_PVAL(VPTR)),
     :       STATUS)
...
*  Copy Q data
         ...
         CALL TSP_HDSPLOTCOPY(NCHANS,BIN,Q,MAXLEN,%VAL(CNF_PVAL(DPTR)),
     :       STATUS)
         CALL TSP_HDSPLOTCOPY(NCHANS,BIN,QE,MAXLEN,%VAL(CNF_PVAL(VPTR)),
     :       STATUS)
         CALL TSP_UNMAP(DLOC,STATUS)
         CALL TSP_UNMAP(VLOC,STATUS)
...
*  Copy U data
         ...
         CALL TSP_MAP_DATA(SLOC,'WRITE',DPTR,DLOC,STATUS)
         CALL TSP_MAP_VAR(SLOC,'WRITE',VPTR,VLOC,STATUS)
         CALL TSP_HDSPLOTCOPY(NCHANS,BIN,U,MAXLEN,%VAL(CNF_PVAL(DPTR)),
     :       STATUS)
         CALL TSP_HDSPLOTCOPY(NCHANS,BIN,UE,MAXLEN,%VAL(CNF_PVAL(VPTR)),
     :       STATUS)
         CALL TSP_UNMAP(DLOC,STATUS)
         CALL TSP_UNMAP(VLOC,STATUS)
         CALL DAT_ANNUL(SLOC,STATUS)
...
*  Copy V data
         ...
         CALL TSP_MAP_DATA(SLOC,'WRITE',DPTR,DLOC,STATUS)
         CALL TSP_MAP_VAR(SLOC,'WRITE',VPTR,VLOC,STATUS)
         CALL TSP_HDSPLOTCOPY(NCHANS,BIN,V,MAXLEN,%VAL(CNF_PVAL(DPTR)),
     :       STATUS)
         CALL TSP_HDSPLOTCOPY(NCHANS,BIN,VE,MAXLEN,%VAL(CNF_PVAL(VPTR)),
     :       STATUS)
         CALL TSP_UNMAP(DLOC,STATUS)
         CALL TSP_UNMAP(VLOC,STATUS)
         CALL DAT_ANNUL(SLOC,STATUS)
