 ...
 */
    FILE *fp, *fp0, *fp1, *fp2;
    char buffer[MAXLINE], file_name[20];
	  ...
	  case '\n':
		...
		if (c_header) {
		    ...
		    fprintf(fp0, "/*\n * C error define file "
				 ...
				 " */\n\n",
				 fac_name, fac_code);
		    fprintf(fp0,"#ifndef %s_ERROR_DEFINED\n"
		...
		if (f77_include) {
		    ...
		    fprintf(fp1, "* FORTRAN error include file for facility "
				 "%s (Code %d)\n"
				 "* Generated by the MESSGEN utility\n\n",
				  fac_name, fac_code);
		}
 ...
 */
    ...
    if (c_header)
	fprintf(fp0, "#endif	/* %s_ERROR_DEFINED */\n", fac_name);
    if (verify)
