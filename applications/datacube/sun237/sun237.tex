...
\newcommand{\stardocdate}      {2010 July 13}
...
\item to build a velocity map from an emission line by line
      ...
      moments (\htmlref{{\bf velmoment}}{velmoment});
\item to build an emmision-line strength map
...
scripts---now has a {\tt -q} option to prevent the reporting of the
filename and its vital statistics.  It has also has an improved 
NDF-validation method, which allows for NDFs within a container file or NDF
extension. 
