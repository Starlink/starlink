...
\newcommand{\stardocdate}      {2008 July 1}
...
\small\begin{verbatim}
   % kappa
        ...
        KAPPA commands are now available -- (Version 1.9-8)
...
\section{\xlabel{se_changes}Release Notes---V1.2\label{se:changes}}
...
It has case insensitive prompting for prompts not specifying file
names. 
