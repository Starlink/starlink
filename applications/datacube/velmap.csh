...
set colfile = "${tmpdir}/${user}/vmap_col.sdf"
set ripfile = "${tmpdir}/${user}/vmap_rip.sdf"
   ...
   while ( $x <= ${ubnd[1]} )
      ...
      `echo $results | awk '{split($0,a," "); for(i=1; i<10; i++) print a[i]}'`
         ...
         if ( $condition == 1 ) then
            ...
            echo "        Spectra ($x,$y): $centre_fit +- $centre_err" 
...
# cleanup temporary velmap files, salvage ${outfile}_tmp in the case
