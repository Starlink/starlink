...
\def\includecomment#1{\expandafter\def\csname#1\endcsname{}%
    \expandafter\def\csname end#1\endcsname{}}
\def\excludecomment#1{\expandafter\def\csname#1\endcsname{\ThrowAwayComment{#1}}%
    {\escapechar=-1\relax
...
% Earlier versions of this document used an index incorporated into
% the file itself, and used the following commands to format it,
% with entries generated by some unknown tool.  This has been replaced
% (2003 July 11) with an index built using (standard) makeindex.
\begin{htmlonly}
...
\includegraphics[width=\textwidth]{sun152_08.eps}
