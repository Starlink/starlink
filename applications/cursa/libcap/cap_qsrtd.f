      SUBROUTINE CAP_QSRTD( EL, X, IP, STATUS )
*+
*  Name:
*     CAP_QSRTx
*  Purpose:
...
*        The global status.
*  Notes:
*     This is a DOUBLE PRECISION routine.
*  References:
...
*     13-DEC-1994 (ACD):
*        Changed standard SAE INCLUDE file and success status to the
*        CAT equivalents.
*     29-NOV-1996 (ACD):
*        Created CAP_QSRTD from CAT1_QSRTD.
*  Bugs:
*     None known.
*-
*  Type Definitions:
