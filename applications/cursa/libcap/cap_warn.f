      SUBROUTINE CAP_WARN (EXCL, PARAM, TEXT, STATUS)
*+
*  Name:
*     CAP_WARN
*  Purpose:
...
*     Fortran 77.
*  Invocation:
*     CAP_WARN (EXCL, PARAM, TEXT; STATUS)
*  Description:
*     Output a warning message.
*
...
*     behaviour is required by the application stargaze when it is
...
*     2/10/94 (ACD): First stable version.
...
*
*       Introduce the text as a warning.

         CALL CHR_PUTC ('(Warning) ', BUFFER, BUFLEN)
