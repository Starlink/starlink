      SUBROUTINE CAP_CPCOL (CIIN, CIOUT, MXCOL, NUMCOL, FIIN, FIOUT,
     :  STATUS)
*+
*  Name:
*     CAP_CPCOL
...
*     Fortran 77.
*  Invocation:
*     CALL CAP_CPCOL (CIIN, CIOUT, MXCOL; NUMCOL, FIIN, FIOUT; STATUS)
*  Description:
...
*     30/9/94  (ACD): Added copying of order attribute.
*     30/10/94 (ACD): Made to set all column attributes.
