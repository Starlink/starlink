...
\newcommand{\stardocnumber}    {190.10}
...
/star/examples/cursa/simple.TXT}.  In this target list the coordinates
...
available as file {\tt /star/examples/cursa/propmotn.TXT}.  Note that
...
\begin{description}
  ...
  \begin{verse}
   {\tt /star/examples/cursa/polygon.TXT}
  \end{verse}
...
{\it Bonner Durchmusterung}                & {\tt /star/examples/cursa/bd.grt}  \\
HST {\it Guide Star Catalog}               & {\tt /star/examples/cursa/gsc.grt} \\
IRAS {\it Point Source Catalogue}          & {\tt /star/examples/cursa/iras\_psc.grt} \\
{\it Positions and Proper Motions}\, (PPM) & {\tt /star/examples/cursa/ppm.grt} \\
{\it Third Ref. Catalogue of Bright Galaxies} & {\tt /star/examples/cursa/rc3.grt} \\
{\it SAO Catalog}                          & {\tt /star/examples/cursa/sao.grt} \\
SIMBAD                                     & {\tt /star/examples/cursa/simbad.grt} \\
SuperCOSMOS surveys (black and white plot) & {\tt /star/examples/cursa/scosmosbw.grt}  \\
SuperCOSMOS surveys (colour plot)          & {\tt /star/examples/cursa/scosmoscol.grt} \\
USNO PMM                                   & {\tt /star/examples/cursa/usno.grt} \\
\end{tabular}
\end{center}
...
\begin{verse}
{\tt /star/examples/cursa/simple.grt}
\end{verse}
...
\begin{verse}
{\tt /star/examples/cursa/complex.grt}
\end{verse}
...
\begin{enumerate}
  ...
  \begin{tabular}{ll}
   {\tt GTFILE - Graphics translation file:}      & {\tt /star/examples/cursa/usno.grt} \\
...
\begin{verse}
{\tt /star/examples/cursa/catpair\_cart.script}
\end{verse}
...
\begin{verse}
{\tt /star/examples/cursa/catpair\_sphplr.script}
\end{verse}
...
\begin{center}
{\tt setenv ~ CATREM\_CONFIG ~ http://www.roe.ac.uk/acdwww/catremote/skycat.cfg}
\end{center}
...
\begin{verse}
{\tt /star/examples/cursa/simple.TXT}
\end{verse}
...
\begin{verse}
{\tt /star/examples/cursa/simple\_radians.TXT}
\end{verse}
...
\begin{verse}
{\tt /star/examples/cursa/complex.TXT}
\end{verse}
...
\begin{verse}
{\tt /star/examples/cursa/scale.TXT}
\end{verse}
...
{\tt /star/examples/cursa/simple.TXT}    \\
{\tt /star/examples/cursa/complex.TXT}   \\
{\tt /star/examples/cursa/propmotn.TXT}
\end{verse}
...
\begin{verse} 
{\tt /star/examples/cursa/angles.TXT}
\end{verse}
...
\begin{verse}
{\tt /star/examples/cursa/kappa.TXT}
\end{verse}
...
/star/examples/cursa/kappa.TXT} was created in this way) or the
...
\begin{verse}
{\tt /star/examples/cursa/pisaresults.TXT} \\
{\tt /star/examples/cursa/pisasizes.TXT}
\end{verse}
