...
are deemed not to be in any clump.
...
applied is specified by configuration parameter CleanIter. The results of 
this cleaning process are the final clump allocations for every data pixel, 
from which the catalogue of clump parameters is produced.
