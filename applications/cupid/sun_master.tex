...
fully in \htmladdnormallink{Williams, de Geus \& Blitz 1994, ApJ, 428, 693}
{http://adsabs.harvard.edu/cgi-bin/nph-bib_query?1994ApJ%2E%2E%2E428%2E%2E693W&db_key=AST}.
...
The CUPID implementation of this algorithm is completely independent of
the Williams implementation (which is written in IDL and available from
...
between the CUPID implementation and the Williams implementation, then
you should set these extra parameters to the following values:

\begin{itemize}
\item ClumpFind.FwhmBeam = 0
\item ClumpFind.MaxBad = 100000  (or some other very large number)
\item ClumpFind.MinPix = 5
