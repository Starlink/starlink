...
*/
  ...
  {"MU_RAD0", "Mean radius at brightness threshold 0",
	&outobj.mu_rad[0], H_FLOAT, T_FLOAT, "%8.4f", "arcsec"},
  {"MU_RAD1", "Mean radius at brightness threshold 1",
	&outobj.mu_rad[1], H_FLOAT, T_FLOAT, "%8.4f", "arcsec"},
  {"MU_RAD2", "Mean radius at brightness threshold 2",
	&outobj.mu_rad[2], H_FLOAT, T_FLOAT, "%8.4f", "arcsec"},
  {"MU_RAD3", "Mean radius at brightness threshold 3",
	&outobj.mu_rad[3], H_FLOAT, T_FLOAT, "%8.4f", "arcsec"},
  {"MU_RAD4", "Mean radius at brightness threshold 4",
	&outobj.mu_rad[4], H_FLOAT, T_FLOAT, "%8.4f", "arcsec"},
  {"MU_RAD5", "Mean radius at brightness threshold 5",
	&outobj.mu_rad[5], H_FLOAT, T_FLOAT, "%8.4f", "arcsec"},
  {"MU_RAD6", "Mean radius at brightness threshold 6",
	&outobj.mu_rad[6], H_FLOAT, T_FLOAT, "%8.4f", "arcsec"},
  {"MU_RAD7", "Mean radius at brightness threshold 7",
	&outobj.mu_rad[7], H_FLOAT, T_FLOAT, "%8.4f", "arcsec"},
  {"MU_RAD8", "Mean radius at brightness threshold 8",
	&outobj.mu_rad[8], H_FLOAT, T_FLOAT, "%8.4f", "arcsec"},
  {"MU_RAD9", "Mean radius at brightness threshold 9",
	&outobj.mu_rad[9], H_FLOAT, T_FLOAT, "%8.4f", "arcsec"},
  {"MU_RAD10", "Mean radius at brightness threshold 10",
	&outobj.mu_rad[10], H_FLOAT, T_FLOAT, "%8.4f", "arcsec"},
  {"MU_RAD11", "Mean radius at brightness threshold 11",
	&outobj.mu_rad[11], H_FLOAT, T_FLOAT, "%8.4f", "arcsec"},
  {"MU_RAD12", "Mean radius at brightness threshold 12",
	&outobj.mu_rad[12], H_FLOAT, T_FLOAT, "%8.4f", "arcsec"},
  {"MU_RAD13", "Mean radius at brightness threshold 13",
	&outobj.mu_rad[13], H_FLOAT, T_FLOAT, "%8.4f", "arcsec"},
  {"MU_RAD14", "Mean radius at brightness threshold 14",
	&outobj.mu_rad[14], H_FLOAT, T_FLOAT, "%8.4f", "arcsec"},
  {"MU_RAD15", "Mean radius at brightness threshold 15",
	&outobj.mu_rad[15], H_FLOAT, T_FLOAT, "%8.4f", "arcsec"},
