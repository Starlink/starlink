...
it, in the \htmladdnormallink{\SExtractor\ User's Guide}{\MUD} (which is issued
...
A patch has been applied to \SExtractor\ that allows it to read some
types of MEF files. To process an image stored in the first extension
...
brackets from the C-shell). MEF files that contain a primary image are
not understood.
