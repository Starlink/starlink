...
\newcommand{\stardocnumber}    {226.3}
\newcommand{\stardocauthors}   {A.J. Chipperfield\\
                                P.W. Draper}
\newcommand{\stardocdate}      {23 November 1999}
...
\subsection{Version 1.1-0}
 ...
 The \EXTRACTOR\ and \SExtractor\ programs have been updated to
 \SExtractor\ version $2.0.19$ (the previous version was
 $2.0.15$). The changes introduced by this are (from the SExtractor
 change log):
 \begin{itemize}
...
\subsection{Version 1.1-3}
 This is a minor update to the \EXTRACTOR\ program.
 \begin{itemize}
 \item  The range of output WCS coordinates should now always be 
       correctly normalised ({\it i.e.} RA's in range $0-24$hrs).
 \item Apertures should now be actually visible in the ``APERTURES'' 
       checkimage.
 \item Skycat catalogues output from detached monoliths (Tcl \& ICL)
