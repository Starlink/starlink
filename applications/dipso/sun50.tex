...
\newcommand{\stardocsource} {sun50.24}
...
\newcommand{\stardoctitle} {DIPSO (V3.6) --- A friendly spectrum analysis
program}
%------------------------------------------------------------------------------
...
\item The {\tt ELFRESTC} command has been changed so that it no longer 
converts the supplied file name to upper case before being used to access
the file. The previous behaviour resulted in open failure for file names 
