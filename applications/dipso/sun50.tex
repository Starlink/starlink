...
\newcommand{\stardocsource} {sun50.22}
\newcommand{\stardocnumber} {50.22}
\newcommand{\stardocauthors} {I D Howarth, J Murray, D Mills \& D S Berry}
\newcommand{\stardocdate} {19th September 2001}
\newcommand{\stardoctitle} {DIPSO (V3.5-5) --- A friendly spectrum analysis
program}
%------------------------------------------------------------------------------
...
% Re-define underscore back to normal for HTML.
\begin{htmlonly}
\renewcommand{\_}{\_}
\end{htmlonly}
...
\renewcommand{\dipcom}[3] { \end{description}
...
\renewenvironment{dipdesc}{\begin{itemize}}{\end{itemize}}

\renewcommand{\dipitem}[2]{ \item {\bf{#1}} {#2} }
...
\dipcom{READ}{file name or NDF name}{Reads data from a disk file to the current arrays (see {\tt{WRITE}})} 
Reads a disk file which has been written with \htmlref{{\tt{WRITE}}}{COM:WRITE}.  This and \htmlref{{\tt{RESTORE}}}{COM:RESTORE}  are the
