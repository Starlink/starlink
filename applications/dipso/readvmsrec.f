...
!
	...
	iv2 = vaxf_byte(2)
	iv3 = vaxf_byte(3)
	iv0 = IAND ( iv0 , '000000FF'X )
	iv1 = IAND ( iv1 , '000000FF'X )
	iv2 = IAND ( iv2 , '000000FF'X )
	iv3 = IAND ( iv3 , '000000FF'X )

	e =  IOR ( IAND ( ISHFT ( iv1,  1  ) , '000000FE'X ) , 
     :             IAND (  iv0 / 128         , '00000001'X )    )
...
!			   }
	     ...
	     IF ( .NOT.rev ) THEN
		ieee_byte(0) =  IOR (   IAND ( iv1,  '00000080'X ) ,
     :                                  IAND ( e/2 , '0000007F'X )   ) 

		ieee_byte(1) =  IOR (   IAND ( iv0,    '0000007F'X ) ,
     :                                  IAND ( e*128 , '00000080'X )   ) 

		ieee_byte(2) = vaxf_byte(3)
		ieee_byte(3) = vaxf_byte(2)

	     ELSE
		ieee_byte(3) =  IOR (   IAND ( iv1,  '00000080'X ) ,
     :                                  IAND ( e/2 , '0000007F'X )   ) 

		ieee_byte(2) =  IOR (   IAND ( iv0,    '0000007F'X ) ,
     :                                  IAND ( e*128 , '00000080'X )   ) 
...
!
		...
		f =  ISHFT ( f , -(3-e) )
             IF ( .NOT.rev ) THEN
		ieee_byte(0) = IAND ( iv1 , '00000080'X )
		ieee_byte(1) = IAND ( f/65536 , '0000007F'X )
		ieee_byte(2) = IAND ( f/256 , '000000FF'X )
		ieee_byte(3) = IAND ( f , '000000FF'X )
             ELSE
		ieee_byte(3) = IAND ( iv1 , '00000080'X )
		ieee_byte(2) = IAND ( f/65536 , '0000007F'X )
		ieee_byte(1) = IAND ( f/256 , '000000FF'X )
		ieee_byte(0) = IAND ( f , '000000FF'X )
	     ENDIF
