...
*  Purpose:
*     Obtain a real parameter value.

*  Language:
*     Starlink Fortran 77

*  Invocation:
*     CALL GET0R( PARAMS, POS, OPT, COMM, PROMPT, DEFVAL, VALUE, STATUS )
...
*  Construct the default string.
      IF( DEFVAL .NE. VAL__BADR ) THEN
         CALL CHR_RTOC( DEFVAL, DEFSTR, NC )
      ELSE
         DEFSTR = 'BAD'
         NC = 3
      END IF
...
*  it. Then re-prompt the user.
         IF( STATUS .NE. SAI__OK ) THEN
            ...
            CALL ERR_REP( 'GET0R_ERR1', 'Unable to convert string '//
