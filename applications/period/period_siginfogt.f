...
C===========================================================================
      ...
      SUBROUTINE PERIOD_SIGINFOGT(IPARRAY, NUMROWS, NUMCOLS, NCOUNT,
     :                             STAT, NSTATS, SAMPLE, WORK2,
     :                             NUMWRK)

C===========================================================================
C Determines significance information for PERIOD; tests for GT/GE.
...
C---------------------------------------------------------------------------
      ...
      DO 10 I = 1, NCOUNT
         IF ( WORK2(I).GT.STAT(SAMPLE) ) STAT(SAMPLE) = WORK2(I)
         IF ( SAMPLE.GT.1 ) THEN
            IF ( WORK2(I).GE.IPARRAY(I, 2) )
