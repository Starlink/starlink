*+  EXPE - Takes the exponential of each pixel of a data array (base e)

      SUBROUTINE EXPE ( STATUS )
*
*    Description :
*
...
*          try to get the base to exponentiate each input array pixel
            ...
            CALL PAR_GDR0R( 'BASE', 2.718282, MNBASE, MXBASE, .TRUE.,
     :                      BASE, STATUS )
...
*                   unmap output data array
                  ...
                  ELSE
                     ...
                     CALL ERR_REP( 'ERR_EXPE_NOMPO',
     :                 'EXPE : Error occurred whilst trying to map '/
     :                 /'output frame', STATUS )
...
*                tidy up output structures
               ...
               ELSE
                  ...
                  IF ( STATUS .NE. PAR__ABORT ) THEN
                     CALL ERR_REP( 'ERR_EXPE_NOFRO',
     :                 'EXPE : Error occurred whilst trying to '/
...
*          unmap input data array
         ...
         ELSE
            ...
            CALL ERR_REP( 'ERR_EXPE_NOMPI',
     :        'EXPE : Error occurred whilst trying to map or find '/
...
*       tidy up the input structures
      ...
      ELSE
         ...
         IF ( STATUS .NE. PAR__ABORT ) THEN
            CALL ERR_REP( 'ERR_EXPE_NOFRI',
     :        'EXPE : Error occurred whilst trying to access input '/
     :        /'frame', STATUS )
         END IF
