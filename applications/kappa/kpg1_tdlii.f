      SUBROUTINE KPG1_TDLII( NDIMI, IDIMS, INARR, VAR, INVAR, TRID,
...
*  Local Variables:
      ...
      INTEGER NCOUT            ! Number of values in the forward
                               ! transformation
      INTEGER NEIGH( 2 ** NDF__MXDIM ) ! Vector of input data values
      ...
      INTEGER STRIDO( NDF__MXDIM ) ! Dimension strides for output arrays
                               ! and co-ordinates
      INTEGER VNEIGH( 2 ** NDF__MXDIM ) ! Vector of input variance
