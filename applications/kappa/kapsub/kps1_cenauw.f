      SUBROUTINE KPS1_CENAUW( NDIMS, SLBND, SUBND, DIN, VIN,
...
*  Invocation:
*     CALL KPS1_CENAUW( NDIMS, SLBND, SUBND, DIN, VIN, VLBND, VUBND,
*                      OUT, STATUS )
...
*  Copy the N-dimensional section from the input data array to the output.
      CALL KPG1_CPNDUW( NDIMS, SLBND, SUBND, DIN, VLBND, VUBND, OUT,
     :                   EL, STATUS )

*  Allocate work array to hold a section copied from the input variance
*  array.
      CALL PSX_CALLOC( EL, '_UWORD', IPW, STATUS )
