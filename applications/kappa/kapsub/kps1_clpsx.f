      SUBROUTINE KPS1_CLPS<R>( AXIS, LO, HI, VAR, METH, WLIM, NEL2, 
...
*  Invocation:
*     CALL KPS1_CLPS<R>( AXIS, LO, HI, VAR, METH, WLIM, NEL2, NDIM1, 
...
*  Check the supplied METH value.
      ...
      ELSE IF( STATUS .EQ. SAI__OK ) THEN
         ...
         CALL ERR_REP( 'KPS1_CLPS<R>_ERR1', 'KPS1_CLPS<R>: '//
...
*  line of data.
      ...
      IF( VAR ) THEN
         ...
         CALL CCG1_CM1<R><R>( WORK1, NEL2, NLIN, WORK2, IMETH, 
     ...
     :                    %VAL (IPUSED ), STATUS )
      ...
      ELSE
         ...
         CALL CCG1_CM3<R><R>( WORK1, NEL2, NLIN, %VAL( IPVAR ), IMETH,
     :                    MAX( 1, NINT( WLIM*REAL( NLIN ) ) ),
     :                    0, 0.0, 0.0, 0.0, 0.0,
