      SUBROUTINE KPS1_CENAW( NDIMS, SLBND, SUBND, DIN, VIN, 
...
*  Invocation:
*     CALL KPS1_CENAW( NDIMS, SLBND, SUBND, DIN, VIN, VLBND, VUBND, 
*                      OUT, STATUS )
