      SUBROUTINE KPS1_NOM1I( EL, INARR, OLDVAL, MEAN, SIGMA, DATMIN,
...
*  Find the maximum and minimum allowable output values.
      HILIM = MIN( NUM_ITOD( VAL__MAXI ), DATMAX )
...
*  the low limit.
      IF ( HILIM .LE. LOLIM ) THEN
         ...
         IF ( 'I' .EQ. 'B' .OR. 'I' .EQ. 'W' .OR.
     :        'I' .EQ. 'UB' .OR. 'I' .EQ. 'UW' .OR.
     :        'I' .EQ. 'I' ) THEN
