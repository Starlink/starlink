      SUBROUTINE KPS1_SPARR( CFRM, MAP,  DIM1, DIM2, ARRAY, LBND, 
...
*  Invocation:
*     CALL KPS1_SPARR( CFRM, MAP, DIM1, DIM2, ARRAY, LBND, ISIZE, RANGE,
...
*  room for the expansion of the token.
         CALL PSX_MALLOC( BINPTS * VAL__NBR, DAPTR, STATUS )
...
*  =========================================
         ...
         CALL KPS1_RPRFR( DIM1, DIM2, ARRAY, LBND, SIG0, AXISR, THETA,
...
*  Now write them to the output parameters.
      ...
      ELSE
         ...
         CALL ERR_REP( 'KPS1_SPARR_NOFITS',
