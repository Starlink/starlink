      SUBROUTINE KPS1_PGFTW( P, PW, PR, NP, NITER, TOLL, AMP, BACK,
     :                         SIGMA, GAMMA, STATUS )
*+
*  Name:
*     KPS1_PGFTx
...
*  If relative accuracy criterion is met, exit from iteration loop.
      ...
      STATUS = SAI__ERROR
      CALL ERR_REP( 'KPS1_PGFTx_TOLNM',
     :  'Tolerance not met when fitting the radial Gaussian profile.',
     :   STATUS )
