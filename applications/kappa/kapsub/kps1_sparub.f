      SUBROUTINE KPS1_SPARUB( CFRM, MAP,  DIM1, DIM2, ARRAY, LBND, 
     :                        ISIZE, RANGE,
...
*  Invocation:
*     CALL KPS1_SPARUB( CFRM, MAP, DIM1, DIM2, ARRAY, LBND, ISIZE, RANGE,
*                        GAUSS, NXY, POS, LOGF, FD,
*                        PNMIN, PAXISR, PORIEN, PFWHM, PGAMMA, IDS, 
...
*  room for the expansion of the token.
         CALL PSX_MALLOC( BINPTS * VAL__NBUB, DAPTR, STATUS )
...
*  Now write them to the output parameters.
      ...
      ELSE
         ...
         CALL ERR_REP( 'KPS1_SPARUB_NOFITS',
