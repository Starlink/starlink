      SUBROUTINE KPS1_RPRFB( DIM1, DIM2, ARRAY, LBND, SIG0, AXISR,
...
*  Invocation:
*     CALL KPS1_RPRFB( DIM1, DIM2, ARRAY, LBND, SIG0, AXISR, THETA,
...
*  If the pixel is valid, calculate the effective radius.
                  IF ( ARRAY( IMLOCN ) .NE. VAL__BADB ) THEN
                     DX2 = DX * DX
                     DXY = DX * DY
...
*  Find the most likely value in the bin.
                  ...
                  ELSE
                     CALL KPG1_MODEB( DATA, ICOUNT, PBAD, NITER, 0.1,
