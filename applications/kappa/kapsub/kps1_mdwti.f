      SUBROUTINE KPS1_MDWTI( DIFF, STEP, DAMP, NUMSAM, MEDPOS, MEDTHR,
...
*  Test for replacement.
               DELTA = MEDIAN - NUM_ITOD( ARRIN( OFSETX, OFSETY ) )
