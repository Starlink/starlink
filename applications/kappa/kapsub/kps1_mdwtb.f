      SUBROUTINE KPS1_MDWTB( DIFF, STEP, DAMP, NUMSAM, MEDPOS, MEDTHR,
...
*  Test for replacement.
               DELTA = MEDIAN - NUM_BTOD( ARRIN( OFSETX, OFSETY ) )
