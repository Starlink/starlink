      SUBROUTINE KPS1_CENAB( NDIMS, SLBND, SUBND, DIN, VIN, 
...
*  Invocation:
*     CALL KPS1_CENAB( NDIMS, SLBND, SUBND, DIN, VIN, VLBND, VUBND, 
*                      OUT, STATUS )
