      SUBROUTINE KPS1_CLPSD( AXIS, LO, HI, VAR, METH, WLIM, NEL2, 
...
*  Invocation:
*     CALL KPS1_CLPSD( AXIS, LO, HI, VAR, METH, WLIM, NEL2, NDIM1, 
...
*  Arguments Returned:
      ...
      DOUBLE PRECISION WORK1( NEL2, * )
      DOUBLE PRECISION WORK2( NEL2, * )
...
*  Check the supplied METH value.
      ...
      ELSE IF( STATUS .EQ. SAI__OK ) THEN
         ...
         CALL ERR_REP( 'KPS1_CLPSD_ERR1', 'KPS1_CLPSD: '//
...
*  line of data.
      ...
      CALL PSX_CALLOC( NLIN, '_DOUBLE', IPWRK1, STATUS )
      CALL PSX_CALLOC( NLIN, '_DOUBLE', IPWRK2, STATUS )
      ...
      IF( VAR ) THEN
         ...
         CALL CCG1_CM1DD( WORK1, NEL2, NLIN, WORK2, IMETH, 
     ...
     :                    %VAL (IPUSED ), STATUS )
      ...
      ELSE
         ...
         CALL CCG1_CM3DD( WORK1, NEL2, NLIN, %VAL( IPVAR ), IMETH,
     :                    MAX( 1, NINT( WLIM*REAL( NLIN ) ) ),
     :                    0, 0.0, 0.0, 0.0, 0.0,
