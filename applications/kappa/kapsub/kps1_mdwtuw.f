      SUBROUTINE KPS1_MDWTUW( DIFF, STEP, DAMP, NUMSAM, MEDPOS, MEDTHR,
...
*  Test for replacement.
               DELTA = MEDIAN - NUM_UWTOD( ARRIN( OFSETX, OFSETY ) )
