      SUBROUTINE KPS1_SPARD( CFRM, MAP,  DIM1, DIM2, ARRAY, LBND, 
...
*  Invocation:
*     CALL KPS1_SPARD( CFRM, MAP, DIM1, DIM2, ARRAY, LBND, ISIZE, RANGE,
...
*  room for the expansion of the token.
         CALL PSX_MALLOC( BINPTS * VAL__NBD, DAPTR, STATUS )
...
*  Now write them to the output parameters.
      ...
      ELSE
         ...
         CALL ERR_REP( 'KPS1_SPARD_NOFITS',
