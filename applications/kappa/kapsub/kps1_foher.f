      SUBROUTINE KPS1_FOHER( M, N, R, I, H, MAXDEV, STATUS )
*+
*  Name:
*     KPS1_FOHEx
...
*  number of lines is even.
      DO K = NP3H, KLIM
         ...
         V1 = R( MP1H, K )
         V2 = R( MP1H, FN - K )
         H( MP1H, K ) = ( V1 + V2 ) / 2.0E0
         MAXDEV = MAX( MAXDEV, ABS( V2 - V1 ) )

         V1 = I( MP1H, FN - K )
         V2 = -I( MP1H, K )
         H( MP1H, FN - K ) = ( V1 + V2 ) / 2.0E0
         MAXDEV = MAX( MAXDEV, ABS( V2 - V1 ) )

         DO J = MP3H, JLIM

            V1 = ( R( J, K ) + R( FM - J, K ) ) / 2.0E0
            V2 = ( R( J, FN - K ) + R( FM - J, FN - K ) ) / 2.0E0
            H( J, K ) = ( V1 + V2 ) / 2.0E0
            MAXDEV = MAX( MAXDEV, ABS( V2 - V1 ) )

            V1 = ( R( J, FN - K ) - R( FM - J, FN - K ) ) / 2.0E0
            V2 = ( R( FM - J, K ) - R( J, K ) ) / 2.0E0
            H( FM - J, FN - K ) = ( V1 + V2 ) / 2.0E0
            MAXDEV = MAX( MAXDEV, ABS( V2 - V1 ) )

            V1 = ( I( FM - J, K ) - I( J, K ) ) / 2.0E0
            V2 = ( I( FM - J, FN - K ) - I( J, FN - K ) ) / 2.0E0
            H( FM - J, K ) = ( V1 + V2 ) / 2.0E0
            MAXDEV = MAX( MAXDEV, ABS( V2 - V1 ) )

            V1 = ( - I( FM - J, K ) - I( J, K ) ) / 2.0E0
            V2 = ( I( FM - J, FN - K ) + I( J, FN - K ) ) / 2.0E0
            H( J, FN - K ) = ( V1 + V2 ) / 2.0E0
            MAXDEV = MAX( MAXDEV, ABS( V2 - V1 ) )
