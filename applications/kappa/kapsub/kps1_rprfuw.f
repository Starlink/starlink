      SUBROUTINE KPS1_RPRFUW( DIM1, DIM2, ARRAY, LBND, SIG0, AXISR,
...
*  Invocation:
*     CALL KPS1_RPRFUW( DIM1, DIM2, ARRAY, LBND, SIG0, AXISR, THETA,
...
*     Council. Copyright (C) 1998-1999 Central Laboratory of the
...
*  If the pixel is valid, calculate the effective radius.
                  IF ( ARRAY( IMLOCN ) .NE. VAL__BADUW ) THEN
                     DX2 = DX * DX
                     DXY = DX * DY
...
*  Find the most likely value in the bin.
                  ...
                  ELSE
                     CALL KPG1_MODEUW( DATA, ICOUNT, PBAD, NITER, 0.1,
