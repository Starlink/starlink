      SUBROUTINE KPS1_CENA<R>( NDIMS, SLBND, SUBND, DIN, VIN, 
...
*  Invocation:
*     CALL KPS1_CENA<R>( NDIMS, SLBND, SUBND, DIN, VIN, VLBND, VUBND, 
*                      OUT, STATUS )
...
*  Copy the N-dimensional section from the input data array to the output.
      CALL KPG1_CPND<R>( NDIMS, SLBND, SUBND, DIN, VLBND, VUBND, OUT, 
     :                   EL, STATUS )
...
*  work array.
      CALL KPG1_CPND<R>( NDIMS, SLBND, SUBND, VIN, VLBND, VUBND, 
     :                   %VAL( IPW ), EL, STATUS )

*  Add Gaussian noise to the returned data section.
      CALL KPG1_NOIS<R>( .TRUE., EL, %VAL( IPW ), OUT, STATUS )
