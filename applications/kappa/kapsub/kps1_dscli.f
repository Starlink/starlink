      SUBROUTINE KPS1_DSCLI( BAD, DIM1, DIM2, INARR, INVERT, PARLOW,
...
*     INTEGER array, and is then asked for the limits between which
...
*  Local Variables:
     ...
     :  DTMAX,                  ! Maximum data value for INTEGER
     :  DTMIN,                  ! Minimum data value for INTEGER
...
*       Check that there is indeed a range.
         ...
         IF ( STATUS .EQ. SAI__OK ) THEN
            ...
            IF ( ABS( DUPPER - DLOWER ) .LT. DSML ) THEN
               STATUS = SAI__ERROR
               CALL ERR_REP( 'KPG1_DSCLI_INVRNG',
...
*    Scale the values between the upper and lower pens.
      ...
      CALL KPG1_ISCLI( BAD, DIM1, DIM2, INARR, INVERT, LOWER, UPPER,
