      SUBROUTINE KPS1_MDWTW( DIFF, STEP, DAMP, NUMSAM, MEDPOS, MEDTHR,
...
*  Test for replacement.
               DELTA = MEDIAN - NUM_WTOD( ARRIN( OFSETX, OFSETY ) )
