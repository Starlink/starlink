      SUBROUTINE KPS1_FOFOD( M, N, UNTANG, DATA, WIM1, WIM2, WIM3,
     :                        STATUS )
*+
*  Name:
*     KPS1_FOFOx
...
*  Arguments Returned:
      DOUBLE PRECISION WIM1( M, N )
      DOUBLE PRECISION WIM2( * )
      DOUBLE PRECISION WIM3( M, N )

*  Status:
      INTEGER STATUS             ! Global status

*  Local Variables:
      DOUBLE PRECISION AA                 ! Real part of FFT of (real
                                 ! part of FFT of data)
      DOUBLE PRECISION AB                 ! Real part of FFT of (imag.
                                 ! part of FFT of data)
      DOUBLE PRECISION BA                 ! Imag. part of FFT of (real
                                 ! part of FFT of data)
      DOUBLE PRECISION BB                 ! Imag. part of FFT of (imag.
                                 ! part of FFT of data)
...
*  Transform the supplied image, storing the FT in the WIM3 array.
      CALL KPG1_FFTFD( M, N, DATA, WIM2, WIM3, STATUS )
