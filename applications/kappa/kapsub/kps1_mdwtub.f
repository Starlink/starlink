      SUBROUTINE KPS1_MDWTUB( DIFF, STEP, DAMP, NUMSAM, MEDPOS, MEDTHR,
...
*  Test for replacement.
               DELTA = MEDIAN - NUM_UBTOD( ARRIN( OFSETX, OFSETY ) )
