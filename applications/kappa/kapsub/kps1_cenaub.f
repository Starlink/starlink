      SUBROUTINE KPS1_CENAUB( NDIMS, SLBND, SUBND, DIN, VIN, 
...
*  Invocation:
*     CALL KPS1_CENAUB( NDIMS, SLBND, SUBND, DIN, VIN, VLBND, VUBND, 
*                      OUT, STATUS )
...
*  Copy the N-dimensional section from the input data array to the output.
      CALL KPG1_CPNDUB( NDIMS, SLBND, SUBND, DIN, VLBND, VUBND, OUT, 
     :                   EL, STATUS )

*  Allocate work array to hold a section copied from the input variance
*  array.
      CALL PSX_CALLOC( EL, '_UBYTE', IPW, STATUS )

*  Copy the N-dimensional section from the input variance array to the 
*  work array.
      CALL KPG1_CPNDUB( NDIMS, SLBND, SUBND, VIN, VLBND, VUBND, 
     :                   %VAL( IPW ), EL, STATUS )

*  Add Gaussian noise to the returned data section.
      CALL KPG1_NOISUB( .TRUE., EL, %VAL( IPW ), OUT, STATUS )
