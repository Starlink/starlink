...
*  Description:
*     The routine obtains access to an existing NDF specified at a
*     given index within the given group, and issues an NDF identifier
*     for it. It is equivalent to NDF_ASSOC.
 ...
 999  CONTINUE
      ...
      IF ( STATUS .NE. SAI__OK ) THEN
         ...
         IF( NAME .NE. ' ' ) THEN
            ...
            CALL ERR_REP( 'NDG_NDFAS_ERR1',
     :         'NDG_NDFAS: Unable to get an NDF identifier for "^NAME"',
     :                     STATUS )

         ELSE
            CALL ERR_REP( 'NDG_NDFAS_ERR2',
     :   'NDG_NDFAS: Unable to get an NDF identifier for an existing '//
     :   'data set.', STATUS )
