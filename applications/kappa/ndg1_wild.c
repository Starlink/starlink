 ...
 *  Returns:
 *     (<) STATUS     (Integer, function value) A status code. Zero for
 *                    success.
 *
 *  Method:
 ...
 *                  The values are defined in the files ndg_err.h
 *+
 */
