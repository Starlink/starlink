      SUBROUTINE CCG1_BMR1R( STACK, NPIX, NLINES, VARS, MINPIX, COVEC,
...
*  Invocation:
*     CALL CCG1_BMR1( STACK, NPIX, NLINES, VARS, MINPIX, COVEC, RESULT,
*                     RESVAR, WRK1, NCON, POINT, USED, STATUS )
...
*  Sum weights.
               SUM = SUM + 1.0D0 / NUM_RTOD( VARS( I, J ) )
...
*  Find the trimmed mean and determine variance.
            CALL CCG1_TRM2R( ALPHA, WRK1, SUM, NGOOD, USED,
