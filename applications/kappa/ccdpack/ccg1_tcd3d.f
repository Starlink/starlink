      SUBROUTINE CCG1_TCD3D( RMIN, RMAX, STACK, NPIX, NLINES, VARS,
...
*  Invocation:
*     CALL CCG1_TCD3( RMIN, RMAX, STACK, NPIX, NLINES, VARS, MINPIX,
...
*  Clip unwanted data.
            CALL CCG1_CLIPD( WRK1, NGOOD, DBLE( RMIN ), DBLE( RMAX ),
     :                       IGOOD, STATUS )
