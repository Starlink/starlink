      SUBROUTINE CCG1_SMR3R( NSIGMA, STACK, NPIX, NLINES, VARS,
...
*  Invocation:
*     CALL CCG1_SMR3( NSIGMA, STACK, NPIX, NLINES, VARS, MINPIX,
...
*  Local Variables:
      REAL RVAL1                ! Dummy DBLE value
      REAL RVAL2                ! Dummy DBLE value
...
*  If any values are retained then form the median.
               IF ( IGOOD .GT. 0 ) THEN
                  CALL CCG1_WTM2R( WRK1( LBND ), WRK2( LBND ), IGOOD,
     :                             USED, VAL, STATUS )
