      SUBROUTINE CCG1_MOR3R( NSIGMA, NITER, STACK, NPIX, NLINES,
...
*  Invocation:
*     CALL CCG1_MOR3( NSIGMA, NITER, STACK, NPIX, NLINES, VARS, MINPIX,
...
*  Form mode.
            CALL CCG1_WMD2R( WRK1, WRK2, NGOOD, PBAD, NITER, TOLL,
