      SUBROUTINE CCG1_TMD3D( ALPHA, STACK, NPIX, NLINES, MINPIX,
...
*  Invocation:
*     CALL CCG1_TMD3( ALPHA, STACK, NPIX, NLINES, MINPIX, RESULT,
...
*  Find the trimmed mean.
            CALL CCG1_TRM3D( ALPHA, WRK1, NGOOD, USED, VAL, STATUS )
