      SUBROUTINE CCG1_BMD1D( STACK, NPIX, NLINES, VARS, MINPIX, COVEC,
...
*  Invocation:
*     CALL CCG1_BMD1( STACK, NPIX, NLINES, VARS, MINPIX, COVEC, RESULT,
*                     RESVAR, WRK1, NCON, POINT, USED, STATUS )

*  Description:
*     This routine accepts an array consisting a series of (vectorised)
*     lines of data. The data values in the lines are then combined to
*     form a broadened medium line. The broadened median is similar to
