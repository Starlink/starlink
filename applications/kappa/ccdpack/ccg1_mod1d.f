      SUBROUTINE CCG1_MOD1D( NSIGMA, NITER, STACK, NPIX, NLINES,
...
*  Invocation:
*     CALL CCG1_MOD1( NSIGMA, NITER, STACK, NPIX, NLINES, VARS, MINPIX,
...
*  Form mode.
            CALL CCG1_WMD3D( WRK1, WRK2, NGOOD, PBAD, NITER, TOLL,
