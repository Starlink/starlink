      SUBROUTINE CCG1_TRM2D( ALPHA, ORDDAT, SVAR, NSET, USED, COVAR,
     :                         TMEAN, TVAR, STATUS )
*+
*  Name:
*     CCG1_TRM2D
...
*  Invocation:
*     CALL CCG1_TRM2D( ALPHA, ORDDAT, ORDVAR, NSET, USED, COVAR,
*                        TMEAN, TVAR, STATUS )
