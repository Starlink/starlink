      SUBROUTINE CCG1_MMR3R( STACK, NPIX, NLINES, MINPIX, RESULT,
...
*  Invocation:
*     CALL CCG1_MMR3( STACK, NPIX, NLINES, MINPIX, RESULT,
*                     WRK1, NCON, POINT, USED, STATUS )
...
*  Find the min-max trimmed mean.
            CALL CCG1_TMN3R( 1, WRK1, NGOOD, USED, VAL, STATUS )
