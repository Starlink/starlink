      SUBROUTINE CCG1_KTHD( N, K, ARRAY, ANCDAT, VALUE, STATUS )
*+
*  Name:
*     CCG1_KTHD
...
*  Invocation:
*     CALL CCG1_KTHD( N, K, ARRAY, ANCDAT, VALUE, STATUS )
...
*     ARRAY( N ) = DOUBLE PRECISION (Given and Returned)
