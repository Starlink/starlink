      SUBROUTINE CCG1_WTM4D( ORDDAT, WEIGHT, VAR, LBND, UBND, NENT,
...
*  Invocation:
*      CALL CCG1_WTM4D( ORDDAT, WEIGHT, VAR, LBND, UBND, NENT, USED,
...
*  Bounds are present value and previous one.
         LOWER = I - 1
         UPPER = I
         D1 = NUM_DTOD( ORDDAT( LOWER ) )
         D2 = NUM_DTOD( ORDDAT( UPPER ) )
