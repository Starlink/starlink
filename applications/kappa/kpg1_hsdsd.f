      SUBROUTINE KPG1_HSDSD( NUMBIN, HIST, HRMIN, HRMAX, STATUS )
*+
*  Name:
*     KPG1_HSDSx
...
*  Local Variables:
      DOUBLE PRECISION NBINWD             ! Width of the report bins
      DOUBLE PRECISION RANGE              ! The difference between the maximum
...
*  square images.
         DO  K = 1, NUMBIN, 1
            WRITE ( TEXT, 10 ) HRMIN + NUM_ITOD( K-1 ) * NBINWD,
     :              HRMIN + NUM_ITOD( K ) * NBINWD, HIST( K )
