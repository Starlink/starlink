      SUBROUTINE CHVALB( DIM, INARR, OLDVAL, NEWVAL, OUTARR, STATUS )
*
*    Description :
*
...
*    Invocation :
*
*     CALL CHVALB( DIM, INARR, OLDVAL, NEWVAL, OUTARR, STATUS )
*
*    Arguments :
*
*     DIM = INTEGER( READ )
...
*    External references :
      ...
      DOUBLE PRECISION
     :  VAL_BTOD             ! Data-conversion external function
...
*    minimum detectable difference.
      ...
      FPOLD = 0.5 * VAL_BTOD( .FALSE., OLDVAL, STATUS )
      DIFF = ABS( FPOLD * VAL__EPSD )
      DO  I = 1, DIM, 1
 
*       The halving is done to prevent overflows.
 
         IF ( ABS( ( VAL_BTOD( .FALSE., INARR( I ), STATUS ) * 0.5 )
     :        - FPOLD ) .LE. DIFF ) THEN
