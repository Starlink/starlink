      SUBROUTINE FTS1_WKEYL( NAME, VALUE, CMTBGN, COMNT, HEADER,
     :                         STATUS )
*+
*  Name:
*     FTS1_WKEYx
...
*  Format the value string.
      CALL CHR_LTOC( VALUE, VALSTR, VALN )
         
*  See if there is any error during formation.
      IF ( VALSTR( : VALN ) .EQ. '*' ) THEN
         STATUS = SAI__ERROR
         CALL MSG_SETL( 'V', VALUE )
         CALL MSG_SETC( 'TYPE', 'LOGICAL' )
         CALL ERR_REP( 'FTS1_WKEYL_TYPCNV',
