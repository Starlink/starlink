      SUBROUTINE KPG1_ISCLD( BAD, DIM1, DIM2, INARR, INVERT, LOWER,
...
*    if the scaling cannot be performed.
      ...
      IF ( ABS( DU - DL ) .LT. NUM_DTOD( VAL__SMLD ) ) THEN
         STATUS = SAI__ERROR
