*+  EXP10 - Takes the base-10 exponential of each pixel of a data array

      SUBROUTINE EXP10 ( STATUS )
*
*    Description :
*
...
*                   unmap output data array
                  ...
                  ELSE
                     ...
                     CALL ERR_REP( 'ERR_EXP10_NOMPO',
     :                 'EXP10 : Error occurred whilst trying to map '/
     :                 /'output frame', STATUS )
...
*                tidy up output structures
               ...
               ELSE
                  ...
                  IF ( STATUS .NE. PAR__ABORT ) THEN
                     CALL ERR_REP( 'ERR_EXP10_NOFRO',
     :                 'EXP10 : Error occurred whilst trying to '/
...
*          unmap input data array
         ...
         ELSE
            ...
            CALL ERR_REP( 'ERR_EXP10_NOMPI',
     :        'EXP10 : Error occurred whilst trying to map or find '/
...
*       tidy up the input structures
      ...
      ELSE
         ...
         IF ( STATUS .NE. PAR__ABORT ) THEN
            CALL ERR_REP( 'ERR_EXP10_NOFRI',
     :        'EXP10 : Error occurred whilst trying to access input '/
     :        /'frame', STATUS )
         END IF
