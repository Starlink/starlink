      SUBROUTINE KPG1_PSFSR( PSF, NPIX, NLIN, WORK, NPW, NLW, FRACT,
...
*  Local Variables:
      REAL CFRACT             ! Fraction of peak amplitude within a
                                 ! safe range
      ...
      REAL T1                 ! Running sum for y profile
      REAL TARGET             ! Lowest significant PSF value
      REAL XMAX               ! Maximum value in the x profile
      REAL XMIN               ! Minimum value in the x profile
      REAL XVAL               ! Current x profile value
      REAL YMAX               ! Maximum value in the y profile
      REAL YMIN               ! Minimum value in the y profile
      REAL YVAL               ! Current y profile value
...
*  Constrain the fraction to be a sensible value.
      IF ( FRACT .LT. VAL__SMLR .OR. FRACT .GT. 0.5 ) THEN
         CFRACT = 1.0E0 / 16.0E0
      ELSE
         CFRACT = FRACT
      END IF
