...
*                   unmap output data array
                  ...
                  ELSE
                     ...
                     CALL ERR_REP( 'ERR_LOGE_NOMPO',
     :                 'LOGE: Error occurred whilst trying to map '/
     :                 /'output frame', STATUS )
...
*                tidy up output structures
               ...
               ELSE
                  ...
                  IF ( STATUS .NE. PAR__ABORT ) THEN
                     CALL ERR_REP( 'ERR_LOGE_NOFRO',
     :                 'LOGE: Error occurred whilst trying to access '/
     :                 /'output frame', STATUS )
                  END IF
...
*          unmap input data array
         ...
         ELSE
            ...
            CALL ERR_REP( 'ERR_LOGE_NOMPI',
     :        'LOGE: Error occurred whilst trying to map or find the '/
     :        /'shape of input frame', STATUS )
...
*       tidy up the input structures
      ...
      ELSE
         ...
         IF ( STATUS .NE. PAR__ABORT ) THEN
            CALL ERR_REP( 'ERR_LOGE_NOFRI',
     :        'LOGE: Error occurred whilst trying to access input '/
     :        /'frame', STATUS )
         END IF
