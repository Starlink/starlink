...
alias qualtobad $KAPPA_DIR/qualtobad
alias kap_qualtobad $KAPPA_DIR/qualtobad

alias remqual $KAPPA_DIR/remqual
alias kap_remqual $KAPPA_DIR/remqual
...
alias setqual $KAPPA_DIR/setqual
alias kap_setqual $KAPPA_DIR/setqual
...
alias showqual $KAPPA_DIR/showqual
alias kap_showqual $KAPPA_DIR/showqual
...
alias ardplot $KAPPA_DIR/ardplot
alias kap_ardplot $KAPPA_DIR/ardplot

alias colcomp $KAPPA_DIR/colcomp
alias kap_colcomp $KAPPA_DIR/colcomp
...
alias drawnorth $KAPPA_DIR/drawnorth
alias kap_drawnorth $KAPPA_DIR/drawnorth
...
alias lutedit $KAPPA_DIR/lutedit
alias kap_lutedit $KAPPA_DIR/lutedit
...
alias kap_collapse $KAPPA_DIR/collapse
...
alias permaxes $KAPPA_DIR/permaxes
alias kap_permaxes $KAPPA_DIR/permaxes
...
alias regrid $KAPPA_DIR/regrid
alias kap_regrid $KAPPA_DIR/regrid
...
alias kapversion $KAPPA_DIR/kapversion
alias kap_kapversion $KAPPA_DIR/kapversion
...
alias kapdemo '$KAPPA_DIR/stardemo.tcl'
alias kap_kapdemo '$KAPPA_DIR/stardemo.tcl'
...
alias lutcold 'lutable mapping=linear coltab=external lut=$KAPPA_DIR/cold_lut'
alias kap_lutcold 'lutable mapping=linear coltab=external lut=$KAPPA_DIR/cold_lut'

alias lutcont 'lutable mapping=linear coltab=external lut=$KAPPA_DIR/cont_lut'
alias kap_lutcont 'lutable mapping=linear coltab=external lut=$KAPPA_DIR/cont_lut'

alias lutfc 'lutable mapping=linear coltab=external lut=$KAPPA_DIR/fc_lut'
alias kap_lutfc 'lutable mapping=linear coltab=external lut=$KAPPA_DIR/fc_lut'
...
alias lutikon 'lutable mapping=linear coltab=external lut=$KAPPA_DIR/ikon_lut'
alias kap_lutikon 'lutable mapping=linear coltab=external lut=$KAPPA_DIR/ikon_lut'

alias lutneg 'lutable mapping=linear coltab=negative'
alias kap_lutneg 'lutable mapping=linear coltab=negative'

alias lutramps 'lutable mapping=linear coltab=external lut=$KAPPA_DIR/ramps_lut'
alias kap_lutramps 'lutable mapping=linear coltab=external lut=$KAPPA_DIR/ramps_lut'

alias lutread 'lutable mapping=linear coltab=external'
alias kap_lutread 'lutable mapping=linear coltab=external'
...
alias lutwarm 'lutable mapping=linear coltab=external lut=$KAPPA_DIR/warm_lut'
alias kap_lutwarm 'lutable mapping=linear coltab=external lut=$KAPPA_DIR/warm_lut'

alias lutzebra 'lutable mapping=linear coltab=external lut=$KAPPA_DIR/zebra_lut'
alias kap_lutzebra 'lutable mapping=linear coltab=external lut=$KAPPA_DIR/zebra_lut'
...
alias outline 'contour clear=n mode=bounds penrot=y'
alias kap_outline 'contour clear=n mode=bounds penrot=y'
...
alias picgrid 'picdef mode=array fraction=1.0 prefix=""'
alias kap_picgrid 'picdef mode=array fraction=1.0 prefix=""'

alias piclast 'piclist picnum=last'
alias kap_piclast 'piclist picnum=last'

alias picxy 'picdef mode=xy fraction=1.0'
alias kap_picxy 'picdef mode=xy fraction=1.0'

alias transformer echo  The transformer command has been retired to the KAPRH package - see SUN239. Use \\\"regrid\\\" instead. 
alias kap_transformer echo  The transformer command has been retired to the KAPRH package - see SUN239. Use \\\"regrid\\\" instead. 

alias traninvert echo  The traninvert command has been retired to the KAPRH package - see SUN239. 
alias kap_traninvert echo  The traninvert command has been retired to the KAPRH package - see SUN239. 

alias tranjoin echo  The tranjoin command has been retired to the KAPRH package - see SUN239. 
alias kap_tranjoin echo  The tranjoin command has been retired to the KAPRH package - see SUN239. 

alias tranmake echo  The tranmake command has been retired to the KAPRH package - see SUN239. 
alias kap_tranmake echo  The tranmake command has been retired to the KAPRH package - see SUN239. 

alias trantrace echo  The trantrace command has been retired to the KAPRH package - see SUN239. 
alias kap_trantrace echo  The trantrace command has been retired to the KAPRH package - see SUN239. 

alias idset echo  The idset command has been retired to the KAPRH package - see SUN239. Use \\\"gdset\\\" instead. 
alias kap_idset echo  The idset command has been retired to the KAPRH package - see SUN239. Use \\\"gdset\\\" instead. 

alias idclear echo  The idclear command has been retired to the KAPRH package - see SUN239. Use \\\"gdclear\\\" instead. 
alias kap_idclear echo  The idclear command has been retired to the KAPRH package - see SUN239. Use \\\"gdclear\\\" instead. 

alias idstate echo  The idstate command has been retired to the KAPRH package - see SUN239. Use \\\"gdstate\\\" instead. 
alias kap_idstate echo  The idstate command has been retired to the KAPRH package - see SUN239. Use \\\"gdstate\\\" instead. 

alias ovset echo  The ovset command has been retired to the KAPRH package - see SUN239. 
alias kap_ovset echo  The ovset command has been retired to the KAPRH package - see SUN239. 

alias ovclear echo  The ovclear command has been retired to the KAPRH package - see SUN239. 
alias kap_ovclear echo  The ovclear command has been retired to the KAPRH package - see SUN239. 

alias idinvisible echo  The idinvisible command has been moved to the KAPRH package - see SUN239. 
alias kap_idinvisible echo  The idinvisible command has been moved to the KAPRH package - see SUN239. 

alias idpazo echo  The idpazo command has been moved to the KAPRH package - see SUN239. 
alias kap_idpazo echo  The idpazo command has been moved to the KAPRH package - see SUN239. 

alias lutflip echo  The lutflip command has been moved to the KAPRH package - see SUN239. 
alias kap_lutflip echo  The lutflip command has been moved to the KAPRH package - see SUN239. 

alias luthilite echo  The luthilite has been moved to the KAPRH package - see SUN239. 
alias kap_luthilite echo  The luthilite has been moved to the KAPRH package - see SUN239. 

alias lutrot echo  The lutrot command has been moved to the KAPRH package - see SUN239. 
alias kap_lutrot echo  The lutrot command has been moved to the KAPRH package - see SUN239. 

alias luttweak echo  The luttweak command has been moved to the KAPRH package - see SUN239. 
alias kap_luttweak echo  The luttweak command has been moved to the KAPRH package - see SUN239. 

alias contover echo  The contover command has been retired. Use \\\"contour clear=no\\\" instead or use the contover command in the KAPRH package - see SUN239. 
alias kap_contover echo  The contover command has been retired. Use \\\"contour clear=no\\\" instead or use the contover command in the KAPRH package - see SUN239. 

alias greyplot echo  The greyplot command has been retired. Use \\\"display key=y\\\" instead or use the greyplot command in the KAPRH package - see SUN239. 
alias kap_greyplot echo  The greyplot command has been retired. Use \\\"display key=y\\\" instead or use the greyplot command in the KAPRH package - see SUN239. 

alias inspect echo  The inspect command has been retired. Use Gaia instead or use the inspect command in the KAPRH package - see SUN239. 
alias kap_inspect echo  The inspect command has been retired. Use Gaia instead or use the inspect command in the KAPRH package - see SUN239. 

alias mosaic echo  The mosaic command has been retired. Use ccdpack:makemos or use the mosaic command in the KAPRH package - see SUN239. 
alias kap_mosaic echo  The mosaic command has been retired. Use ccdpack:makemos or use the mosaic command in the KAPRH package - see SUN239. 

alias quilt echo  The quilt command has been retired. Use ccdpack:makemos or use the quilt command in the KAPRH package - see SUN239. 
alias kap_quilt echo  The quilt command has been retired. Use ccdpack:makemos or use the quilt command in the KAPRH package - see SUN239. 

alias snapshot echo  The snapshot command has been retired. Use a utility such as gimp or xv or use the snapshot command in the KAPRH package - see SUN239. 
alias kap_snapshot echo  The snapshot command has been retired. Use a utility such as gimp or xv or use the snapshot command in the KAPRH package - see SUN239. 

alias turbocont echo  The turbocont command has been retired. Use \\\"contour\\\" instead or use the turbocont command in the KAPRH package - see SUN239. 
alias kap_turbocont echo  The turbocont command has been retired. Use \\\"contour\\\" instead or use the turbocont command in the KAPRH package - see SUN239. 

alias crelut echo  The crelut command has been retired. Use \\\"lutedit\\\" instead or use the crelut command in the KAPRH package - see SUN239. 
alias kap_crelut echo  The crelut command has been retired. Use \\\"lutedit\\\" instead or use the crelut command in the KAPRH package - see SUN239. 
...
echo ""
echo "     NOTE, several applications have had major changes made to their"
echo "     parameter lists. See the 'Release Notes' section of SUN/95 for"
echo "     details."
echo ""
echo "   "
