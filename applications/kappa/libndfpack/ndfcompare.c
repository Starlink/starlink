...
*     ADAM parameter SIMILAR to "FALSE" if they are significantly
*     different in any way, and to "TRUE" if they are not significantly
*     different.
*
...
*        3   - The list of coordinate systems in the WCS FrameSet are
*              compared.
...
*        insensitive) indicating how the numerical value is to be used:
*
...
*        the mean is close to zero, a lower limit equal to the the RMS of
