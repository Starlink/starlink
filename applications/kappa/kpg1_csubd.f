      SUBROUTINE KPG1_CSUBD( BAD, EL, A, CONST, B, NERR, STATUS )
*+
*  Name:
*     KPG1_CSUBx
...
*  External References:
      ...
      DOUBLE PRECISION VAL_DTOD          ! Convert from double precision
 
*  Local Variables:
      DOUBLE PRECISION DCON              ! Type converted constant
      INTEGER I                  ! Loop counter for array elements
      LOGICAL ALLBAD             ! Set output array all bad?
 
*  Internal References:
      INCLUDE 'NUM_DEC_CVT'      ! NUM_ type conversion functions
      INCLUDE 'NUM_DEC_D'      ! NUM_ arithmetic/maths functions
...
*  Convert the constant to be subtracted to the appropriate data type.
      ALLBAD = .FALSE.
      DCON = VAL_DTOD( .FALSE., CONST, STATUS )
