      SUBROUTINE KPG1_BMEDR( BAD, SAMBAD, VAR, NX, NY, IN, HX, HY,
...
*  Local Variables:
      REAL DUMMY              ! Un-used dummy argument
      ...
      REAL MIDPER             ! Central percentile, i.e. median
...
*  met.
                        IF ( SAMBAD .OR. N .GE. NLIM ) THEN
                           CALL KPG1_QNTLR( .FALSE., .TRUE., MIDPER,
     :                                        N, WORK1, DUMMY, WORK2,
     :                                        OUT( I, J ), STATUS )
...
*  Find the median of the data in the work array and store it in the
*  output image.
                     CALL KPG1_QNTLR( .FALSE., .TRUE., MIDPER, N,
     :                                  WORK1, DUMMY, WORK2,
     :                                  OUT( I, J ), STATUS )
