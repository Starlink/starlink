      SUBROUTINE KPG1_POISD( EL, VALUES, SEED, STATUS )
*+
*  Name:
*     KPG1_POISx
...
*  square root.
     ...
     :                    SQRT( NUM_DTOD( VALUES( I ) ) )
                  VALUES( I )  =  NUM_DTOD( NOISE ) + VALUES( I )
