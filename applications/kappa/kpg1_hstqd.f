      SUBROUTINE KPG1_HSTQD( BAD, EL, INARR, NUMBIN, OLDHST, MAP,
     :                         OUTARR, STATUS )
*+
*  Name:
*     KPG1_HSTQx
...
*  Local Variables:
      ...
      DOUBLE PRECISION MAXMUM             ! Maximum value in array
      INTEGER MAXPOS             ! Position of maximum found in array
      DOUBLE PRECISION MINMUM             ! Minimum value in array
...
*  histogram.  Derive the number of good pixels.
      CALL KPG1_MXMND( BAD, EL, INARR, NINVAL, MAXMUM, MINMUM,
...
*  Generate the histogram between those bounds.
      CALL KPG1_GHSTD( BAD2, EL, INARR, NUMBIN, MAXMUM, MINMUM,
     :                   OLDHST, STATUS )
...
*  create an equalised output array.
      CALL KPG1_RMAPD( EL, INARR, MAXMUM, MINMUM, NUMBIN, MAP, OUTARR,
     :                   STATUS )
