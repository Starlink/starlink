      SUBROUTINE KPG1_HSTAD( BAD, EL, DATA, NUMBIN, NUMPER, PERCNT,
...
*  Local Variables:
      ...
      DOUBLE PRECISION MAXMUM             ! Maximum data value
      DOUBLE PRECISION MINMUM             ! Minimum data value
...
*  needed later and for ease of display.
      CALL KPG1_MXMND( BAD, EL, DATA, NINVAL, MAXMUM, MINMUM,
     :                   IMAX, IMIN, STATUS )
      DMAX = NUM_DTOD( MAXMUM )
      DMIN = NUM_DTOD( MINMUM )
...
*  Generate the histogram between those bounds.
         CALL KPG1_GHSTD( BAD2, EL, DATA, NUMBIN, MAXMUM, MINMUM,
     :                      HIST, STATUS )
