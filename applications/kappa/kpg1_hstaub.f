      SUBROUTINE KPG1_HSTAUB( BAD, EL, DATA, NUMBIN, NUMPER, PERCNT,
...
*  Local Variables:
      ...
      BYTE MAXMUM             ! Maximum data value
      BYTE MINMUM             ! Minimum data value
...
*  needed later and for ease of display.
      CALL KPG1_MXMNUB( BAD, EL, DATA, NINVAL, MAXMUM, MINMUM,
     :                   IMAX, IMIN, STATUS )
      DMAX = NUM_UBTOD( MAXMUM )
      DMIN = NUM_UBTOD( MINMUM )
...
*  Generate the histogram between those bounds.
         CALL KPG1_GHSTUB( BAD2, EL, DATA, NUMBIN, MAXMUM, MINMUM,
     :                      HIST, STATUS )
