      SUBROUTINE KPG1_CPNTD( PNNDF, PNTIT, NDIM, DIMS, ARRAY, NULL,
     :                         STATUS )
*+
*  Name:
*     KPG1_CPNTx
...
*    Create a new NDF.
      ...
      CALL NDG_CREPL( PNNDF, '_DOUBLE', NDIM, DIMS, NDFO, STATUS )
 
*    Map the data array.  Wrap to prevent line overflow when the token
*    is expanded.
 
      CALL KPG1_MAP( NDFO, 'Data', '_DOUBLE', 'WRITE', OPNTR, EL,
     :              STATUS )
