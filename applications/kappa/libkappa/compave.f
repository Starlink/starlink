...
*     whether or not variance is present.  If it is determine if
*     weighted averages are to be computed.  Obtain the data-type
*     preservation flag.  Compute the dimensions of the output NDF.
...
*        two-dimensionally, but with a dummy second dimension.  Axis
*        widths are summed, not averaged.
*     -  Tidy the NDF system.
