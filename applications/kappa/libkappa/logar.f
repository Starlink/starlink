*+  LOGAR - Takes the logarithm of each pixel of a data array (specified
*           base)
...
*                   call working subroutine to take the log of each
*                   pixel of input array, result going into output
*                   array
...
*                   unmap output data array
                  ...
                  ELSE
                     ...
                     CALL ERR_REP( 'ERR_LOGAR_NOMPO',
     :                 'LOGAR: Error occurred whilst trying to map '/
     :                 /'output frame', STATUS )
...
*                tidy up output structures
               ...
               ELSE
                  ...
                  IF ( STATUS .NE. PAR__ABORT ) THEN
                     CALL ERR_REP( 'ERR_LOGAR_NOFRO',
     :                 'LOGAR: Error occurred whilst trying to '/
...
*                announce the error
                  ...
                  CALL ERR_REP( 'ERR_LOGAR_PAR',
     :              'LOGAR: Error obtaining base - aborting', STATUS )
               END IF
...
*          unmap input data array
         ...
         ELSE
            ...
            CALL ERR_REP( 'ERR_LOGAR_NOMPI',
     :        'LOGAR: Error occurred whilst trying to map or find '/
...
*       tidy up the input structures
      ...
      ELSE
         ...
         IF ( STATUS .NE. PAR__ABORT ) THEN
            CALL ERR_REP( 'ERR_LOGAR_NOFRI',
     :        'LOGAR: Error occurred whilst trying to access input '/
     :        /'frame', STATUS )
         END IF
