      SUBROUTINE KPG1_PRSAR( BUFFER, MAXVAL, VALUES, NVAL, STATUS )
*+
*  Name:
*     KPG1_PRSAx
...
*  Invocation:
*     CALL KPG1_PRSAR( BUFFER, MAXVAL, VALUES, NVAL, STATUS )
...
*       Extract the value required and convert to REAL type.
 
         NVAL = NVAL + 1
         CALL CHR_CTOR( BUFFER( INDEXS:INDEXE ), VALUES( NVAL ),
     :                    STATUS )
      END DO
...
*    exit the loop.
      ...
      IF ( STATUS .NE. SAI__OK ) THEN
         ...
         ELSE
            ...
            CALL ERR_REP( 'KPG1_PRSAR_EXTR',
     :        'KPG1_PRSAR: Error extracting value ^N from string ^S.',
     :        STATUS )
         END IF
      END IF
