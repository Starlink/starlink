      SUBROUTINE KPG1_ORVAR( NSET, NBIG, PP, VEC, STATUS )
*+
*  Name:
*     KPG1_ORVAR
...
*        MXVAL (needed extra workspace and this is the easiest
*        place to create it).
*     24-FEB-1997 (PDRAPER):
...
*  Local Constants:
      ...
      INTEGER MXVAL
      PARAMETER ( MXVAL = 100 )            ! Largest number of data values
...
*  Local Variables:
      DOUBLE PRECISION MATRIX( MXVAL, MXVAL ) ! Workspace
