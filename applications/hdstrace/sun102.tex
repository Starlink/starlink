...
\stardocabstract    {This document describes the HDSTRACE application which can
be used to list the contents of an HDS file.}
\stardoccopyright {Copyright \copyright\ 1993-2014 Science and Technology Facilities Council}
% -----------------------------------------------------------------------------
