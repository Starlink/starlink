...
printing or documentation. This is where {\footnotesize HDSTRACE}
comes in handy.
...
distinguish it from the name (\textit{cf.}\ \xref{SGP/38}{sgp38}{}).  Indentation
...
\end{terminalv}
\normalsize
\xref{SUN/115}{sun115}{} tells you how to interpret the interface file; it describes
...
\end{terminalv}
\normalsize
\xref{SUN/144}{sun144}{} has more details of the ADAM\_IFL environmental variable.
\bigskip
