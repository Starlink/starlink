...
$    ALINK ASCII2NDF,CONVERT_DIR:CONVERT/OPT,KAPPA_DIR:AIF/LIB,CONVERT_DIR:PART/LIB
$ ENDSUBROUTINE
$!
...
$    ALINK BDF2NDF,CONVERT_DIR:CONVERT/OPT,CONVERT_DIR:PART/LIB,INTERIM/LIB/INCLUDE=(STL_DATA) 
$ ENDSUBROUTINE
$!
$ LINK_DIPSO2NDF: SUBROUTINE
$    ALINK DIPSO2NDF,CONVERT_DIR:CONVERT/OPT,KAPPA_DIR:AIF/LIB
$ ENDSUBROUTINE
$!
...
$    ALINK UNF2NDF,CONVERT_DIR:CONVERT/OPT,KAPPA_DIR:AIF/LIB,CONVERT_DIR:PART/LIB
$ ENDSUBROUTINE
$$!
$ LINK_NDF2ASCII: SUBROUTINE
$    ALINK NDF2ASCII,CONVERT_DIR:CONVERT/OPT,CONVERT_DIR:PART/LIB
$ ENDSUBROUTINE
$!
$! Note that the INTERIM shareable library has an illegal format
$! (probably because it is so old).
...
$    ALINK NDF2BDF,CONVERT_DIR:CONVERT/OPT,CONVERT_DIR:PART/LIB,INTERIM/LIB/INCLUDE=(STL_DATA)
$ ENDSUBROUTINE
$!
$ LINK_NDF2DIPSO: SUBROUTINE
$    ALINK NDF2DIPSO,CONVERT_DIR:CONVERT/OPT,KAPPA_DIR:AIF/LIB
$ ENDSUBROUTINE
$!
...
$    ALINK NDF2IRAF,CONVERT_DIR:CONVERT/OPT,LIBIMFORT/LIB,LIBSYS/LIB,LIBVOPS/LIB,LIBOS/LIB
$ ENDSUBROUTINE
$!
$ LINK_NDF2UNF: SUBROUTINE
$    ALINK NDF2UNF,CONVERT_DIR:CONVERT/OPT,CONVERT_DIR:PART/LIB
$ ENDSUBROUTINE
