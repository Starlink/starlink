...
$    ALINK ASCII2NDF,CONVERT_DIR:CONVERT/OPT,KAPPA_DIR:AIF/LIB,KAPPA_DIR:PART/LIB
$ ENDSUBROUTINE
$!
...
$    ALINK BDF2NDF,CONVERT_DIR:CONVERT/OPT,KAPPA_DIR:PART/LIB,INTERIM/LIB/INCLUDE=(STL_DATA) 
$ ENDSUBROUTINE
$!
...
$    ALINK UNF2NDF,CONVERT_DIR:CONVERT/OPT,KAPPA_DIR:AIF/LIB,KAPPA_DIR:PART/LIB
$ ENDSUBROUTINE
$$!
$ LINK_NDF2ASCII: SUBROUTINE
$    ALINK NDF2ASCII,CONVERT_DIR:CONVERT/OPT,KAPPA_DIR:PART/LIB
$ ENDSUBROUTINE
$!
$! Note that the INTERIM shareable library has an illegal format
$! (probably because it is so old).
...
$    ALINK NDF2BDF,CONVERT_DIR:CONVERT/OPT,INTERIM/LIB/INCLUDE=(STL_DATA)
$ ENDSUBROUTINE
$!
...
$    ALINK NDF2UNF,CONVERT_DIR:CONVERT/OPT,KAPPA_DIR:PART/LIB
$ ENDSUBROUTINE
