...
$    ALINK ASCII2NDF,CONVERT_DIR:CONLIB/L,DISK$RLSVS2B:[PMA.SOFT_DEV.FIO.RELEASE]FIO/LIB,KAPPA_DIR:AIF/LIB,KAPPA_DIR:PART/LIB
$ ENDSUBROUTINE
$!
...
$    ALINK UNF2NDF,CONVERT_DIR:CONLIB/L,DISK$RLSVS2B:[PMA.SOFT_DEV.FIO.RELEASE]FIO/LIB,KAPPA_DIR:AIF/LIB,KAPPA_DIR:PART/LIB
$ ENDSUBROUTINE
$$!
$ LINK_NDF2ASCII: SUBROUTINE
$    ALINK NDF2ASCII,CONVERT_DIR:CONLIB/L,DISK$RLSVS2B:[PMA.SOFT_DEV.FIO.RELEASE]FIO/LIB,KAPPA_DIR:PART/LIB
$ ENDSUBROUTINE
$!
...
$    ALINK NDF2UNF,CONVERT_DIR:CONLIB/L,DISK$RLSVS2B:[PMA.SOFT_DEV.FIO.RELEASE]FIO/LIB,KAPPA_DIR:PART/LIB
$ ENDSUBROUTINE
