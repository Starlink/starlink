...
$    ALINK ASCII2NDF,CONVERT_DIR:CONLIB/LIB,KAPPA_DIR:AIF/LIB,KAPPA_DIR:PART/LIB
$ ENDSUBROUTINE
$!
$ LINK_BDF2NDF: SUBROUTINE
$    ALINK BDF2NDF,CONVERT_DIR:CONLIB/LIB,KAPPA_DIR:PART/LIB,INTERIM/LIB/INCLUDE=(STL_DATA) 
$ ENDSUBROUTINE
$!
$ LINK_DIPSO2NDF: SUBROUTINE
$    ALINK DIPSO2NDF,CONVERT_DIR:CONLIB/LIB,KAPPA_DIR:AIF/LIB
$ ENDSUBROUTINE
$!
...
$    ALINK UNF2NDF,CONVERT_DIR:CONLIB/LIB,KAPPA_DIR:AIF/LIB,KAPPA_DIR:PART/LIB
$ ENDSUBROUTINE
$$!
$ LINK_NDF2ASCII: SUBROUTINE
$    ALINK NDF2ASCII,CONVERT_DIR:CONLIB/LIB,KAPPA_DIR:PART/LIB
$ ENDSUBROUTINE
$!
$ LINK_NDF2BDF: SUBROUTINE
$    ALINK NDF2BDF,CONVERT_DIR:CONLIB/LIB,INTERIM/LIB/INCLUDE=(STL_DATA)
$ ENDSUBROUTINE
$!
$ LINK_NDF2DIPSO: SUBROUTINE
$    ALINK NDF2DIPSO,CONVERT_DIR:CONLIB/LIB,KAPPA_DIR:AIF/LIB
$ ENDSUBROUTINE
$!
...
$    ALINK NDF2IRAF,CONVERT_DIR:CONLIB/LIB,LIBIMFORT/LIB,LIBSYS/LIB,LIBVOPS/LIB,LIBOS/LIB
$ ENDSUBROUTINE
$!
$ LINK_NDF2UNF: SUBROUTINE
$    ALINK NDF2UNF,CONVERT_DIR:CONLIB/LIB,KAPPA_DIR:PART/LIB
$ ENDSUBROUTINE
