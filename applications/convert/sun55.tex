...
\newcommand{\stardocauthors}   {Malcolm J. Currie\\
                                ...
                                D.S.Berry\\
                                A.C.Davenhall}
\newcommand{\stardocdate}      {2008 April 21}
\newcommand{\stardoctitle}     {CONVERT\\
                                A Format-conversion Package}
\newcommand{\stardocversion}   {Version 1.5-14}
...
\sstroutine{
   ...
   \sstdiytopic{
      ...
      For compatibility
      with older applications, AXIS structures may also be added to the output
      cube (see parameter AXIS). Axes 1 and 2 are offsets from the central position of the map,
