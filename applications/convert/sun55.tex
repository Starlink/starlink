...
\newcommand{\stardocauthors}   {Malcolm J. Currie\\
                                ...
                                D.S.Berry\\
                                A.C.Davenhall}
\newcommand{\stardocdate}      {2006 April 10}
\newcommand{\stardoctitle}     {CONVERT\\
                                A Format-conversion Package}
\newcommand{\stardocversion}   {Version 1.5-7}
   ...
   \sstsubsection{
	 ...
	 line is desired.  \texttt{["TRUE"]}
      ...
      \sstsubsection{
         ...
         must be one of the following HDS types: \texttt{"\_BYTE"}, 
         ...
         TYPE = \texttt{"_UBYTE"}) to be a valid NDF.  The suggested 
         default is the current value.  Note that setting TYPE may 
...
\sstroutine{
   ...
   \sstparameters{
      ...
      \sstsubsection{
         ...
         If \textt{TRUE}, the supplied IN files are any multi-NDF HDS 
   ...
   \sstexamples{
      ...
      \sstexamplesubsection{
         ...
         This converts the UIST container file \texttt{u20040730_00675.sdf}
         to FITS file \texttt{u20040730_00675.fit}, merging its .I1 and 
      ...
      \sstexamplesubsection{
         ...
         \texttt{c20011204_00016.sdf} to the multiple-extension FITS 
         file \texttt{cgs4_16.fit}.  The primary HDU has the global 
         ...
         \ssthitemlist{
            \sstitem
             HDSNAME --- is the NDF name for a component NDF in a multi-NDF
               container file, for example \tezxttt{I2}.
             \sstitem
             HDSTYPE --- is set to \texttt{NDF} for a component NDF in a multi-NDF
               container file.
         }
      }      
   }
...
BITPIX, or BSCALE asnd BZERO precision when FMTCNV is \texttt{TRUE}.
