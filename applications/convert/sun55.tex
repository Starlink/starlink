...
\newcommand{\stardocauthors}   {Malcolm J. Currie\\
                                ...
                                D.S.Berry\\
                                A.C.Davenhall}
\newcommand{\stardocdate}      {2009 September 18}
...
variable {\tt NDF\_AUTO\_HISTORY} to a non-zero value.  In fact, we
recommend that you set this in your login script so any NDF created
from scratch will have this property.
