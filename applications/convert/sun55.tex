...
\newcommand{\stardocnumber}    {55.28}
\newcommand{\stardocauthors}   {Malcolm J. Currie\\
                                G.J.Privett\\
                                A.J.Chipperfield\\
                                D.S.Berry\\
                                A.C.Davenhall}
\newcommand{\stardocdate}      {2011 February 25}
\newcommand{\stardoctitle}     {CONVERT\\
                                A Format-conversion Package}
\newcommand{\stardocversion}   {Version 1.6-1}
...
%  ======================
\begin{latexonly}
   \textsc{RAL Space} \hfill \textbf{\stardocname}\\
   {\large Science \& Technology Facilities Council}\\
   {\large Starlink Software\\}
...
% ? End of picture
   ...
   \begin{rawhtml} </I> </P> <H3> \end{rawhtml}
      \htmladdnormallink{RAL Space}
                        {http://www.stfc.ac.uk/RALSpace/Default.aspx} \\
      \htmladdnormallink{Science \& Technology Facilities Council}
                        {http://www.stfc.ac.uk} \\
   \begin{rawhtml} </H3> <H2> \end{rawhtml}
      \htmladdnormallink{Starlink Software}{http://www.starlink.ac.uk/}
...
\subsection{Release Notes -- V1.6}

Support for FITS -TAB projection type added.

Add new WCSCOMP parameter to \htmlref{FITS2NDF}{FITS2NDF}.  It
controls where world co-ordinate information is propagated in the output
NDF.
