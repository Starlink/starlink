...
*  without needing any extra WCS information. We can remove the PIXEL Frame 
*  from the WCS FrameSet because the PIXEL Frame can be regenerated from 
*  the GRID Frame and does not need to be written out, thus reducing the 
...
*  If the AXIS Frame could not be found, indicat this by assigning the
