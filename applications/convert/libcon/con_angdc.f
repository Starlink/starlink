...
*  History:
*     14/8/97 (ACD): Original version, created from CAP_ANGDC.  The
*        only change was to report messages directly with MSG_OUT
*        rather than through the CURSA/CAP specific routine CAP_INFO.
*     28/8/97 (ACD): Changed the routine used to report messages
*        from MSG_OUT to MSG_OUTIF.
*  Bugs:
*     None known
*-
*  Type Definitions:
