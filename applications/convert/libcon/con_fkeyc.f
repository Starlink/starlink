4      SUBROUTINE CON_FKEYC( NAME, VALUE, CMTBGN, COMNT, COMCAR,
     :                      HEADER, STATUS )
*+
*  Name:
*     CON_FKEYC
...
*  Purpose:
*     Formats a FITS-header card for a CHARACTER value or a comment.

*  Language:
*     Starlink Fortran 77

*  Invocation:
*     CALL CON_FKEYC( NAME, VALUE, CMTBGN, COMNT, COMCAR, HEADER, 
*                     STATUS )
