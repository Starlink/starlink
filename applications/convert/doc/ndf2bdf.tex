   ...
   \sstnotes{
      ...
      \sstitemlist{
         ...
         \sstitem
            ...
            descriptor CRTYPE1. (Similarly for AXIS(2) structures {\it etc.})
         ...
         \sstitem
            ...
            exceptions:
            \begin{itemize}
               \item NAXIS, and NAXISn are derived from the dimensions of
               ...
               \item The CDELTn, CRVALn, and CRTYPEn descriptors in the FITS
