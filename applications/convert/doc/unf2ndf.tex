...
\sstroutine{
   ...
   \sstparameters{
      ...
      \sstsubsection{
         ...
         header.  It has a default file extension of {\tt ".DAT"}.
      }
      \sstsubsection{
   ...
   \sstexamples{
      ...
      \sstexamplesubsection{
         ...
         This copies a data array from the unformatted file SPECTRUM.DAT
         to the NDF called ZZ.  SPECTRUM.DAT contains two header
