...
\newcommand{\stardocabstract}  {
  ...
  for reducing and displaying SCUBA-2 total power data. We describe
  some of the data artefacts present in SCUBA-2 time series and
  methods we employ to fix thos artefacts. This guide does not cover
  the ancillary instruments POL-2 or FTS-2.
}
