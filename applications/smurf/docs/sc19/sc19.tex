...
Section~\ref{sec:quality} for futher details) using the \Kappa\ task
\setbb),
...
`filt\_edghigh' parameter explicitly, since the goal now is to see
...
indicating frequenyt, the second and third axes detector row and
...
\item[\texttt{dimmconfig\_veryshort.lis}]
