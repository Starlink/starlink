...
\begin{latexonly}
   \begin{figure}[htb]
   \begin{center}
     \includegraphics[width=150mm]{sun258_rebinmap}
...
representation of some of the components.

\begin{latexonly}
   \begin{figure}[htb]
   \begin{center}
     \includegraphics[width=150mm]{sun258_signalcpts}
...
\begin{latexonly}
   \begin{figure}[htb]
   \begin{center}
     \includegraphics[width=150mm]{sun258_itermap}
     \caption{Image reconstructed from simulated data using the
