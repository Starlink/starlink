...
\item[6. Check for convergence:] Finally, the solution is checked for
  ...
  configuration parameters \cparam{AST.ZERO\_SNR} and   \cparam{AST.ZERO\_MASK}).
...
parameters are summarized in Section~\ref{par:full}.
Various pre-defined configuration
