...
\newcommand{\stardoctitle}     {SMURF -- the Sub-Millimetre User Reduction Facility}
\newcommand{\stardocversion}   {Version 1.5.0}
...
be used effectively\cite{archibald,dempsey,sc2ana002}.
...
sharp or gentle turnarounds and a lissajous pattern \cite{kackley}.
...
relations for SCUBA-2 are available from Dempsey et al.\ (2013).
...
\section{Citing SMURF}

If you use SMURF in your work please use the following references:

For the continuum map-maker: Chapin et al., 2013, MNRAS, 430, 2545

For the heterodyne components see Jenness et al., Astronomy \& Computing, in preparation.

The general SMURF reference should be to use the Astrophysics Source Code Library entry of \texttt{ascl:1310.007}.
...
\bibitem{kackley}
Kackley~R., et al., 2010, Proc.\ SPIE, 7740, 77401Z
