...
\sstroutine{
   ...
   \sstdescription{
      This script uses a visual file comparison tool such as {\tt "}meld{\tt "}, to
   ...
   \sstdiylist{
      ...
      \sstsubsection{
         ...
         an NDF created by MAKEMAP. It should be one of {\tt "}450{\tt "} or {\tt "}850{\tt "}. It
      ...
      \sstsubsection{
         ...
         {\tt "}\$SMURF\_DIR/smurf\_makemap.def{\tt "}. [TRUE]
      }
      \sstsubsection{
         TOOL = LITERAL (Read)
      }{
