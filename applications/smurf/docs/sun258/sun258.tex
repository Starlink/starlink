...
\sstroutine{
   ...
   \sstparameters{
      ...
      \sstsubsection{
         ...
         an NDF created by MAKEMAP. It should be one of {\tt "}450{\tt"},
         {\tt "}850{\tt "}. It specifies which value should be displayed
         for configuration parameters that have separate values for 450
         and 850 um. If either CONFIG1 or CONFIG2 is an NDF created by
         MAKEMAP, then the wavebands to use are determined from the
         headers in the NDFs.
      }
      \sstsubsection{
