...
\begin{htmlonly}
\renewcommand{\telName}{TEL\_NAME (C1TEL)\ref{GSDVars:telName}}
\renewcommand{\project}{PROJECT (C1PID)\ref{GSDVars:project}}
\renewcommand{\projectObsA}{PROJECT\_OBS\_1 (C1OBS)\ref{GSDVars:projectObsA}}
\renewcommand{\projectObsB}{PROJECT\_OBS\_2 (C1ONA1)\ref{GSDVars:projectObsB}}
\renewcommand{\projectObsC}{PROJECT\_OBS\_3 (C1ONA2)\ref{GSDVars:projectObsC}}
...
\renewcommand{\centreCoords}{CENTRE\_COORDS (C4CSC)\ref{GSDVars:centreCoords}}
\renewcommand{\centreCode}{CENTRE\_CODE (C4CECO)\ref{GSDVars:centreCode}}
\renewcommand{\epochType}{EPOCH\_TYPE (C4EPT)\ref{GSDVars:epochType}}
\renewcommand{\centreMoving}{CENTRE\_MOVING (C4MCF)\ref{GSDVars:centreMoving}}
\renewcommand{\centreEpoch}{CENTRE\_EPOCH (C4EPH)\ref{GSDVars:centreEpoch}}
\renewcommand{\centreRARB}{CENTRE\_RA1950 (C4ERA)\ref{GSDVars:centreRARB}}
\renewcommand{\centreDecRB}{CENTRE\_DEC1950 (C4EDEC)\ref{GSDVars:centreDecRB}}
\renewcommand{\centreRA}{CENTRE\_RA (C4RADATE)\ref{GSDVars:centreRA}}
\renewcommand{\centreDec}{CENTRE\_DEC (C4DECDATE)\ref{GSDVars:centreDec}}
\renewcommand{\centreRARJ}{CENTRE\_RA2000 (C4RA2000)\ref{GSDVars:centreRARJ}}
\renewcommand{\centreDecRJ}{CENTRE\_DEC2000 (C4EDEC2000)\ref{GSDVars:centreDecRJ}}
\renewcommand{\centreGL}{CENTRE\_GL (C4GL)\ref{GSDVars:centreGL}}
\renewcommand{\centreGB}{CENTRE\_GB (C4GB)\ref{GSDVars:centreGB}}
\renewcommand{\centreAz}{CENTRE\_AZ (C4AZ)\ref{GSDVars:centreAz}}
\renewcommand{\centreEl}{CENTRE\_EL (C4EL)\ref{GSDVars:centreEl}}
\renewcommand{\cellCoords}{CELL\_COORDS (C4LSC)\ref{GSDVars:cellCoords}}
\renewcommand{\cellCode}{CELL\_CODE (C6FC)\ref{GSDVars:cellCode}}
\renewcommand{\cellUnit}{CELL\_UNIT (C4ODCO)\ref{GSDVars:cellUnit}}
\renewcommand{\cellX}{CELL\_X (C6DX)\ref{GSDVars:cellX}}
\renewcommand{\cellY}{CELL\_Y (C6DY)\ref{GSDVars:cellY}}
\renewcommand{\cellVX}{CELL\_V2X (C6MSA)\ref{GSDVars:cellVX}}
\renewcommand{\cellVY}{CELL\_V2Y (CELL\_V2Y)\ref{GSDVars:cellVY}}
\renewcommand{\cellXY}{CELL\_X2Y (C4AXY)\ref{GSDVars:cellXY}}
\renewcommand{\centreOffsetX}{CENTRE\_OFFSET\_X (C4SX)\ref{GSDVars:centreOffsetX}}
\renewcommand{\centreOffsetY}{CENTRE\_OFFSET\_Y (C4SY)\ref{GSDVars:centreOffsetY}}
\renewcommand{\referenceX}{REFERENCE\_X (C4RX)\ref{GSDVars:referenceX}}
\renewcommand{\referenceY}{REFERENCE\_Y (C4RY)\ref{GSDVars:referenceY}}
\renewcommand{\telHeight}{TEL\_HEIGHT (C1HGT)\ref{GSDVars:telHeight}}
\renewcommand{\telLongitude}{TEL\_LONGITUDE (C1LONG)\ref{GSDVars:telLongitude}}
\renewcommand{\telLatitude}{TEL\_LATITUDE (C1LAT)\ref{GSDVars:telLatitude}}
\renewcommand{\nObs}{NOBS (C1SNO)\ref{GSDVars:nObs}}
\renewcommand{\obsType}{OBS\_TYPE (C6ST)\ref{GSDVars:obsType}}
\renewcommand{\frontend}{FRONTEND (C1RCV)\ref{GSDVars:frontend}}
\renewcommand{\FEType}{FE\_TYPE (C1FTYP)\ref{GSDVars:FEType}}
\renewcommand{\backend}{BACKEND (C1BKE)\ref{GSDVars:backend}}
\renewcommand{\BEType}{BE\_TYPE (C1BTYP)\ref{GSDVars:BEType}}
...
\renewcommand{\obsLST}{OBS\_LST (C3LST)\ref{GSDVars:obsLST}}
\renewcommand{\obsCalibration}{OBS\_CALIBRATION (C3CAL)\ref{GSDVars:obsCalibration}}
\renewcommand{\obsCentre}{OBS\_CENTRE (C3CEN)\ref{GSDVars:obsCentre}}
\renewcommand{\obsContinuous}{OBS\_CONTINUOUS (C3FLY)\ref{GSDVars:obsContinuous}}
\renewcommand{\obsFocus}{OBS\_FOCUS (C3FOCUS)\ref{GSDVars:obsFocus}}
\renewcommand{\obsMap}{OBS\_MAP (C3MAP)\ref{GSDVars:obsMap}}
...
\renewcommand{\mapStartX}{X\_MAP\_START (C6XGC)\ref{GSDVars:mapStartX}}
\renewcommand{\mapStartY}{Y\_MAP\_START (C6YGC)\ref{GSDVars:mapStartY}}
\renewcommand{\scanRev}{SCAN\_REVERSAL (C6REV)\ref{GSDVars:scanRev}}
\renewcommand{\obsDirection}{OBS\_DIRECTION (C6SD)\ref{GSDVars:obsDirection}}
\renewcommand{\mapPosX}{X\_MAP\_POSITIVE (C6XPOS)\ref{GSDVars:mapPosX}}
\renewcommand{\mapPosY}{Y\_MAP\_POSITIVE (C6YPOS)\ref{GSDVars:mapPosY}}
...
\renewcommand{\cycleTime}{CYCLE\_TIME (C3CL)\ref{GSDVars:cycleTime}}
...
\renewcommand{\tamb}{TAMB (C5AT)\ref{GSDVars:tamb}}
\renewcommand{\pamb}{PAMB (C5PRS)\ref{GSDVars:pamb}}
\renewcommand{\hamb}{HAMB (C5RH)\ref{GSDVars:hamb}}
\renewcommand{\errAz}{SDIS(7) (C4AZERR)\ref{GSDVars:errAz}}
\renewcommand{\errEl}{SDIS(8) (C4ELERR)\ref{GSDVars:errEl}}
\renewcommand{\userAz}{SDIS(36) (UAZ)\ref{GSDVars:userAz}}
\renewcommand{\userEl}{SDIS(37) (UEL)\ref{GSDVars:userEl}}
\renewcommand{\nVRad}{SZVRAD (C7SZVRAD)\ref{GSDVars:nVRad}}
\renewcommand{\apertureEff}{APERTURE\_EFF (C8AAE)\ref{GSDVars:apertureEff}}
\renewcommand{\beamEff}{BEAM\_EFF (C8ABE)\ref{GSDVars:beamEff}}
\renewcommand{\antennaGain}{ANTENNA\_GAIN (C8GN)\ref{GSDVars:antennaGain}}
\renewcommand{\etal}{ETAL (C8EL)\ref{GSDVars:etal}}
\renewcommand{\etafss}{ETAFSS (C8EF)\ref{GSDVars:etafss}}
\renewcommand{\chopping}{CHOPPING (C4SM)\ref{GSDVars:chopping}}
\renewcommand{\chopWaveform}{WAVEFORM (C4FUN)\ref{GSDVars:chopWaveform}}
\renewcommand{\chopFrequency}{FREQUENCY (C4FRQ)\ref{GSDVars:chopFrequency}}
\renewcommand{\chopCoords}{COORDS (C4SMCO)\ref{GSDVars:chopCoords}}
\renewcommand{\chopThrow}{THROW (C4THROW)\ref{GSDVars:chopThrow}}
\renewcommand{\chopPA}{POSANG (C4POSANG)\ref{GSDVars:chopPA}}
\renewcommand{\smuOffsEW}{OFFS\_EW (C4OFFS\_EW)\ref{GSDVars:smuOffsEW}}
\renewcommand{\smuOffsNS}{OFFS\_NS (C4OFFS\_NS)\ref{GSDVars:smuOffsNS}}
\renewcommand{\smuX}{X (C4X)\ref{GSDVars:smuX}}
\renewcommand{\smuY}{Y (C4Y)\ref{GSDVars:smuY}}
\renewcommand{\smuZ}{Z (C4Z)\ref{GSDVars:smuZ}}
\renewcommand{\smuEWScale}{EW\_AMPL\_SCALE (C4EW\_SCALE)\ref{GSDVars:smuEWScale}}
\renewcommand{\smuNSScale}{NS\_AMPL\_SCALE (C4NS\_SCALE)\ref{GSDVars:smuNSScale}}
\renewcommand{\smuEWEnc}{AMPL\_E\_SET (C4EW\_ENCODER)\ref{GSDVars:smuEWEnc}}
\renewcommand{\smuNSEnc}{AMPL\_N\_SET (C4NS\_ENCODER)\ref{GSDVars:smuNSEnc}}
\renewcommand{\smuDX}{DX (C2FV)\ref{GSDVars:smuDX}}
\renewcommand{\smuDY}{DY (C2FL)\ref{GSDVars:smuDY}}
\renewcommand{\smuDZ}{DZ (C2FR)\ref{GSDVars:smuDZ}}
\renewcommand{\telCoords}{TEL\_COORDS (C4MOCO)\ref{GSDVars:telCoords}}
\renewcommand{\nFEChans}{NO\_FE\_O\_CH (C3NFOC)\ref{GSDVars:nFEChans}}
\renewcommand{\velocity}{VELOCITY (C7VR)\ref{GSDVars:velocity}}
\renewcommand{\tCold}{T\_COLD (C12TCOLD)\ref{GSDVars:tCold}}
\renewcommand{\tHot}{T\_HOT (C12TAMB)\ref{GSDVars:tHot}}
\renewcommand{\velDefn}{VEL\_DEFN (C12VDEF)\ref{GSDVars:velDefn}}
\renewcommand{\velRef}{VEL\_REF (C12VREF)\ref{GSDVars:velRef}}
...
\renewcommand{\badVal}{BAD\_CHANNEL (C7BCV)\ref{GSDVars:badVal}}
\renewcommand{\dataUnits}{DATA\_UNITS (C12CAL)\ref{GSDVars:dataUnits}}
\renewcommand{\swMode}{SWITCH\_MODE (C6MODE)\ref{GSDVars:swMode}}
\renewcommand{\calInstrument}{BE\_CAL\_TASK (C12CALTASK)\ref{GSDVars:calInstrument}}
\renewcommand{\calType}{BE\_CAL\_TYPE (C12CALTYPE)\ref{GSDVars:calType}}
\renewcommand{\calmode}{BE\_RED\_MODE (C12REDMODE)\ref{GSDVars:calmode}}
\renewcommand{\IFPerSection}{NO\_IF\_PER\_BES (C3NOIFPBES)\ref{GSDVars:IFPerSection}}
\renewcommand{\BEConfig}{DAS\_CONF\_NR (C3CONFIGNR)\ref{GSDVars:BEConfig}}
\renewcommand{\dataOutput}{DAS\_OUTPUT (C3DASOUTPUT)\ref{GSDVars:dataOutput}}
\renewcommand{\calSource}{DAS\_CAL\_SOURCE (C3DASCALSRC)\ref{GSDVars:calSource}}
\renewcommand{\shiftFrac}{DAS\_SHIFT\_FRAC (C3DASSHFTFRAC)\ref{GSDVars:shiftFrac}}
\renewcommand{\tauCSO}{CSO\_TAU (C7TAU225)\ref{GSDVars:tauCSO}}
\renewcommand{\tauRMS}{CSO\_TAU\_RMS (C7TAURMS)\ref{GSDVars:tauRMS}}
\renewcommand{\tauTime}{CSO\_YYMMDDHHMM (C7TAUTIME)\ref{GSDVars:tauTime}}
\renewcommand{\seeing}{SAO\_SEEING (C7SEEING)\ref{GSDVars:seeing}}
\renewcommand{\seeTime}{SAO\_YYMMDDHHMM (C7SEETIME)\ref{GSDVars:seeTime}}
\renewcommand{\polarity}{C3POLARITY (C3POLARITY)\ref{GSDVars:polarity}}
\renewcommand{\sbMode}{C3SBMODE (C3SBMODE)\ref{GSDVars:sbMode}}
\renewcommand{\IFONPhase}{DAS\_NO\_PHASE (C55NPH)\ref{GSDVars:IFONPhase}}
\renewcommand{\IFONCycle}{DAS\_NO\_CYCLES (C55NCYC)\ref{GSDVars:IFONCycle}}
\renewcommand{\IFONIntCycle}{DAS\_NINTCYCLE (C55NINT)\ref{GSDVars:IFONIntCycle}}
\renewcommand{\nCorrCycle}{DAS\_NCORRCYCLE (C55NCORR)\ref{GSDVars:nCorrCycle}}
\renewcommand{\procBits}{DAS\_PROC\_BITS (C55DASPRBIT)\ref{GSDVars:procBits}}
\renewcommand{\procLoc}{DAS\_PROC\_LOC (C55DASPRLOC)\ref{GSDVars:procLoc}}
\renewcommand{\RXJLengthX}{RXJ.LX (C55LX)\ref{GSDVars:RXJLengthX}}
\renewcommand{\RXJLengthY}{RXJ.LY (C55LY)\ref{GSDVars:RXJLengthY}}
\renewcommand{\RXJLengthZ}{RXJ.LZ (C55LZ)\ref{GSDVars:RXJLengthZ}}
\renewcommand{\RXJSin}{RXJ.A (C55A)\ref{GSDVars:RXJSin}}
\renewcommand{\RXJCos}{RXJ.B (C55B)\ref{GSDVars:RXJCos}}
\renewcommand{\RXJConstant}{RXJ.C (C55C)\ref{GSDVars:RXJConstant}}
\renewcommand{\RXJCSOSwitch}{RXJ.CSO\_SWITCH (C55CSOSW)\ref{GSDVars:RXJCSOSwitch}}
\renewcommand{\RXJJCMTSwitch}{RXJ.JCMT\_SWITCH (C55JCMTSW)\ref{GSDVars:RXJJCMTSwitch}}
\renewcommand{\RXJNSecs}{RXJ.NSECS (C55SECOND)\ref{GSDVars:RXJNSecs}}
\renewcommand{\CSOAbsorb}{RXJ.ABSORB (C55ABSORB)\ref{GSDVars:CSOAbsorb}}
\renewcommand{\CSOTAU}{RXJ.CSO\_TAU (C55TAU)\ref{GSDVars:CSOTAU}}
\renewcommand{\CSODAz}{RXJ.DAZ (C55DAZ)\ref{GSDVars:CSODAz}}
\renewcommand{\CSODEl}{RXJ.DEL (C55DEL)\ref{GSDVars:CSODEl}}
\renewcommand{\CSORA}{RXJ.RA (C55RA)\ref{GSDVars:CSORA}}
\renewcommand{\CSODec}{RXJ.DEC (C55DEC)\ref{GSDVars:CSODec}}
\renewcommand{\CSOEpoch}{RXJ.EPOCH (C55EPOCH)\ref{GSDVars:CSOEpoch}}
\renewcommand{\CSOPAz}{RXJ.PAZ (C55PAZ)\ref{GSDVars:CSOPAz}}
\renewcommand{\CSOPEl}{RXJ.PEL (C55PEL)\ref{GSDVars:CSOPEl}}
\renewcommand{\CSOTrack}{RXJ.TRACK (C55TRACK)\ref{GSDVars:CSOTrack}}
\renewcommand{\CSOFocus}{RXJ.FMODE (C55FMODE)\ref{GSDVars:CSOFocus}}
\renewcommand{\CSOFocusX}{RXJ.FX (C55FX)\ref{GSDVars:CSOFocusX}}
\renewcommand{\CSOFocusY}{RXJ.FY (C55FY)\ref{GSDVars:CSOFocusY}}
\renewcommand{\CSOFocusZ}{RXJ.FZ (C55FZ)\ref{GSDVars:CSOFocusZ}}
\renewcommand{\CSOVelocity}{RXJ.VLSR (C55VLSR)\ref{GSDVars:CSOVelocity}}
\renewcommand{\CSOVelOffset}{RXJ.COFF (C55VOFF)\ref{GSDVars:CSOVelOffset}}
\renewcommand{\CSORadVel}{RXJ.VRAD (C55VRAD)\ref{GSDVars:CSORadVel}}
\renewcommand{\CSOPhaseLock}{RXJ.PLOCK (C55PLOCK)\ref{GSDVars:CSOPhaseLock}}
\renewcommand{\CSORestFreq}{RXJ.RFREQ (C55RFREQ)\ref{GSDVars:CSORestFreq}}
\renewcommand{\CSOIFFreq}{RXJ.IFFREQ (C55IFFREQ)\ref{GSDVars:CSOIFFreq}}
\renewcommand{\CSOLOFreq}{RXJ.LOFREQ (C55LOFREQ)\ref{GSDVars:CSOLOFreq}}
\renewcommand{\CSOFreqOffset}{RXJ.FREQOFF (C55FREQOFF)\ref{GSDVars:CSOFreqOffset}}
\renewcommand{\CSOSideband}{RXJ.SIDEBAND (C55SIDEBAND)\ref{GSDVars:CSOSideband}}
\renewcommand{\CSOMultHarm}{RXJ.MHN (C55MHN)\ref{GSDVars:CSOMultHarm}}
\renewcommand{\CSOStatus}{RXJ.CSO\_STATUS (C55CSOSTATUS)\ref{GSDVars:CSOStatus}}
\renewcommand{\telAz}{TEL.SDIS(9) (C55TELAZ)\ref{GSDVars:telAz}}
\renewcommand{\telEl}{TEL.SDIS(10) (C55TELEL)\ref{GSDVars:telEl}}
\renewcommand{\FEFreqs}{FE\_NUOBS (C55FENUOBS)\ref{GSDVars:FEFreqs}}
\renewcommand{\FESBSigns}{FE\_SB\_SIGN (C55FESBSIGN)\ref{GSDVars:FESBSigns}}
\renewcommand{\FELOFreqs}{FE\_NULO (C55FENULO)\ref{GSDVars:FELOFreqs}}
\renewcommand{\vRadial}{C7VRADIAL (C7VRADIAL)\ref{GSDVars:vRadial}}
\renewcommand{\scanVarsA}{SCAN\_VARS1 (C12SCAN\_VARS1)\ref{GSDVars:scanVarsA}}
\renewcommand{\scanVarsB}{SCAN\_VARS2 (C12SCAN\_VARS2)\ref{GSDVars:scanVarsB}}
\renewcommand{\scanTableA}{SCAN\_TABLE1 (C12SCAN\_TABLE\_1)\ref{GSDVars:scanTableA}}
\renewcommand{\scanTableB}{SCAN\_TABLE2 (C12SCAN\_TABLE\_2)\ref{GSDVars:scanTableB}}
\renewcommand{\mapTable}{MAP\_TABLE (C14PHIST)\ref{GSDVars:mapTable}}
\renewcommand{\phaseVars}{PHASE\_VARS (C11VD)\ref{GSDVars:phaseVars}}
\renewcommand{\phaseTable}{PHASE\_TABLE (C11PHA)\ref{GSDVars:phaseTable}}
\renewcommand{\corrModes}{BES\_CORR\_MODE (C12CM)\ref{GSDVars:corrModes}}
\renewcommand{\bitmodes}{BES\_BITMODE (C12BM)\ref{GSDVars:bitmodes}}
\renewcommand{\sbOverlaps}{BES\_OVERLAP (C3OVERLAP)\ref{GSDVars:sbOverlaps}}
\renewcommand{\mixNums}{DAS\_MIXER (C3MIXNUM)\ref{GSDVars:mixNums}}
\renewcommand{\BEInputChans}{BES\_CONN (C3BESCONN)\ref{GSDVars:BEInputChans}}
\renewcommand{\BEConnChans}{BE\_IN\_CONN (C3BEINCON)\ref{GSDVars:BEConnChans}}
\renewcommand{\BEChans}{NO\_BES\_O\_CH (C3LSPC)\ref{GSDVars:BEChans}}
\renewcommand{\BESubsys}{BES\_SPECTRUM (C3BESSPEC)\ref{GSDVars:BESubsys}}
...
\renewcommand{\LOFreqs}{BES\_FE\_NULO (C3BEFENULO)\ref{GSDVars:LOFreqs}}
\renewcommand{\totIFs}{BES\_TOT\_IF (C3BETOTIF)\ref{GSDVars:totIFs}}
\renewcommand{\sbSigns}{BES\_FE\_SB\_SIGN (C3BEFESB)\ref{GSDVars:sbSigns}}
\renewcommand{\BEInputFreqs}{BE\_NUIN (C12INFREQ)\ref{GSDVars:BEInputFreqs}}
...
\renewcommand{\recTemps}{BES\_T\_REC (C12RT)\ref{GSDVars:recTemps}}
\renewcommand{\sourceSysTemps}{BES\_T\_SYS (C12SST)\ref{GSDVars:sourceSysTemps}}
\renewcommand{\skyTemps}{BES\_T\_SKY (C12TSKY)\ref{GSDVars:skyTemps}}
\renewcommand{\telTemps}{BES\_T\_TEL (C12TTEL)\ref{GSDVars:telTemps}}
\renewcommand{\gains}{BES\_GAIN (C12GAINS)\ref{GSDVars:gains}}
\renewcommand{\caltemps}{BES\_T\_TEL (C12CT)\ref{GSDVars:caltemps}}
\renewcommand{\opacities}{BES\_T\_TEL (C12WO)\ref{GSDVars:opacities}}
\renewcommand{\skyTrans}{BES\_ETA\_SKY (C12ETASKY)\ref{GSDVars:skyTrans}}
\renewcommand{\alphas}{BES\_ALPHA (C12ALPHA)\ref{GSDVars:alphas}}
\renewcommand{\sbGainNorms}{BES\_G\_S (C12GS)\ref{GSDVars:sbGainNorms}}
\renewcommand{\telTrans}{BES\_ETA\_TEL (C12ETATEL)\ref{GSDVars:telTrans}}
\renewcommand{\FETSkyIm}{BES\_T\_SKY\_IM (C12TSKYIM)\ref{GSDVars:FETSkyIm}}
\renewcommand{\FESkyTrans}{BES\_ETA\_SKY\_IM (C12ETASKYIM)\ref{GSDVars:FESkyTrans}}
\renewcommand{\FETSysIm}{BES\_T\_SYS\_IM (C12TSYSIM)\ref{GSDVars:FETSysIm}}
\renewcommand{\sbRatios}{BES\_TA\_SKY (C12TASKY)\ref{GSDVars:sbRatios}}
\renewcommand{\intTimes}{INTGRN\_TIME (C3INTT)\ref{GSDVars:intTimes}}
\renewcommand{\data}{DATA (C13DAT)\ref{GSDVars:data}}
\renewcommand{\hotPower}{DAS\_HOT\_POWER (C55HOTPOWER)\ref{GSDVars:hotPower}}
\renewcommand{\skyPower}{DAS\_SKY\_POWER (C55SKYPOWER)\ref{GSDVars:skyPower}}
\renewcommand{\samples}{SAMPLES (C55SAM)\ref{GSDVars:samples}}
\renewcommand{\totPower}{DAS\_POWER (C55POWER)\ref{GSDVars:totPower}}
\end{htmlonly}
