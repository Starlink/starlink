...
*+
*  Name:
*     sc2fts_ifgmflatfield.c

*  Purpose:
*     Flatfield individual interfergram
...
*  Invocation:
*     sc2fts_ifgmflatfield ( Grp* igrp, Grp* ogrp, AstKeyMap* parKeymap, int* status )
...
{
   printf("IfgmFlatfield operation!\n");
