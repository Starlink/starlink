...
*+
*  Name:
*     sc2fts_portimbalance.c

*  Purpose:
*     Remove the imbalance between the dual ports
...
*  Invocation:
*     sc2fts_portimbalance ( Grp* igrp, Grp* ogrp, AstKeyMap * parKeymap, int *status )
...
{
   printf("PORTIMBALANCE operation!\n");
