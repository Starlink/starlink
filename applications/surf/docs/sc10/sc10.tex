...
%  Copyright:
%     Copyright (C) 1997 Particle Physics and Astronomy
...
\begin{latexonly}
   ...
   \vspace{5mm}
   \begin{center}
   \epsfig{file=sc10_logo.eps,width=2.0in}
...
% ? Add picture here if required.
   \epsfig{width=2.0in,file=sc10_logo.eps}
% ? End of picture
...
\begin{figure}
\epsfig{angle=-90,width=6.0in,file=sc10_fig1.eps}
...
\begin{figure}
\epsfig{angle=-90,width=6.0in,file=sc10_fig2.eps}
...
\begin{figure}
\epsfig{angle=-90,width=6.0in,file=sc10_fig3.eps}
...
\begin{figure}
\epsfig{angle=-90,width=6.0in,file=sc10_fig4.eps}
