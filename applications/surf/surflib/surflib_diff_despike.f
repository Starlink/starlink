*+  SURFLIB_DIFF_DESPIKE - despike data scan by detecting points
...
*    History :
*     $Log$
*     Revision 1.1  1997/12/18 21:37:43  timj
*     Initial revision
*
*    endhistory
*    Type Definitions :
...
*  go through and throw out DIFF points more than 5 sigma from the mean,
