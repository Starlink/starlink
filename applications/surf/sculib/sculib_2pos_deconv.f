...
*  OK, there is some data for the scan
                  ...
                  CALL MSG_OUTIF(MSG__NORM,' ',
     :                 '2POS_DECONV: Processing exposure ^NE'//
     :                 ' of integration ^NI', STATUS)
                  ...
                  IF (2*N_SCAN + 1 .GT. MAX_CONV) THEN
                     IF (STATUS .EQ. SAI__OK) THEN
                        ...
                        CALL ERR_REP (' ', 'SCULIB_2POS_DECONV: '//
...
*  chop throw or its harmonics. Any signal there must be noise. This can
