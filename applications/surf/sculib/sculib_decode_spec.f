      SUBROUTINE SCULIB_DECODE_SPEC (SPEC, DEMOD_POINTER, N_SWITCHES,
     :  N_EXPOSURES, N_INTEGRATIONS, N_MEASUREMENTS, N_POS, N_BOLS,
     :  SWITCH_EXPECTED, POS_SELECTED, POS_S, SWITCH_S, EXP_S, INT_S,
     :  MEAS_S, BOL_S, STATUS) 
*+
*  Name:
*     SCULIB_DECODE_SPEC
...
*  get name and value of component
     ...
     :                    N_SWITCHES, SWITCH_S, STATUS)
                     ELSE
                        ...
                        CALL ERR_REP (' ', 'SCULIB_DECODE_SPEC: '//
     :                    'switch specified when it should not be '//
     :                    '- ^C', STATUS)
                     END IF
