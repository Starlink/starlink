      SUBROUTINE NDG1_HSPLT( NAME, F1, F2, P1, P2, STATUS )
*+
*  Name:
*     NDG1_HSPLT
...
*  Invocation:
*     CALL NDG1_HSPLT( NAME, F1, F2, P1, P2, STATUS )
