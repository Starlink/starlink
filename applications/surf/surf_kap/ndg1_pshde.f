      SUBROUTINE NDG1_PSHDE( STR, NDIM, DIM, LBND, UBND, STATUS )
*+
*  Name:
*     NDG1_PSHDE
...
*  Invocation:
*     CALL NDG1_PSHDE( STR, NDIM, DIM, LBND, UBND, STATUS )
...
*  Otherwise, parse the field to determine the dimension bounds.
               ELSE
                  F = F + I1 - 1
                  L = L + I1 - 1
                  CALL NDG1_PSHDF( STR( F : L ), DIM( NBND ),
