      SUBROUTINE NDG1_PSHDF( STR, DIM, LBND, UBND, STATUS )
*+
*  Name:
*     NDG1_PSHDF
...
*  Invocation:
*     CALL NDG1_PSHDF( STR, DIM, LBND, UBND, STATUS )
...
*  lower bound.
         ELSE
            CALL NDG1_PSHDB( STR( F : COLON - 1 ), 1, LBND, STATUS )
...
*  upper bound.
         ELSE
            CALL NDG1_PSHDB( STR( COLON + 1 : L ), DIM, UBND, STATUS )
            IF ( STATUS .EQ. SAI__OK ) THEN
