*+
      SUBROUTINE NDFX__GET_FITSD (NEL, FITSAR, POS, VALUE, STATUS)
*  Description:
*     Return the value of double precision FITS item at position POS in the FITS array.
*  Invocation:
*     CALL NDFX__GET_FITSD (NEL, FITSAR, POS, VALUE, STATUS)
*  Arguments:
*     NEL = INTEGER (Given)
...
*  Export:
      DOUBLE PRECISION VALUE                 ! Value to return
*  Status:
...
*    Extract the value fro the relevant field
      CALL CHR_CTOD (FITSAR(POS)(10:30), VALUE, STATUS)
