*+
      SUBROUTINE NDFX__GET_FITSI (NEL, FITSAR, POS, VALUE, STATUS)
*  Description:
*     Return the value of integer FITS item at position POS in the FITS array.
*  Invocation:
*     CALL NDFX__GET_FITSI (NEL, FITSAR, POS, VALUE, STATUS)
*  Arguments:
*     NEL = INTEGER (Given)
...
*    Extract the value fro the relevant field
      CALL CHR_CTOI (FITSAR(POS)(10:30), VALUE, STATUS)
