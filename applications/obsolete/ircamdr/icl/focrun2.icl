...
proc focrun ost oen oda
  ...
  if image_workstn = 1
    ...
    if yn1
      print "Enter RANGE START for input image(s) :"
    ...
    value3 = noen
    if yn3
      print "Enter DARK number :"
      asknum (noda) "Dark Number \1\ ? "
    else
      noda = oda
    end if
    stda = pref & noda & suff
    ...
    loop for dummy = (value2) to (value3)
      ...
      print "  Sigma level = " (disp_ns)
      obeyw plt2d nsigma (st2mda) (disp_ns)
      if dummy = nost
