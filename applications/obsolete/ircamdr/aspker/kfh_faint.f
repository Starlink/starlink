*+  KFH_FAINT - Scales image to range mean-s.d. to mean+7*s.d..
      SUBROUTINE KFH_FAINT(IMAGE,XDIM,YDIM,SCRTCH,BLNKVL,STATUS)
*    Description :
...
*    Invocation :
*     CALL KFH_FAINT(IMAGE,XDIM,YDIM,SCRTCH,BLNKVL,STATUS)
*    Parameters :
...
*
         ...
         DO I = 1,YDIM,1
            ...
            DO J = 1,XDIM,1
               SCRTCH(J,I) = MIN(MAX(NINT((IMAGE(J,K)-LOWER)*255.0
     :          /(UPPER-LOWER)),0),255)
            ENDDO
