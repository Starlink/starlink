*+  KFH_IMSCL - User defines limits of image scaling.
      SUBROUTINE KFH_IMSCL(IMAGE,XDIM,YDIM,SCRTCH,UPPER,LOWER,
     : MINV,MAXV,FOUND,BLNKVL,STATUS)
*    Description :
...
*    Invocation :
*     CALL KFH_IMSCL(IMAGE,XDIM,YDIM,SCRTCH,UPPER,LOWER,
*    : MINV,MAXV,FOUND,BLNKVL,STATUS)
*    Parameters :
