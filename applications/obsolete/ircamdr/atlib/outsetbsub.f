...
*     outside the bounds of a specified box, where a given fixed
...
*     29-10-1988 : my version for OUTSETB (JACH::CAA)
...
*         test if current pixel outside box and set to old value if it is ...
