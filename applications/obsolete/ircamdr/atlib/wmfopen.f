...
*    Invocation :
*
*     CALL WMFOPEN( FNAME, PARAM, LUN, LOC, NUMBER, MAXI, MINI, WT, STATUS )
*
*    Parameters :
*
*     FNAME  =  CHAR( READ )
...
*     07-03-1989 : Added read of weight (JACH::CAA)
...
*    Export :
      ...
      INTEGER
     :    LOC,                    ! central image structure locator
