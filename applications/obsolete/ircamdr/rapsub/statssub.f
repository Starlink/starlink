...
*+  STATSSUB - works out image statistics
      ...
      SUBROUTINE STATSSUB ( ARRAY, DIMSX, DIMSY, XSTART, YSTART, XSIZE,
...
*    Invocation :
*
*     CALL STATSSUB ( ARRAY, DIMSX, DIMSY, XSTART, YSTART, XSIZE,
*    :                YSIZE, NUMPIX, MAXIMUM, MINIMUM,
*    :                TOTAL, MEAN, STDDEV, STATUS )
*
*    Method :
...
*    Import :
      ...
      INTEGER
     :     DIMSX,            ! X dimensions of input array
     :     DIMSY,            ! Y dimensions of input array
