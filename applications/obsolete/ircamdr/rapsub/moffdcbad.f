...
*     This version of MOFFDCSUB handles bad pixels using a bad mask, which
*     is non-zero at the location of fixed bad pixels in the input arrays.
*
*    Invocation :
*
*     CALL MOFFDCBAD( ARRAYA, DIMSA, ARRAYB, DIMSB, XOFF, YOFF, DCOFF, STATUS )
*
*    Parameters :
*
...
*         Bad pixel mask - non-zero value denotes a fixed bad pixel
*     BADDIMS( 2 )  =  INTEGER( READ )
*         Dimensions of bad pixel mask
*     DCOFF  =  REAL( WRITE )
