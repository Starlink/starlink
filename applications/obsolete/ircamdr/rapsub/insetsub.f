...
*     inside the bounds of a specified circle, where a given fixed
...
*        If distance is less than radius of circle then
...
*             pixel lies inside circle - output array pixel value is
