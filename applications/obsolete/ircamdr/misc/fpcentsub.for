      SUBROUTINE FPCENTSUB( INARRAY, DIMS1, DIMS2, XINIT, 
...
!	type *, 'MAXSHIFT = ', maxshift
!	type *, 'MAXITER = ', maxiter
!	type *, 'TOLER = ', toler
...
*       the n-th smallest into XBACK
         CALL FPNTHMIN( XAV, NSAMPLES, NTH, STACK)
         XBACK  =  STACK( 1 )

*       similarly for the y profile, value placed in YBACK
         CALL FPNTHMIN( YAV, NSAMPLES, NTH, STACK)
         YBACK  =  STACK( 1 )
...
*             values, set the error variable, and return
               ...
               YFINAL  =  YINIT
               FINISHED  =  .TRUE.
	       type *, 'MAX ERROR REACHED'
	       type *, 'DO NOT BELIEVE RESULT!!!!'
            ELSE
