*+  AIF_SCALVW - scale and shift a vectorised array of type INTEGER*2
      SUBROUTINE AIF_SCALVW( DIM, BIAS, SCALE, ARRAY, STATUS )
*    Description :
...
*    Invocation :
*      CALL AIF_SCALVW( DIM, BIAS, SCALE; ARRAY, STATUS )
*    Parameters :
*     DIM           = INTEGER( READ )
