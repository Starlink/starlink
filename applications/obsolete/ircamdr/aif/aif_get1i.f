*+  AIF_GET1I - Obtain exact number of INTEGER values within given range
      SUBROUTINE AIF_GET1I( PARNAM, MIN, MAX, NVALS, VALUES, STATUS )
*    Description :
*     This routine obtains an exact number of INTEGER values, within a given
...
*    Invocation :
*      CALL AIF_GET1I( PARNAM, MIN, MAX, NVALS, VALUES, STATUS )
*    Parameters :
...
*             obtain the range of the values given
               CALL AIF_MMVI( NVALS, VALUES, VRANGE, STATUS )
