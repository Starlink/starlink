*+  AIF_GET1R - Obtain exact number of REAL values within given range
      SUBROUTINE AIF_GET1R( PARNAM, MIN, MAX, NVALS, VALUES, STATUS )
*    Description :
*     This routine obtains an exact number of REAL values, within a given
...
*    Invocation :
*      CALL AIF_GET1R( PARNAM, MIN, MAX, NVALS, VALUES, STATUS )
*    Parameters :
...
*             obtain the range of the values given
               CALL AIF_MMVR( NVALS, VALUES, VRANGE, STATUS )
