*+  AIF_EXACD - Obtain exact number of DOUBLE PRECISION values from parameter system
      SUBROUTINE AIF_EXACD( PARNAM, NVALS, VALUES, STATUS )
*    Description :
*     This routine obtains an exact number of DOUBLE PRECISION values from the parameter
