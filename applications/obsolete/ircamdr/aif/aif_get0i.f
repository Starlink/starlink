*+  AIF_GET0I - Returns a scalar of type INTEGER in a given range.
      SUBROUTINE AIF_GET0I( PARNAM, DEFAUL, MIN, MAX, VALUE, STATUS )
*    Description :
...
*    Invocation :
*     CALL AIF_GET0I( PARNAM, DEFAUL, MIN, MAX, VALUE, STATUS )
*    Parameters :
