*+  AIF_SUMY2R - Sum REAL 2-D array in 2nd (Y) dimension to give 1-D array
      SUBROUTINE AIF_SUMY2R( DIMS, ARR2D, ARR1D, STATUS )
*    Description :
*     This takes the REAL 2-dimensional array ARR2D and sums together its
*     contents in its second (Y) dimension to give a REAL 1-dimensional
*     array ARR1D.
*     E.g.
*                1  6  3  7
*      ARR2D     4  5  2  3
...
*      ARR1D     13 20 10 16
*    Invocation :
*     CALL AIF_SUMY2R( DIMS, ARR2D, ARR1D, STATUS )
*    Parameters :
*     DIMS( 2 )                 = INTEGER( READ )
*           dimensions of 2-D array
*     ARR2D( DIMS(1), DIMS(2) ) = REAL( READ )
*           2-D array to be summed in the Y direction
*     ARR1D( DIMS(1) )          = REAL( WRITE )
