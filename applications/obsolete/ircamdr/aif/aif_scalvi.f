*+  AIF_SCALVI - scale and shift a vectorised array of type INTEGER
      SUBROUTINE AIF_SCALVI( DIM, BIAS, SCALE, ARRAY, STATUS )
*    Description :
...
*    Invocation :
*      CALL AIF_SCALVI( DIM, BIAS, SCALE; ARRAY, STATUS )
*    Parameters :
*     DIM           = INTEGER( READ )
