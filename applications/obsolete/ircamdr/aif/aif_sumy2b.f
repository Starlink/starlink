*+  AIF_SUMY2B - Sum BYTE 2-D array in 2nd (Y) dimension to give 1-D array
      SUBROUTINE AIF_SUMY2B( DIMS, ARR2D, ARR1D, STATUS )
*    Description :
...
*      ARR1D     13 20 10 16
*    Invocation :
*     CALL AIF_SUMY2B( DIMS, ARR2D, ARR1D, STATUS )
*    Parameters :
*     DIMS( 2 )                 = INTEGER( READ )
