*+  AIF_MMVD - Return minimum and maximum values in vectorised DOUBLE PRECISION array.
      SUBROUTINE AIF_MMVD( NPTS, ARRAY, RANGE, STATUS )
*    Description :
*     The vectorised array ARRAY( NPTS ) of type DOUBLE PRECISION is searched for the
