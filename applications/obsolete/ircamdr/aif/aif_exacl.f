*+  AIF_EXACL - Obtain exact number of LOGICAL values from parameter system
      SUBROUTINE AIF_EXACL( PARNAM, NVALS, VALUES, STATUS )
*    Description :
*     This routine obtains an exact number of LOGICAL values from the parameter
...
*               obtain values associated with parameter
                  CALL PAR_GETVL( PARNAM, NEEDED, WORK, NOBT, STATUS )
...
*            supply the complete VALUES array back to the parameter system
               CALL PAR_PUTVL( PARNAM, NVALS, VALUES, STATUS )
...
*      report the error
         ...
         CALL ERR_REP( 'AIF_EXAC_EXMX', 'AIF_EXACL: Request for '/
