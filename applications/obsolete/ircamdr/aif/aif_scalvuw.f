*+  AIF_SCALVUW - scale and shift a vectorised array of type INTEGER*2
      SUBROUTINE AIF_SCALVUW( DIM, BIAS, SCALE, ARRAY, STATUS )
*    Description :
...
*    Invocation :
*      CALL AIF_SCALVUW( DIM, BIAS, SCALE; ARRAY, STATUS )
*    Parameters :
*     DIM           = INTEGER( READ )
