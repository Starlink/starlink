...
*+  AIF_SORT1R - sort a 1-D array of type REAL
      SUBROUTINE AIF_SORT1R( DIM, ARRAY, STATUS )
*    Description :
*     This routine sorts a 1-D array of type REAL in situ using an
*     element swapping sort. This is a rather slow sort, but useful
*     for small arrays ( DIM < 100 ).
*    Invocation :
*     CALL AIF_SORT1R( DIM, ARRAY; STATUS )
*    Parameters :
*     DIM          = INTEGER( READ )
*           Dimension of array
*     ARRAY( DIM ) = REAL( UPDATE )
