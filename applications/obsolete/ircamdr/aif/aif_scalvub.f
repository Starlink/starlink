*+  AIF_SCALVUB - scale and shift a vectorised array of type BYTE
      SUBROUTINE AIF_SCALVUB( DIM, BIAS, SCALE, ARRAY, STATUS )
*    Description :
...
*    Invocation :
*      CALL AIF_SCALVUB( DIM, BIAS, SCALE; ARRAY, STATUS )
*    Parameters :
*     DIM           = INTEGER( READ )
