*+  AIF_GET0R - Returns a scalar of type REAL in a given range.
      SUBROUTINE AIF_GET0R( PARNAM, DEFAUL, MIN, MAX, VALUE, STATUS )
*    Description :
*     A value is obtained for the REAL variable VALUE, associated with
...
*    Invocation :
*     CALL AIF_GET0R( PARNAM, DEFAUL, MIN, MAX, VALUE, STATUS )
*    Parameters :
