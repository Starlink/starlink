*+  AIF_MMVI - Return minimum and maximum values in vectorised INTEGER array.
      SUBROUTINE AIF_MMVI( NPTS, ARRAY, RANGE, STATUS )
*    Description :
*     The vectorised array ARRAY( NPTS ) of type INTEGER is searched for the
