*+  AIF_SUMX2B - Sum BYTE 2-D array in 1st (X) dimension to give 1-D array
      SUBROUTINE AIF_SUMX2B( DIMS, ARR2D, ARR1D, STATUS )
*    Description :
...
*                8 9 5 6          28
*    Invocation :
*     CALL AIF_SUMX2B( DIMS, ARR2D, ARR1D, STATUS )
*    Parameters :
*     DIMS( 2 )                 = INTEGER( READ )
