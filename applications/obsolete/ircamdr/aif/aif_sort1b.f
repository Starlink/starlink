*+  AIF_SORT1B - sort a 1-D array of type BYTE
      SUBROUTINE AIF_SORT1B( DIM, ARRAY, STATUS )
*    Description :
*     This routine sorts a 1-D array of type BYTE in situ using an
*     element swapping sort. This is a rather slow sort, but useful
*     for small arrays ( DIM < 100 ).
*    Invocation :
*     CALL AIF_SORT1B( DIM, ARRAY; STATUS )
*    Parameters :
*     DIM          = INTEGER( READ )
*           Dimension of array
*     ARRAY( DIM ) = BYTE( UPDATE )
