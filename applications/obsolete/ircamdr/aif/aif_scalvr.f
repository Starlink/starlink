*+  AIF_SCALVR - scale and shift a vectorised array of type REAL
      SUBROUTINE AIF_SCALVR( DIM, BIAS, SCALE, ARRAY, STATUS )
*    Description :
...
*    Invocation :
*      CALL AIF_SCALVR( DIM, BIAS, SCALE; ARRAY, STATUS )
*    Parameters :
*     DIM           = INTEGER( READ )
