*+  AIF_MMVW - Return minimum and maximum values in vectorised INTEGER*2 array.
      SUBROUTINE AIF_MMVW( NPTS, ARRAY, RANGE, STATUS )
*    Description :
...
*    Invocation :
*     CALL AIF_MMVW( NPTS, ARRAY, RANGE, STATUS )
*    Parameters :
*     NPTS          = INTEGER( READ )
