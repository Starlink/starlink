*+  AIF_MMVR - Return minimum and maximum values in vectorised REAL array.
      SUBROUTINE AIF_MMVR( NPTS, ARRAY, RANGE, STATUS )
*    Description :
*     The vectorised array ARRAY( NPTS ) of type REAL is searched for the
