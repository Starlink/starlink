*+  AIF_SUMX2R - Sum REAL 2-D array in 1st (X) dimension to give 1-D array
      SUBROUTINE AIF_SUMX2R( DIMS, ARR2D, ARR1D, STATUS )
*    Description :
*     This takes the 2-dimensional REAL array ARR2D and sums together its
*     contents in its first (X) dimension to give a 1-dimensional REAL array
*     ARR1D.
*     E.g.
*                 ARR2D          ARR1D
*                1 6 3 7          17
