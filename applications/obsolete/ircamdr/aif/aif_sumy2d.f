*+  AIF_SUMY2D - Sum DOUBLE PRECISION 2-D array in 2nd (Y) dimension to give 1-D array
      SUBROUTINE AIF_SUMY2D( DIMS, ARR2D, ARR1D, STATUS )
*    Description :
*     This takes the DOUBLE PRECISION 2-dimensional array ARR2D and sums together its
*     contents in its second (Y) dimension to give a DOUBLE PRECISION 1-dimensional
*     array ARR1D.
*     E.g.
*                1  6  3  7
*      ARR2D     4  5  2  3
