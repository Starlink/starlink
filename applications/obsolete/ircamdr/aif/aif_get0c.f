*+  AIF_GET0C - Returns a scalar of type CHARACTER*(*) in a given range.
      SUBROUTINE AIF_GET0C( PARNAM, DEFAUL, MIN, MAX, VALUE, STATUS )
*    Description :
*     A value is obtained for the CHARACTER*(*) variable VALUE, associated with
...
*       suggest value in DEFAUL to data system as dynamic default
         CALL PAR_DEF0C( PARNAM, DEFAUL, STATUS )
