...
*     of adding the pixels of the second input array to those of
*     the first input array one at a time.
*
*    Invocation :
*
*     CALL ADDARR2D( INARRAY1, INARRAY2, OUTARRAY, DIMS, STATUS )
*
*    Method :
*
...
*          set output pixel to be first input array pixel plus
