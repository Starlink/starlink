...
*     of subtracting a given real scalar value from the pixels of
*     the input array one at a time.
*
*    Invocation :
*
*     CALL SUBSCA2D( INARRAY, DIMS, SCALAR; OUTARRAY, STATUS )
*
*    Method :
*
...
*     12-Aug-1994   Changed DIM arguments so that routine willcompile(SKL@JACH)
*
*    Type definitions :
...
*    Import :
     ...
     :   SCALAR           ! number to be subtracted from each pixel of array
...
*          set output pixel to be input array pixel minus scalar
