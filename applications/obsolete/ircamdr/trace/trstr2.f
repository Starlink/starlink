*+ TRSTR2 - A copy of TRSTR1 used by TRACE for pseodeo recursion.
      SUBROUTINE TRSTR2( STRLOC, INDENT, FULL, STATUS )
*    Description :
...
*-
     ...
     :        STATUS )
            IF( .NOT. PRIM ) THEN
               IF( NDIM .EQ. 0 ) THEN
                  CALL TRSTR3( LOC, INDENT+3, FULL, STATUS )
               ELSE
                  CALL TRARR3( LOC, NAME, SIZE, NDIM, DIMS, INDENT+3,
     :              FULL, STATUS )
               ENDIF
            ENDIF
