*+  TRARR3 - This is a copy of TRARR1 used by TRACE for pseudo recursion.
      SUBROUTINE TRARR3( OBJLOC, NAME, SIZE, NDIM, DIMS, INDENT, FULL,
     :  STATUS )
*    Description :
...
*-
      IF( STATUS .EQ. SAI__OK ) THEN
         ...
         DO INDEX = 1, MAXEL
            ...
            IF( STATUS .EQ. SAI__OK ) THEN
               CALL TRSTR3( CELLOC, INDENT, FULL, STATUS )
