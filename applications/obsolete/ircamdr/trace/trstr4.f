*+ TRSTR4 - A copy of TRSTR1 used by TRACE for pseodeo recursion.
      SUBROUTINE TRSTR4( STRLOC, INDENT, FULL, STATUS )
*    Description :
...
*-
     ...
     :        STATUS )
            IF( .NOT. PRIM ) THEN
               IF( NDIM .EQ. 0 ) THEN
                  CALL TRSTR5( LOC, INDENT+3, FULL, STATUS )
               ELSE
                  CALL TRARR5( LOC, NAME, SIZE, NDIM, DIMS, INDENT+3,
     :              FULL, STATUS )
               ENDIF
            ENDIF
