*+  TRARR6 - This is a copy of TRARR1 used by TRACE for pseudo recursion.
      SUBROUTINE TRARR6( OBJLOC, NAME, SIZE, NDIM, DIMS, INDENT, FULL,
     :  STATUS )
*    Description :
...
*             terminate pseudo recursion by a call to LSDIR
               CALL LSDIR( CELLOC, INDENT, STATUS )
