*+CON_RECHECK_TARG   Consistency check for Rosat Proposal Target form.
      LOGICAL FUNCTION CON_RECHECK_TARG(REF_NO)
...
*     1991 Nov	MJR		From check to recheck
*     1992 Jun  M Duesterhaus   port to UNIX
*******************************************************************************
      IMPLICIT NONE
