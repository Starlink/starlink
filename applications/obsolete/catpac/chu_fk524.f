...
*
        ...
        DO FLDCOUNT = 1, NUMFLDS
          ...
          ELSEIF (NAMES(FLDCOUNT) .EQ. DECFK5) THEN
            D1FLG = .TRUE.
            D1FMT = FORMAT(FLDCOUNT)
          ELSEIF (NAMES(FLDCOUNT) .EQ. RAPMFK5) THEN
            DR1FLG = .TRUE.
            DR1FMT = FORMAT(FLDCOUNT)
          ELSEIF (NAMES(FLDCOUNT) .EQ. DECPMFK5) THEN
            DD1FLG = .TRUE.
            DD1FMT = FORMAT(FLDCOUNT)
          ELSEIF (NAMES(FLDCOUNT) .EQ. PARLXFK5) THEN
            P1FLG = .TRUE.
            P1FMT = FORMAT(FLDCOUNT)
          ELSEIF (NAMES(FLDCOUNT) .EQ. RADVELFK5) THEN
            V1FLG = .TRUE.
...
*
          ...
          COMMENTS(NUMFLDS) = 'HH MM SS!       RA B1950'
*
          NUMFLDS = NUMFLDS + 1
          D2POS = NUMFLDS
          NAMES(NUMFLDS) = DECFK4
          FORMAT(NUMFLDS) = 'SDD MM SS'
          UNITS(NUMFLDS) = 'RADIAN'
          COMMENTS(NUMFLDS) = 'SDD MM SS!      DEC B1950'
*
          NUMFLDS = NUMFLDS + 1
          DR2POS = NUMFLDS
          NAMES(NUMFLDS) = RAPMFK4
          FORMAT(NUMFLDS) = 'F10.7'
          UNITS(NUMFLDS) = 'SEC/YR'
          COMMENTS(NUMFLDS) = '               RA proper motion B1950'
*
          NUMFLDS = NUMFLDS + 1
          DD2POS = NUMFLDS
          NAMES(NUMFLDS) = DECPMFK4
          FORMAT(NUMFLDS) = 'F10.7'
          UNITS(NUMFLDS) = 'ARCSEC/YR'
          COMMENTS(NUMFLDS) = '                DEC proper motion B1950'
*
          NUMFLDS = NUMFLDS + 1
          P2POS = NUMFLDS
          NAMES(NUMFLDS) = PARLXFK4
          FORMAT(NUMFLDS) = 'F10.7'
...
*
           IF (FIRSTPASS) THEN
             ...
             DO FLDCOUNT = 1, INPUTNFLDS
              IF (OLDFNAMES(FLDCOUNT) .EQ. RAFK5) THEN
                R1POS = FLDCOUNT
              ELSEIF (OLDFNAMES(FLDCOUNT) .EQ. DECFK5) THEN
                D1POS = FLDCOUNT
              ELSEIF (OLDFNAMES(FLDCOUNT) .EQ. RAPMFK5) THEN
                DR1POS = FLDCOUNT
              ELSEIF (OLDFNAMES(FLDCOUNT) .EQ. DECPMFK5) THEN
                DD1POS = FLDCOUNT
              ELSEIF (OLDFNAMES(FLDCOUNT) .EQ. PARLXFK5) THEN
                P1POS = FLDCOUNT
              ELSEIF (OLDFNAMES(FLDCOUNT) .EQ. RADVELFK5) THEN
                V1POS = FLDCOUNT
              ENDIF
             ENDDO
           ENDIF
...
*
             DBDR1 = DS2R * DBDR1
             DBDD1 = DAS2R * DBDD1
             CALL SLA_FK524(DBR1, DBD1, DBDR1, DBDD1, DBP1, DBV1,
