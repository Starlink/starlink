      SUBROUTINE
     : CHP_1PAR( CD, EXPRESS, FNAMES, FTYPES, STATUS )
*+
*  Name:
*     CHP_1PAR
...
*  Invocation:
*     CALL CHP_1PAR( CD, EXPRESS, FNAMES, FTYPES, STATUS )
...
*     CHI_SEARCH and CHI_JOIN call the parser on you behalf. CHI_1PAR and
*     CHI_2PAR give
...
*     CHI_APPLY routine. CHI_1PAR uses the arguments FNAMES and FTYPES to
...
*           print *,'status = ',status
*           print *,'after CHI_ASPLIT'
*           print *,'wstring = ',wstring(1:60)
*           do i = 1,nitems
