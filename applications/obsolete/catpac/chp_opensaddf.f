      SUBROUTINE
     : CHP_OPENSADDF( DIR, FILE, ACMODE, FORM, RECSZ, FD, STATUS )
*+
*  Name:
*     CHI_OPENADDF
...
*  Local Variables:
      CHARACTER * ( 132 ) FILENAME ! Full filename
...
*
      ...
      call chr_appnd('ADDF',filename,length)
      length = chr_len(filename)
      call chr_appnd(file,filename,length)
      length = chr_len(filename)
