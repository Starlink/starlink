      SUBROUTINE BDI_PUT0<T>( ID, ITEMS, DATA, STATUS )
*+
*  Name:
*     BDI_PUT0<T>

*  Purpose:
*     Put the named scalar items with the type <COMM>

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL BDI_PUT0<T>( ID, ITEMS, DATA, STATUS )
...
*  Invoke basic routine
      CALL BDI_PUT<T>( ID, ITEMS, 0, 0, DATA, STATUS )

*  Report any errors
      IF ( STATUS .NE. SAI__OK ) CALL AST_REXIT( 'BDI_PUT0<T>', STATUS )
