      SUBROUTINE BDI_AXPUT0<T>( ID, IAX, ITEMS, DATA, STATUS )
*+
*  Name:
*     BDI_AXPUT0<T>

*  Purpose:
*     Put the named axis items as <COMM> scalars

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL BDI_AXPUT0<T>( ID, IAX, ITEMS, DATA, STATUS )
...
*  Report any errors
      IF ( STATUS .NE. SAI__OK ) CALL AST_REXIT( 'BDI_AXPUT0<T>', STATUS )
