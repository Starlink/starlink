      SUBROUTINE ADI1_CCH2AZ( LOC, CMP, ID, MEMBER, STATUS )
*+
*  Name:
*     ADI1_CCH2AZ
...
*  Invocation:
*     CALL ADI1_CCH2AZ( LOC, CMP, ID, MEMBER, STATUS )
...
*  Switch on type
      ...
      ELSE
        ...
        CALL ERR_REP( 'ADI1_CCH2AZ_1', 'Copy operation not defined '/
     :                /'for HDS type ^T', STATUS )

      END IF

*  Report any errors
      IF ( STATUS .NE. SAI__OK ) CALL AST_REXIT( 'ADI1_CCH2AZ', STATUS )
