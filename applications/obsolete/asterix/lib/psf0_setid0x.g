      SUBROUTINE PSF0_SETID0<T>( PSID, NAME, VALUE, STATUS )
*+
*  Name:
*     PSF0_SETID0<T>

*  Purpose:
*     Set value of the <COMM> psf instance data member called NAME

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL PSF0_SETID0<T>( PSID, NAME, VALUE, STATUS )
...
*  Report any errors
      IF ( STATUS .NE. SAI__OK ) THEN
        CALL AST_REXIT( 'PSF0_SETID0<T>', STATUS )
      END IF
