...
*  Store the stuff
      CALL ADI_CPUT0L( AXIS, 'Ok', OK, STATUS )
      CALL ADI_CPUT0I( AXIS, 'Dim', DIM, STATUS )
      CALL ADI_CPUT0L( AXIS, 'Reg', REG, STATUS )
      CALL ADI_CPUT0I( AXIS, 'Ptr', APTR, STATUS )
      CALL ADI_CPUT0R( AXIS, 'Base', BASE, STATUS )
      CALL ADI_CPUT0R( AXIS, 'Scale', SCALE, STATUS )
      CALL ADI_CPUT0R( AXIS, 'Tor', TOR, STATUS )
      CALL ADI_CPUT0C( AXIS, 'Label', LABEL, STATUS )
      CALL ADI_CPUT0C( AXIS, 'Units', UNITS, STATUS )
