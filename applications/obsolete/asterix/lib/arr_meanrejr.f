*+  ARR_MEANREJR - Finds mean and standard deviation of array
      SUBROUTINE ARR_MEANREJR( N, ARRAY, MEDIAN, SDEV, STATUS )
*
*    History :
*
*     30 Aug 89 : ( BHVAD :: DJA )
