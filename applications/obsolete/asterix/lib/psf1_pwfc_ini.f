      SUBROUTINE PSF1_PWFC_INI( PSID, STATUS )
*+
*  Name:
*     PSF1_PWFC_INI

*  Purpose:
*     Initialise a WFC pointed phase psf

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL PSF1_PWFC_INI( PSID, STATUS )
...
*  Store methods
      CALL PSF0_SETRTN( PSID, 'Data', PSF1_PWFC_DAT, STATUS )

*  Report any errors
      IF ( STATUS .NE. SAI__OK ) THEN
        CALL AST_REXIT( 'PSF1_PWFC_INI', STATUS )
      END IF
