      SUBROUTINE PSF1_PWFC_DAT( PSID, X0, Y0, QX, QY, DX, DY,
...
*  Purpose:
*     Return pointed WFC psf probability

*  Language:
*     Starlink Fortran

*  Invocation:
*     CALL PSF1_PWFC_DAT( PSID, X0, Y0, QX, QY, DX, DY, INTEG, NX,
*                          NY, ARRAY, STATUS )
...
*  Report any errors
      IF ( STATUS .NE. SAI__OK ) THEN
        CALL AST_REXIT( 'PSF1_PWFC_DAT', STATUS )
      END IF
