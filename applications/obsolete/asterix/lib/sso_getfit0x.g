*+  SSO_GETFITEM0<T> - Read a field item of type <COMM>
      SUBROUTINE SSO_GETFITEM0<T>( LOC, FLD, ITEM, VALUE, STATUS )
*    Description :
*
...
*      Read value
        CALL CMP_GET0<T>( FLOC, ITEM, VALUE, STATUS )
...
*      Tidy up
 99     IF ( STATUS .NE. SAI__OK ) THEN
          CALL ERR_REP( ' ', '...from SSO_GETFITEM0<T>', STATUS )
        END IF
