      SUBROUTINE ADI1_ARYSHP( LOC, MAXNDIM, DIMS, NDIM, TYPE, STATUS )
*+
*  Name:
*     ADI1_ARYSHP
...
*  Invocation:
*     CALL ADI1_ARYSHP( LOC, MAXNDIM, DIMS, NDIM, TYPE, STATUS )
...
*  Report any errors
      IF ( STATUS .NE. SAI__OK ) CALL AST_REXIT( 'ADI1_ARYSHP', STATUS )
