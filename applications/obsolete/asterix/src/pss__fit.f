...
*    First time through?
     ...
     :                 PREDICTION_PREDPTR(1,FIT_PRED), STATUS )
        CALL DYN_MAPR( 1, 2*PSS__CACHELEN,
     :                 PREDICTION_PREDPTR(2,FIT_PRED), STATUS )
        PREDICTION_PGDPTR(1,FIT_PRED) = PREDICTION_PREDPTR(1,FIT_PRED)
        PREDICTION_PGDPTR(2,FIT_PRED) = PREDICTION_PREDPTR(2,FIT_PRED)
