...
*  get coordinate frame
     ...
     :                        'active to use these coordinates')
        ...
        ELSEIF (FRAME.EQ.1) THEN				! RA/DEC
          CALL PAR_GET0C('RA1',SRA,STATUS)
          CALL PAR_GET0C('DEC1',SDEC,STATUS)
          CALL CONV_RADEC(SRA,SDEC,AZ1,EL1,STATUS)
          CALL PAR_GET0C('RA2',SRA,STATUS)
          CALL PAR_GET0C('DEC2',SDEC,STATUS)
          CALL CONV_RADEC(SRA,SDEC,AZ2,EL2,STATUS)

        ELSEIF (FRAME.EQ.2) THEN			! Ecliptic
          CALL PAR_GET0D('ELON1',AZ1,STATUS)
          CALL PAR_GET0D('ELAT1',EL1,STATUS)
          CALL PAR_GET0D('ELON2',AZ2,STATUS)
          CALL PAR_GET0D('ELAT2',EL2,STATUS)

        ELSEIF (FRAME.EQ.3) THEN			! Galactic
          CALL PAR_GET0D('L1',AZ1,STATUS)
          CALL PAR_GET0D('B1',EL1,STATUS)
          CALL PAR_GET0D('L2',AZ2,STATUS)
          CALL PAR_GET0D('B2',EL2,STATUS)
        ...
        ELSEIF (FRAME.EQ.5) THEN			! pixel coords
          CALL PAR_GET0R('XPIX1',XPIX1,STATUS)
          CALL PAR_GET0R('YPIX1',YPIX1,STATUS)
          CALL PAR_GET0R('XPIX2',XPIX2,STATUS)
          CALL PAR_GET0R('YPIX2',YPIX2,STATUS)
