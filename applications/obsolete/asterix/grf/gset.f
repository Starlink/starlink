...
*  specific to x-axis
          IF (X) THEN
            CALL GCB_CAN('XAXIS_LOG',STATUS)
            CALL GCB_CAN('XAXIS_HI',STATUS)
            CALL GCB_CAN('XAXIS_LO',STATUS)
            CALL GCB_CAN('XAXIS_OPT',STATUS)
            CALL GCB_CAN('XAXIS_DIV',STATUS)
            CALL GCB_CAN('XAXIS_TICK',STATUS)
          ENDIF
*  specific to y-axis
          IF (Y) THEN
            CALL GCB_CAN('YAXIS_LOG',STATUS)
            CALL GCB_CAN('YAXIS_HI',STATUS)
            CALL GCB_CAN('YAXIS_LO',STATUS)
            CALL GCB_CAN('YAXIS_OPT',STATUS)
            CALL GCB_CAN('YAXIS_DIV',STATUS)
            CALL GCB_CAN('YAXIS_TICK',STATUS)
          ENDIF
*  common to both axes
          CALL GCB_CAN('AXES_BOLD',STATUS)
          CALL GCB_CAN('AXES_SIZE',STATUS)
          CALL GCB_CAN('AXES_FONT',STATUS)
          CALL GCB_CAN('AXES_WIDTH',STATUS)
          CALL GCB_CAN('AXES_COLOUR',STATUS)
          CALL GCB_CAN('AXES_SCALING',STATUS)
          CALL GCB_GETL('AXES_RADEC',OK,RADEC,STATUS)
          IF (OK.AND.RADEC) THEN
            CALL GCB_CAN('AXES_RADEC',STATUS)
            CALL GCB_CAN('XLABEL_TEXT',STATUS)
...
*    Local variables :
      ...
      INTEGER COLOUR
      INTEGER DIV
      LOGICAL SETW,SETT,SETD,SETF,SETS,SETB,SETO,SETL,SETHI,SETLO,SETC
      LOGICAL LOGAX
...
*  get individual control parameters - NULL means no change
          ...
          CALL GSET_GET0I( 'DIV', SETD, DIV, STATUS )
...
*  common to both axes
          ...
          ENDIF
          IF (SETC) THEN
            CALL GCB_SETI('AXES_COLOUR',COLOUR,STATUS)
          ENDIF
          IF (SETW) THEN
...
*  specific to x-axis
          IF (X) THEN
            CALL GCB_CAN('XLABEL_OFFSET',STATUS)
            CALL GCB_CAN('XLABEL_TEXT',STATUS)
...
*  specific to y-axis
          IF (Y) THEN
            CALL GCB_CAN('YLABEL_OFFSET',STATUS)
            CALL GCB_CAN('YLABEL_TEXT',STATUS)
...
*      Load GCB
          ...
          CALL GCB_CAN('KEY_OPT',STATUS)
          CALL GCB_CAN('KEY_BOLD',STATUS)
          CALL GCB_CAN('KEY_SIZE',STATUS)
          CALL GCB_CAN('KEY_FONT',STATUS)
...
*      Load GCB
          ...
          CALL GCB_CAN('STAMP_FLAG',STATUS)
          CALL GCB_CAN('STAMP_TEXT',STATUS)
...
*      Load GCB
          ...
          CALL GCB_CAN('FUNC_FLAG',STATUS)
          CALL GCB_CAN('FUNC_STYLE',STATUS)
          CALL GCB_CAN('FUNC_WIDTH',STATUS)
          CALL GCB_CAN('FUNC_COLOUR',STATUS)
          CALL GCB_CAN('FUNC_TYPE',STATUS)
          NAME='FUNC_PAR'
          DO I=1,6
            WRITE(NAME(9:9),'(I1)') I
...
*  get individual control parameters - NULL means no change
        ...
        CALL GSET_GET0I( 'STYLE', SETS, STYLE, STATUS )
        CALL GSET_GET0I( 'COLOUR', SETC, COLOUR, STATUS )
        CALL GSET_GET0I( 'BGCOL', SETBG, BGND, STATUS )
        CALL GSET_GET0I( 'FONT', SETF, FONT, STATUS )
...
*      Load GCB
          ...
          IF (SETBG) THEN
            CALL GCB_SETI('DEFAULT_BGND',BGND,STATUS)
          ENDIF
...
*      Load GCB
          ...
          CALL GCB_CAN('POLY_FLAG',STATUS)
          CALL GCB_CAN('POLY_STYLE',STATUS)
          CALL GCB_CAN('POLY_WIDTH',STATUS)
          CALL GCB_CAN('POLY_COLOUR',STATUS)
...
*      Load GCB
          ...
          CALL GCB_CAN('STEP_FLAG',STATUS)
          CALL GCB_CAN('STEP_STYLE',STATUS)
          CALL GCB_CAN('STEP_WIDTH',STATUS)
          CALL GCB_CAN('STEP_COLOUR',STATUS)
...
*      Load GCB
          ...
          CALL GCB_CAN('POINT_FLAG',STATUS)
          CALL GCB_CAN('POINT_SYMBOL',STATUS)
          CALL GCB_CAN('POINT_SIZE',STATUS)
          CALL GCB_CAN('POINT_BOLD',STATUS)
...
*      Load GCB
          ...
          CALL GCB_CAN('PIX_FLAG',STATUS)
          CALL GCB_CAN('PIX_MIN',STATUS)
          CALL GCB_CAN('PIX_MAX',STATUS)
          CALL GCB_CAN('PIX_SCALING',STATUS)
          CALL GCB_CAN('PIX_CYCLES',STATUS)
...
*      Load GCB
          ...
          CALL GCB_CAN('CONT_FLAG',STATUS)
          CALL GCB_GETI('CONT_N',OK,N,STATUS)
          IF (.NOT.OK) THEN
            N=1
          ENDIF
          CALL GCB_CAN('CONT_N',STATUS)
          CALL GCB_CAN1('CONT_LEVS,CONT_STYLE,CONT_WIDTH,CONT_COLOUR',
     :                  1,N,STATUS)
...
*      Load GCB
          ...
          CALL GCB_CAN('SURF_FLAG',STATUS)
          CALL GCB_CAN('SURF_ANGLE',STATUS)
...
*      Load GCB
          ...
          CALL GCB_CAN('GRID_FRAME',STATUS)
          CALL GCB_CAN('GRID_POS',STATUS)
...
*      Load GCB
          ...
          CALL GCB_CAN('ERR_SHAPE',STATUS)
          CALL GCB_CAN('ERR_WIDTH',STATUS)
...
*    Load GCB
        ...
        CALL GCB_CAN1('TITLE_TEXT,TITLE_FONT,TITLE_BOLD,'/
     :                /'TITLE_SIZE,TITLE_JUST',1,N,STATUS)
...
*    Load GCB
        ...
        IF (.NOT.OK) THEN
          N=1
        ENDIF
        CALL GCB_CAN('NOTE_N',STATUS)
        CALL GCB_CAN1('NOTE_TEXT,NOTE_X,NOTE_Y,NOTE_ANGLE',1,N,STATUS)
        CALL GCB_CAN1('NOTE_FONT,NOTE_BOLD,NOTE_SIZE,'/
     :                /'NOTE_JUST,NOTE_COLOUR',1,N,STATUS)
...
*    Load GCB
        ...
        CALL GCB_CAN('MARKER_N',STATUS)
        CALL GCB_CAN1('MARKER_SYMBOL,MARKER_X,MARKER_Y',1,N,STATUS)
        CALL GCB_CAN1('MARKER_BOLD,MARKER_SIZE,MARKER_COLOUR',1,
     :                 N,STATUS)
        CALL GCB_CAN('MARKER_NUMBER',STATUS)
...
*    Load GCB
        ...
        IF (.NOT.OK) THEN
          N=1
        ENDIF
        CALL GCB_CAN('SHAPE_N',STATUS)
        CALL GCB_CAN1('SHAPE_TYPE,SHAPE_X,SHAPE_Y',1,N,STATUS)
        CALL GCB_CAN1('SHAPE_DATA1,SHAPE_DATA2,SHAPE_DATA3',1,N,STATUS)
        CALL GCB_CAN1('SHAPE_WIDTH,SHAPE_STYLE,SHAPE_COLOUR',1,N,STATUS)
...
*      Load GCB
          ...
          CALL GCB_CAN('POS_X1',STATUS)
          CALL GCB_CAN('POS_X2',STATUS)
          CALL GCB_CAN('POS_Y1',STATUS)
          CALL GCB_CAN('POS_Y2',STATUS)
...
*      Load GCB
          ...
          IF (.NOT.OK) THEN
            N=1
          ENDIF
          CALL GCB_CAN('COLOUR_N',STATUS)
          CALL GCB_CAN1('COLOUR_RED,COLOUR_GREEN,COLOUR_BLUE',1,N,
     :                  STATUS)
          CALL GCB_CAN('COLOUR_RGB',STATUS)
          CALL GCB_CAN('COLOUR_NEG',STATUS)
