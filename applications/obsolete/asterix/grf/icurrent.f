...
*    Version :
      ...
      PARAMETER (VERSION = 'ICURRENT Version 2.1-0')
*-
      CALL USI_INIT()
...
*  Current position
        ...
        CALL USI_PUT0D('RA',RA,STATUS)			! RA/DEC
        CALL USI_PUT0D('DEC',DEC,STATUS)
        CALL USI_PUT0D('ELON',ELON,STATUS)		! Ecliptic
        CALL USI_PUT0D('ELAT',ELAT,STATUS)
        CALL USI_PUT0D('L',L,STATUS)			! Galactic
        CALL USI_PUT0D('B',B,STATUS)
...
*  Current mode
        ...
        ELSE
          MODE='KEY'
        ENDIF
        CALL USI_PUT0C('MODE',MODE,STATUS)
