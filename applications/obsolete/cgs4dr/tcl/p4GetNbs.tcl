...
#  Get character nbs items
    set P4Widgets(C01) [string trim [nbs get ${root}display_data]]
    set P4Widgets(C02) [string trim [nbs get ${root}device_lut]]
    set P4Widgets(C03) [string trim [nbs get ${root}title]]
    set P4Widgets(C04) [string trim [nbs get ${root}device_name]]
    set P4Widgets(C05) [string trim [nbs get ${root}device_xopt]]
    set P4Widgets(C06) [string trim [nbs get ${root}device_yopt]]
    set P4Widgets(C07) [string trim [nbs get ${root}display_type]]
    set P4Widgets(C08) [string trim [nbs get ${root}display_plane]]
    set P4Widgets(C09) [string trim [nbs get ${root}contour_type]]
    set P4Widgets(C10) [string trim [nbs get ${root}overcolour]]
    set P4Widgets(C11) [string trim [nbs get ${root}colour_style]]
    set P4Widgets(C12) [string trim [nbs get ${root}fg_colour]]
    set P4Widgets(C13) [string trim [nbs get ${root}bg_colour]]
    set P4Widgets(C14) [string trim [nbs get ${root}cut_direction]]
    set P4Widgets(C15) [string trim [nbs get ${root}last_type]]
