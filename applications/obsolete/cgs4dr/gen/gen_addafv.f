C+
      SUBROUTINE GEN_ADDAFV (NELM, ARRAY1, ARRAY2, ARRAY3,
     :                       Q1DATA, Q2DATA, Q3DATA,
     :                       V1DATA, V2DATA, V3DATA,
     :                       QUAL, FLAGS, FBAD, VARIANCES)
C
C     G E N _ A D D A F V
C
C     Adds together two floating point arrays, propogating VARIANCE.
...
C                                to distinguish it from basic GEN_ADDAF
C
C
C+
      IMPLICIT NONE
