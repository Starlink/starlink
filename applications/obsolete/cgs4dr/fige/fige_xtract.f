...
C
C     Note that this routine does not combined together the variances
C     of the different rows. FIG_XTRACT4 should be used to do this.
C
...
C     Bug fix. NUMBER converted to REAL.    SMB / ROE 5th DEcember 1990
C+
      IMPLICIT NONE
C
C     Parameters -
