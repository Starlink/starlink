*+  RED4_ORMASK - Combine two mask arrays with OR operation.
      SUBROUTINE RED4_ORMASK( DIM1, DIM2, MASK1, MASK2, OUTPUT,
     :  STATUS )
*    Description :
*     This routine combines two bad pixel mask arrays to produce a third
*     using the logical OR operation. The following truth table is used:-
*
*                             MASK1
*                    +----------+----------+
*                    |   GOOD   |   BAD    |
...
*           The output mask. OUTPUT = MASK1 .OR. MASK2
...
*         (using a logical OR operation).
            ...
            OUTPUT_BAD = ( MASK1_BAD .OR. MASK2_BAD )
