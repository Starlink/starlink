      SUBROUTINE IRM_BILN1( X, Y, XLO, XHI, YLO, YHI, DATA, INTERP,
     :                      STATUS )
*+
*  Name:
*     IRM_BILN1
...
*  Invocation:
*     CALL IRM_BILN1( X, Y, XLO, XHI, YLO, YHI, DATA, INTERP, STATUS )
...
*  Return a bad value if any of the four surrrounding pixels are bad.
         ELSE
            INTERP = VAL__BADR
