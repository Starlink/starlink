      SUBROUTINE IRM_QNTLR( USEWT, INTERP, FRACT, EL, X, W, IP, Q,
     :                      STATUS )
*+
*  Name:
*     IRM_QNTLR
...
*  Invocation:
*     CALL IRM_QNTLR( USEWT, INTERP, FRACT, EL, X, W, IP, Q, STATUS )
...
*        data.
*     29-SEP-1992 (DSB):
*        Original IRAS90 version copied from the CCDPACK routine
*        CCD1_QNTLx.
