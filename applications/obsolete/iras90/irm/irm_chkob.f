      SUBROUTINE IRM_CHKOB( LOC, INNAME, INTYPE, NDIMS, DIMS, STATUS )
*+
*  Name:
*     IRM_CHKOB
...
*  Invocation:
*     CALL IRM_CHKOB( LOC, INNAME, INTYPE, NDIMS, DIMS, STATUS )
...
*  Local Variables:
      ...
      CHARACTER*( DAT__SZNAM ) NAME ! Name of the object to be checked
      ...
      CHARACTER*( DAT__SZTYP ) TYPE ! Type of the object to be checked
...
*  Get a locator to the required object.
     ...
     :                 'IRM_CHKOB: Unable to find object ^NAME',
     :                 STATUS )
         GO TO 999
      END IF
...
*  Get the objects data type.
     ...
     :      'IRM_CHKOB: Unable to obtain the data type of object ^NAME',
     :                 STATUS )
         GO TO 999
      END IF
...
*  Check the object type matches the given type.
     ...
     :      'IRM_CHKOB: Object ^NAME has an invalid data type of ^TYPE',
     :                 STATUS )
         GO TO 999
      END IF
...
*  Get the objects shape.
     ...
     :         'IRM_CHKOB: Unable to obtain the shape of object ^NAME',
     :                 STATUS )
         GO TO 999
      END IF
...
*  Check the number of dimensions matches the given value.
     ...
     :   'IRM_CHKOB: Object ^NAME has an invalid no. of '//
...
*  Check the dimension sizes matches the given values.
     ...
     :      'IRM_CHKOB: Object ^NAME has an invalid size of ^SZ for '//
     :      'dimension ^DM', STATUS )
            GO TO 999
         END IF
      END DO
