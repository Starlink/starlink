      SUBROUTINE IRC1_DCLPI( IDC, DETIND, RA, DEC, CLSAMP, CLZFP,
     :                       STATUS )
*+
*  Name:
*     IRC1_DCLPI
...
*  Description:
*     This routine provides the functionality for IRC_DCLAP, without
...
*  If the CRDD type is unrecognised, give an error report.
      ELSE
         ...
         CALL ERR_REP( 'IRC1_DCLPI_ERR1',
     :                 'IRC1_DCLPI does not yet support ^T data',
     :                 STATUS )
      END IF
