      SUBROUTINE DREXAM3( STATUS )
*+
*  Name:
*     DREXAM3

*  Purpose:
*     Produce plot file for DRGRD example 3 in ID2.TEX.
...
*  Description:
*     Calls IRA_DRGRD to produce a grid showing an Lambert cylindrical
*     projection in ecliptic coordinates, covering all the
