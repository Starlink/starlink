      SUBROUTINE DREXAM1( STATUS )
*+
*  Name:
*     DREXAM1

*  Purpose:
*     Produce plot file for DRGRD example 1 in ID2.TEX.
...
*  Description:
*     Calls IRA_DRGRD to produce a grid showing an orthographic
*     projection in equatorial coordinates, covering half of the
