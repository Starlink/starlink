      SUBROUTINE MAPCC8( XLO, YLO, XHI, YHI, RLO, RHI, PLO, PHI, POFFX,
...
*  Purpose:
*     Paste data and weight values for a single sample.

*  Language:
*     Starlink Fortran 77

*  Invocation:
*     CALL MAPCC8( XLO, YLO, XHI, YHI, RLO, RHI, PLO, PHI, POFFX, POFFY,
*                  TOTWGT, PWGSZX, PWGSZY, PWGRID, DATVAL, DATOUT,
*                  WGTOUT, INSIDE, STATUS )

*  Description:
*     This routine adds the data and weight values for a single detector
*     sample to the "running-sum" images, DATOUT and WGTOUT.
