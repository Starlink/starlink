      SUBROUTINE HISTC0( STRING, LOGPOS, FD, STATUS )
*+
*  Name:
*     HISTC0
...
*  Invocation:
*     CALL HISTC0( STRING, LOGPOS, FD, STATUS )
...
*  Write the string to any log file, restricting the length to 80
*  characters to avoid exceeding the log file record length.
