      SUBROUTINE MAPCB6( IDC, IDA, WFACT, DET, DETNO, SFACT, VFACT,
...
*  Invocation:
*     CALL MAPCB6( IDC, IDA, WFACT, DET, DETNO, SFACT, VFACT, SAMP0,
...
*     for BAD values are performed on the input data, but any sample
...
*  Local Variables:
      ...
      INTEGER NBAD               ! No. of samples with zero variance.
...
*  coefficients, and calculate a new set of pixel weight grids.
            IF( CHANGE ) THEN
               ...
               CALL MSG_SETI( 'D', DET )
               CALL MSG_OUTIF( MSG__VERB, 'MAPCB6_MSG1',
...
*  detector.
      ...
      CALL MSG_OUTIF( MSG__VERB, 'MAPCB6_MSG2',
