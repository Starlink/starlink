      SUBROUTINE POINB3( MAXDET, DETNUM, IDET, LOGFID, LOGREQ, STATUS )
*+
*  Name:
*     POINB3

*  Purpose:
*     To report no point sources found in current detector

*  Language:
*     Starlink Fortran 77

*  Invocation:
*     CALL POINB3( MAXDET, DETNUM, IDET, LOGFID, LOGREQ, STATUS )
...
*  If no source has been detected, report.
         ...
         CALL MSG_OUT( 'POINB3_MSG2', 'No point source detected '/
...
*  Write to the logging file as well if requested.
         IF ( LOGREQ ) THEN
            ...
            CALL FIO_WRITE( LOGFID, 'No point source detected in the '/
