      SUBROUTINE MAPCB5( IDC, IDA, WFACT, DET, DETNO, SFACT, VFACT,
...
*  Invocation:
*     CALL MAPCB5( IDC, IDA, WFACT, DET, DETNO, SFACT, VFACT, SAMP0,
...
*     No checks for BAD values are performed on the input data or
*     variance values.  Each input data sample is given a total weight
*     of unity (excluding the sector shrinkage factor, WFACT). Output
*     variances are created based on the input variance values.
...
*  coefficients, and calculate a new set of pixel weight grids.
            IF( CHANGE ) THEN
               ...
               CALL MSG_SETI( 'D', DET )
               CALL MSG_OUTIF( MSG__VERB, 'MAPCB5_MSG1',
...
*  detector.
      ...
      CALL MSG_OUTIF( MSG__VERB, 'MAPCB5_MSG2',
