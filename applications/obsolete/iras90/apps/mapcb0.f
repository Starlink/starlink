      SUBROUTINE MAPCB0( IDC, IDA, WFACT, DET, DETNO, SFACT, VFACT,
...
*  Invocation:
*     CALL MAPCB0( IDC, IDA, WFACT, DET, DETNO, SFACT, VFACT,
...
*     brightness variance). Output variances are created based on the
...
*        variances. The weighted input variances are added into
...
*  coefficients, and calculate a new set of pixel weight grids.
            IF( CHANGE ) THEN
               ...
               CALL MSG_SETI( 'D', DET )
               CALL MSG_OUTIF( MSG__VERB, 'MAPCB0_MSG1',
...
*  detector.
      ...
      CALL MSG_OUTIF( MSG__VERB, 'MAPCB0_MSG2',
