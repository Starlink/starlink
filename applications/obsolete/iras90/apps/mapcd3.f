      SUBROUTINE MAPCD3( IDC, IDA, WFACT, DET, DETNO, SFACT, SAMP0,
...
*  Invocation:
*     CALL MAPCD3( IDC, IDA, WFACT, DET, DETNO, SFACT, SAMP0, START,
...
*  coefficients, and calculate a new set of pixel weight grids.
            IF( CHANGE ) THEN
               ...
               CALL MSG_SETI( 'D', DET )
               CALL MSG_OUTIF( MSG__VERB, 'MAPCD3_MSG1',
...
*  detector.
      ...
      CALL MSG_OUTIF( MSG__VERB, 'MAPCD3_MSG2',
