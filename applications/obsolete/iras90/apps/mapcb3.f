      SUBROUTINE MAPCB3( IDC, IDA, WFACT, DET, DETNO, SFACT,
...
*  Invocation:
*     CALL MAPCB3( IDC, IDA, WFACT, DET, DETNO, SFACT, SAMP0,
...
*     stream to the "running-sum" images, DATOUT and WGTOUT. Any sample
*     for which the input data value is BAD is excluded from the output
*     image. Each input data sample is given a weight of unity
*     (excluding the sector shrinkage factor, WFACT). No output
...
*  coefficients, and calculate a new set of pixel weight grids.
            IF( CHANGE ) THEN
               ...
               CALL MSG_SETI( 'D', DET )
               CALL MSG_OUTIF( MSG__VERB, 'MAPCB3_MSG1',
...
*  detector.
      ...
      CALL MSG_OUTIF( MSG__VERB, 'MAPCB3_MSG2',
