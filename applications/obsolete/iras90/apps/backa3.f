      SUBROUTINE BACKA3( QNAME, INDF, XNAME, XTYPE, LOCS, OK, STATUS )
*+
*  Name:
*     BACKA3
...
*  Invocation:
*     CALL BACKA3( QNAME, INDF, XNAME, XTYPE, LOCS, OK, STATUS )
...
*        the estimation of the scan background. If QNAME is blank, OK is
...
*  If the quality name does not already exist, add a definition.
      ELSE
         CALL IRQ_ADDQN( LOCS, QNAME, .FALSE., 'BACKCRDD: Samples '//
     :                   'excluded from background estim.', STATUS )
      END IF
