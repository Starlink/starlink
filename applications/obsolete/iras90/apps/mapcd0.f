      SUBROUTINE MAPCD0( IDC, IDA, WFACT, DET, DETNO, SFACT, VFACT,
...
*  Invocation:
*     CALL MAPCD0( IDC, IDA, WFACT, DET, DETNO, SFACT, VFACT, SAMP0,
...
*     brightness variance). Output variances will be created by MAPCC4
*     based on the spread of input data values.
...
*  coefficients, and calculate a new set of pixel weight grids.
            IF( CHANGE ) THEN
               ...
               CALL MSG_SETI( 'D', DET )
               CALL MSG_OUTIF( MSG__VERB, 'MAPCD0_MSG1',
...
*  detector.
      ...
      CALL MSG_OUTIF( MSG__VERB, 'MAPCD0_MSG2',
