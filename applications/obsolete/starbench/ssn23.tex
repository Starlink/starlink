...
\newcommand{\stardocnumber}    {23.6}
\newcommand{\stardocauthors}   {S.E.RAnkin \\
                                M.J.Bly\\
                                T.M.Gledhill \\
                                C.A.Clayton}
\newcommand{\stardocdate}      {29 Jan 2003}
...
astronomy data reduction software. This manual is intended for Starlink Site 
Managers and describes how to install and use the package.}
...
%  Package Version.
\newcommand{\pkgver}     {v1.4}

% Package FTP directory.
\newcommand{\pkgftpdir}  {/pub/tools}

% Package FTP server.
\newcommand{\pkgftpsrv} {ftp.starlink.rl.ac.uk}
...
\item Alpha/Tru64 Unix --- \htmladdnormallinkfoot{starbench\_alpha\_OSF1\_\pkgver.tar.Z}{\pkgurl/starbench\_alpha\_OSF1\_\pkgver.tar.Z}

\item PC/Linux --- \htmladdnormallinkfoot{starbench\_ix86\_Linux\_\pkgver.tar.Z}{\pkgurl/starbench\_ix86\_Linux\_\pkgver.tar.Z}

\item SPARC/Solaris --- \htmladdnormallinkfoot{starbench\_sun4\_Solaris\_\pkgver.tar.Z}{\pkgurl/starbench\_sun4\_Solaris\_\pkgver.tar.Z}
...
The individual benchmarks are described in Appendix~\ref{benchmark_descriptions}.
...
\htmladdnormallinkfoot{at this
URL}{http://info.cv.nrao.edu/aips/ddt.html}
...
\newpage
\appendix
\section{\xlabel{benchmark_descriptions}Benchmark Descriptions}
