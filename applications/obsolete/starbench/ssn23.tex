...
\newcommand{\stardocnumber}    {23.5}
\newcommand{\stardocauthors}   {T.M.Gledhill \\
                                C.A.Clayton}
\newcommand{\stardocdate}      {22 Jan 1999}
...
The package is currently supported on {\bf Solaris}, {\bf Digital Unix}
and {\bf Red Hat Linux} platforms at version \pkgver.  Compressed tar
...
\htmladdnormallinkfoot{starbench\_ix86\_Linux\_\pkgver.tar.Z}{\pkgurl/starbench\_ix86\_Linux\_\pkgver.tar.Z} ~~~~~~~~~~~~~ (Red Hat Linux systems) 
...
USSC207 or later (the Autumn 97 CD release). {\bf It will not work
...
host% scan
 ...
 Starlink Benchmark Utilities v1.2

 Benchmarks calibrated against rlsul1
 ...
 Online Processors  : 2
 Processor Speed    : 168MHz
 USSC version       : USSC212
 IRAF version       : "NOAO/IRAF V2.11EXPORT"

 STARmark : 1.22 +/- 0.01  (based on 20 measurements)
 IRAFmark : 1.16 +/- 0.01  (based on 20 measurements)
...
against the RAL machine {\tt rlsul1} (an UltrSPARC 1/140 with 143MHz
processor). The {\tt scan} command will also use user-supplied
...
host% scan -f
 ...
 Average Load : 0.436 +/- 0.510

 Benchmark  ucpu    kcpu       tpcu            Speed          Elapsed
 ---------  ----    ----       ----            -----          -------

       FFT  18.08   0.39  18.47 +/- 0.04    1.16 +/- 0.00   18.90 +/- 0.30

       SLA   8.20   0.01   8.21 +/- 0.10    1.19 +/- 0.02    8.24 +/- 0.11

     KAPPA   7.58   2.20   9.77 +/- 0.13    1.20 +/- 0.02   19.03 +/- 0.95

      PISA   6.55   1.67   8.23 +/- 0.13    1.21 +/- 0.02   16.04 +/- 0.46

   SPECDRE   5.30   2.48   7.78 +/- 0.12    1.23 +/- 0.02   15.19 +/- 0.47

   CCDPACK   8.43   4.09  12.51 +/- 0.13    1.23 +/- 0.01   27.10 +/- 1.47

    CCDRED  10.65   2.82  13.48 +/- 0.20    1.13 +/- 0.02   30.43 +/- 1.14

   DAOPHOT  12.02   2.59  14.61 +/- 0.12    1.18 +/- 0.01   22.90 +/- 1.10

    IMAGES   9.51   1.22  10.73 +/- 0.10    1.17 +/- 0.01   16.69 +/- 0.72
