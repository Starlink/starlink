...
#include "sbmlib.h"
#include "sbmmac.h"
void sbmgaleq(double qfoo,double qbar,double*qbaz,double*Q0)
...
sbmdcs2c(qfoo,qbar,qfobar);sbmdimxv(q2,qfobar,q1);sbmdcc2s(
q1,qbaz,Q0);*qbaz=sbmdranrm(*qbaz);*Q0=sbmdrange(*Q0);}
