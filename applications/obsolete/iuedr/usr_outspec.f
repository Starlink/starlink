      SUBROUTINE USR_OUTSPEC( STATUS )
*+
*  Name:
*     SUBROUTINE USR_OUTSPEC

*  Purpose:
*     Output Net Spectrum for current order to SPECTRUM file.
...
*  Description:
*     The current spectrum/order is output in a binary file suitable
...
*   1st label (CAMERA,IMAGE,RESOLUTION,APERTURE/ORDER,labels).
      POS = 0
      ...
      END IF
      CALL STR_WRITS( ', %s.\\', FLABEL, 79, LABEL1, POS )
