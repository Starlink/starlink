      SUBROUTINE RDPARF( NAME, GIVEN, MAXVAL, VALUES, ACTVAL, STATUS )
*+
*  Name:
*     SUBROUTINE RDPARF

*  Purpose:
*     Read REAL*8 parameter values.

*  Language:
*     Starlink Fortran 77

*  Invocation:
*     CALL RDPARF( NAME, GIVEN, MAXVAL, VALUES, ACTVAL, STATUS )
...
*     VALUES = REAL*8( MAXVAL )  (Given and Returned)
...
*  Arguments Given and Returned:
      REAL*8 VALUES( MAXVAL )      ! Array of parameter values.
...
*     IF ( STATUS .NE. SAI__OK ) RETURN
      ...
      IF ( GIVEN ) THEN
         IF ( MAXVAL .GT. 1 ) THEN
            CALL PAR_DEF1D( LNAME, MAXVAL, VALUES, STATUS )

         ELSE
            CALL PAR_DEF0D( LNAME, VALUES, STATUS )
         END IF
      END IF

      IF ( MAXVAL .GT. 1 ) THEN
         CALL PAR_GET1D( LNAME, MAXVAL, VALUES, ACTVAL, STATUS )

      ELSE
         CALL PAR_GET0D( LNAME, VALUES, STATUS )
         ACTVAL = 1
      END IF
