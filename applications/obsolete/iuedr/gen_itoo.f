      SUBROUTINE gen_ITOO(IVALUE, FIELD, MAXC, SVALUE)
...
*
*   Description:
*      Encode octal integer value into string.
*
*   Authors:
*      Jack Giddings
*
...
*
*   Method:
*      The integer is written using O-format into the string parameter.
*
*-
...
*   Local variables:
      ...
      WRITE (FORMAT, '(''(o'',I3,'')'')', IOSTAT=CODE) FIELD
