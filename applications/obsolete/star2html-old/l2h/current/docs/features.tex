...
\cbversion{98.1}\begin{changebar}\cbversion{98.1}
...
in the \fn{versions/} subdirectory,
...
\cbversion{97.1b}\begin{changebar}
...
\begin{longtable}{|c|l|}
\caption{Supported \protect\latextohtml\ style-files.}\\
\hline
\endhead
\hline
\endfoot
