...
\item [\Lippman] \Email{lippmann@cdc.Informatik.TH-Darmstadt.DE}
...
an extensive rewrite of the \fn{texexpand} utility.
...
Thanks again to \Lippman\ and members of the \LiPS\ for organising this meeting;
...
\item \dots
\RossMoore, \Lippman\ and \Rouchal\ described recent improvements.
\item
...
\htmladdnormallinkfoot{Cougar}{http://www.w3.org/pub/Markup/Cougar/}.
%
