...
\cbversion{96.1}\begin{changebar}%\cbversion{96.1}%
\item
...
\cbversion{96.1h}\begin{changebar}%
\item
...
\html{\strikeout{at least the \appl{Common \LaTeX{} Commands}
...
\end{changebar}\cbversion{97.1}\begin{changebar}\cbversion{97.1}%
...
or \htmladdnormallinkfoot{``down-under''}{http://www-math.mpce.mq.edu.au/texdev/xyguide.html}
\html{\smallskip}%
...
\htmladdnormallink{Manual}{http://cdc-server.cdc.informatik.th-darmstadt.de%
/home/zohar/LiPS/documentation/objects/doc/html/Manual2.1/lipsdist/},
\htmladdnormallink{Lecture Notes}{http://cdc-server.cdc.informatik.th-darmstadt.de%
