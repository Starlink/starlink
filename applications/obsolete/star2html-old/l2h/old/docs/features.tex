...
Currently this is \htmladdnormallink{version 3.2}%
{http://www.w3.org/hypertext/WWW/MarkUp/html-spec/html-spec_toc.html};
it is the default version for \latextohtml, version 97.1.
...
\cbversion{97.1}\begin{changebar}\cbversion{97.1}
...
\hyperref[page]{option switch}{option switch, on page~}{}{htmlversion}.
%
...
\env{french}, \env{english} and \env{german}
but it is trivial to add support for another language in the
file \fn{latex2html.config}.
...
is being used (see \hyperref[page]{here}{page~}{}{aaliastext}),
...
{http://www-math.mpce.mq.edu.au/texdev/LaTeX2HTML/mathdocs/}.
...
\begin{figure}
    ...
    \caption{A sample figure showing part of a page generated by
       ...
       (from the \protect\htmladdnormallink
...
\subsection{Other Style-Files\label{sec:sty}}
%\section{Other Style-Files\label{sec:sty}}
\tableofchildlinks*
...
style-files is auto\-matic\-ally loaded, if such code is available.
...
\begin{longtable}{|c|l|}
\caption{Supported \protect\latextohtml\ style-files\label{styles}.}\\
\hline
\endhead
\hline
\endfoot
...
\env{\bf francais}\index{package!francais@\env{francais}}\index{french!francais@\env{francais} package}%
 & Special support for the French language, same as \fn{french.perl}.\label{francais}\\
\env{\bf french}\index{package!french@\env{french}}\index{french@\env{french} package}%
 & Special support for the French language.\label{french}\\
\env{\bf german}\index{package!german@\env{german}}\index{german@\env{german} package}%
 & Special support for the German language.\label{german}\\
\env{\bf germanb}\index{package!germanb@\env{germanb}}\index{german!germanb@\env{germanb} package}%
 & Special support for the German language, same as \fn{german.perl}.\label{germanb}\\
...
\begin{htmllist}\htmlitemmark{WhiteBall}
%begin{latexonly}
\addtolength{\leftskip}{15pt}
%end{latexonly}
\item[Item 1:] This will have a white ball.
...
\noindent\cbversion{96.1f}\begin{changebar}%
