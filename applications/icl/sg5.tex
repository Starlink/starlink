...
\stardocnumber      {5.2}
\stardocauthors   {J A Bailey\footnote{Anglo-Australian Observatory}\\A J Chipperfield}
\stardocdate        {9th June 1998}
\stardoctitle     {ICL\\[2.5ex]
                                The Interactive Command Language\\
                                for ADAM}
\stardocversion     {Version 1.5-6}
\stardocmanual      {User's Guide}

\stardocabstract  {ICL is a language designed to provide
...
\scfrontmatter
   ...
   \section{\xlabel{icl_introduction}Introduction}
   \subsection{\xlabel{what_is_icl}What is ICL?}
...
programs easy to write.
   \end{itemize}
   \subsection{\xlabel{icl_documentation}ICL Documentation}
...
\subsection{\xlabel{icl_and_fortran}ICL and FORTRAN}
...
\subsection{\xlabel{history_and_support}History and Support}
...
\subsection{\xlabel{direct_mode}Direct Mode}
...
\begin{terminalv}
    ...
    ICL>
\end{terminalv}
\subsection{\xlabel{entering_commands}Entering Commands}
...
\subsection{\xlabel{the_immediate_statement}The Immediate Statement}
...
\subsection{\xlabel{the_assignment_statement}The Assignment Statement}
...
\subsection{\xlabel{expressions}Expressions}
...
\subsubsection{\xlabel{values}Values}
...
\subsubsection{\xlabel{constants}Constants}
...
FORTRAN).
\subsubsection{\xlabel{variables}Variables}
...
\subsubsection{\xlabel{operators}Operators}
...
\subsubsection{\xlabel{functions}Functions}
...
\subsection{\xlabel{formatting_numbers_for_output}Formatting Numbers For Output}
...
\begin{terminalv}
    ...
    00377
\end{terminalv}
\subsection{\xlabel{commands}Commands}
...
commands such as PRINT, EDIT, LIST \emph{etc.}
...
\end{itemize}
\subsubsection{\xlabel{command_format}Command Format}
...
\subsubsection{\xlabel{summary_of_rules_for_command_parameters}Summary of Rules for Command Parameters\label{parameter_rules}}
...
\section{\xlabel{icl_procedures}ICL Procedures\label{icl_procedures}}
...
\subsection{\xlabel{direct_entry_of_procedures}Direct Entry of Procedures}
...
\subsection{\xlabel{running_a_procedure}Running a Procedure}
...
\subsection{\xlabel{listing_procedures}Listing Procedures}
...
\begin{terminalv}
    ...
    ICL>
\end{terminalv}
\subsection{\xlabel{editing_procedures}Editing Procedures}
...
\subsection{\xlabel{direct_commands_during_procedure_entry}Direct Commands During Procedure Entry}
...
\subsection{\xlabel{saving_and_loading_procedures}Saving and Loading Procedures}
...
\subsection{\xlabel{control_structures}Control Structures}
...
\end{itemize}
\subsubsection{\xlabel{the_if_structure}The IF structure}
...
\begin{terminalv}
    ...
    END PROC
\end{terminalv}
\subsubsection{\xlabel{the_loop_structure}The LOOP Structure}
...
\subsection{\xlabel{prompting_for_procedure_parameters}Prompting for Procedure Parameters}
...
\subsection{\xlabel{variables_in_procedures}Variables in Procedures}
...
\subsection{\xlabel{tracing_procedure_execution}Tracing Procedure Execution}
...
\subsection{\xlabel{running_icl_as_a_batch_job}Running ICL as a Batch Job\label{running_as_batch_job}}
...
\section{\xlabel{inputoutput}Input/Output}

\subsection{\xlabel{terminal_io}Terminal I/O}
...
\subsection{\xlabel{text_file_io}Text File I/O}
...
\subsection{\xlabel{screen_mode}Screen Mode}
...
\subsection{\xlabel{keyboard_facilities_in_screen_mode}Keyboard Facilities in Screen Mode}
...
\section{\xlabel{access_to_dcl}Access to DCL}
...
\subsection{\xlabel{the_command}The \$\ Command}
...
\subsection{\xlabel{the_spawn_command}The SPAWN Command}
...
\subsection{\xlabel{changing_the_default_directory}Changing the Default Directory}
...
\subsection{\xlabel{allocating_and_mounting_tape_drives}Allocating and Mounting Tape Drives}
...
\section{\xlabel{errors_and_exceptions}Errors and Exceptions}

\subsection{\xlabel{icl_exceptions}ICL Exceptions}
...
\subsection{\xlabel{exception_handlers}Exception Handlers}
...
\subsection{\xlabel{keyboard_aborts}Keyboard Aborts}
...
\subsection{\xlabel{signal_command}SIGNAL command}
...
\section{\xlabel{extending_icl}Extending ICL}
...
to write an ICL procedure as described in Section~\ref{icl_procedures}. There are several other
ways of defining new commands which are described in this section. If you
...
\subsection{\xlabel{login_files}Login files}
...
\subsection{\xlabel{the_defstring_command}The DEFSTRING Command}
...
\subsection{\xlabel{hidden_procedures}Hidden Procedures}
...
\subsection{\xlabel{the_defproc_command}The DEFPROC Command}
...
\subsection{\xlabel{defining_additional_help_topics}Defining Additional Help Topics}
...
\subsection{\xlabel{other_ways_of_defining_commands}Other Ways of Defining Commands}
...
\section{\xlabel{introduction_to_adam}Introduction to ADAM}

\subsection{\xlabel{what_is_adam}What is ADAM?}
...
There are several references in the following sections to Starlink User Notes
...
\subsection{\xlabel{the_role_of_the_command_language}The Role of the Command Language}
...
\section{\xlabel{using_adam_for_data_reduction}Using ADAM for Data Reduction}

\subsection{\xlabel{atasks}A-tasks}
...
\subsection{\xlabel{monoliths}Monoliths}
...
\subsection{\xlabel{running_kappa}Running KAPPA}
...
\subsection{\xlabel{adam_parameter_format}ADAM Parameter Format}
...
\subsection{\xlabel{kappa_from_procedures}KAPPA from Procedures}
...
\subsection{\xlabel{error_reports}Error Reports}
...
\section{\xlabel{writing_adam_tasks}Writing ADAM tasks\label{writing_adam_tasks}}

\subsection{\xlabel{writing_adam_tasks_introduction}Introduction}
...
\subsection{\xlabel{compiling_and_linking}Compiling and Linking}
...
\subsection{\xlabel{tasks_with_parameters}Tasks with Parameters}
...
\subsection{\xlabel{status_and_error_handling}STATUS and error handling}
...
\subsection{\xlabel{returning_values_to_icl}Returning values to ICL}
\label{retval}
...
\subsection{\xlabel{graphics_with_adam_}Graphics with ADAM}
...
\subsection{\xlabel{accessing_data}Accessing Data}
\label{accdat}
...
\section{\xlabel{adam_as_a_data_aquisition_environment}ADAM as a Data Acquisition Environment}

\subsection{\xlabel{instrumentation_tasks}Instrumentation Tasks}
...
(referred to as \emph{Actions}) rather than the single command of an A-task;
...
\subsection{\xlabel{dtasks_and_ctasks}D-tasks and C-tasks}
...
\subsection{\xlabel{task_loading}Task Loading}
...
\subsection{\xlabel{killing_tasks}Killing Tasks}
...
\subsection{\xlabel{the_adam_message_system}The ADAM message system}
...
between ICL and A-tasks described in the last section (\S\ref{writing_adam_tasks}), but in this case
...
\subsection{\xlabel{an_example}An Example}
...
\subsubsection{\xlabel{the_itask_interface_file}The I-task Interface File}
...
\subsubsection{\xlabel{running_photom}Running PHOTOM}
...
\subsubsection{\xlabel{supplying_parameters_in_the_obey_message}Supplying Parameters in the Obey Message}
...
\subsubsection{\xlabel{cancelling_actions}Cancelling Actions}
...
\subsubsection{\xlabel{missing_parameters}Missing Parameters}
...
\subsubsection{\xlabel{the_get_command}The GET command}
...
\subsubsection{\xlabel{the_obeyw_command}The OBEYW command}
...
\subsubsection{\xlabel{multiple_concurrent_actions}Multiple Concurrent Actions}
...
\appendix
\section{\xlabel{icl_functions}ICL Functions}
...
\section{\xlabel{icl_commands}ICL Commands}

\subsection{\xlabel{alloc}ALLOC}
...
\subsection{\xlabel{ALOAD}ALOAD\label{ALOAD}}
...
\subsection{\xlabel{APPEND}APPEND\label{APPEND}}
...
\subsection{\xlabel{CHECKTASK}CHECKTASK\label{CHECKTASK}}
...
\subsection{\xlabel{CLEAR}CLEAR\label{CLEAR}}

   CLEAR \hspace{.5cm} first \hspace{.5cm} last

In screen mode the range of lines on the screen between \textit{first} and \textit{last}
are cleared.

\subsection{\xlabel{CLOSE}CLOSE\label{CLOSE}}
...
\subsection{\xlabel{CREATE}CREATE\label{CREATE}}
...
\subsection{\xlabel{CREATEGLOBAL}CREATEGLOBAL\label{CREATEGLOBAL}}
...
\subsection{\xlabel{DCL}\$\ (DCL)\label{DCL}}
 ...
 \emph{e.g.} \$ SET DEF will set the default directory for the subprocess but not
...
\subsection{\xlabel{DEALLOC}DEALLOC\label{DEALLOC}}
...
\subsection{\xlabel{DEFAULT}DEFAULT\label{DEFAULT}}
...
\subsection{\xlabel{DEFHELP}DEFHELP\label{DEFHELP}}
...
\subsection{\xlabel{DEFINE}DEFINE\label{DEFINE}}
...
\subsection{\xlabel{DEFPROC}DEFPROC\label{DEFPROC}}
...
\subsection{\xlabel{DEFSHARE}DEFSHARE\label{DEFSHARE}}
...
\subsection{\xlabel{DEFSTRING}DEFSTRING\label{DEFSTRING}}
...
\subsection{\xlabel{DEFTASK}DEFTASK\label{DEFTASK}}
...
\subsection{\xlabel{DEFUSER}DEFUSER\label{DEFUSER}}
...
\end{description}
 ...
 Typing \emph{command} causes the shareable image to be activated dynamically
...
\subsection{\xlabel{DELETE}DELETE\label{DELETE}}

   DELETE \hspace{.5cm} proc

 Delete procedure proc from the procedure table.

\subsection{\xlabel{DISMOUNT}DISMOUNT\label{DISMOUNT}}
...
\subsection{\xlabel{DUMPTASK}DUMPTASK\label{DUMPTASK}}

   DUMPTASK \hspace{.5cm}  taskname

This command causes the ADAM task of name \emph{taskname} to output a
...
\subsection{\xlabel{EDIT}EDIT\label{EDIT}}
 ...
 To edit a \emph{file} use the command:

    DCL EDIT filename

\subsection{\xlabel{ENDOBEY}ENDOBEY\label{ENDOBEY}}
...
\subsection{\xlabel{EXIT}EXIT\label{EXIT}}
...
\subsection{\xlabel{GET}GET\label{GET}}
...
\subsection{\xlabel{GETGLOBAL}GETGLOBAL\label{GETGLOBAL}}
...
\subsection{\xlabel{GETNBS}GETNBS\label{GETNBS}}
...
components (\emph{e.g.} NOTICEBOARD.ITEM1.ITEM2). If the primitive item is an array
only the first component is accessed.


\subsection{\xlabel{GETPAR}GETPAR\label{GETPAR}}
...
This will only be relevant for parameters which are not \emph{internal}.
...
\subsection{\xlabel{HELP}HELP\label{HELP}}
...
The first keyword may be the \emph{name} specified in a DEFHELP command.

\end{description}

\subsection{\xlabel{INPUT}INPUT\label{INPUT}}
...
\subsection{\xlabel{INPUTI}INPUTI\label{INPUTI}}
...
\subsection{\xlabel{INPUTL}INPUTL\label{INPUTL}}
...
\subsection{\xlabel{INPUTR}INPUTR\label{INPUTR}}
...
\subsection{\xlabel{KEY}KEY\label{KEY}}
...
\subsection{\xlabel{KEYTRAP}KEYTRAP\label{KEYTRAP}}
...
\subsection{\xlabel{KEYUSER}KEYUSER\label{KEYUSER}}
...
\subsection{\xlabel{KILL}KILL\label{KILL}}
...
\subsection{\xlabel{KILLDCL}KILLDCL\label{KILLDCL}}

    KILLDCL

 Kill the DCL subprocess

\subsection{\xlabel{KILLW}KILLW\label{KILLW}}
...
\subsection{\xlabel{LIST}LIST\label{LIST}}

    LIST \hspace{.5cm} proc

 List procedure `proc' on the terminal

\subsection{\xlabel{LOAD}LOAD\label{LOAD}}
...
\subsection{\xlabel{LOADD}LOADD\label{LOADD}}
...
\subsection{\xlabel{LOADW}LOADW\label{LOADW}}
...
\subsection{\xlabel{MOUNT}MOUNT\label{MOUNT}}
...
\subsection{\xlabel{NOREP}NOREP\label{NOREP}}
...
\subsection{\xlabel{OBEYW}OBEYW\label{OBEYW}}
...
\subsection{\xlabel{OPEN}OPEN\label{OPEN}}
...
\subsection{\xlabel{READ}READ\label{READ}}
...
\subsection{\xlabel{READI}READI\label{READI}}
...
\subsection{\xlabel{READL}READL\label{READL}}
...
\subsection{\xlabel{READR}READR\label{READR}}
...
\subsection{\xlabel{REPFILE}REPFILE\label{REPFILE}}
...
\subsection{\xlabel{REPORT}REPORT\label{REPORT}}
...
\subsection{\xlabel{SAVE}SAVE\label{SAVE}}
...
\subsection{\xlabel{SAVEINPUT}SAVEINPUT\label{SAVEINPUT}}
...
\subsection{\xlabel{SEND}SEND\label{SEND}}
...
In that case, \emph{action} is replaced by \emph{atask} and \emph{parameter}
by \emph{atask:parameter} where \emph{atask} is the name of
the individual A-task within the monolith.
\end{description}


\subsection{\xlabel{SET}SET\label{SET}}

The SET command is used to control various features of the state of ICL.

\subsubsection{\xlabel{SET_ATTRIBUTES}SET ATTRIBUTES\label{SET_ATTRIBUTES}}

   SET ATTRIBUTES \hspace{.5cm} attributes

Sets the attributes for text written with the LOCATE command. \textit{attributes}
is a string containing any combination of the letters D (double size),
B (bold), R (Reverse video), U (underlined) and F (flashing).

\subsubsection{\xlabel{SET_AUTOLOAD}SET AUTOLOAD, SET NOAUTOLOAD\label{SET_AUTOLOAD}}
...
\subsubsection{\xlabel{SET_CHECKPARS}SET CHECKPARS, SET NOCHECKPARS\label{SET_CHECKPARS}}
...
\subsubsection{\xlabel{SET_EDITOR}SET EDITOR\label{SET_EDITOR}}
...
\subsubsection{\xlabel{SET_HELPFILE}SET HELPFILE\label{SET_HELPFILE}}
...
\subsubsection{\xlabel{SET_MESSAGES}SET MESSAGES, SET NOMESSAGES\label{SET_MESSAGES}}
...
\subsubsection{\xlabel{SET_PRECISION}SET PRECISION\label{SET_PRECISION}}
...
\subsubsection{\xlabel{SET_PROMPT}SET PROMPT\label{SET_PROMPT}}
...
\subsubsection{\xlabel{SET_SAVE}SET SAVE, SET NOSAVE\label{SET_SAVE}}
...
\subsubsection{\xlabel{SET_SCREEN}SET SCREEN, SET NOSCREEN\label{SET_SCREEN}}
...
\subsubsection{\xlabel{SET_TRACE}SET TRACE, SET NOTRACE\label{SET_TRACE}}
...
\subsection{\xlabel{SETGLOBAL}SETGLOBAL\label{SETGLOBAL}}
...
\subsection{\xlabel{SETPAR}SETPAR\label{SETPAR}}
...
\subsection{\xlabel{SIGNAL}SIGNAL\label{SIGNAL}}
...
\subsection{\xlabel{SPAWN}SPAWN\label{SPAWN}}
...
\subsection{\xlabel{STARTOBEY}STARTOBEY\label{STARTOBEY}}
...
\subsection{\xlabel{TASKS}TASKS\label{TASKS}}

   TASKS

 List all loaded ADAM tasks.

\subsection{\xlabel{VARS}VARS\label{VARS}}
...
\subsection{\xlabel{WAIT}WAIT\label{WAIT}}

    WAIT  interval

Wait for a specified \textit{interval} expressed in seconds.

\subsection{\xlabel{WRITE}WRITE\label{WRITE}}

    WRITE  intname \hspace{.5cm}  p2 \hspace{.5cm} p3  ....

 The parameters of WRITE are concatenated and written to the text file
of name \textit{intname}. This file must have been previously opened with an
APPEND or CREATE command.


\section{\xlabel{icl_exceptions_appendix}ICL Exceptions}
\begin{center}
\begin{tabular}{ll}
\\
name & description \\
...
\\
OPNOTLOG  &  Operands of a logical operator (AND, OR \emph{etc.}) are \\
   &  not logical values.  \\
\\
...
\\
UNDEFVAR  &  Attempt to use an undefined variable --- \emph{i.e.} one \\
...
\section{\xlabel{icl_syntax}ICL Syntax}
...
control structures and procedures. The definitions of \emph{if\_block},
\emph{loop\_block} and \emph{procedure} below form the second level syntax,
...
\emph{i.e.} symbols which are defined in terms of other symbols.

\item Upper case words or other characters are terminal symbols.
\emph{i.e.} the basic lexical elements out of which the language is built.
