...
\scfrontmatter
   ...
   \chapter{\xlabel{icl_introduction}Introduction}
...
\subsection{\xlabel{summary_of_rules_for_command_parameters}Summary of Rules for Command Parameters\label{parameter_rules}}
...
\chapter{\xlabel{icl_procedures}ICL Procedures\label{icl_procedures}}
...
\section{\xlabel{running_icl_as_a_batch_job}Running ICL as a Batch Job\label{running_as_batch_job}}
...
\chapter{\xlabel{writing_adam_tasks}Writing ADAM tasks\label{writing_adam_tasks}}

\section{\xlabel{writing_adam_tasks_introduction}Introduction}
...
\subsection{\xlabel{multiple_concurrent_actions}Multiple Concurrent Actions}
...
\chapter{\xlabel{icl_exceptions_appendix}ICL Exceptions}
\begin{center}
\begin{tabular}{ll}
\\
name & description \\
