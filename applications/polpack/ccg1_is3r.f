      SUBROUTINE CCG1_IS3R( ORDDAT, RDAT, PDAT, NENT, STATUS )
*+
*  Name:
*     CCG1_IS3R
...
*     the ancillary data RDAT and PDAT correspondingly.

*  Language:
*     Starlink Fortran 77

*  Invocation:
*     CALL CCG1_IS3R( ORDDAT, RDAT, PDAT, NENT, STATUS )
...
*     ancillary data RDAT, and PDAT these maintain their
...
*        order.
*     RDAT( NENT ) = REAL (Given and Returned)
