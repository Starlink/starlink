      SUBROUTINE POL1_CTCLMD( CI, NROW, NCOL, GI, OUT, STATUS )
*+
*  Name:
*     POL1_CTCLMD
...
*  Invocation:
*     CALL POL1_CTCLMD( CI, NROW, NCOL, GI, OUT, STATUS )
...
*     a separate row in the OUT array. Unlike POL1_CTCLM, it uses double
*     precision values.
