      SUBROUTINE POL1_FIOER( FSTAT, PARAM, ROUTIN, MESSGE, STATUS )
*+
*  Name:
*     POL1_FIOER
...
*  Invocation:
*     CALL POL1_FIOER( FSTAT, PARAM, ROUTIN, MESSGE, STATUS )
...
*  and exit.
      IF ( FSTAT .LE. 0 ) THEN
         STATUS = SAI__ERROR
         CALL ERR_REP( 'POL1_FIOER',
     :     'POL1_FIOER: No FITSIO error to report (programming error).',
     :     STATUS )
         GOTO 999
      END IF
