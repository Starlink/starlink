...
\newcommand{\stardocdate}      {23rd June 1998}
...
\htmlref{edit}{POLKA_EDITING_POLYGONS} these
...
\htmlref{{\em Restore}}{POLKA_RESTORE} command. There are two
options:
...
In either case, you supply the name of the text file in a simple dialog
...
NOTE, for polarimeter data, you should choose a mapping type which does
...
\subsection {\mylabel{POLKA_STOP_START}Use the Same Mask for Several Runs}
...
\subsection {\mylabel{POLKA_USING_HELP}Align Data from Several Runs}
