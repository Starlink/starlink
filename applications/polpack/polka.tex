...
\item Independant sky subtraction within each aligned sub-region.
...
The images are resampled using either nearest-neighbour or bi-linear
...
facility enables execution of POLKA to be interupted and continued at a
later time.
...
the sky background, resampling the intensity images, and calculating the
...
temporary interuption of POLKA,
...
This can be useful, for instance, if you want to interupt POLKA before
...
the dump file, then the extra images are left unchnaged.
...
\subsubsection {\mylabel{POLKA_COPY}{\em Paste}} Pastes any previously
...
\subsection {\mylabel{POLKA_AREA_SELECTION}Make the Image Display Bigger}
...
\subsection {\mylabel{POLKA_EDITING_POLYGONS}Use pre-aligned images}
