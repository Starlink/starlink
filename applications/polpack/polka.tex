...
between any pair of images is assumed to be linear with a shift of
origin. Further restrictions may be imposed on the mappings (for
instance, restricting them to a shift of origin only, or a shift plus a
magnification, etc). The coefficients of the mappings are determined by
...
template {\bf m101_%}, putting the output $O$-ray intensity images
...
{\em O-E Mapping Type} entry in the \htmlref{{\em Mapping
Types}}{POLKA_MAP_TYPES} entry in the \htmlref{{\em
Options}}{POLKA_OPTIONS_MENU} menu. A similar menu containing the same
list of mappings is displayed, from which a selection may be made.
Usually {\em Shift of origin only} will be the most appropriate.
...
\subsubsection {\mylabel{POLKA_DUMP}{\em Dump}} To be written.
...
\subsubsection {\mylabel{POLKA_RESTORE}{\em Restore}} To be written.
