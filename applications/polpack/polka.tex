...
\newcommand{\stardocdate}      {19th May 1998}
...
The \htmlref{{\em Dump}}{POLKA_DUMP} command (available in the \htmlref{{\em 
File}}{POLKA_FILE_MENU} menu) can be used to save the current state of
...
restored using the \htmlref{{\em Restore}}{POLKA_RESTORE} command. This
...
later on, and use the \htmlref{{\em Restore}}{POLKA_RESTORE} command to
...
been created using the \htmlref{{\em Dump}}{POLKA_DUMP} command. All
...
Use the \htmlref{{\em Dump}}{POLKA_DUMP} and \htmlref{{\em
Restore}}{POLKA_RESTORE} commands in the \htmlref{{\em
File}}{POLKA_FILE_MENU} menu. {\em Dump} creates a text file containing 
all the features positions, masks, mappings, etc, which you have supplied so 
far. After using {\em Dump}, you can use \htmlref{{\em Quit}}{POLKA_QUIT}
...
use the \htmlref{{\em Undo}}{POLKA_TRANSFER} command in the \htmlref{{\em
File}}{POLKA_IMAGES_MENU} menu to transfer them to the other images.
