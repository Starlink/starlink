...
\htmlref{{\em Sky Subtraction}}{POLREG_SKYSUB_EFFECT} item in the 
...
labelled \htmlref{{\em Current:}}{POLREG_CURRENT}. Sky areas within
...
By default, a flat surface equal to the mean value in these sky areas
...
\htmlref{{\em Sky}}{POLREG_SKY} item in the 
...
\item [\mylabel{POLREG_LOG_EFFECT}{\em Log} ] - To be written.
\item [\mylabel{POLREG_MATHS_EFFECT}{\em Maths} ] - To be written.
\item [\mylabel{POLREG_NEGATE_EFFECT}{\em Negate} ] - To be written.
\item [\mylabel{POLREG_SKYSUB_EFFECT}{\em Sky Subtraction} ] - To be written.
