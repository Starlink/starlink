...
\section {\mylabel{POLREG_SKYSUB}Sky Subtraction}
...
PolReg is run, or the \htmlref{{\em Remove Sky}}{POLREG_REMOVE_SKY} 
item in the \htmlref{{\em Options}}{POLREG_OPTIONS_MENU} menu
...
\htmlref{{\em Fit Sky}}{POLREG_FITSKY_EFFECT} item in the 
\htmlref{{\em Effects}}{POLREG_EFFECTS_MENU} menu.
...
\htmlref{{\em Current:}}{POLREG_CURRENT}. You then identify sky areas
...
\htmlref{{\em Remove Sky}}{POLREG_REMOVE_SKY} box in the
...
greater than zero for the \htmlref{{\em Sky Order}}{POLREG_SKYORDER} item
in the \htmlref{{\em Options}}{POLREG_OPTIONS_MENU} menu. Larger values
...
the \htmlref{{\em Fit Sky}}{POLREG_FITSKY_EFFECT} item in the
\htmlref{{\em Effects}}{POLREG_EFFECTS_MENU} menu. This will perform
...
\htmlref{{\em Undo All}}{POLREG_UNDO_ALL_EFFECTS} item in the 
\htmlref{{\em Effects}}{POLREG_EFFECTS_MENU} menu to restore the original
displayed image.
...
Current:}}{POLREG_CURRENT}. This will cause default $E$-ray sky areas to
...
\subsection {\mylabel{POLREG_FILE_MENU}The {\em File} Menu}
...
\subsubsection {\mylabel{POLREG_SAVE}{\em Save}} Causes the output images to be
...
\subsubsection {\mylabel{POLREG_EXIT}{\em Exit}} Creates the output images by executing
...
\subsubsection {\mylabel{POLREG_QUIT}{\em Quit}} Closes down PolReg without first saving the output
images. The user is asked to confirm the operation.

\subsection {\mylabel{POLREG_EDIT_MENU}The {\em Edit} Menu}
The {\em Edit} menu provides access to commands which relate to
the changing of information stored within PolReg. They are:

\subsubsection {\mylabel{POLREG_CLEAR_ALL}{\em Clear All}} Causes all currently defined information to be
...
\subsubsection {\mylabel{POLREG_CLEAR_CURRENT}{\em Clear Current}} Causes the
...
\subsubsection {\mylabel{POLREG_CLEAR_IMAGE}{\em Clear Image}} Causes the
...
\subsubsection {\mylabel{POLREG_DELETE_FEATURES}{\em Delete}} Deletes any features
...
\subsubsection {\mylabel{POLREG_EDIT_MAPPINGS}{\em Mappings}} Allows the current
...
\subsection {\mylabel{POLREG_OPTIONS_MENU}The {\em Options} Menu}
...
\subsubsection {\mylabel{POLREG_COLOURS}{\em Colours}} 
...
\subsubsection {\mylabel{POLREG_FEATURE_SIZE}{\em Feature Size}} This option
...
\subsubsection {\mylabel{POLREG_INTERPOLATION_METHOD}{\em Interpolation Method}}
...
\subsubsection {\mylabel{POLREG_MAP_TYPES}{\em Mapping Types}} This displays a list of
...
\subsubsection {\mylabel{POLREG_SKYORDER}{\em Sky Order}} This is used to control
...
\subsubsection {\mylabel{POLREG_STATUS_ITEMS}{\em Status Items}} This is used to
...
\subsubsection {\mylabel{POLREG_VIEW}{\em View}} Determines how to display new
...
\subsubsection {\mylabel{POLREG_USE_CROSS_HAIR}{\em Use Cross-hair}}
...
\subsubsection {\mylabel{POLREG_REMOVE_SKY}{\em Remove Sky}}
...
\htmlref{{\em Fit Sky}}{POLREG_FITSKY_EFFECT} item in the
\htmlref{{\em Effects}}{POLREG_EFFECTS_MENU} menu is inoperative.

\subsubsection {\mylabel{POLREG_DISPLAY_HELP_AREA}{\em Display Help Area}} 
...
\subsubsection {\mylabel{POLREG_DISPLAY_STATUS_AREA}{\em Display Status Area}} 
If this button is selected, then the PolReg GUI will include a
...
\subsubsection {\mylabel{POLREG_SAVE_OPTIONS}{\em Save Options}} 
...
\subsection {\mylabel{POLREG_IMAGES_MENU}The {\em Images} Menu}
...
\subsection {\mylabel{POLREG_EFFECTS_MENU}The {\em Effects} Menu}
...
effect may be removed using the \htmlref{{\em Undo}}{POLREG_UNDO_EFFECT}
menu item. All effects may be removed using the \htmlref{{\em Undo
All}}{POLREG_UNDO_ALL_EFFECT} menu item.
...
\subsubsection {\mylabel{POLREG_ALIGN_EFFECT}{\em Align} } To be written.
\subsubsection {\mylabel{POLREG_FILL_EFFECT}{\em Fill} } To be written.
\subsubsection {\mylabel{POLREG_FILTER_EFFECT}{\em Filter} } To be written.
\subsubsection {\mylabel{POLREG_FITSKY_EFFECT}{\em Fit Sky} } To be written.
\subsubsection {\mylabel{POLREG_LOG_EFFECT}{\em Log} } To be written.
\subsubsection {\mylabel{POLREG_MATHS_EFFECT}{\em Maths} } To be written.
\subsubsection {\mylabel{POLREG_NEGATE_EFFECT}{\em Negate} } To be written.
\subsubsection {\mylabel{POLREG_SMOOTH_EFFECT}{\em Smooth} } To be written.
\subsubsection {\mylabel{POLREG_THRESHOLD_EFFECT}{\em Threshold} } To be written.
\subsubsection {\mylabel{POLREG_SHOW_EFFECTS}{\em Show Effects} } To be written.
\subsubsection {\mylabel{POLREG_UNDO_EFFECT}{\em Undo} } To be written.
\subsubsection {\mylabel{POLREG_UNDO_ALL_EFFECTS}{\em Undo All} } To be written.

\subsection {\mylabel{POLREG_HELP_MENU}The {\em Help} Menu}
...
\htmlref{{\em Remove Sky}}{POLREG_REMOVE_SKY} entry in the \htmlref{{\em
Options}}{POLREG_OPTIONS_MENU} menu is not selected.
