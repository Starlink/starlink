...
\newcommand{\stardocdate}      {9 November 1998}
...
\sstroutine{
   ...
   \sstparameters{
      ...
      \sstsubsection{
         ...
         descriptions can also be given by supplying a group of {\tt "}name=value{\tt "}
         strings where {\tt "}name{\tt "} is the name of an AST Frame attribute (see
         \xref{SUN/210}{sun210}{}), and {\tt "}value{\tt "} is the value to assign to it. In addition,
         IRAS90 Sky Coordinate System (SCS) values (such as {\tt "}EQUATORIAL(J2000){\tt "},
         ...
         FrameSet (see \xref{SUN/210}{sun210}{}) in the supplied catalogue. If the catalogue
...
\item The vectors positions in the catalogue supplied to POLPLOT must now
