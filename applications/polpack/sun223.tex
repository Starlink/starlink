...
\newcommand{\stardocnumber}    {223.1}
\newcommand{\stardocauthors}   {D.S. Berry \& T.M. Gledhill }
\newcommand{\stardocdate}      {1 June 1998}
...
\hspace*{1in}\makebox[1in][l]{\tt IMGID} {\tt OBSNUM//IDATE}\\
      ...
      an {\tt "}input{\tt "} string into an {\tt "}output{\tt "} string. So 
...
\hspace*{1in}\makebox[1in][l]{\tt WPLATE} {\tt POLPLATE  48.0=0.0 -}\\
\hspace*{1in}\makebox[1in][l]{}           {\tt 138.0=45.0}\\
...
\sstroutine{
   ...
   \sstparameters{
      ...
      \sstsubsection{
         ...
         A group of 2D input intensity frames. This may take the form of a
