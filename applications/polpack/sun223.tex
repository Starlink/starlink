...
\sstroutine{
   ...
   \sstnotes{
	 ...
	 the form \texttt{polka\_temp\_$<$nnn$>$} where \texttt{$<$nnn$>$} 
         is some This directory will be created within the directory
	 specified by the HDS\_SCRATCH environment variable. If
	 HDS\_SCRATCH is not defined then it will be created within the
	 current directory.
