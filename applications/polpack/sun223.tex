...
\sstroutine{
   ...
   \sstnotes{
      \sstitemlist{
         ...
         \sstitem
         The reference direction in the output NDFs and in {\tt "}LIKE{\tt "} (if
...
\begin{itemize}
 \item The ANGLE parameter of the POLROTREF command now specifies the
 position angle of the required reference direction, rather than the angle
 though which to rotate the reference direction. {\bf Any existing
 scripts that use ANGLE will need to be changed.}
\end{itemize}
