...
\sstroutine{
   ...
   \sstexamples{
      ...
      \sstexamplesubsection{
         ...
         to the description given in text file {\tt mystyle.dat}. If this
         files contains the following lines:

\hspace*{1in}{\tt title=My favorite colours}\\
\hspace*{1in}{\tt grid=1}\\
\hspace*{1in}{\tt minticklen=0}\\
\hspace*{1in}{\tt colour(border)=green}\\
\hspace*{1in}{\tt colour(grid)=blue}\\
\hspace*{1in}{\tt colour(vec)=red}\\
\hspace*{1in}{\tt width(border)=0.05}\\
