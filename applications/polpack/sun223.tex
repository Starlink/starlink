...
intensity image or contour map of the object to emphasize any correlation
between the visual appearance of the object and the morphology of the
polarization map.
...
displays the progress being made during this phase.
...
\xref{\verb+psmerge+}{sun164}{} command. In step \ref{STEP:DEVICE},
