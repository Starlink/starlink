...
\begin{htmlonly}
   ...
   \begin{figure}[bhtp]
   \label{fig:optical}
   \includegraphics[clip,scale=0.4]{sun223_figures/optical.eps}
   \caption{The main optical components in a typical dual-beam imaging polarimeter.}
   \end{figure}
   \end{quote}
\end{htmlonly}
...
\begin{htmlonly}
   ...
   \begin{figure}[hbtp]
   \label{fig:grids}
   \includegraphics[clip,scale=0.55]{sun223_figures/grids.eps}
   \caption{An example of a masking system used in a dual-beam imaging polarimeter.}
   \end{figure}
   \end{quote}
\end{htmlonly}
...
\begin{htmlonly}
   ...
   \begin{figure}[bhtp]
   \label{fig:effan}
   \includegraphics[clip,scale=0.6]{sun223_figures/effan.eps}
    \caption{The effective analyser position for a rotating half-wave plate.}
   \end{figure}
   \end{quote}
\end{htmlonly}
...
\sstroutine{
   ...
   \sstdescription{
      ...
      transmissions, \emph{etc}. The pixel values supplied in these templates are
