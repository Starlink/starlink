...
\sstroutine{
   ...
   \sstdescription{
      ...
      \xref{CCDPACK}{sun139}{} to perform all these tasks. Note, if the find 
      the image display area too small for comfort you can make it bigger 
      using the DPI parameter described below.
