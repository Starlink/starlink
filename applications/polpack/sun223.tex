...
% ? Add picture here if required.
   \begin{center}
   \includegraphics[clip,scale=0.5]{sun223_figures/map2.eps}\hfill
   \end{center}
% ? End of picture
...
\begin{htmlonly}
   ...
   \begin{figure}[hbtp]
   \label{fig:grids}
   \includegraphics[clip,scale=0.65]{sun223_figures/grids.eps}
   \caption{An example of a masking system used in a dual-beam imaging polarimeter.}
   \end{figure}
   \end{quote}
\end{htmlonly}
...
\begin{htmlonly}
   ...
   \begin{figure}[hbtp]
   \label{fig:extract}
   \includegraphics[clip,scale=0.3]{sun223_figures/extract.eps}
   \caption{Extraction of the $O$ and $E$ ray images.}
   \end{figure}
   \end{quote}
\end{htmlonly}
...
\begin{htmlonly}
   ...
   \begin{figure}[bhtp]
   \label{fig:singopt}
   \includegraphics[clip,scale=0.45]{sun223_figures/singopt.eps}
   \caption{The main optical components in a typical single-beam imaging polarimeter.}
   \end{figure}
   \end{quote}
\end{htmlonly}
...
\begin{htmlonly}
   ...
   \begin{figure}[bhtp]
   \label{fig:effan}
   \includegraphics[clip,scale=0.4]{sun223_figures/effan.eps}
    \caption{The effective analyser position for a rotating half-wave plate.}
   \end{figure}
   \end{quote}
\end{htmlonly}
...
detector. Ideally, the noise in each data value should be independent of
...
\begin{htmlonly}
   ...
   \begin{figure}[bhtp]
   \label{fig:dataflow}
   \includegraphics[clip,scale=0.6]{sun223_figures/dataflow.eps}
   \caption{The main steps in the production of a polarization map.}
   \end{figure}
   \end{quote}
\end{htmlonly}
...
package \latexonly{(see SUN/139)} will usually be able to perform these corrections.
...
\begin{htmlonly}
   ...
   \begin{figure}[bhtp]
   \label{fig:polka}
   \includegraphics[clip,scale=0.8]{sun223_figures/polka.eps}
   \caption{The Graphical User Interface presented by POLKA.}
   \end{figure}
   \end{quote}
\end{htmlonly}
...
\sstroutine{
   ...
   \sstdescription{
      ...
      the supplied catalogue should correspond to those created by \htmlref{POLVEC}{POLVEC}.
...
\sstroutine{
   ...
   \sstdescription{
      ...
      application \htmlref{POLIMP}{POLIMP} may be used in place of POLEXT (\htmlref{POLIMP}{POLIMP} reads the
...
\begin{tabbing}
 xxxxxxxxxxxx \= xxxxxxxxxxxx            \= xxxxxxxxxxxxxx \kill
              \>  \texttt{\_INTEGER}        \> \texttt{OBSNUM}  \\
              \>  \texttt{\_INTEGER}        \> \texttt{IDATE}  \\
...
\begin{tabbing}
 xxxxxxxxxxxx \= xxxxxxxxxxxx            \= xxxxxxxxxxxxxx \kill
              \>  \texttt{WPLATE}        \> \texttt{POLPLATE  48.0=0.0 -} \\
              \>                         \> \texttt{138.0=45.0} 
\end{tabbing}
...
\sstroutine{
   ...
   \sstparameters{
      \sstsubsection{
         ...
         such as produced by \htmlref{POLCAL}{POLCAL}.
      }
      \sstsubsection{
         IN = NDF (Read)
      }{
...
\sstroutine{
   ...
   \sstdescription{
      ...
      normally have been created by \htmlref{POLKA}{POLKA} or \htmlref{POLCAL}{POLCAL}). These calculated
      ...
      package (see \xref{SUN/190}{sun190}{}).
   }
   \sstusage{
   ...
   \sstparameters{
      ...
      \sstsubsection{
         ...
         is usually better to use the \htmlref{POLBIN}{POLBIN} application to bin the Stokes
         vectors. [1]
      }
      \sstsubsection{
         CAT = LITERAL (Read)
...
\begin{htmlonly}
   ...
   \begin{figure}[bhtp]
   \label{fig:varest}
   \includegraphics[clip,scale=0.6]{sun223_figures/varest.eps}
   \caption{The estimation of input variances. The observed and expected
            intensity images are combined to form a single variance image.}
   \end{figure}
   \end{quote}
...
\begin{htmlonly}
   ...
   \begin{figure}[bhtp]
   \label{fig:quadfit}
   \includegraphics[clip,scale=0.5]{sun223_figures/quadfit.eps}
   \caption{A 1-dimensional representation of the smoothing performed by
            POLCAL in single-beam mode. In this example, each pixel is 
            replaced by the value of a quadratic surface fitted to the 
            nearest 5 data values.}
...
\begin{htmlonly}
   ...
   \begin{figure}[ht]
   \label{fig:polext}
   \includegraphics[clip,scale=0.65]{sun223_figures/polext.eps}
   \caption{The allowed items within the POLPACK extension.}
   \end{figure}
   \end{quote}
\end{htmlonly}
