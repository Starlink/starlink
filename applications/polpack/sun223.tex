   ...
   \sstparameters{
      ...
      \sstsubsection{
         ...
         \sstitemlist{
            ...
            as the \texttt{"} Recalc\texttt{"}  option except that only the P and PI columns are
            recalculated.
            ...
            \sstitem
             \texttt{"} Recalc\texttt{"} : All columns that are derived from the Stokes parameter
