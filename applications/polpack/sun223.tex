...
\begin{htmlonly}
   ...
   \htmlfig{map2}{fig.png}{The above polarization map shows
...
\begin{htmlonly}
\htmlfig{fig:optical}{optical.png}{The main optical components in a
...
\begin{htmlonly}
\htmlfig{fig:grids}{grids.png}{An example of a masking system used in
...
\begin{htmlonly}
\htmlfig{fig:extract}{extract.png}{
...
\begin{htmlonly}
\htmlfig{fig:singopt}{singopt.png}{The main optical components in a typical single-beam imaging polarimeter.}
\end{htmlonly}
...
\begin{htmlonly}
\htmlfig{fig:dataflow}{dataflow.png}{
...
package \latex{(see SUN/55)} provides facilities for converting to and
...
package \latex{(see SUN/139)} will usually be able to perform these corrections.
...
\latex{(see SG/5)} command language, and the IRAF cl.
...
\xref{GAIA}{sun214}{} \latex{(SUN/214)}.

Since the polarization parameters are stored in a catalogue, the
\xref{CURSA}{sun190}{} package \latex{(see SUN/190)} can be used to
...
to use \xref{GAIA}{sun214}{} \latex{(SUN/214)} to do this.
...
\latex{in appendix \ref{APP:DESCRIPTION}} as being associated with
...
calibration to a 2-dimensional image using \xref{GAIA}{sun214}{} \latex{(see
SUN/214)}.
...
\begin{htmlonly}
\htmlfig{fig:quadfit}{quadfit.png}{
...
\xref{GAIA}{sun214}{} \latex{(SUN/214)}. These commands are not
