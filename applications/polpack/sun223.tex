...
% ? Add picture here if required for the LaTeX version.
   \begin{center}
   \includegraphics[scale=0.6]{sun223_figures/map2_mono.eps}
   \end{center}
% ? End of picture
...
% ? Add picture here if required.
   \begin{center}
   \includegraphics[scale=0.5]{sun223_figures/map2.eps}\hfill
   \end{center}
% ? End of picture
...
\begin{htmlonly}
   ...
   \begin{figure}[bhtp]
   \label{fig:optical}
   \includegraphics[scale=0.6,width=8in]{sun223_figures/optical.eps}
   \caption{The main optical components in a typical dual-beam imaging polarimeter.}
   \end{figure}
   \end{quote}
\end{htmlonly}
...
\begin{htmlonly}
   ...
   \begin{figure}[hbtp]
   \label{fig:grids}
   \includegraphics[scale=0.35,width=9in]{sun223_figures/grids.eps}
   \caption{An example of a masking system used in a dual-beam imaging polarimeter.}
   \end{figure}
   \end{quote}
\end{htmlonly}
...
\begin{htmlonly}
   ...
   \begin{figure}[hbtp]
   \label{fig:extract}
   \includegraphics[scale=0.6,width=8in]{sun223_figures/extract.eps}
   \caption{Extraction of the $O$ and $E$ ray images.}
   \end{figure}
   \end{quote}
\end{htmlonly}
...
\begin{htmlonly}
   ...
   \begin{figure}[bhtp]
   \label{fig:dataflow}
   \includegraphics[scale=0.6,width=8in]{sun223_figures/dataflow.eps}
   \caption{The main steps in the production of a polarization map.}
   \end{figure}
   \end{quote}
\end{htmlonly}
...
The POLKA command activates a standard Starlink A-task which acquires
...
\begin{htmlonly}
   ...
   \begin{figure}[bhtp]
   \label{fig:polka}
   \includegraphics[scale=0.6,width=8in]{sun223_figures/polka.eps}
   \caption{The Graphical User Interface presented by POLKA.}
   \end{figure}
   \end{quote}
\end{htmlonly}
...
\begin{htmlonly}
   ...
   \begin{figure}[bhtp]
   \label{fig:polext}
   \includegraphics[scale=0.6,width=8in]{sun223_figures/polext.eps}
   \caption{The allowed items within the POLPACK extension.}
   \end{figure}
   \end{quote}
\end{htmlonly}
