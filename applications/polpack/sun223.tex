...
\item \htmlref{POLKA}{POLKA} has been re-implemented so that the Tcl script
which creates the GUI is executed in a different process to the POLKA
A-task. This enables POLPACK to be run succesfully as a monolith, from
the ICL or IRAF cl command languages for instance.
