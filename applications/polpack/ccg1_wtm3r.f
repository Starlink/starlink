      SUBROUTINE CCG1_WTM3R( ORDDAT, WEIGHT, VAR, NENT, USED, COVAR,
...
*  Invocation:
*      CALL CCG1_WTM3R( ORDDAT, WEIGHT, VAR, NENT, USED, COVAR,
*                         RESULT, RESVAR, STATUS )
