...
ccg1_wtm3r.f ctm_par dialog.tcl feature.bit \
gethlp.f gthlpi.f gui.gif hlpcmd pol1_hist.f pol1_tiqac.f pol1_angrt.f \
...
pol1_ctclm.f pol1_gtcta.f pol1_gtctc.f pol1_gtctw.f pol1_3dwcs.f \
pol1_gtwcs.f pol1_knext.f pol1_lnam.f pol1_mkcat.f pol1_fbbox.f \
...
pol1_cnfig.f pol1_pkaxs.f pol1_fclos.f polzconv.f polzconv.ifl pol1_gcolc.f \
$(KAPFIX) $(DATA)
...
UNIX_TOTAL = polka.htx_tar ctg_source.tar polpack_source.tar \
