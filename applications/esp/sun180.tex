...
\newcommand{\stardocversion}   {Version 0.10-8}	%%VERSION%%
...
\LineBreak
   ...
   \sstparameters{
      ...
      \sstsubsection{
         ...
         the final column of the ELLPRO output file.  It{\tt '}s not
         ...
         ideal.  I{\tt '}ve added here the range and the squared-differences
         as alternatives, selectable by options$\sim$1 and$\sim$2 respectively.

         I don{\tt '}t really recommend you play with this unless you wish to
