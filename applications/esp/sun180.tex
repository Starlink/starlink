...
% inverted commas being crazily mapped to {\tt '}.
%
...
\hbox{}\qquad             AUTOL AUTOLT FRZORI [CURSOR] [IN] [ORIGIN] (FINE)\\{}
\hbox{}\qquad             [RLIM] (LIM1) (LIM2) [SAME] [AGAIN] [INFILE]\\{}
\hbox{}\qquad             [IMGDEV] (COLOUR) (ANGCON) (ANGOFF) (FRACT)
   }
   \sstparameters{
      \sstsubsection{
         AGAIN=\_LOGICAL (Read)
...
\hbox{}\qquad             AUTOL AUTOLT FRZORI [CURSOR] [IN] [ORIGIN] (FAST)\\{}
\hbox{}\qquad             (FINE) [RLIM] (LIM1) (LIM2) (LIM3) (FRACT) [SAME]\\{}
\hbox{}\qquad             [AGAIN] [INFILE) [IMGDEV] (COLOUR) (ANGCON) (ANGOFF)
   }
   \sstparameters{
      \sstsubsection{
         AGAIN=\_LOGICAL (Read)
      ...
      \sstsubsection{
         ...
         this parameter the option$\sim$0 -- is rational, but not obviously
         ideal.  I've added here the range and the squared-differences
         as alternatives, selectable by options$\sim$1 and$\sim$2 respectively.
...
\hbox{}\qquad   MODTYPE COLOUR ANGCON ANGOFF FWHM PSIZE\\{}
\hbox{}\qquad   BACK SIGMA NSIGMA\\{}
\hbox{}\qquad   LSQFIT=false AUTOL XINC YINC SAINC SBINC PINC ANGINC NITER\\{}

      GAUFIT IN INFILE OUT MODE MODEL IMGDEV\\{}
\hbox{}\qquad   MODTYPE COLOUR ANGCON ANGOFF FWHM PSIZE\\{}
\hbox{}\qquad   BACK SIGMA NSIGMA\\{}
\hbox{}\qquad   LSQFIT=true CALCSD MAXITER
   }
   \sstparameters{
      \sstsubsection{
         ANGCON = \_LOGICAL (Read)
...
\hbox{}\qquad   [FITLIM] [RADISP] [WHATD] (LOWLIM) (ANGCON) (ANGOFF)
   }
   \sstparameters{
      \sstsubsection{
         AGAIN = \_LOGICAL(Read)
...
\LineBreak
         ...
         other The profiles and {\tt '}fits{\tt '} may be observed interactively as
...
\sstroutine{HISTPEAK}{\label{des:HISTPEAK}Establish the mean, mode, median and other statistics
   ...
   \sstparameters{
      ...
      \sstsubsection{
         ...
         is present and then {\tt '}fitting{\tt '} it. The {\tt '}fit{\tt '} obtained
   ...
   \sstexamples{
      ...
      \sstexamplesubsection{
         histpeak in=galaxy2 sfact=-1 use=a device=xwindows 
\LineBreak
ardfil=$\wedge$okay.dat
      }{
...
\sstroutine{HSUB}{\label{des:HSUB}A subroutine version of HISTPEAK for developers
   ...
   \sstparameters{
      ...
      \sstsubsection{
         ...
         series of keyword-value pairs, which isn't really \emph{un}readable,
...
\hbox{}\qquad   ZEROP OUT [IN] [DEVICE] [IMGDEV] [FITLIM] [POSANG]\\{}
\hbox{}\qquad   [ANGWID] [RLIM] [SAME] [AGAIN] [ORIGIN] (COLOUR)
   }
   \sstparameters{
      \sstsubsection{
         AGAIN = \_LOGICAL(Read)
...
\LineBreak
             rlim=25 origin={\tt "}12:36:53.42 62:12:21.8{\tt "}
      }{
...
\LineBreak
         ...
         be determined from a SKY coordinate frame in the image{\tt '}s WCS
...
\LineBreak
         ...
         image{\tt '}s WCS component if possible.
