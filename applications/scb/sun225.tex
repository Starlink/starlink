...
The program uses a DBM file to store the indices on disk.
...
\end{verbatim}
\end{quote}
--- first a private copy is made of the global indices using 
...
The indexing program {\tt scbindex.pl} builds disk-based indices, and the 
...
More detailed documentation of the implementation of these indices
...
The {\tt scbcp.pl} utility copies all the indices which have
