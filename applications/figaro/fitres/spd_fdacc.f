      SUBROUTINE SPD_FDACC( FILL, DIM1, DIM2, SHIFT0, SHIFT1,
     :   ARRAY, STATUS )
*+
*  Name:
*     SPD_FDAC{CDR}
...
*  Invocation:
*     CALL SPD_FDACC( FILL, DIM1, DIM2, SHIFT0, SHIFT1, ARRAY,
*        STATUS )
...
*     ARRAY( DIM1, DIM2 ) = CHARACTER * ( * ) (Given and Returned)
