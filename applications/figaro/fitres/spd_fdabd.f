      DOUBLE PRECISION FUNCTION SPD_FDABD( ARRAY, ELEM, STATUS )
*+
*  Name:
*     SPD_FDAB{CDIR}
...
*  Invocation:
*     RESULT = SPD_FDABD( ARRAY, ELEM, STATUS )
...
*  Arguments:
*     ARRAY( ELEM ) = DOUBLE PRECISION (Given)
