C+
C                   D S A _ _ A X I S _ U N I T S _ N A M E
C
C  Routine name:
C     DSA__AXIS_UNITS_NAME
C
C  Function:
C     Returns the name of the units string for an axis in a structure.
C
C  Description:
C     This routine, given the refernece slot number for a structure,
C     returns the DTA system name of the units string for the
...
C
C  Call:
C     CALL DSA__AXIS_UNITS_NAME (REF_SLOT,AXIS,NAME,LENGTH)
C
...
C                        axis units string in the structure.
...
C+
      SUBROUTINE DSA__AXIS_UNITS_NAME (REF_SLOT,AXIS,NAME,LENGTH)
C
      IMPLICIT NONE
C
C     Parameters
