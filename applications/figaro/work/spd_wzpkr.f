      SUBROUTINE SPD_WZPKR( LMAX, CLM, CRSL, NEEDC, STATUS )
*+
*  Name:
*     SPD_WZPK{DR}
...
*  Invocation:
*     CALL SPD_WZPKR( LMAX, CLM, CRSL, NEEDC, STATUS )
...
*        result vector.
*     CLM( LMAX, LMAX ) = REAL (Given)
*        The given matrix.
*     CRSL( LMAX ) = REAL (Returned)
