      SUBROUTINE SPD_WZQAD( VTHER1, VTHER2, NELM1, NELM2,
...
*     INDAT( NELM1 ) = DOUBLE PRECISION (Given)
*        The input data array.
*     INVAR( NELM1 ) = DOUBLE PRECISION (Given)
*        The input variance array.
*     OUTDAT( NELM2 ) = DOUBLE PRECISION (Given and Returned)
*        The output data array.
*     OUTVAR( NELM2 ) = DOUBLE PRECISION (Given and Returned)
...
*  Arguments Given:
      ...
      REAL TOL
      DOUBLE PRECISION INDAT( NELM1 )
      DOUBLE PRECISION INVAR( NELM1 )

*  Arguments Given and Returned:
      DOUBLE PRECISION OUTDAT( NELM2 )
      DOUBLE PRECISION OUTVAR( NELM2 )
