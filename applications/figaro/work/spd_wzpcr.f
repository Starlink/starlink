      SUBROUTINE SPD_WZPCR( INFO, KMAX, LMAX, XK, WK, XL, WL, OKL,
     :   STATUS )
*+
*  Name:
*     SPD_WZPC{DR}
...
*  Invocation:
*     CALL SPD_WZPCR( INFO, KMAX, LMAX, XK, WK, XL, WL, OKL, STATUS )
...
*  Local Variables:
      ...
      REAL SUMK                ! Sum over the row
      REAL LEFTK               ! Lower bound of pixel from first set
      REAL RIGHTK              ! Upper bound of pixel from first set
      REAL LEFTL               ! Lower bound of pixel from second set
      REAL RIGHTL              ! Upper bound of pixel from second set
...
*        Overlap.
     ...
     :               - MAX(  LEFTL,  LEFTK )
            OKL(K,L) = MAX( OKL(K,L), VAL__ZEROR )
