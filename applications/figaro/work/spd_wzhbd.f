      SUBROUTINE SPD_WZHBD( SPAXIS, TNPAR, PARA1,
...
*  Purpose:
*     Add a Gauss result component to a data array.
...
*     result array PARAMS as describing a Gauss component.
...
*  Internal References:
      DOUBLE PRECISION SPD_UAAYD         ! Component ordinate value
