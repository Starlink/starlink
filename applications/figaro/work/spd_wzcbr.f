      SUBROUTINE SPD_WZCBR( BIAS, NELM, XDATA, YDATA, MOMENT, STATUS )
*+
*  Name:
*     SPD_WZCB{DR}
...
*  Invocation:
*     CALL SPD_WZCBR( BIAS, NELM, XDATA, YDATA, MOMENT, STATUS )
