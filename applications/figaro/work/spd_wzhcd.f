      SUBROUTINE SPD_WZHCD( SPAXIS, TNPAR, PARA1,
...
*  Purpose:
*     Add a triangular result component to a data array.
...
*  Description:
*     This routine uses the parameters PARA1 ... PARA1 + 2 from the
*     result array PARAMS as describing a triangular component.
*     For each element in the given and returned data array
...
*  Internal References:
      DOUBLE PRECISION SPD_UAATD         ! Component ordinate value
...
*        arguments of that function are centre, peak and FWHM.
            IF ( DVALS(I1,I2,I3,I4,I5,I6,I7) .NE. VAL__BADD .AND.
     :            PARAMS(  PARA1,J(2),J(3),J(4),J(5),J(6),J(7))
     :               .NE. VAL__BADD .AND.
