      SUBROUTINE SPD_WZPHR( LMAX, VECI, CLM, VL, STATUS )
*+
*  Name:
*     SPD_WZPH{DR}
...
*  Invocation:
*     CALL SPD_WZPHR( LMAX, VECI, CLM, VL, STATUS )
...
*           (Bad diagonal may be signalled by zero counter.)
     ...
     :               VALCMM .EQ. VAL__BADR .OR.
     :               VALCLL .EQ. VAL__BADR ) THEN
                  CLM(M,L) = 0.
