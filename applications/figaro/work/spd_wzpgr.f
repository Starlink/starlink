      SUBROUTINE SPD_WZPGR( PROPCO, LMAX, VECI, SCLM, IL, STATUS )
*+
*  Name:
*     SPD_WZPG{DR}
...
*  Invocation:
*     CALL SPD_WZPGR( PROPCO, LMAX, VECI, SCLM, IL, STATUS )
...
*        If both operands are good.
            IF ( VALCL .GT. 0. .AND. VALIL .NE. VAL__BADR ) THEN
               IL(L) = VALIL / VALCL
