      subroutine r2ldel(array,lrow,urow,lcol,ucol,rowcol,indxcr,status)
*+
* Name:
*    R2LDEL

* Invocation:
*    CALL R2LDEL(ARRAY,LROW,UROW,LCOL,UCOL,ROWCOL,INDXCR,STATUS)

* Purpose:
*   Delete row or column in 2-d array

* Description:
*   Given a 2D REAL array, and a column (or row) within that array
...
*     ARRAY(LROW:UROW,LCOL:UCOL) = REAL ARRAY (Given and returned)
...
*
      ...
      real array(lrow:urow, lcol:ucol)
      character*(*) rowcol
      logical rowdel
*
