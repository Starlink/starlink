...
* Retrieved from NETLIB on Mon Feb 24 11:44:49 1997.
* ======================================================================
      DOUBLE PRECISION FUNCTION DGAMLN(Z,IERR)
C***BEGIN PROLOGUE  DGAMLN
C***DATE WRITTEN   830501   (YYMMDD)
C***REVISION DATE  970324   (YYMMDD)
C***               Changed to use PDA_D1MACH and PDA_I1MACH
C***REVISION DATE  970324   (YYMMDD)
C***               Explicitly define the types of PDA_D1MACH and
C***               PDA_I1MACH (ACD).
C***CATEGORY NO.  B5F
...
C***ROUTINES CALLED  PDA_I1MACH,PDA_D1MACH
