C+
      SUBROUTINE GEN_SUBSET(IN,NX,NY,NXNEW,NYNEW,NXST,NYST,OUT)
C
C     G E N _ S U B S E T
C
C     Returns a subset of a 2-dimensional array.
C
...
C                IN that is to be the first element of OUT.
C     (<) OUT    (Real array OUT(NXNEW,NYNEW)) The result array.
C
