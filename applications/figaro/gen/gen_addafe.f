C+
      SUBROUTINE GEN_ADDAFE(NELM,ARRAY1,ARRAY2,ARRAY3,
     :                     Q1DATA,Q2DATA,Q3DATA,
     :                     E1DATA,E2DATA,E3DATA,
     :                     QUAL,FLAGS,FBAD,VARIANCE)
C
C     G E N _ A D D A F E
C
C     Adds together two floating point arrays.  The arrays
...
C     (>) VARIANCE (Logical)    True if both input arras have variance arrays
C
