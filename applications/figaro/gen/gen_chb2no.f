C+
      SUBROUTINE GEN_CHB2NO(NORDER,XMIN,XMAX,A,C)
C
C     G E N _ C H B 2 N O
C
C     Converts polynomial coefficients held in Chebyshev series
C     form with normalised argument (such as are generated by the
C     NAG routine E02ADF) into 'normal' power series polynomial
C     coefficients.
C
