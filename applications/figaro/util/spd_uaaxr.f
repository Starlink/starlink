      REAL FUNCTION SPD_UAAXR( XMIN, XMAX, COEFF, XVAL )
*+
*  Name:
*     SPD_UAAX{DR}
...
*  Invocation:
*     RESULT = SPD_UAAXR( XMIN, XMAX, COEFF, XVAL )
...
*  Local Variables:
      REAL XX                  ! Argument for E02AEF
      REAL PCOEFF( MAXPOL )    ! Coefficients of ordinary polynomial
...
*  Calculate the (ordinary) polynomial.
      SPD_UAAXR =        PCOEFF(1) + XX * ( PCOEFF(2)
