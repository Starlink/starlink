      DOUBLE PRECISION FUNCTION SPD_UAAQD( LGT_ARG, LGNU_ARG )
*+
*  Name:
*     SPD_UAAQ{DR}
...
*  Arguments Given:
      DOUBLE PRECISION LGT_ARG
      DOUBLE PRECISION LGNU_ARG
