      SUBROUTINE SPD_UAAHD( NELM, ARRAY, EPS,
...
*  Invocation:
*     CALL SPD_UAAHD( NELM, ARRAY, EPS, LVAL, UVAL, LINEAR, STATUS )
...
*  Local Variables:
      ...
      DOUBLE PRECISION LOCEPS              ! Local, absolute EPS
      DOUBLE PRECISION INCR                ! Average value step
