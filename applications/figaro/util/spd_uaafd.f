      SUBROUTINE SPD_UAAFD( ELEM1, ELEM2, ARRAY, VALUE, STATUS )
*+
*  Name:
*     SPD_UAAF{CDIR}
...
*  Invocation:
*     CALL SPD_UAAFD( ELEM1, ELEM2, ARRAY, VALUE, STATUS )
...
*     ARRAY( ELEM2 ) = DOUBLE PRECISION (Returned)
