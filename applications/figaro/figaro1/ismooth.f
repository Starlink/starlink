...
C     less than from a 'side' neighbour.  Repeating the process increases
C     the amount of smothing applied, and the operation is close in 
C     effect to a gaussian convolution.
C
...
C                    Modified dynamic memory handling - now uses DYN rotuines
