...
\end{description}
\subsection{BCLEAN\xlabel{BCLEAN}-\label{BCLEAN}Automatic removal of bad lines & cosmic rays from CCD data}
\begin{description}
...
\end{verbatim}
\end{description}
\subsection{CSPIKE\xlabel{CSPIKE}-\label{CSPIKE}Create calibration spiketrum given spiketrum & standard spectrum}
\begin{description}
...
\end{verbatim}
\end{description}
\subsection{HCROSS\xlabel{HCROSS}-\label{HCROSS}Cross-correlate two spectra & get redshift and error}
\begin{description}
...
\item [{\bf See also:}]
\xref{KAPPA}{sun95}{}: \xref{CONTOVER}{sun95}{CONTOVER}, \xref{TURBOCONT}{sun95}{TURBOCONT}.\\
...
\xref{KAPPA}{sun95}{}: \xref{CURSOR}{sun95}{CURSOR}, \xref{INSPECT}{sun95}{INSPECT}, \xref{PICCUR}{sun95}{PICCUR}.\\
...
\xref{KAPPA}{sun95}{}: \xref{DISPLAY}{sun95}{DISPLAY}, \xref{GREYPLOT}{sun95}{GREYPLOT}.\\
...
\xref{KAPPA}{sun95}{}: \xref{INSPECT}{sun95}{INSPECT}, \xref{LINPLOT}{sun95}{LINPLOT}, \xref{MLINPLOT}{sun95}{MLINPLOT}.\\
...
\xref{KAPPA}{sun95}{}: \xref{FLIP}{sun95}{FLIP}, \xref{ROTATE}{sun95}{ROTATE}, \xref{TRANSFORMER}{sun95}{TRANSFORMER}.\\
...
\item [{\bf See also:}]
\xref{KAPPA}{sun95}{}: \xref{HISTAT}{sun95}{HISTAT}, \xref{HISTOGRAM}{sun95}{HISTOGRAM}, \xref{INSPECT}{sun95}{INSPECT}, \xref{MSTATS}{sun95}{MSTATS}, \xref{NUMB}{sun95}{NUMB}, \xref{STATS}{sun95}{STATS}.\\
...
\item [{\bf See also:}]
\xref{KAPPA}{sun95}{}: \xref{BLOCK}{sun95}{BLOCK}, \xref{COMPAVE}{sun95}{COMPAVE}, \xref{COMPICK}{sun95}{COMPICK}, \xref{PIXDUPE}{sun95}{PIXDUPE}, \xref{SQORST}{sun95}{SQORST}, \xref{TRANSFORMER}{sun95}{TRANSFORMER}.\\
...
\end{verbatim}
\end{description}
\subsection{SCROSS\xlabel{SCROSS}-\label{SCROSS}Cross-correlate two spectra & get relative shift}
\begin{description}
