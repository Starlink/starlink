      subroutine intrpl(l,x,y,n,u,v,status)
*+
* Name:
*    INTRPL

* Invocation:
*    CALL INTRPL(L,X,Y,N,U,V,STATUS)
* Purpose:
...
*    X(L) = DOUBLE PRECISION ARRAY (Given)
*        storing X data points
*    Y(L) = DOUBLE PRECISION ARRAY (Given)
*        storing Y data points
*    N = INTEGER (Given)
*        number of required points
*    U(N) = DOUBLE PRECISION ARRAY (Given)
*        stores ordinates of desired
*    STATUS = INTEGER (Given and returned)
*
*    V(N) = DOUBLE PRECISION ARRAY (Returned)
...
* output character string for par_wruser
      ...
      character chars*64
      double precision m1,m2,m3,m4,m5,uk,sw,y2
      double precision y5,t3,a3,a2,a4,t4,y4,x4,y3,x3
