...
#     This is virtually the same as demo.cl but some applications are run
#     in use_imh mode.
# 
#  Language:
#     IRAF CL
...
#
#     cl> task $demo=figaro$figdemo.cl
#     cl> demo
# 
#  Parameters:
#     none.
...
#      7-AUG-1997 (AJC):
#        Use flprcache not bye to kill executables
#     28-AUG-1997 (AJC):
...
#  Start-up.
      ...
      delete test1d.sdf,test2d.sdf,test_sdist*.sdf,test_stand*.sdf
      delete test_cmplx*.sdf,testfits*.sdf
      imdelete test_sdist*.imh,test_fits*.imh,test_stand*.imh,test_cmplx*.imh
# 
...
#!     mv test_fits2.sdf test_fits.sdf
      imdelete test_fits.imh
      imcopy test_fits2.imh test_fits.imh
      istat  test_fits  
#
...
#  Complex data and FFT
      ...
      image test_cmplx7 erase=no optimize=0.25 \
         autoscale=yes xplaces=1 yplaces=1 aspect=no
