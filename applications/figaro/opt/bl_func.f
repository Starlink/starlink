      subroutine bl_func(iflag,m,n,xc,rc,ajc,ljc,miw,liw,wn,niw)
*+
* Name:
*    BL_FUNC

* Invocation:
*    CALL BL_FUNC(IFLAG,M,N,XC,RC,AJC,LJC,MIW,LIW,WN,NIW)

* Purpose:
*   Evaluate the residuals and their first derivatives for Lorentzian

* Description
*  routine to evaluate the residuals and their first derivatives
*  for Lorentzian (unconstrained).
...
*-
      ...
      call bl_fun(m,n,xc,rc,ajc,%VAL(CNF_PVAL(dataptr)),
