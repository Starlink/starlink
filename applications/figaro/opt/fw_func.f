      subroutine fw_func(iflag,m,n,xc,rc,ajc,ljc,miw,liw,wn,niw)
*+
* Name:
*    FW_FUNC

* Invocation:
*    CALL FW_FUNC(IFLAG,M,N,XC,RC,AJC,LJC,MIW,LIW,WN,NIW)
...
*  for double with fixed width ratio.
...
*-
      ...
      call fw2_fun(m,n,xc,rc,ajc,ratio,%VAL(CNF_PVAL(dataptr)),
