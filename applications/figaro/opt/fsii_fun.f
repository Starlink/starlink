      subroutine FSII_fun(m,n,xc,rc,ajc,ajtjc,
...
* Invocation:
*    CALL FSII_FUN(M,N,XC,RC,AJC,AJTJC,
*                       MAX_PARMS,GC,DATA,DENS,WEIGHT)

* Description:
* Perform a 2 component fit to a combination of the [SII] 6717/6731
...
* lower redshift line for SII

      Double Precision SII_Z
      Parameter (SII_Z = 0.0021410)

* Symbolic constants giving the seperation of the Special line
* groups in Angstroms. The Seperations are defined relative to the
* lower redshift line for SII

      Double Precision SII_SEP
      Parameter (SII_SEP = 14.38)
