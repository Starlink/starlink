...
C
     ...
     :SUM,EXES,EXCH,XMED,WLAM,XRANGL(2),XRANGH(2),YRANGE(2),ACH,ABS,
     :RSHIFT,TEM,SPLITSUM,XSIGU,XSIGL,WIDTH,SIGN,ASYM,VALUE,Q
C
      DOUBLE PRECISION 
     :   DUMMY,
     :   EPS,
...
C
     ...
     :   IPTRS,IPTRC,IPTRX,IXSTART,CHCEN,CHDELP,CHDELM,NSEG,
     :   NCONTSS,NCST(10),NCEND(10),NFIT,I,J,LEOBJ,JNEW,NQ,NITN,NREJ,
     :   NL,NH,NTEM,JTEM,NML,LENAM,JST,JEND,NINT,JCST,JCEND,
     :   LECEN,LEINP,ISHIFT,LEHARDF,INDEX,
     :   IGNORE,INVOKE,NEXT,IFAIL,
     :   IFAIL2,
     :   IDOT,BYTES,NCH,LDAY,LDATE,LHOUR,
     :   PGSTAT,
     :   SLOT,
     :   TPTR,
     :   WSLOT
...
C
      CHARACTER  YN*1,CURC*1,DAT*20,TIM*12,TEXT*100,INP*20,KEY*3,
     :INPAR*17,CSHIFT*1,COMMAND*8,STRING*80,DAY*9
C
      LOGICAL
     :   QREPLY,
     :   LIMIT,
