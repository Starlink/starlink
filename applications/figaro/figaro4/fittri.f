...
*     report.
         CALL SPD_WZDC( .FALSE., 6, MSKDIM, FITPAR, FITDIM,
     :      IN, NELM,
...
*     Get the guess data corresponding to the masked data.
         CALL SPD_WZDD( MAXTRI, MSKELM, NCOMP, CONT,
     :      CENTRE, PEAK, FWHM, %VAL(PNTR(4)), %VAL(PNTR(8)), STATUS )
...
*  Do the fit.
     ...
     :   %VAL(PNTR(4)), CFLAGS, PFLAGS, SFLAGS, CENTRE, PEAK, FWHM,
