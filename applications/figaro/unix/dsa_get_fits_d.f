*+
*   D S A _ G E T _ F I T S _ D
*
      subroutine dsa_get_fits_d(refnam,item,el,val,comment,status)
*
*  Description:
*
*
...
*
      ...
      call dta_rdvard(refnam//'.fits.'//item,1,val,status)
