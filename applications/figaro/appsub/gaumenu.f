...
C
      LOGICAL PAR_ABORT
      INTEGER ICH_ENCODE,ICH_FOLD,ICH_KEY,ICH_NUMBR,ICH_LEN
C
C     Local variables
C
      INTEGER I,J,K,STATUS,NEXT,LIM,SIN,NEW,NEX,INCH,SEL,LIS,OPT,
     ...
     :MAXR,MINR,CHAINP(10),CHAINH(10),CHAINW(10),RUB,EW,RMST,RMS,
     :MERR,MILIM,MALIM
