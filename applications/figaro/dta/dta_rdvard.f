...
C     (<) DARRAY   (Double precision array) The data to be read.
...
C
      INCLUDE 'DTATCON'
C
      CALL DTA_RDVAR(NAME,NITEM,TYP_DSDOUBLE,DARRAY,STATUS)
C
      END
