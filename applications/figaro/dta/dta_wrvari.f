...
C     (>) IARRAY   (Integer array) The data to be written.
...
C
      INCLUDE 'DTATCON'
C
      CALL DTA_WRVAR(NAME,NITEM,TYP_DSINT,IARRAY,STATUS)
C
      END
