...
C     (>) SARRAY   (Integer*2 array) The data to be written.
...
C
      INCLUDE 'DTATCON'
C
      CALL DTA_WRVAR(NAME,NITEM,TYP_DSSHORT,SARRAY,STATUS)
C
      END
