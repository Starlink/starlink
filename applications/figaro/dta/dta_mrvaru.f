C+
      SUBROUTINE DTA_MRVARU (NAME,NITEM,POINTER,STATUS)
C
C     D T A _ M R V A R U
C
...
C     Modified:
C
C     27th Aug  1992.  HME/UoE.   Syntax of include statements changed to
...
C
      INCLUDE 'DTATCON'
C
      CALL DTA_MRVAR(NAME,NITEM,TYP_DSUSHORT,POINTER,STATUS)
C
      END
