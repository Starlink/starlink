...
C     (<) FARRAY   (Real array) The data to be read.
...
C
      INCLUDE 'DTATCON'
C
      CALL DTA_RDVAR(NAME,NITEM,TYP_DSFLOAT,FARRAY,STATUS)
C
      END
