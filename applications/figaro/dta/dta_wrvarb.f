...
C     (>) BARRAY   (Byte array) The data to be written.
...
C
      INCLUDE 'DTATCON'
C
      CALL DTA_WRVAR(NAME,NITEM,TYP_DSBYTE,BARRAY,STATUS)
C
      END
