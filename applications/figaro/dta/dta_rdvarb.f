...
C     (<) BARRAY   (Byte array) The data to be read.
...
C
      INCLUDE 'DTATCON'
C
      CALL DTA_RDVAR(NAME,NITEM,TYP_DSBYTE,BARRAY,STATUS)
C
      END
