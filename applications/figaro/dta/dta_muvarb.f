C+
      SUBROUTINE DTA_MUVARB (NAME,NITEM,POINTER,STATUS)
C
C     D T A _ M U V A R B
C
...
C
C     TYP_DSBYTE   Code for byte data type
C
      INCLUDE 'DTATCON'
C
      CALL DTA_MUVAR(NAME,NITEM,TYP_DSBYTE,POINTER,STATUS)
C
      END
