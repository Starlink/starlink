...
C     (<) SARRAY   (Integer*2 array) The data to be read.
...
C
      INCLUDE 'DTATCON'
C
      CALL DTA_RDVAR(NAME,NITEM,TYP_DSUSHORT,SARRAY,STATUS)
C
      END
