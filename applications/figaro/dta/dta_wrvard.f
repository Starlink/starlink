...
C     (>) DARRAY   (Double precision array) The data to be written.
...
C
      INCLUDE 'DTATCON'
C
      CALL DTA_WRVAR(NAME,NITEM,TYP_DSDOUBLE,DARRAY,STATUS)
C
      END
