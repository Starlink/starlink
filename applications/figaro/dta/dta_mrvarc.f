C+
      SUBROUTINE DTA_MRVARC (NAME,NITEM,POINTER,STATUS)
C
C     D T A _ M R V A R C
C
...
C     CHAR.  Note that numeric data cannot be converted to
C     character type by the system.
C
...
C
      INCLUDE 'DTATCON'
C
      CALL DTA_MRVAR(NAME,NITEM,TYP_DSCHAR,POINTER,STATUS)
C
      END
