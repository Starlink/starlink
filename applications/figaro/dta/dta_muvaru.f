C+
      SUBROUTINE DTA_MUVARU (NAME,NITEM,POINTER,STATUS)
C
C     D T A _ M U V A R U
C
...
C
C     TYP_DSUSHORT   Code for USHORT data type
C
      INCLUDE 'DTATCON'
C
      CALL DTA_MUVAR(NAME,NITEM,TYP_DSUSHORT,POINTER,STATUS)
C
      END
