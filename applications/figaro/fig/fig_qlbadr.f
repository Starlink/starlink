      SUBROUTINE FIG_QLBADR( NELM, BADXST, LQUAL, INDAT, OUTDAT,
     :   STATUS )
*+
*  Name:
*     FIG_QLBADR
...
*  Invocation:
*     CALL FIG_QLBADR( NELM, BADXST, LQUAL, INDAT, OUTDAT, STATUS )

*  Description:
*     This routine copies data from INDAT to OUTDAT (_REAL arrays).
...
*     INDAT( NELM ) = REAL (Given)
*        The given data array.
*     OUTDAT( NELM ) = REAL (Returned)
