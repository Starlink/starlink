C+
      SUBROUTINE FIG_HORIZONTALQ (DATA,QUAL,NX,NY,IY,IX1,IX2,
     :                            LIMX1,LIMX2,NCOEFF,MAXPT,X,Z,STATUS)
C
C     F I G _ H O R I Z O N T A L Q
C
...
C                    JTY_... now.
C     21st Jul 1998  MBT / IoA, Starlink.  Changed name to FIG_HORIZONQ
...
C
      ...
      REAL    DATA(NX,NY),X(MAXPT),Z(MAXPT)
      BYTE    QUAL(NX,NY)
C
C     Functions
C
