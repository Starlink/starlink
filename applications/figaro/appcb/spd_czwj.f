      SUBROUTINE SPD_CZWJ( FILE, FU, NCOMP, LINENA, LABFRE, COMPTY,
...
*  Purpose:
*     List result components (_REAL).

*  Language:
*     Starlink Fortran 77

*  Invocation:
*     CALL SPD_CZWJ( FILE, FU, NCOMP, LINENA, LABFRE, COMPTY, NPARA,
*        MASKL, MASKR, STATUS )
...
*     formats are adjusted for _REAL laboratory frequencies. The mask
...
*  bounds are not intercepted.
 101  FORMAT ( ' ', I3, ' ', A32, ' ', G13.7E2, ' ', A32,
     :         ' ', I4, ' ', G13.7E2, ' ', G13.7E2 )
 103  FORMAT ( ' ', I3, ' ', A32, ' **** bad **** ', A32,
     :         ' ', I4, ' ', G13.7E2, ' ', G13.7E2 )
 201  FORMAT ( ' ', I3, ' ', A12, ' ', G13.7E2, ' ', A12,
     :         ' ', I4, ' ', G12.6E2, ' ', G12.6E2 )
 202  FORMAT ( A )
 203  FORMAT ( ' ', I3, ' ', A12, ' **** bad **** ', A12,
     :         ' ', I4, ' ', G12.6E2, ' ', G12.6E2 )
...
*     Table header.
         SHORT = '   # line name    lab freq.     ' //
     :      'comp. type  npara mask from    to'
         CALL MSG_OUT( 'SPD_CZWJ_LIST', SHORT, STATUS )
