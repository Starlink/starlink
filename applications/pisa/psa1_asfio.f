      SUBROUTINE PSA1_ASFIO( PNFILE, ACMODE, FORM, RECSZ, FD, OPEN,
     :                       STATUS )
*+
*  Name:
*     PSA1_ASFIO
...
*  Invocation:
*     CALL PSA1_ASFIO( PNFILE, ACMODE, FORM, RECSZ, FD, OPEN, STATUS )
