...
*  Local variables:
      ...
      INTEGER ID2               ! AGI picture identifier for
                                ! residuals viewport.
      INTEGER IHIST             ! Pointer to histogram
      ...
      REAL V2( 4 )              ! Limits of residuals plotting
                                ...
                                ! coordinates
      REAL WIDTH                ! Width of histogram bin
      REAL ZERO                 ! Zero of histogram

*  Minimization buffers:
      INTEGER IFAIL
      DOUBLE PRECISION FVEC( FITSIZ )
      DOUBLE PRECISION BL( 3 )
      DOUBLE PRECISION BU( 3 )
...
*  Miscellaneous local variables (from old style declarations).
      ...
      INTEGER ISBUF( FITSIZ ),IRBUF( FITSIZ )
...
*  Write out the sky value and noise estimate to the user
     ...
     :              STATUS )
      CALL MSG_FMTR( 'SIGMA', 'F12.3', SIGMA )
      CALL MSG_OUT( 'SDEV',
