...
\stardocnumber      {109.11}
\stardocauthors     {Peter W. Draper and Nicholas Eaton}
\stardocdate        {23 October 2002}
\stardoctitle       {PISA \\
                  Position Intensity and Shape Analysis}
\stardocversion     {2.4-5}
\stardoccopyright
...
%%\startitlepic{\vskip -20mm\centering\leavevmode\includegraphics[width=4in]{sun109_cover}}
...
\verb+'[1,2,3,4]'+  or \texttt{\textbackslash[1,2,3,4\textbackslash]} not \verb+[1,2,3,4]+
