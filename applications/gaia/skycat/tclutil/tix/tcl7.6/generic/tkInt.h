 ...
 *
 *     RCS:  $Id: tkInt.h,v 1.2 2005/02/02 01:43:02 brighton Exp $
 * ========================================================================
...
typedef struct TkWindow {
    ...
    Tcl_Command widgetCmd;	/* Access command for widget.  NULL means
				 * this window is not a widget */

    struct TkWindow *megaPtr;	/* Pointer to mega-widget containing
				 * this window as a component.  NULL
				 * means that this window is not part
				 * of a mega-widget. */
