...
itcl::class ::gaia3d::Gaia3dVtkArdRowPrism {
   ...
   protected method create_polygon_ {} {
      ...
      if { $axis == 1 } {
         $points_ InsertPoint 0 0.0 0     $coord
         $points_ InsertPoint 1 0.0 $ydim $coord
      } elseif { $axis == 2 } {
         $points_ InsertPoint 0 0     0.0 $coord
         $points_ InsertPoint 1 $xdim 0.0 $coord
      } else {
         $points_ InsertPoint 0 0     $coord 0.0
         $points_ InsertPoint 1 $xdim $coord 0.0
      }
