...
#  Invocations:
#
#        ColourMenu object_name [configuration options]
#
#     This creates an instance of a ColourMenu object. The return is
...
itcl::class gaia::ColourMenu {
   ...
   #  Constructor:
   #  ------------
   #  Need the menu option otherwise there would be nothing to do.
