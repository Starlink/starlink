...
#  Purpose:
#     Defines a class of ARD Box with an annulus of the same shape.

#  Description:
#     This class creates an ARD canvas rectangle item and draws an
#     annulus at the given scale factor about it. The annulus is
#     updated with the ARD rectangle.

#  Invocations:
#
#        StarArdAnnBox object_name [configuration options]
#
#     This creates an instance of a StarArdAnnBox object. The return is
...
itcl::class gaia::StarArdAnnBox {

   #  Inheritances:
   #  -------------

   inherit gaia::StarArdBox
