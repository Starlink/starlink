...
#  Purpose:
#     Defines a class of ARD RotBox with an annulus of the same shape.

#  Description:
#     This class creates an ARD canvas RotBox item and draws an
#     annulus at the given scale factor about it. The annulus is
#     updated with the ARD RotBox.

#  Invocations:
#
#        StarArdAnnRotBox object_name [configuration options]
#
#     This creates an instance of a StarArdAnnRotBox object. The return is
...
#  Inheritance:
#     This object inherits StarArdRotBox.
...
itcl::class gaia::StarArdAnnRotBox {
   ...
   public method getann {} {
      if { $annulus_id_ != {} } {
         ...
         set major [image_dist [expr $maj*2.0]]
         set minor [image_dist [expr $min*2.0]]
   ...
   public variable annulus_tag {ArdRotBox} {}
