...
#  Purpose:
#     Defines a class of ARD Column with an annulus of the same shape.

#  Description:
#     This class creates an ARD canvas Column item and draws an
#     annulus at the given scale factor about it. The annulus is
#     updated with the ARD Column.

#  Invocations:
#
#        StarArdAnnColumn object_name [configuration options]
#
#     This creates an instance of a StarArdAnnColumn object. The return is
...
#  Inheritance:
#     This object inherits StarArdColumn.
...
itcl::class gaia::StarArdAnnColumn {
   ...
   #  factor (Column is an image pixel wide not a canvas pixel).
   ...
   public variable annulus_tag {ArdColumn} {}
