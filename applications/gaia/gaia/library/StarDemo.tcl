...
#  Invocations:
#
#        StarDemo object_name [configuration options]
#
#     This creates an instance of a StarDemo object. The return is
...
itcl::class gaia::StarDemo {
 ...
 estimates etc. that appear in the main part and in the details list.
