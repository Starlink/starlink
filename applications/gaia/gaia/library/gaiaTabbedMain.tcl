...
#  Purpose:
#     Main routine for tabbed interface to the GAIA image display and
#     analysis tool. 
...
#     15-JUL-2003 (PWD):
#        Modified to start the tabbed version of interface.
#     {enter_changes_here}
...
#  This is the tabbed interface.
lappend argv "-tabbedgaia"
lappend argv "1"
incr argc 2
