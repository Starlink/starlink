...
#  Invocations:
#
#        StarPatch object_name [configuration options]
#
...
itcl::class gaia::StarPatch {
   ...
   constructor {args} {
      ...
      #  Add window help.
      global gaia_dir
      add_help_button $gaia_dir/StarPatch.hlp "On Window..."
   ...
   method do_patch {} {
      if { [$itk_option(-rtdimage) cget -file] != "" } {
         ...
         #  regions.
         if { [$Repl_ save_description {StarPatchNew.ard}] } {
            ...
            set backok 0
            if { $itk_option(-use_annuli) } {
               set backok [$Repl_ save_annuli_description {StarPatchFit.ard}]
               set fit_region [$Repl_ bbox_annuli]
            } else {
               set backok [$Back_ save_description {StarPatchFit.ard}]
            ...
            if { $backok } {
               ...
               $itk_option(-rtdimage) foreign patch \
                  "-new StarPatchNew.ard -fit StarPatchFit.ard \
