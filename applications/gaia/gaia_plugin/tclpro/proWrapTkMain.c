 ...
 * proWrapTkMain.c --
 *
 *      Main program for Tk applications wrapped using TclPro Wrapper.
 *
 * Copyright (c) 1998 Scriptics Corporation
 * All rights reserved.
 *
 * SCCS: @(#) proWrapTkMain.c 1.7 98/08/22 16:21:33
 */
...
Pro_WrapTkMain(argc, argv, appInitProc)
    ...
    Tcl_AppInitProc *appInitProc;	/* Application-specific initialization
					 ...
					 * to execute commands. */
{
    char *args, *fileName, **saveArgv = NULL;
    char buf[20];
    int code, saveArgc;
    size_t length;
    ...
    /*
     * Initialize the wrapper for this interpreter.
     */
     ...
     * standard wish behavior on the assumption that if initialization
