...
itcl::class gaia::StarAstGrid {
   ...
   #  Close this window (for the moment).
   public method close {} {
      wm withdraw $w_
   ...
   protected method remove_grid_ {} {
      $itk_option(-canvas) delete [$itk_option(-rtdimage) cget -grid_tag]
   }
   ...
   public method read_options {filename} {
      if { [file readable $filename] } {
         busy {
            ...
            #  associated variable so as tp reflect these changes.
   ...
   protected variable fontmap_ {
      ...
      17 "-adobe-helvetica-bold-r-*-*-20-*-*-*-*-*-*-*"        "large screen"
   }
