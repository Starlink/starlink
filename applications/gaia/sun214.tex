...
GAIA is an image display tool but with the additional capability of being
extendable to integrate other programs.  At present extensions are provided
...
\end{quote}
The GAIA home page (which should have a current list of known bugs,
work arounds and other useful information) is at:
\begin{quote}
...
\begin{quote}
\mytt{\% gaiadispmany image\_name1 image\_name2 image\_name3 ...}
\end{quote}
