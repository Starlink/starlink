...
\item Display of image planes from data cubes. Using this you can step
  through on the axes and display the image formed by the other two axes. 
...
This is a major release of GAIA incorporating two new automated astrometry
