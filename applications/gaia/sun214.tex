...
cubes and plotting spectra extracted from the third dimension. It can also 
interoperate with other PLASTIC enabled applications.
...
\section{Release notes for version 3.2-0}
...
\begin{itemize}
    ...
    \item Support for a subset of the PLASTIC protocols has been added to
    enable GAIA to interoperate with tools designed for the Virtual
    Observatory.  See the new \mytt{Interop} menu in the main display and the
    help page available in the on-line help.
