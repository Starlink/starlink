...
\newcommand{\stardocdate}      {6th May 2003}
...
\subsection{This release - 2.6-12}

New to this release:
\begin{itemize}

   \item A number of new catalogues and image servers are now available. 
   ...
   \mytt{\~{}/.skycat/skycat.cfg} file, you should just say yes. Some
   ...
   \item GAIA is now released under the GNU General Public License.
