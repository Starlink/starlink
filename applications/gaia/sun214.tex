...
Two useful options that can only be set as X preferences
are:
\begin{quote}
\begin{verbatim}
*max_scale: 30
...
\subsection{Release - 2.6} 
  ...
  \begin{itemize}
     ...
     \item SuperCOSMOS surveys are now available. To access these you need
       ...
       dialog under the ``Data-Servers'' menu for the sub-list
       ``SuperCOSMOS catalogues''. 
