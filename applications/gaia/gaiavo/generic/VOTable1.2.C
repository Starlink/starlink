...
namespace votable_12
{
  ...
  const INFO::VALUES_optional& INFO::
  VALUES () const
  {
    return this->VALUES_;
  }

  INFO::VALUES_optional& INFO::
  VALUES ()
  {
    return this->VALUES_;
  }
  ...
  const INFO::LINK_sequence& INFO::
  LINK () const
  {
    return this->LINK_;
  }

  INFO::LINK_sequence& INFO::
  LINK ()
  {
    return this->LINK_;
  }
...
namespace votable_12
{
  ...
  _xsd_encodingType_indexes_[4] =
  {
    ::votable_12::encodingType::base64,
    ::votable_12::encodingType::dynamic,
    ::votable_12::encodingType::gzip,
    ::votable_12::encodingType::none
  };
  ...
  _xsd_dataType_indexes_[12] =
  {
    ::votable_12::dataType::bit,
    ::votable_12::dataType::boolean,
    ::votable_12::dataType::char_,
    ::votable_12::dataType::double_,
    ::votable_12::dataType::doubleComplex,
    ::votable_12::dataType::float_,
    ::votable_12::dataType::floatComplex,
    ::votable_12::dataType::int_,
    ::votable_12::dataType::long_,
    ::votable_12::dataType::short_,
    ::votable_12::dataType::unicodeChar,
    ::votable_12::dataType::unsignedByte
  };
         ...
         ::xml_schema::flags f)
  {
    for (; p.more_elements (); p.next_element ())
    {
      ...
      // OPTION
      //
      if (n.name () == "OPTION" && n.namespace_ () == "http://www.ivoa.net/xml/VOTable/v1.2")
      {
         ...
         ::xml_schema::flags f)
  {
    for (; p.more_elements (); p.next_element ())
    {
      ...
      // MIN
      //
      if (n.name () == "MIN" && n.namespace_ () == "http://www.ivoa.net/xml/VOTable/v1.2")
      {
      ...
      // MAX
      //
      if (n.name () == "MAX" && n.namespace_ () == "http://www.ivoa.net/xml/VOTable/v1.2")
      {
         ...
         ::xml_schema::flags f)
  {
    for (; p.more_elements (); p.next_element ())
    {
      ...
      // DESCRIPTION
      //
      if (n.name () == "DESCRIPTION" && n.namespace_ () == "http://www.ivoa.net/xml/VOTable/v1.2")
      {
      ...
      // VALUES
      //
      if (n.name () == "VALUES" && n.namespace_ () == "http://www.ivoa.net/xml/VOTable/v1.2")
      {
      ...
      // LINK
      //
      if (n.name () == "LINK" && n.namespace_ () == "http://www.ivoa.net/xml/VOTable/v1.2")
      {
         ...
         ::xml_schema::flags f)
  {
    for (; p.more_elements (); p.next_element ())
    {
      ...
      // COOSYS
      //
      if (n.name () == "COOSYS" && n.namespace_ () == "http://www.ivoa.net/xml/VOTable/v1.2")
      {
      ...
      // PARAM
      //
      if (n.name () == "PARAM" && n.namespace_ () == "http://www.ivoa.net/xml/VOTable/v1.2")
      {
  ...
  PARAM (const ::xercesc::DOMElement& e,
         ::xml_schema::flags f,
         ::xml_schema::container* c)
  : ::votable_12::FIELD (e, f | ::xml_schema::flags::base, c),
    value_ (f, this)
  {
    if ((f & ::xml_schema::flags::base) == 0)
    {
  ...
  parse (::xsd::cxx::xml::dom::parser< char >& p,
         ::xml_schema::flags f)
  {
    this->::votable_12::FIELD::parse (p, f);
         ...
         ::xml_schema::flags f)
  {
    for (; p.more_elements (); p.next_element ())
    {
      ...
      // FIELDref
      //
      if (n.name () == "FIELDref" && n.namespace_ () == "http://www.ivoa.net/xml/VOTable/v1.2")
      {
      ...
      // PARAMref
      //
      if (n.name () == "PARAMref" && n.namespace_ () == "http://www.ivoa.net/xml/VOTable/v1.2")
      {
      ...
      // GROUP
      //
      if (n.name () == "GROUP" && n.namespace_ () == "http://www.ivoa.net/xml/VOTable/v1.2")
      {
         ...
         ::xml_schema::flags f)
  {
    for (; p.more_elements (); p.next_element ())
    {
      ...
      // TABLEDATA
      //
      if (n.name () == "TABLEDATA" && n.namespace_ () == "http://www.ivoa.net/xml/VOTable/v1.2")
      {
      ...
      // BINARY
      //
      if (n.name () == "BINARY" && n.namespace_ () == "http://www.ivoa.net/xml/VOTable/v1.2")
      {
      ...
      // FITS
      //
      if (n.name () == "FITS" && n.namespace_ () == "http://www.ivoa.net/xml/VOTable/v1.2")
      {
      ...
      // INFO
      //
      if (n.name () == "INFO" && n.namespace_ () == "http://www.ivoa.net/xml/VOTable/v1.2")
      {
         ...
         ::xml_schema::flags f)
  {
    for (; p.more_elements (); p.next_element ())
    {
      ...
      // TR
      //
      if (n.name () == "TR" && n.namespace_ () == "http://www.ivoa.net/xml/VOTable/v1.2")
      {
         ...
         ::xml_schema::flags f)
  {
    for (; p.more_elements (); p.next_element ())
    {
      ...
      // TD
      //
      if (n.name () == "TD" && n.namespace_ () == "http://www.ivoa.net/xml/VOTable/v1.2")
      {
         ...
         ::xml_schema::flags f)
  {
    for (; p.more_elements (); p.next_element ())
    {
      ...
      // STREAM
      //
      if (n.name () == "STREAM" && n.namespace_ () == "http://www.ivoa.net/xml/VOTable/v1.2")
      {
         ...
         ::xml_schema::flags f)
  {
    for (; p.more_elements (); p.next_element ())
    {
      ...
      // FIELD
      //
      if (n.name () == "FIELD" && n.namespace_ () == "http://www.ivoa.net/xml/VOTable/v1.2")
      {
      ...
      // DATA
      //
      if (n.name () == "DATA" && n.namespace_ () == "http://www.ivoa.net/xml/VOTable/v1.2")
      {
         ...
         ::xml_schema::flags f)
  {
    for (; p.more_elements (); p.next_element ())
    {
      ...
      // TABLE
      //
      if (n.name () == "TABLE" && n.namespace_ () == "http://www.ivoa.net/xml/VOTable/v1.2")
      {
      ...
      // RESOURCE
      //
      if (n.name () == "RESOURCE" && n.namespace_ () == "http://www.ivoa.net/xml/VOTable/v1.2")
      {
      ...
      // any
      //
      if ((!n.namespace_ ().empty () && n.namespace_ () != "http://www.ivoa.net/xml/VOTable/v1.2"))
      {
        ::xercesc::DOMElement* r (
          static_cast< ::xercesc::DOMElement* > (
            this->dom_document ().importNode (
    ...
    while (p.more_attributes ())
    {
      ...
      if ((!n.namespace_ ().empty () &&
           n.namespace_ () != "http://www.ivoa.net/xml/VOTable/v1.2" &&
  ...
  _xsd_type_indexes_[2] =
  {
    ::votable_12::type::actual,
    ::votable_12::type::legal
  };
  ...
  _xsd_system_indexes_[10] =
  {
    ::votable_12::system::ICRS,
    ::votable_12::system::barycentric,
    ::votable_12::system::ecl_FK4,
    ::votable_12::system::ecl_FK5,
    ::votable_12::system::eq_FK4,
    ::votable_12::system::eq_FK5,
    ::votable_12::system::galactic,
    ::votable_12::system::geo_app,
    ::votable_12::system::supergalactic,
    ::votable_12::system::xy
  };
  ...
  _xsd_type1_indexes_[4] =
  {
    ::votable_12::type1::hidden,
    ::votable_12::type1::location,
    ::votable_12::type1::no_query,
    ::votable_12::type1::trigger
  };
  ...
  _xsd_type2_indexes_[2] =
  {
    ::votable_12::type2::locator,
    ::votable_12::type2::other
  };
  ...
  _xsd_actuate_indexes_[4] =
  {
    ::votable_12::actuate::none,
    ::votable_12::actuate::onLoad,
    ::votable_12::actuate::onRequest,
    ::votable_12::actuate::other
  };
  ...
  _xsd_type3_indexes_[2] =
  {
    ::votable_12::type3::meta,
    ::votable_12::type3::results
  };
         ...
         ::xml_schema::flags f)
  {
    for (; p.more_elements (); p.next_element ())
    {
      ...
      // DEFINITIONS
      //
      if (n.name () == "DEFINITIONS" && n.namespace_ () == "http://www.ivoa.net/xml/VOTable/v1.2")
      {
...
namespace votable_12
{
  ::std::auto_ptr< ::votable_12::VOTABLE >
                ...
                const ::xml_schema::properties& p)
  {
    ...
    ::std::auto_ptr< ::votable_12::VOTABLE > r (
      ::votable_12::VOTABLE_read (
                ...
                const ::xml_schema::properties& p)
  {
    ...
    return ::votable_12::VOTABLE_read (isrc, f, p);
  }
                ...
                const ::xml_schema::properties& p)
  {
    ...
    ::xsd::cxx::xml::sax::std_input_source isrc (is);
    return ::votable_12::VOTABLE_read (isrc, h, f, p);
  }
                ...
                const ::xml_schema::properties& p)
  {
    ...
    {
      ::std::auto_ptr< ::votable_12::VOTABLE > r (
        ::xsd::cxx::tree::traits< ::votable_12::VOTABLE, char >::create (
          e, f, 0));
      return r;
    }
...
namespace votable_12
{
  ...
  {
    e << static_cast< const ::votable_12::FIELD& > (i);
                 ...
                 ::xml_schema::flags f)
  {
    ...
    ::xml_schema::dom::auto_ptr< ::xercesc::DOMDocument > d (
      ::votable_12::VOTABLE_write (s, m, f));
  ...
  VOTABLE_write (const ::votable_12::VOTABLE& s,
                 const ::xml_schema::namespace_infomap& m,
                 ::xml_schema::flags f)
  {
    ::xml_schema::dom::auto_ptr< ::xercesc::DOMDocument > d (
    ...
    ::votable_12::VOTABLE_write (*d, s, f);
    return d;
  }
