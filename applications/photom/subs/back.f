************************************************************************
      ...
      SUBROUTINE BACK ( SKYEST, NX, NY, IMAGE, IMVAR, USEVAR, GRID, GS,
...
*
*  Invocation :
*     CALL BACK( SKYEST, NX, NY, IMAGE, IMVAR, USEVAR, GRID, GS, MASK,
*                USEMSK, NXL, NXH, NYL, NYH, VALUES, NV, SKY, SIGMA, VSKY )
*
*  Description :
