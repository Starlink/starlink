      SUBROUTINE PHO1_ASFIO( PNFILE, ACMODE, FORM, RECSZ, FD, OPEN,
     :                       STATUS )
*+
*  Name:
*     PHO1_ASFIO
...
*  Invocation:
*     CALL PHO1_ASFIO( PNFILE, ACMODE, FORM, RECSZ, FD, OPEN, STATUS )
...
*        (on UNIX system).
*     12-APr-1996 (PDRAPER):
*        Now named PHO1_ASFIO and incorporated into PHOTOM.
