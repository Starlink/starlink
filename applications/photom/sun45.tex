...
\stardocnumber      {45.16}
\stardocauthors     {Nicholas Eaton, Peter W.\ Draper \& Alasdair Allan}
\stardocdate        {27th November 2009}
\stardoctitle       {PHOTOM --- A Photometry Package }
\stardocversion     {Version 1.12-0}
\stardocmanual      {User's Manual}
\startitlepic{\includegraphics{sun45_cover}}
\stardocabstract  {
...
\slhyperref{here}{section \S}{}{dataformat}),
...
\slhyperref{this appendix}{in appendix }{}{AUTOPHOTOM}.
Basically this
...
\sstroutine{AUTOPHOTOM}{
   ...
   \sstnotes{
      \sstitemlist{
        ...
        \sstitem
        \emph{Aperture Extraction} -- The input/output file must contain
       ...
       The other fields are the same as for an object aperture.\\
        ...
        \sstitem
        \emph{Optimal Extraction} -- Then the first star in the file must be
