...
than to a selection of generated entities/files.

<p>HACK ALERT: This parameter is slightly hacky.  It's tested in
all of the places where nochunks is tested, and the result should
be as if nochunks were set as well.
...
then alter (root-file-name) to use that information when it
...
<misccode>
<description><p>The rest of the functions in this group are
