...
# usual.  The catalogue must have all of the fields NUMBER, X_IMAGE,
# Y_IMAGE, FLUX_ISO, A_IMAGE, B_IMAGE, ERRX2_IMAGE, ERRY2_IMAGE,
# ISOAREA_IMAGE, of which A_IMAGE, B_IMAGE, and the ERR* parameters
