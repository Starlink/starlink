...
\newcommand{\findcoordsversion}{1.0~}
...
\newcommand{\stardocnumber}    {240.1}
\newcommand{\stardocauthors}   {A.C.~Davenhall}
\newcommand{\stardocdate}      {29 May 2001}
\newcommand{\stardoctitle}     {FINDCOORDS --- \\
Finding the Coordinates of a \\ Named Object}
\newcommand{\stardocversion}   {Version \findcoordsversion}
\newcommand{\stardocabstract}
{{\tt findcoords} is a utility for finding the equatorial coordinates of
...
{\tt findcoords} is a utility for finding the equatorial coordinates of
a named astronomical object.  You simply enter the name of the object
and its coordinates are displayed.  {\tt findcoords} works by submitting a
...
{http://cdsweb.u-strasbg.fr/CDS.html}, CDS).  Consequently, {\tt
findcoords} will only work on computers with a suitable Internet
connection.  Also, the name given must be recognised by SIMBAD, though
the latter's dictionary of names is very extensive.  {\tt findcoords} is a
simple wrap-around for the name-resolver function of application {\tt
catremote} in \htmladdnormallink{CURSA}{http://www.starlink.rl.ac.uk/cursa/}
...
\begin{quote}
{\tt findcoords} ~ {\it object-name}
\end{quote}

The {\it object-name}\/ should be entered without embedded spaces.  The
...
This section gives a detailed description of {\tt findcoords}.

% -- Script description -------------------------------------------------------

% \input{sun240help.tex}
