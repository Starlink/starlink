...
\stardocnumber      {199.12}
\stardocauthors   {P W Draper\\
                                A J Chipperfield\\
                                M D Lawden}
\stardocdate        {26 January 2009}
\stardoctitle     {Star2HTML\\[1ex]
...
\emph{The advice in this document, in particular that found in
  Section~\ref{common_problems}, covers the \latextohtml-based
  document conversion system and not the more modern
  \texttt{tex4ht}-based system.}  }
...
\providecommand{\HTMLURL}{http://www.w3.org/hypertext/WWW/MarkUp/MarkUp.html}
\providecommand{\LtoHURL}{http://www.tex.ac.uk/tex-archive/support/latex2html/}
\providecommand{\LtoHManURL}{http://astro.dur.ac.uk/~{}pdraper/latex2html/manual2002/}
\providecommand{\supportURL}{http://astro.dur.ac.uk/\~{}pdraper/star2html/star2html.html}
