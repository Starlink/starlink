...
\newcommand{\halfpfig} [4] {
  \begin{figure}[htbp]
    ...
    \centering\epsfig{file=#1,width=#4,clip=}
...
The \cnam{\iref{BOXFRAME}} command can label axes using a \verb+HH MM
SS.S+ and \verb+DD MM SS.S+ format providing the data and frame limits
...
\sstroutine{
   ...
   \sstnotes{
      \sstitemlist{
         ...
         \begin{description}
            \item \verb+XOPT='BCNSTZHG' YOPT='BCNSTZDG'+
         \end{description}
