      SUBROUTINE PROJ_TANPTLM( PHI0, THETA0, PHI, THETA, L, M, STATUS )
*+
*  Name:
*     PROJ_TANPTLM

*  Purpose:
*     Find direction cosines for position in the TAN projection

*  Language:
*     Starlink Fortran 77

*  Invocation:
*     CALL PROJ_TANPTLM( PHI0, THETA0, PHI, THETA, L, M, STATUS )

*  Description:
*     Uses a TAN projection where the projected point is made by
*     drawing a line from the centre of the celestial sphere to the
*     tangent plane of the reference point
*
