      SUBROUTINE PON_ASFIO( PNFILE, ACMODE, FORM, RECSZ, FD, OPEN,
     :                       STATUS )
*+
*  Name:
*     PON_ASFIO
...
*  Invocation:
*     CALL PON_ASFIO( PNFILE, ACMODE, FORM, RECSZ, FD, OPEN, STATUS )
