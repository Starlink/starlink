      SUBROUTINE PROJ_MERPTLM( PHI0, THETA0, PHI, THETA, L, M, STATUS )
*+
*  Name:
*     PROJ_MERPTLM

*  Purpose:
*     Find direction cosines for position in the MER projection

*  Language:
*     Starlink Fortran 77

*  Invocation:
*     CALL PROJ_MERPTLM( PHI0, THETA0, PHI, THETA, L, M, STATUS )
...
*  Check inherited global status.
      ...
      CALL PROJ_MERPAR( THETA0, GEOMPAR)
      CALL PROJ_MERPTLMQK(PHI0, PHI, THETA, GEOMPAR, L, M, STATUS)
      END
* $Id$
