      SUBROUTINE PROJ_AITLMPT( PHI0, THETA0, L, M, PHI, THETA, STATUS )
*+
*  Name:
*     PROJ_AITLMPT
...
*  Local Variables:
      DOUBLE PRECISION AITPARS( 3 ) ! scaling parameters
...
*  Check inherited global status.
      ...
      CALL PROJ_AITPAR(THETA0,AITPARS)
      CALL PROJ_AITLMPTQK( PHI0, THETA0, L, M, AITPARS, PHI, THETA,
     : STATUS )
